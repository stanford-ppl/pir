...
lazy val pir = Project("pir", 
  ...
  unmanagedSourceDirectories in Compile += baseDirectory(_ / "src/pass/DeadCodeElimination.scala").value,
  unmanagedSourceDirectories in Compile += baseDirectory(_ / "src/pass/ControlPropogation.scala").value,
  unmanagedSourceDirectories in Compile += baseDirectory(_ / "src/pass/ContextInsertion.scala").value,
  unmanagedSourceDirectories in Compile += baseDirectory(_ / "src/pass/PIRPass.scala").value,
