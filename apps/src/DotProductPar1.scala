...
object DotProductPar1 extends PIRApp {
  ...
  def main(top:Top) = {
    ...
    val x1094 = MetaPipeline(name="x1094",parent=x1098) { implicit CU => 
      ...
      val ctr1 = Counter(min=Const(0), max=x1019_x1030.load, step=Const(3200), par=1) // Counter
      val x1032 = CounterChain(name = "x1032", ctr1).iter(240)
    }
    val x1033_dsp0 = MemoryPipeline(name="x1033_dsp0",parent="x1094") { implicit CU => 
      ...
      val x1033_x1078 =  SRAM(size=3200,banking = Strided(1)).wtPort(x1051_x1051.readPort).rdPort(x1033_x1078_x1087_v).rdAddr(x1076(0)).wtAddr(x1047(0))
    ...
    val x1034_dsp0 = MemoryPipeline(name="x1034_dsp0",parent="x1094") { implicit CU => 
      ...
      val x1076 = CounterChain.copy("x1087_0", "x1076")
      val x1034_x1079 =  SRAM(size=3200,banking = Strided(1)).wtPort(x1070_x1070.readPort).rdPort(x1034_x1079_x1087_v).rdAddr(x1076(0)).wtAddr(x1066(0))
      var stage: List[Stage] = Nil
    }
    ...
    val x1044_0 = Pipeline(name="x1044_0",parent=x1053) { implicit CU => 
      ...
      Stage(operands=List(Const(12800)), op=Bypass, results=List(CU.scalarOut(x1035_b1118_x1043_b1120_s)))
    }
    ...
    val x1052 = Pipeline(name="x1052",parent=x1053) { implicit CU => 
      ...
      val x1047 = CounterChain(name = "x1047", ctr2).iter(200)
      var stage: List[Stage] = Nil
    }
    ...
    val x1063_0 = Pipeline(name="x1063_0",parent=x1072) { implicit CU => 
      ...
      Stage(operands=List(Const(12800)), op=Bypass, results=List(CU.scalarOut(x1054_b1122_x1062_b1124_s)))
    }
    ...
    val x1071 = Pipeline(name="x1071",parent=x1072) { implicit CU => 
      ...
      val x1066 = CounterChain(name = "x1066", ctr3).iter(200)
      var stage: List[Stage] = Nil
    }
    val x1087_0 = Pipeline(name="x1087_0",parent=x1094) { implicit CU => 
      ...
      val x1076 = CounterChain(name = "x1076", ctr4).iter(200)
      var stage: List[Stage] = Nil
