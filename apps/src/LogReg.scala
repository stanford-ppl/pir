...
object LogRegDesign extends PIRApp {
  def main(args: String*)(top:Top) = {
    ...
    val x5991_0 = UnitPipeline(name = "x5991_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5576_x5982 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
    ...
    val x6002_0 = UnitPipeline(name = "x6002_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5576_x5993 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6013_0 = UnitPipeline(name = "x6013_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5576_x6004 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6024_0 = UnitPipeline(name = "x6024_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5576_x6015 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6035_0 = UnitPipeline(name = "x6035_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5576_x6026 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6046_0 = UnitPipeline(name = "x6046_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5576_x6037 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6057_0 = UnitPipeline(name = "x6057_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5576_x6048 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6068_0 = UnitPipeline(name = "x6068_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5576_x6059 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6079_0 = UnitPipeline(name = "x6079_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5576_x6070 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6090_0 = UnitPipeline(name = "x6090_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5576_x6081 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6101_0 = UnitPipeline(name = "x6101_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5576_x6092 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6112_0 = UnitPipeline(name = "x6112_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5576_x6103 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6123_0 = UnitPipeline(name = "x6123_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5576_x6114 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6134_0 = UnitPipeline(name = "x6134_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5576_x6125 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6145_0 = UnitPipeline(name = "x6145_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5576_x6136 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6156_0 = UnitPipeline(name = "x6156_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5576_x6147 = SemiFIFO(size = 10, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5647_mc.vdata).rdAddr(x5672(0))
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6203_0 = Pipeline(name = "x6203_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6193 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6216_0 = Pipeline(name = "x6216_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6206 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6229_0 = Pipeline(name = "x6229_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6219 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6242_0 = Pipeline(name = "x6242_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6232 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6255_0 = Pipeline(name = "x6255_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6245 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6268_0 = Pipeline(name = "x6268_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6258 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6281_0 = Pipeline(name = "x6281_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6271 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6294_0 = Pipeline(name = "x6294_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6284 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6307_0 = Pipeline(name = "x6307_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6297 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6320_0 = Pipeline(name = "x6320_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5575_x6310 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6333_0 = Pipeline(name = "x6333_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6323 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6346_0 = Pipeline(name = "x6346_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5674 = CounterChain.copy(x6509, "x5674")
      val x5672 = CounterChain.copy(x6509, "x5672")
      val x5575_x6336 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6359_0 = Pipeline(name = "x6359_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5575_x6349 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6372_0 = Pipeline(name = "x6372_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5575_x6362 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6385_0 = Pipeline(name = "x6385_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5575_x6375 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
    ...
    val x6398_0 = Pipeline(name = "x6398_0", parent=x6509, deps=List()) { implicit CU => 
      ...
      val x5575_x6388 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x5674(0))).wtPort(x5602_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
