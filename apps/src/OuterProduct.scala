...
object OuterProduct extends PIRApp {
  def main(args: String*)(top:Top) = {
    ...
    val x1097_x1115_v = Vector("x1097_x1115")
    ...
    val x1124 = Sequential(name="x1124",parent=top) { implicit CU => 
      val x1019_x1031 = ScalarBuffer(size = 1).wtPort(x1019_argin)
      val x1018_x1033 = ScalarBuffer(size = 1).wtPort(x1018_argin)
    }
    val x1123 = MetaPipeline(name="x1123",parent=x1124) { implicit CU => 
      val x1019_x1031 = ScalarBuffer(size = 1).wtPort(x1019_argin)
      val x1018_x1033 = ScalarBuffer(size = 1).wtPort(x1018_argin)
      val ctr1 = Counter(min=Const(0), max=x1018_x1033.load, step=Const(64), par=1) // Counter
      val ctr2 = Counter(min=Const(0), max=x1019_x1031.load, step=Const(64), par=1) // Counter
      val x1035 = CounterChain(name = "x1035", ctr1, ctr2)
    }
    ...
    val x1059 = StreamController(name="x1059",parent=x1123) { implicit CU => 
      ...
      val x1059_unit = CounterChain(name = "x1059_unit", ctr3)
    }
    val x1047 = Pipeline(name="x1047",parent=x1059) { implicit CU => 
      val x646 = CU.temp
      val x1043 = CU.temp
      val x1043 = CU.temp
      val x1042 = ScalarBuffer(size = 1).wtPort(x1042_argin)
      val x1035 = CounterChain.copy("x1123", "x1035")
      val ctr4 = Counter(min=Const(1), max=Const(1), step=Const(1), par=1) // Counter
      val x1047_unit = CounterChain(name = "x1047_unit", ctr4)
      var stage: List[Stage] = Nil
      stage = CU.emptyStage +: Stages(5)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1035(0)), Const(4)), op=FixMul, results=List(CU.temp(stage(1), x646)))
      Stage(stage(2), operands=List(CU.temp(stage(1), x646), CU.load(stage(1), x1042)), op=FixAdd, results=List(CU.temp(stage(2), x1043)))
      Stage(stage(3), operands=List(CU.temp(stage(2), x1043)), op=Bypass, results=List(CU.scalarOut(stage(3), x1039_b1141_x1045_b1143_s)))
      Stage(stage(4), operands=List(Const(256)), op=Bypass, results=List(CU.scalarOut(stage(4), x1039_b1142_x1045_b1144_s)))
      Stage(stage(5), operands=List(Const(64)), op=Bypass, results=List(CU.scalarOut(stage(5), x1040_x1046_s)))
    }
    val x1048 = Fringe(name="x1048",parent=x1059,dram=x1023_oc, mode=TileLoad) { implicit CU => 
      CU.sizeFIFO = ScalarFIFO(size = 1, banking = Strided(1)).wtPort(x1039_b1142_x1045_b1144_s)
      CU.offsetFIFO = ScalarFIFO(size = 1, banking = Strided(1)).wtPort(x1039_b1141_x1045_b1143_s)
      CU.data = x1041_x1048_data_v
    }
    val x1058 = MetaPipeline(name="x1058",parent=x1059) { implicit CU => 
      ...
      val x1058_unit = CounterChain(name = "x1058_unit", ctr5)
    }
    val x1050 = Pipeline(name="x1050",parent=x1058) { implicit CU => 
      val x1040_x1049 = ScalarFIFO(size = 16, banking = Strided(1)).wtPort(x1040_x1046_s)
      val ctr6 = Counter(min=Const(1), max=Const(1), step=Const(1), par=1) // Counter
      val x1050_unit = CounterChain(name = "x1050_unit", ctr6)
      var stage: List[Stage] = Nil
    }
    val x1057 = Pipeline(name="x1057",parent=x1058) { implicit CU => 
      val x1041_x1053 = VectorFIFO(size = 1, banking = Strided(1)).wtPort(x1041_x1048_data_v)
      val ctr7 = Counter(min=Const(0), max=Const(64), step=Const(1), par=1) // Counter
      val x1052 = CounterChain(name = "x1052", ctr7)
      var stage: List[Stage] = Nil
    ...
    val x1080 = StreamController(name="x1080",parent=x1123) { implicit CU => 
      ...
      val x1080_unit = CounterChain(name = "x1080_unit", ctr8)
    }
    val x1068 = Pipeline(name="x1068",parent=x1080) { implicit CU => 
      val x1064 = CU.temp
      val x1064 = CU.temp
      val x673 = CU.temp
      val x1063 = ScalarBuffer(size = 1).wtPort(x1063_argin)
      val x1035 = CounterChain.copy("x1123", "x1035")
      val ctr9 = Counter(min=Const(1), max=Const(1), step=Const(1), par=1) // Counter
      val x1068_unit = CounterChain(name = "x1068_unit", ctr9)
      var stage: List[Stage] = Nil
      stage = CU.emptyStage +: Stages(5)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1035(1)), Const(4)), op=FixMul, results=List(CU.temp(stage(1), x673)))
      Stage(stage(2), operands=List(CU.temp(stage(1), x673), CU.load(stage(1), x1063)), op=FixAdd, results=List(CU.temp(stage(2), x1064)))
      Stage(stage(3), operands=List(CU.temp(stage(2), x1064)), op=Bypass, results=List(CU.scalarOut(stage(3), x1060_b1145_x1066_b1147_s)))
      Stage(stage(4), operands=List(Const(256)), op=Bypass, results=List(CU.scalarOut(stage(4), x1060_b1146_x1066_b1148_s)))
      Stage(stage(5), operands=List(Const(64)), op=Bypass, results=List(CU.scalarOut(stage(5), x1061_x1067_s)))
    }
    val x1069 = Fringe(name="x1069",parent=x1080,dram=x1025_oc, mode=TileLoad) { implicit CU => 
      CU.offsetFIFO = ScalarFIFO(size = 1, banking = Strided(1)).wtPort(x1060_b1145_x1066_b1147_s)
      CU.sizeFIFO = ScalarFIFO(size = 1, banking = Strided(1)).wtPort(x1060_b1146_x1066_b1148_s)
      CU.data = x1062_x1069_data_v
    }
    val x1079 = MetaPipeline(name="x1079",parent=x1080) { implicit CU => 
      ...
      val x1079_unit = CounterChain(name = "x1079_unit", ctr10)
    }
    val x1071 = Pipeline(name="x1071",parent=x1079) { implicit CU => 
      val x1061_x1070 = ScalarFIFO(size = 16, banking = Strided(1)).wtPort(x1061_x1067_s)
      val ctr11 = Counter(min=Const(1), max=Const(1), step=Const(1), par=1) // Counter
      val x1071_unit = CounterChain(name = "x1071_unit", ctr11)
      var stage: List[Stage] = Nil
    }
    val x1078 = Pipeline(name="x1078",parent=x1079) { implicit CU => 
      val x1062_x1074 = VectorFIFO(size = 1, banking = Strided(1)).wtPort(x1062_x1069_data_v)
      val ctr12 = Counter(min=Const(0), max=Const(64), step=Const(1), par=1) // Counter
      val x1073 = CounterChain(name = "x1073", ctr12)
      var stage: List[Stage] = Nil
      stage = CU.emptyStage +: Stages(1)
    ...
    val x1092 = Pipeline(name="x1092",parent=x1123) { implicit CU => 
      ...
      val x1084 = CounterChain(name = "x1084", ctr13, ctr14)
      var stage: List[Stage] = Nil
      stage = CU.emptyStage +: Stages(1)
    ...
    val x1122 = StreamController(name="x1122",parent=x1123) { implicit CU => 
      ...
      val x1094 = CounterChain(name = "x1094", ctr15)
    }
    val x1117 = MetaPipeline(name="x1117",parent=x1122) { implicit CU => 
      ...
      val x1117_unit = CounterChain(name = "x1117_unit", ctr16)
    }
    val x1108 = Pipeline(name="x1108",parent=x1117) { implicit CU => 
      ...
      val x1104 = CU.temp
      val x1104 = CU.temp
      val x1019_x1100 = ScalarBuffer(size = 1).wtPort(x1019_argin)
      val x1099 = ScalarBuffer(size = 1).wtPort(x1099_argin)
      val x1035 = CounterChain.copy("x1123", "x1035")
      val x1094 = CounterChain.copy("x1122", "x1094")
      val ctr17 = Counter(min=Const(1), max=Const(1), step=Const(1), par=1) // Counter
      val x1108_unit = CounterChain(name = "x1108_unit", ctr17)
      var stage: List[Stage] = Nil
      stage = CU.emptyStage +: Stages(8)
      ...
      Stage(stage(5), operands=List(CU.temp(stage(4), x1103), CU.load(stage(4), x1099)), op=FixAdd, results=List(CU.temp(stage(5), x1104)))
      Stage(stage(6), operands=List(CU.temp(stage(5), x1104)), op=Bypass, results=List(CU.scalarOut(stage(6), x1095_b1151_x1106_b1153_s)))
      Stage(stage(7), operands=List(Const(256)), op=Bypass, results=List(CU.scalarOut(stage(7), x1095_b1152_x1106_b1154_s)))
      Stage(stage(8), operands=List(Const(64)), op=Bypass, results=List(CU.scalarOut(stage(8), x1096_x1107_s)))
    }
    val x1116 = Pipeline(name="x1116",parent=x1117) { implicit CU => 
      ...
      val x1110 = CounterChain(name = "x1110", ctr18)
      var stage: List[Stage] = Nil
      stage = CU.emptyStage +: Stages(1)
      Stage(stage(1), operands=List(CU.temp(stage(0), x1112)), op=Bypass, results=List(CU.vecOut(stage(1), x1097_x1115_v)))
    }
    val x1118 = Fringe(name="x1118",parent=x1122,dram=x1028_oc, mode=TileStore) { implicit CU => 
      CU.offsetFIFO = ScalarFIFO(size = 1, banking = Strided(1)).wtPort(x1095_b1151_x1106_b1153_s)
      CU.dataFIFO = VectorFIFO(size = 1, banking = Strided(1)).wtPort(x1097_x1115_v)
      CU.sizeFIFO = ScalarFIFO(size = 1, banking = Strided(1)).wtPort(x1095_b1152_x1106_b1154_s)
      CU.ack = x1098_x1118_ack_v
    }
    val x1121 = Pipeline(name="x1121",parent=x1122) { implicit CU => 
      val x1096_x1119 = ScalarFIFO(size = 16, banking = Strided(1)).wtPort(x1096_x1107_s)
      val x1098_x1120 = VectorFIFO(size = 1, banking = Strided(1)).wtPort(x1098_x1118_ack_v)
      val ctr19 = Counter(min=Const(1), max=Const(1), step=Const(1), par=1) // Counter
      val x1121_unit = CounterChain(name = "x1121_unit", ctr19)
      var stage: List[Stage] = Nil
    }
