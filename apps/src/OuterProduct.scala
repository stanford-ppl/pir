...
object OuterProduct extends PIRApp {
  def main(top:Top) = {
    ...
    val x1203_argin = ArgIn("x1203").bound(3840)
    val x1245_b1342_x1254_b1344_s = Scalar("x1245_b1342_x1254_b1344")
    val x1221_x1273_x1278_v = Vector("x1221_x1273_x1278")
    ...
    val x1204_argin = ArgIn("x1204").bound(3840)
    ...
    val x1319 = MetaPipeline(name="x1319",parent=x1320) { implicit CU => 
      ...
      val ctr1 = Counter(min=Const(0), max=x1203_x1218.load, step=Const(32), par=1) // Counter
      val ctr2 = Counter(min=Const(0), max=x1204_x1216.load, step=Const(32), par=1) // Counter
      val x1220 = CounterChain(name = "x1220", ctr1, ctr2).iter(14400)
    }
    val x1221_dsp0 = MemoryPipeline(name="x1221_dsp0",parent="x1319") { implicit CU => 
      ...
      val x1221_x1273 =  SRAM(size=32,banking = Strided(1)).wtPort(x1242_x1242.readPort).rdPort(x1221_x1273_x1278_v).rdAddr(x1269(0)).wtAddr(x1237(0))
    }
    val x1222_dsp0 = MemoryPipeline(name="x1222_dsp0",parent="x1319") { implicit CU => 
      ...
      val x1269 = CounterChain.copy("x1278", "x1269")
      val x1222_x1274 =  SRAM(size=32,banking = Strided(1)).wtPort(x1263_x1263.readPort).rdPort(x1222_x1274_x1278_v).rdAddr(x1269(1)).wtAddr(x1258(0))
    }
    val x1223_dsp0 = MemoryPipeline(name="x1223_dsp0",parent="x1319") { implicit CU => 
      ...
      val x1223_x1303 =  SRAM(size=1024,banking = Strided(1)).wtPort(x1277_x1277.readPort).rdPort(x1223_x1303_x1307_v)
      WAStage(operands=List(CU.ctr(x1269(0)), Const(32)), op=FixMul, results=List(b1345))
      WAStage(operands=List(b1345, CU.ctr(x1269(1))), op=FixAdd, results=List(x1223_x1303.writeAddr))
      RAStage(operands=List(CU.ctr(x1280(0)), Const(32)), op=FixMul, results=List(b1351))
    ...
    val x1234 = Pipeline(name="x1234",parent=x1244) { implicit CU => 
      ...
      Stage(operands=List(Const(128)), op=Bypass, results=List(CU.scalarOut(x1224_b1338_x1233_b1340_s)))
    }
    ...
    val x1243 = Pipeline(name="x1243",parent=x1244) { implicit CU => 
      ...
      val x1237 = CounterChain(name = "x1237", ctr3).iter(2)
    }
    ...
    val x1255 = Pipeline(name="x1255",parent=x1265) { implicit CU => 
      ...
      Stage(operands=List(Const(128)), op=Bypass, results=List(CU.scalarOut(x1245_b1342_x1254_b1344_s)))
    }
    ...
    val x1264 = Pipeline(name="x1264",parent=x1265) { implicit CU => 
      ...
      val x1258 = CounterChain(name = "x1258", ctr4).iter(2)
    }
    val x1278 = Pipeline(name="x1278",parent=x1319) { implicit CU => 
      val x1273_x1273 =  VectorFIFO(size=1).wtPort(x1221_x1273_x1278_v)
      val x1274_x1274 =  VectorFIFO(size=1).wtPort(x1222_x1274_x1278_v)
      val ctr5 = Counter(min=Const(0), max=Const(32), step=Const(1), par=1) // Counter
      val ctr6 = Counter(min=Const(0), max=Const(32), step=Const(1), par=16) // Counter
      val x1269 = CounterChain(name = "x1269", ctr5, ctr6).iter(64)
    ...
    val x1318 = StreamController(name="x1318",parent=x1319) { implicit CU => 
      ...
      val x1280 = CounterChain(name = "x1280", ctr7).iter(32)
    }
    ...
    val x1297 = Pipeline(name="x1297",parent=x1308) { implicit CU => 
      ...
      Stage(operands=List(Const(128)), op=Bypass, results=List(CU.scalarOut(x1281_b1348_x1296_b1350_s)))
    }
    val x1307 = Pipeline(name="x1307",parent=x1308) { implicit CU => 
      val ctr8 = Counter(min=Const(0), max=Const(32), step=Const(1), par=16) // Counter
      val x1299 = CounterChain(name = "x1299", ctr8).iter(2)
    }
