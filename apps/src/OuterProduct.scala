...
object OuterProduct extends PIRApp {
  def main(args: String*)(top:Top) = {
    ...
    val x5012 = MetaPipeline(name="x5012",parent=x5013) { implicit CU => 
      ...
      val ctr1 = Counter(min=Const(0), max=x4011_x4026.load, step=Const(384), par=1) // Counter
      val ctr2 = Counter(min=Const(0), max=x4012_x4024.load, step=Const(96), par=10) // Counter
      val x4028 = CounterChain(name = "x4028", ctr1, ctr2).iter(1474560)
    }
    val x4029_dsp0 = MemoryPipeline(name="x4029_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4029_x4496 =  SRAM(size=384,banking = Strided(1)).wtPort(x4077_x4077.readPort).rdPort(x4029_x4496_x4501_v).rdAddr(x4492(0)).wtAddr(x4072(0))
    ...
    val x4030_dsp0 = MemoryPipeline(name="x4030_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4030_x4508 =  SRAM(size=384,banking = Strided(1)).wtPort(x4120_x4120.readPort).rdPort(x4030_x4508_x4513_v).rdAddr(x4504(0)).wtAddr(x4115(0))
      var stage: List[Stage] = Nil
    }
    val x4031_dsp0 = MemoryPipeline(name="x4031_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4031_x4520 =  SRAM(size=384,banking = Strided(1)).wtPort(x4163_x4163.readPort).rdPort(x4031_x4520_x4525_v).rdAddr(x4516(0)).wtAddr(x4158(0))
      var stage: List[Stage] = Nil
    }
    val x4032_dsp0 = MemoryPipeline(name="x4032_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4032_x4532 =  SRAM(size=384,banking = Strided(1)).wtPort(x4206_x4206.readPort).rdPort(x4032_x4532_x4537_v).rdAddr(x4528(0)).wtAddr(x4201(0))
      var stage: List[Stage] = Nil
    }
    val x4033_dsp0 = MemoryPipeline(name="x4033_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4033_x4544 =  SRAM(size=384,banking = Strided(1)).wtPort(x4249_x4249.readPort).rdPort(x4033_x4544_x4549_v).rdAddr(x4540(0)).wtAddr(x4244(0))
      var stage: List[Stage] = Nil
    }
    val x4034_dsp0 = MemoryPipeline(name="x4034_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4034_x4556 =  SRAM(size=384,banking = Strided(1)).wtPort(x4292_x4292.readPort).rdPort(x4034_x4556_x4561_v).rdAddr(x4552(0)).wtAddr(x4287(0))
      var stage: List[Stage] = Nil
    }
    val x4035_dsp0 = MemoryPipeline(name="x4035_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4035_x4568 =  SRAM(size=384,banking = Strided(1)).wtPort(x4335_x4335.readPort).rdPort(x4035_x4568_x4573_v).rdAddr(x4564(0)).wtAddr(x4330(0))
      var stage: List[Stage] = Nil
    }
    val x4036_dsp0 = MemoryPipeline(name="x4036_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4036_x4580 =  SRAM(size=384,banking = Strided(1)).wtPort(x4378_x4378.readPort).rdPort(x4036_x4580_x4585_v).rdAddr(x4576(0)).wtAddr(x4373(0))
      var stage: List[Stage] = Nil
    }
    val x4037_dsp0 = MemoryPipeline(name="x4037_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4037_x4592 =  SRAM(size=384,banking = Strided(1)).wtPort(x4421_x4421.readPort).rdPort(x4037_x4592_x4597_v).rdAddr(x4588(0)).wtAddr(x4416(0))
      var stage: List[Stage] = Nil
    }
    val x4038_dsp0 = MemoryPipeline(name="x4038_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4038_x4604 =  SRAM(size=384,banking = Strided(1)).wtPort(x4464_x4464.readPort).rdPort(x4038_x4604_x4609_v).rdAddr(x4600(0)).wtAddr(x4459(0))
      var stage: List[Stage] = Nil
    }
    val x4039_dsp0 = MemoryPipeline(name="x4039_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4492 = CounterChain.copy("x4501_0", "x4492")
      val x4039_x4497 =  SRAM(size=96,banking = Strided(1)).wtPort(x4098_x4098.readPort).rdPort(x4039_x4497_x4501_v).rdAddr(x4492(1)).wtAddr(x4093(0))
      var stage: List[Stage] = Nil
    }
    val x4040_dsp0 = MemoryPipeline(name="x4040_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4504 = CounterChain.copy("x4513_0", "x4504")
      val x4040_x4509 =  SRAM(size=96,banking = Strided(1)).wtPort(x4141_x4141.readPort).rdPort(x4040_x4509_x4513_v).rdAddr(x4504(1)).wtAddr(x4136(0))
      var stage: List[Stage] = Nil
    }
    val x4041_dsp0 = MemoryPipeline(name="x4041_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4516 = CounterChain.copy("x4525_0", "x4516")
      val x4041_x4521 =  SRAM(size=96,banking = Strided(1)).wtPort(x4184_x4184.readPort).rdPort(x4041_x4521_x4525_v).rdAddr(x4516(1)).wtAddr(x4179(0))
      var stage: List[Stage] = Nil
    }
    val x4042_dsp0 = MemoryPipeline(name="x4042_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4528 = CounterChain.copy("x4537_0", "x4528")
      val x4042_x4533 =  SRAM(size=96,banking = Strided(1)).wtPort(x4227_x4227.readPort).rdPort(x4042_x4533_x4537_v).rdAddr(x4528(1)).wtAddr(x4222(0))
      var stage: List[Stage] = Nil
    }
    val x4043_dsp0 = MemoryPipeline(name="x4043_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4540 = CounterChain.copy("x4549_0", "x4540")
      val x4043_x4545 =  SRAM(size=96,banking = Strided(1)).wtPort(x4270_x4270.readPort).rdPort(x4043_x4545_x4549_v).rdAddr(x4540(1)).wtAddr(x4265(0))
      var stage: List[Stage] = Nil
    }
    val x4044_dsp0 = MemoryPipeline(name="x4044_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4552 = CounterChain.copy("x4561_0", "x4552")
      val x4044_x4557 =  SRAM(size=96,banking = Strided(1)).wtPort(x4313_x4313.readPort).rdPort(x4044_x4557_x4561_v).rdAddr(x4552(1)).wtAddr(x4308(0))
      var stage: List[Stage] = Nil
    }
    val x4045_dsp0 = MemoryPipeline(name="x4045_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4564 = CounterChain.copy("x4573_0", "x4564")
      val x4045_x4569 =  SRAM(size=96,banking = Strided(1)).wtPort(x4356_x4356.readPort).rdPort(x4045_x4569_x4573_v).rdAddr(x4564(1)).wtAddr(x4351(0))
      var stage: List[Stage] = Nil
    }
    val x4046_dsp0 = MemoryPipeline(name="x4046_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4576 = CounterChain.copy("x4585_0", "x4576")
      val x4046_x4581 =  SRAM(size=96,banking = Strided(1)).wtPort(x4399_x4399.readPort).rdPort(x4046_x4581_x4585_v).rdAddr(x4576(1)).wtAddr(x4394(0))
      var stage: List[Stage] = Nil
    }
    val x4047_dsp0 = MemoryPipeline(name="x4047_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4588 = CounterChain.copy("x4597_0", "x4588")
      val x4047_x4593 =  SRAM(size=96,banking = Strided(1)).wtPort(x4442_x4442.readPort).rdPort(x4047_x4593_x4597_v).rdAddr(x4588(1)).wtAddr(x4437(0))
      var stage: List[Stage] = Nil
    }
    val x4048_dsp0 = MemoryPipeline(name="x4048_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4600 = CounterChain.copy("x4609_0", "x4600")
      val x4048_x4605 =  SRAM(size=96,banking = Strided(1)).wtPort(x4485_x4485.readPort).rdPort(x4048_x4605_x4609_v).rdAddr(x4600(1)).wtAddr(x4480(0))
      var stage: List[Stage] = Nil
    }
    val x4049_dsp0 = MemoryPipeline(name="x4049_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4049_x4635 =  SRAM(size=36864,banking = Strided(1)).wtPort(x4500_x4500.readPort).rdPort(x4049_x4635_x4639_v)
      var stage: List[Stage] = Nil
      WAStage(operands=List(CU.ctr(x4492(0)), Const(96)), op=FixMul, results=List(b5110))
      WAStage(operands=List(b5110, CU.ctr(x4492(1))), op=FixAdd, results=List(x4049_x4635.writeAddr))
      RAStage(operands=List(CU.ctr(x4612(0)), Const(96)), op=FixMul, results=List(b5134))
    ...
    val x4050_dsp0 = MemoryPipeline(name="x4050_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4050_x4675 =  SRAM(size=36864,banking = Strided(1)).wtPort(x4512_x4512.readPort).rdPort(x4050_x4675_x4679_v)
      var stage: List[Stage] = Nil
      WAStage(operands=List(CU.ctr(x4504(0)), Const(96)), op=FixMul, results=List(b5112))
      WAStage(operands=List(b5112, CU.ctr(x4504(1))), op=FixAdd, results=List(x4050_x4675.writeAddr))
      RAStage(operands=List(CU.ctr(x4652(0)), Const(96)), op=FixMul, results=List(b5140))
    ...
    val x4051_dsp0 = MemoryPipeline(name="x4051_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4051_x4715 =  SRAM(size=36864,banking = Strided(1)).wtPort(x4524_x4524.readPort).rdPort(x4051_x4715_x4719_v)
      var stage: List[Stage] = Nil
      WAStage(operands=List(CU.ctr(x4516(0)), Const(96)), op=FixMul, results=List(b5114))
      WAStage(operands=List(b5114, CU.ctr(x4516(1))), op=FixAdd, results=List(x4051_x4715.writeAddr))
      RAStage(operands=List(CU.ctr(x4692(0)), Const(96)), op=FixMul, results=List(b5146))
    ...
    val x4052_dsp0 = MemoryPipeline(name="x4052_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4052_x4755 =  SRAM(size=36864,banking = Strided(1)).wtPort(x4536_x4536.readPort).rdPort(x4052_x4755_x4759_v)
      var stage: List[Stage] = Nil
      WAStage(operands=List(CU.ctr(x4528(0)), Const(96)), op=FixMul, results=List(b5116))
      WAStage(operands=List(b5116, CU.ctr(x4528(1))), op=FixAdd, results=List(x4052_x4755.writeAddr))
      RAStage(operands=List(CU.ctr(x4732(0)), Const(96)), op=FixMul, results=List(b5152))
    ...
    val x4053_dsp0 = MemoryPipeline(name="x4053_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4053_x4795 =  SRAM(size=36864,banking = Strided(1)).wtPort(x4548_x4548.readPort).rdPort(x4053_x4795_x4799_v)
      var stage: List[Stage] = Nil
      WAStage(operands=List(CU.ctr(x4540(0)), Const(96)), op=FixMul, results=List(b5118))
      WAStage(operands=List(b5118, CU.ctr(x4540(1))), op=FixAdd, results=List(x4053_x4795.writeAddr))
      RAStage(operands=List(CU.ctr(x4772(0)), Const(96)), op=FixMul, results=List(b5158))
    ...
    val x4054_dsp0 = MemoryPipeline(name="x4054_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4054_x4835 =  SRAM(size=36864,banking = Strided(1)).wtPort(x4560_x4560.readPort).rdPort(x4054_x4835_x4839_v)
      var stage: List[Stage] = Nil
      WAStage(operands=List(CU.ctr(x4552(0)), Const(96)), op=FixMul, results=List(b5120))
      WAStage(operands=List(b5120, CU.ctr(x4552(1))), op=FixAdd, results=List(x4054_x4835.writeAddr))
      RAStage(operands=List(CU.ctr(x4812(0)), Const(96)), op=FixMul, results=List(b5164))
    ...
    val x4055_dsp0 = MemoryPipeline(name="x4055_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4055_x4875 =  SRAM(size=36864,banking = Strided(1)).wtPort(x4572_x4572.readPort).rdPort(x4055_x4875_x4879_v)
      var stage: List[Stage] = Nil
      WAStage(operands=List(CU.ctr(x4564(0)), Const(96)), op=FixMul, results=List(b5122))
      WAStage(operands=List(b5122, CU.ctr(x4564(1))), op=FixAdd, results=List(x4055_x4875.writeAddr))
      RAStage(operands=List(CU.ctr(x4852(0)), Const(96)), op=FixMul, results=List(b5170))
    ...
    val x4056_dsp0 = MemoryPipeline(name="x4056_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4056_x4915 =  SRAM(size=36864,banking = Strided(1)).wtPort(x4584_x4584.readPort).rdPort(x4056_x4915_x4919_v)
      var stage: List[Stage] = Nil
      WAStage(operands=List(CU.ctr(x4576(0)), Const(96)), op=FixMul, results=List(b5124))
      WAStage(operands=List(b5124, CU.ctr(x4576(1))), op=FixAdd, results=List(x4056_x4915.writeAddr))
      RAStage(operands=List(CU.ctr(x4892(0)), Const(96)), op=FixMul, results=List(b5176))
    ...
    val x4057_dsp0 = MemoryPipeline(name="x4057_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4057_x4955 =  SRAM(size=36864,banking = Strided(1)).wtPort(x4596_x4596.readPort).rdPort(x4057_x4955_x4959_v)
      var stage: List[Stage] = Nil
      WAStage(operands=List(CU.ctr(x4588(0)), Const(96)), op=FixMul, results=List(b5126))
      WAStage(operands=List(b5126, CU.ctr(x4588(1))), op=FixAdd, results=List(x4057_x4955.writeAddr))
      RAStage(operands=List(CU.ctr(x4932(0)), Const(96)), op=FixMul, results=List(b5182))
    ...
    val x4058_dsp0 = MemoryPipeline(name="x4058_dsp0",parent="x5012") { implicit CU => 
      ...
      val x4058_x4995 =  SRAM(size=36864,banking = Strided(1)).wtPort(x4608_x4608.readPort).rdPort(x4058_x4995_x4999_v)
      var stage: List[Stage] = Nil
      WAStage(operands=List(CU.ctr(x4600(0)), Const(96)), op=FixMul, results=List(b5128))
      WAStage(operands=List(b5128, CU.ctr(x4600(1))), op=FixAdd, results=List(x4058_x4995.writeAddr))
      RAStage(operands=List(CU.ctr(x4972(0)), Const(96)), op=FixMul, results=List(b5188))
    ...
    val x4069_0 = Pipeline(name="x4069_0",parent=x4079) { implicit CU => 
      ...
      Stage(operands=List(Const(1536)), op=Bypass, results=List(CU.scalarOut(x4059_b5031_x4068_b5033_s)))
    }
    ...
    val x4078 = Pipeline(name="x4078",parent=x4079) { implicit CU => 
      ...
      val x4072 = CounterChain(name = "x4072", ctr3).iter(24)
      var stage: List[Stage] = Nil
    }
    ...
    val x4090_0 = Pipeline(name="x4090_0",parent=x4100) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4080_b5035_x4089_b5037_s)))
    }
    ...
    val x4099 = Pipeline(name="x4099",parent=x4100) { implicit CU => 
      ...
      val x4093 = CounterChain(name = "x4093", ctr4).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4112_0 = Pipeline(name="x4112_0",parent=x4122) { implicit CU => 
      ...
      Stage(operands=List(Const(1536)), op=Bypass, results=List(CU.scalarOut(x4102_b5039_x4111_b5041_s)))
    }
    ...
    val x4121 = Pipeline(name="x4121",parent=x4122) { implicit CU => 
      ...
      val x4115 = CounterChain(name = "x4115", ctr5).iter(24)
      var stage: List[Stage] = Nil
    }
    ...
    val x4133_0 = Pipeline(name="x4133_0",parent=x4143) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4123_b5043_x4132_b5045_s)))
    }
    ...
    val x4142 = Pipeline(name="x4142",parent=x4143) { implicit CU => 
      ...
      val x4136 = CounterChain(name = "x4136", ctr6).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4155_0 = Pipeline(name="x4155_0",parent=x4165) { implicit CU => 
      ...
      Stage(operands=List(Const(1536)), op=Bypass, results=List(CU.scalarOut(x4145_b5047_x4154_b5049_s)))
    }
    ...
    val x4164 = Pipeline(name="x4164",parent=x4165) { implicit CU => 
      ...
      val x4158 = CounterChain(name = "x4158", ctr7).iter(24)
      var stage: List[Stage] = Nil
    }
    ...
    val x4176_0 = Pipeline(name="x4176_0",parent=x4186) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4166_b5051_x4175_b5053_s)))
    }
    ...
    val x4185 = Pipeline(name="x4185",parent=x4186) { implicit CU => 
      ...
      val x4179 = CounterChain(name = "x4179", ctr8).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4198_0 = Pipeline(name="x4198_0",parent=x4208) { implicit CU => 
      ...
      Stage(operands=List(Const(1536)), op=Bypass, results=List(CU.scalarOut(x4188_b5055_x4197_b5057_s)))
    }
    ...
    val x4207 = Pipeline(name="x4207",parent=x4208) { implicit CU => 
      ...
      val x4201 = CounterChain(name = "x4201", ctr9).iter(24)
      var stage: List[Stage] = Nil
    }
    ...
    val x4219_0 = Pipeline(name="x4219_0",parent=x4229) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4209_b5059_x4218_b5061_s)))
    }
    ...
    val x4228 = Pipeline(name="x4228",parent=x4229) { implicit CU => 
      ...
      val x4222 = CounterChain(name = "x4222", ctr10).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4241_0 = Pipeline(name="x4241_0",parent=x4251) { implicit CU => 
      ...
      Stage(operands=List(Const(1536)), op=Bypass, results=List(CU.scalarOut(x4231_b5063_x4240_b5065_s)))
    }
    ...
    val x4250 = Pipeline(name="x4250",parent=x4251) { implicit CU => 
      ...
      val x4244 = CounterChain(name = "x4244", ctr11).iter(24)
      var stage: List[Stage] = Nil
    }
    ...
    val x4262_0 = Pipeline(name="x4262_0",parent=x4272) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4252_b5067_x4261_b5069_s)))
    }
    ...
    val x4271 = Pipeline(name="x4271",parent=x4272) { implicit CU => 
      ...
      val x4265 = CounterChain(name = "x4265", ctr12).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4284_0 = Pipeline(name="x4284_0",parent=x4294) { implicit CU => 
      ...
      Stage(operands=List(Const(1536)), op=Bypass, results=List(CU.scalarOut(x4274_b5071_x4283_b5073_s)))
    }
    ...
    val x4293 = Pipeline(name="x4293",parent=x4294) { implicit CU => 
      val ctr13 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16) // Counter
      val x4287 = CounterChain(name = "x4287", ctr13).iter(24)
      var stage: List[Stage] = Nil
    }
    ...
    val x4305_0 = Pipeline(name="x4305_0",parent=x4315) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4295_b5075_x4304_b5077_s)))
    }
    ...
    val x4314 = Pipeline(name="x4314",parent=x4315) { implicit CU => 
      ...
      val x4308 = CounterChain(name = "x4308", ctr14).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4327_0 = Pipeline(name="x4327_0",parent=x4337) { implicit CU => 
      ...
      Stage(operands=List(Const(1536)), op=Bypass, results=List(CU.scalarOut(x4317_b5079_x4326_b5081_s)))
    }
    ...
    val x4336 = Pipeline(name="x4336",parent=x4337) { implicit CU => 
      val ctr15 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16) // Counter
      val x4330 = CounterChain(name = "x4330", ctr15).iter(24)
      var stage: List[Stage] = Nil
    }
    ...
    val x4348_0 = Pipeline(name="x4348_0",parent=x4358) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4338_b5083_x4347_b5085_s)))
    }
    ...
    val x4357 = Pipeline(name="x4357",parent=x4358) { implicit CU => 
      ...
      val x4351 = CounterChain(name = "x4351", ctr16).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4370_0 = Pipeline(name="x4370_0",parent=x4380) { implicit CU => 
      ...
      Stage(operands=List(Const(1536)), op=Bypass, results=List(CU.scalarOut(x4360_b5087_x4369_b5089_s)))
    }
    ...
    val x4379 = Pipeline(name="x4379",parent=x4380) { implicit CU => 
      val ctr17 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16) // Counter
      val x4373 = CounterChain(name = "x4373", ctr17).iter(24)
      var stage: List[Stage] = Nil
    }
    ...
    val x4391_0 = Pipeline(name="x4391_0",parent=x4401) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4381_b5091_x4390_b5093_s)))
    }
    ...
    val x4400 = Pipeline(name="x4400",parent=x4401) { implicit CU => 
      ...
      val x4394 = CounterChain(name = "x4394", ctr18).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4413_0 = Pipeline(name="x4413_0",parent=x4423) { implicit CU => 
      ...
      Stage(operands=List(Const(1536)), op=Bypass, results=List(CU.scalarOut(x4403_b5095_x4412_b5097_s)))
    }
    ...
    val x4422 = Pipeline(name="x4422",parent=x4423) { implicit CU => 
      val ctr19 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16) // Counter
      val x4416 = CounterChain(name = "x4416", ctr19).iter(24)
      var stage: List[Stage] = Nil
    }
    ...
    val x4434_0 = Pipeline(name="x4434_0",parent=x4444) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4424_b5099_x4433_b5101_s)))
    }
    ...
    val x4443 = Pipeline(name="x4443",parent=x4444) { implicit CU => 
      val ctr20 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16) // Counter
      val x4437 = CounterChain(name = "x4437", ctr20).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4456_0 = Pipeline(name="x4456_0",parent=x4466) { implicit CU => 
      ...
      Stage(operands=List(Const(1536)), op=Bypass, results=List(CU.scalarOut(x4446_b5103_x4455_b5105_s)))
    }
    ...
    val x4465 = Pipeline(name="x4465",parent=x4466) { implicit CU => 
      val ctr21 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16) // Counter
      val x4459 = CounterChain(name = "x4459", ctr21).iter(24)
      var stage: List[Stage] = Nil
    }
    ...
    val x4477_0 = Pipeline(name="x4477_0",parent=x4487) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4467_b5107_x4476_b5109_s)))
    }
    ...
    val x4486 = Pipeline(name="x4486",parent=x4487) { implicit CU => 
      val ctr22 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16) // Counter
      val x4480 = CounterChain(name = "x4480", ctr22).iter(6)
      var stage: List[Stage] = Nil
    }
    val x4501_0 = Pipeline(name="x4501_0",parent=x5012) { implicit CU => 
      val x4497_x4497 =  VectorFIFO(size=1).wtPort(x4039_x4497_x4501_v)
      val x4496_x4496 =  VectorFIFO(size=1).wtPort(x4029_x4496_x4501_v)
      ...
      val x4492 = CounterChain(name = "x4492", ctr23, ctr24).iter(2304)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(x4496_x4496), CU.load(x4497_x4497)), op=FixMul, results=List(CU.vecOut(x4049_x4500_v)))
    }
    val x4513_0 = Pipeline(name="x4513_0",parent=x5012) { implicit CU => 
      val x4509_x4509 =  VectorFIFO(size=1).wtPort(x4040_x4509_x4513_v)
      val x4508_x4508 =  VectorFIFO(size=1).wtPort(x4030_x4508_x4513_v)
      val ctr25 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val ctr26 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16) // Counter
      val x4504 = CounterChain(name = "x4504", ctr25, ctr26).iter(2304)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(x4508_x4508), CU.load(x4509_x4509)), op=FixMul, results=List(CU.vecOut(x4050_x4512_v)))
    }
    val x4525_0 = Pipeline(name="x4525_0",parent=x5012) { implicit CU => 
      val x4521_x4521 =  VectorFIFO(size=1).wtPort(x4041_x4521_x4525_v)
      val x4520_x4520 =  VectorFIFO(size=1).wtPort(x4031_x4520_x4525_v)
      ...
      val x4516 = CounterChain(name = "x4516", ctr27, ctr28).iter(2304)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(x4520_x4520), CU.load(x4521_x4521)), op=FixMul, results=List(CU.vecOut(x4051_x4524_v)))
    }
    val x4537_0 = Pipeline(name="x4537_0",parent=x5012) { implicit CU => 
      val x4533_x4533 =  VectorFIFO(size=1).wtPort(x4042_x4533_x4537_v)
      val x4532_x4532 =  VectorFIFO(size=1).wtPort(x4032_x4532_x4537_v)
      val ctr29 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val ctr30 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16) // Counter
      val x4528 = CounterChain(name = "x4528", ctr29, ctr30).iter(2304)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(x4532_x4532), CU.load(x4533_x4533)), op=FixMul, results=List(CU.vecOut(x4052_x4536_v)))
    }
    val x4549_0 = Pipeline(name="x4549_0",parent=x5012) { implicit CU => 
      val x4545_x4545 =  VectorFIFO(size=1).wtPort(x4043_x4545_x4549_v)
      val x4544_x4544 =  VectorFIFO(size=1).wtPort(x4033_x4544_x4549_v)
      val ctr31 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val ctr32 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16) // Counter
      val x4540 = CounterChain(name = "x4540", ctr31, ctr32).iter(2304)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(x4544_x4544), CU.load(x4545_x4545)), op=FixMul, results=List(CU.vecOut(x4053_x4548_v)))
    }
    val x4561_0 = Pipeline(name="x4561_0",parent=x5012) { implicit CU => 
      val x4557_x4557 =  VectorFIFO(size=1).wtPort(x4044_x4557_x4561_v)
      val x4556_x4556 =  VectorFIFO(size=1).wtPort(x4034_x4556_x4561_v)
      val ctr33 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val ctr34 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16) // Counter
      val x4552 = CounterChain(name = "x4552", ctr33, ctr34).iter(2304)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(x4556_x4556), CU.load(x4557_x4557)), op=FixMul, results=List(CU.vecOut(x4054_x4560_v)))
    }
    val x4573_0 = Pipeline(name="x4573_0",parent=x5012) { implicit CU => 
      val x4569_x4569 =  VectorFIFO(size=1).wtPort(x4045_x4569_x4573_v)
      val x4568_x4568 =  VectorFIFO(size=1).wtPort(x4035_x4568_x4573_v)
      val ctr35 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val ctr36 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16) // Counter
      val x4564 = CounterChain(name = "x4564", ctr35, ctr36).iter(2304)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(x4568_x4568), CU.load(x4569_x4569)), op=FixMul, results=List(CU.vecOut(x4055_x4572_v)))
    }
    val x4585_0 = Pipeline(name="x4585_0",parent=x5012) { implicit CU => 
      val x4581_x4581 =  VectorFIFO(size=1).wtPort(x4046_x4581_x4585_v)
      val x4580_x4580 =  VectorFIFO(size=1).wtPort(x4036_x4580_x4585_v)
      val ctr37 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val ctr38 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16) // Counter
      val x4576 = CounterChain(name = "x4576", ctr37, ctr38).iter(2304)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(x4580_x4580), CU.load(x4581_x4581)), op=FixMul, results=List(CU.vecOut(x4056_x4584_v)))
    }
    val x4597_0 = Pipeline(name="x4597_0",parent=x5012) { implicit CU => 
      val x4593_x4593 =  VectorFIFO(size=1).wtPort(x4047_x4593_x4597_v)
      val x4592_x4592 =  VectorFIFO(size=1).wtPort(x4037_x4592_x4597_v)
      val ctr39 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val ctr40 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16) // Counter
      val x4588 = CounterChain(name = "x4588", ctr39, ctr40).iter(2304)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(x4592_x4592), CU.load(x4593_x4593)), op=FixMul, results=List(CU.vecOut(x4057_x4596_v)))
    }
    val x4609_0 = Pipeline(name="x4609_0",parent=x5012) { implicit CU => 
      val x4605_x4605 =  VectorFIFO(size=1).wtPort(x4048_x4605_x4609_v)
      val x4604_x4604 =  VectorFIFO(size=1).wtPort(x4038_x4604_x4609_v)
      ...
      val x4600 = CounterChain(name = "x4600", ctr41, ctr42).iter(2304)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(x4604_x4604), CU.load(x4605_x4605)), op=FixMul, results=List(CU.vecOut(x4058_x4608_v)))
    }
    val x4650 = StreamController(name="x4650",parent=x5012) { implicit CU => 
      val ctr43 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val x4612 = CounterChain(name = "x4612", ctr43).iter(384)
    }
    ...
    val x4629_0 = Pipeline(name="x4629_0",parent=x4640) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4613_b5131_x4628_b5133_s)))
    }
    val x4639 = Pipeline(name="x4639",parent=x4640) { implicit CU => 
      ...
      val x4631 = CounterChain(name = "x4631", ctr44).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4690 = StreamController(name="x4690",parent=x5012) { implicit CU => 
      val ctr46 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val x4652 = CounterChain(name = "x4652", ctr46).iter(384)
    }
    ...
    val x4669_0 = Pipeline(name="x4669_0",parent=x4680) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4653_b5137_x4668_b5139_s)))
    }
    val x4679 = Pipeline(name="x4679",parent=x4680) { implicit CU => 
      ...
      val x4671 = CounterChain(name = "x4671", ctr47).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4730 = StreamController(name="x4730",parent=x5012) { implicit CU => 
      val ctr49 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val x4692 = CounterChain(name = "x4692", ctr49).iter(384)
    }
    ...
    val x4709_0 = Pipeline(name="x4709_0",parent=x4720) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4693_b5143_x4708_b5145_s)))
    }
    val x4719 = Pipeline(name="x4719",parent=x4720) { implicit CU => 
      ...
      val x4711 = CounterChain(name = "x4711", ctr50).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4770 = StreamController(name="x4770",parent=x5012) { implicit CU => 
      val ctr52 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val x4732 = CounterChain(name = "x4732", ctr52).iter(384)
    }
    ...
    val x4749_0 = Pipeline(name="x4749_0",parent=x4760) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4733_b5149_x4748_b5151_s)))
    }
    val x4759 = Pipeline(name="x4759",parent=x4760) { implicit CU => 
      ...
      val x4751 = CounterChain(name = "x4751", ctr53).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4810 = StreamController(name="x4810",parent=x5012) { implicit CU => 
      val ctr55 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val x4772 = CounterChain(name = "x4772", ctr55).iter(384)
    }
    ...
    val x4789_0 = Pipeline(name="x4789_0",parent=x4800) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4773_b5155_x4788_b5157_s)))
    }
    val x4799 = Pipeline(name="x4799",parent=x4800) { implicit CU => 
      ...
      val x4791 = CounterChain(name = "x4791", ctr56).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4850 = StreamController(name="x4850",parent=x5012) { implicit CU => 
      val ctr58 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val x4812 = CounterChain(name = "x4812", ctr58).iter(384)
    }
    ...
    val x4829_0 = Pipeline(name="x4829_0",parent=x4840) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4813_b5161_x4828_b5163_s)))
    }
    val x4839 = Pipeline(name="x4839",parent=x4840) { implicit CU => 
      ...
      val x4831 = CounterChain(name = "x4831", ctr59).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4890 = StreamController(name="x4890",parent=x5012) { implicit CU => 
      val ctr61 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val x4852 = CounterChain(name = "x4852", ctr61).iter(384)
    }
    ...
    val x4869_0 = Pipeline(name="x4869_0",parent=x4880) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4853_b5167_x4868_b5169_s)))
    }
    val x4879 = Pipeline(name="x4879",parent=x4880) { implicit CU => 
      ...
      val x4871 = CounterChain(name = "x4871", ctr62).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4930 = StreamController(name="x4930",parent=x5012) { implicit CU => 
      val ctr64 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val x4892 = CounterChain(name = "x4892", ctr64).iter(384)
    }
    ...
    val x4909_0 = Pipeline(name="x4909_0",parent=x4920) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4893_b5173_x4908_b5175_s)))
    }
    val x4919 = Pipeline(name="x4919",parent=x4920) { implicit CU => 
      ...
      val x4911 = CounterChain(name = "x4911", ctr65).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x4970 = StreamController(name="x4970",parent=x5012) { implicit CU => 
      val ctr67 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val x4932 = CounterChain(name = "x4932", ctr67).iter(384)
    }
    ...
    val x4949_0 = Pipeline(name="x4949_0",parent=x4960) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4933_b5179_x4948_b5181_s)))
    }
    val x4959 = Pipeline(name="x4959",parent=x4960) { implicit CU => 
      ...
      val x4951 = CounterChain(name = "x4951", ctr68).iter(6)
      var stage: List[Stage] = Nil
    }
    ...
    val x5010 = StreamController(name="x5010",parent=x5012) { implicit CU => 
      val ctr70 = Counter(min=Const(0), max=Const(384), step=Const(1), par=1) // Counter
      val x4972 = CounterChain(name = "x4972", ctr70).iter(384)
    }
    ...
    val x4989_0 = Pipeline(name="x4989_0",parent=x5000) { implicit CU => 
      ...
      Stage(operands=List(Const(384)), op=Bypass, results=List(CU.scalarOut(x4973_b5185_x4988_b5187_s)))
    }
    val x4999 = Pipeline(name="x4999",parent=x5000) { implicit CU => 
      ...
      val x4991 = CounterChain(name = "x4991", ctr71).iter(6)
      var stage: List[Stage] = Nil
    }
