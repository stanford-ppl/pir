...
object MatMult_outerDesign extends PIRApp {
  def main(args: String*)(top:Top) = {
    ...
    val bus_2670_vector = Vector("bus_2670")
    val bus_2638_vector = Vector("bus_2638")
    val x6502_x6830_addr_vector = Vector("x6502_x6830_addr")
    val bus_2710_vector = Vector("bus_2710")
    val bus_2622_vector = Vector("bus_2622")
    ...
    val bus_2237_scalar = Scalar("bus_2237")
    ...
    val bus_2236_scalar = Scalar("bus_2236")
    ...
    val bus_2206_scalar = Scalar("bus_2206")
    val bus_2662_vector = Vector("bus_2662")
    ...
    val bus_2630_vector = Vector("bus_2630")
    val bus_2614_vector = Vector("bus_2614")
    val x6513_x6863_addr_vector = Vector("x6513_x6863_addr")
    val bus_2654_vector = Vector("bus_2654")
    ...
    val x6445 = MetaPipeline(name = "x6445", parent=x6932, deps=List()) { implicit CU =>
      val stage0 = CU.emptyStage
      val ctr7 = (Const("0i").out, Const("16i").out, Const("1i").out) // Counter
      val x6401 = CounterChain(name = "x6401", ctr7)
      var stage: List[Stage] = Nil
    }
    val x6420 = StreamController(name = "x6420", parent=x6445, deps=List()) { implicit CU =>
      val stage0 = CU.emptyStage
      val x6420_unitcc = CounterChain(name = "x6420_unitcc", (Const("0i"), Const("1i"), Const("1i")))
      var stage: List[Stage] = Nil
    }
    val x6420_0 = StreamPipeline(name = "x6420_0", parent=x6420, deps=List()) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2206 = CU.temp
      val tr2204 = CU.temp
      val tr2199 = CU.temp
      ...
      val x6420_unitcc = CounterChain.copy(x6420, "x6420_unitcc")
      var stage: List[Stage] = Nil
      ...
      Stage(stage(7), operands=List(CU.temp(stage(6), tr2204), Const("64i")), op=FixMod, results=List(CU.temp(stage(7), tr2206), CU.scalarOut(stage(7), bus_2206_scalar)))
      Stage(stage(8), operands=List(CU.temp(stage(7), tr2204), CU.temp(stage(7), tr2206)), op=FixSub, results=List(CU.scalarOut(stage(8), bus_2207_scalar)))
    }
    val x6420_1 = StreamPipeline(name = "x6420_1", parent=x6420, deps=List(x6420_0)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2210 = CU.temp
      val tr2209 = CU.temp
      val x6420_unitcc = CounterChain.copy(x6420, "x6420_unitcc")
      ...
      Stage(stage(1), operands=List(CU.scalarIn(stage(0), bus_2206_scalar), Const("0i")), op=FixNeq, results=List(CU.temp(stage(1), tr2209)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr2209), Const("64i"), Const("0i")), op=Mux, results=List(CU.temp(stage(2), tr2210)))
      Stage(stage(3), operands=List(CU.scalarIn(stage(2), bus_2207_scalar), CU.temp(stage(2), tr2210)), op=FixAdd, results=List(CU.scalarOut(stage(3), x6424_mc.len)))
    }
    val x6492 = MetaPipeline(name = "x6492", parent=x6932, deps=List()) { implicit CU =>
      val stage0 = CU.emptyStage
      val ctr15 = (Const("0i").out, Const("48i").out, Const("1i").out) // Counter
      val x6448 = CounterChain(name = "x6448", ctr15)
      var stage: List[Stage] = Nil
    }
    val x6467 = StreamController(name = "x6467", parent=x6492, deps=List()) { implicit CU =>
      val stage0 = CU.emptyStage
      val x6467_unitcc = CounterChain(name = "x6467_unitcc", (Const("0i"), Const("1i"), Const("1i")))
      var stage: List[Stage] = Nil
    }
    val x6467_0 = StreamPipeline(name = "x6467_0", parent=x6467, deps=List()) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2236 = CU.temp
      val tr2234 = CU.temp
      val tr2229 = CU.temp
      ...
      val x6467_unitcc = CounterChain.copy(x6467, "x6467_unitcc")
      val x6396 = CounterChain.copy(x6932, "x6396")
      val x6393 = CounterChain.copy(x6956, "x6393")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(8)
      ...
      Stage(stage(7), operands=List(CU.temp(stage(6), tr2234), Const("64i")), op=FixMod, results=List(CU.temp(stage(7), tr2236), CU.scalarOut(stage(7), bus_2236_scalar)))
      Stage(stage(8), operands=List(CU.temp(stage(7), tr2234), CU.temp(stage(7), tr2236)), op=FixSub, results=List(CU.scalarOut(stage(8), bus_2237_scalar)))
    }
    val x6467_1 = StreamPipeline(name = "x6467_1", parent=x6467, deps=List(x6467_0)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2240 = CU.temp
      val tr2239 = CU.temp
      val x6467_unitcc = CounterChain.copy(x6467, "x6467_unitcc")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(3)
      Stage(stage(1), operands=List(CU.scalarIn(stage(0), bus_2236_scalar), Const("0i")), op=FixNeq, results=List(CU.temp(stage(1), tr2239)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr2239), Const("64i"), Const("0i")), op=Mux, results=List(CU.temp(stage(2), tr2240)))
      Stage(stage(3), operands=List(CU.scalarIn(stage(2), bus_2237_scalar), CU.temp(stage(2), tr2240)), op=FixAdd, results=List(CU.scalarOut(stage(3), x6471_mc.len)))
    }
    ...
    val x6579_0 = Pipeline(name = "x6579_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6397_x6566 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      val x6398_x6569 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      var stage: List[Stage] = Nil
    ...
    val x6595_0 = Pipeline(name = "x6595_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6397_x6582 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      val x6398_x6585 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6611_0 = Pipeline(name = "x6611_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      //val x6499 = CounterChain.copy(x6930, "x6499")
      val x6496 = CounterChain.copy(x6930, "x6496")
      val x6398_x6601 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      val x6397_x6598 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6627_0 = Pipeline(name = "x6627_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6398_x6617 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      val x6397_x6614 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6643_0 = Pipeline(name = "x6643_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6398_x6633 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      val x6397_x6630 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6659_0 = Pipeline(name = "x6659_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6398_x6649 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      val x6397_x6646 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6675_0 = Pipeline(name = "x6675_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6397_x6662 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      val x6398_x6665 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6691_0 = Pipeline(name = "x6691_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      //val x6499 = CounterChain.copy(x6930, "x6499")
      val x6496 = CounterChain.copy(x6930, "x6496")
      val x6398_x6681 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      val x6397_x6678 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6707_0 = Pipeline(name = "x6707_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6398_x6697 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      val x6397_x6694 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6723_0 = Pipeline(name = "x6723_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6397_x6710 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      val x6398_x6713 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6739_0 = Pipeline(name = "x6739_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      //val x6499 = CounterChain.copy(x6930, "x6499")
      val x6496 = CounterChain.copy(x6930, "x6496")
      val x6398_x6729 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      val x6397_x6726 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6755_0 = Pipeline(name = "x6755_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6398_x6745 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      val x6397_x6742 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6771_0 = Pipeline(name = "x6771_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6397_x6758 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      val x6398_x6761 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6787_0 = Pipeline(name = "x6787_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6398_x6777 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      val x6397_x6774 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6803_0 = Pipeline(name = "x6803_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6397_x6790 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      val x6398_x6793 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6819_0 = Pipeline(name = "x6819_0", parent=x6930, deps=List()) { implicit CU =>
      ...
      val x6398_x6809 = SemiFIFO(size = 2304, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6471_mc.vdata)
      val x6397_x6806 = SemiFIFO(size = 768, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x6496(0))).wtPort(x6424_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(5)
    ...
    val x6928_0 = StreamPipeline(name = "x6928_0", parent=x6928, deps=List()) { implicit CU =>
      ...
      Stage(stage(3), operands=List(CU.ctr(stage(2), x6499(0)), Const("48i")), op=FixMul, results=List(CU.temp(stage(3), tr2610)))
      Stage(stage(4), operands=List(CU.temp(stage(3), tr2610), CU.ctr(stage(3), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(4), x6501_x6827_addr_vector)))
      Stage(stage(5), operands=List(CU.ctr(stage(4), x6499(0)), Const("48i")), op=FixMul, results=List(CU.vecOut(stage(5), bus_2614_vector)))
    }
    val x6928_1 = StreamPipeline(name = "x6928_1", parent=x6928, deps=List(x6928_0)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2618 = CU.temp
      val x6499 = CounterChain.copy(x6928, "x6499")
      val bus_2614_fifo = FIFO(size = 4096, banking = Strided(1)).wtPort(bus_2614_vector)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(4)
      Stage(stage(1), operands=List(bus_2614_fifo.load, CU.ctr(stage(0), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(1), x6502_x6830_addr_vector)))
      Stage(stage(2), operands=List(CU.ctr(stage(1), x6499(0)), Const("48i")), op=FixMul, results=List(CU.temp(stage(2), tr2618)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr2618), CU.ctr(stage(2), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(3), x6503_x6833_addr_vector)))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x6499(0)), Const("48i")), op=FixMul, results=List(CU.vecOut(stage(4), bus_2622_vector)))
    }
    val x6928_2 = StreamPipeline(name = "x6928_2", parent=x6928, deps=List(x6928_1)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2626 = CU.temp
      val x6499 = CounterChain.copy(x6928, "x6499")
      val bus_2622_fifo = FIFO(size = 4096, banking = Strided(1)).wtPort(bus_2622_vector)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(4)
      Stage(stage(1), operands=List(bus_2622_fifo.load, CU.ctr(stage(0), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(1), x6504_x6836_addr_vector)))
      Stage(stage(2), operands=List(CU.ctr(stage(1), x6499(0)), Const("48i")), op=FixMul, results=List(CU.temp(stage(2), tr2626)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr2626), CU.ctr(stage(2), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(3), x6505_x6839_addr_vector)))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x6499(0)), Const("48i")), op=FixMul, results=List(CU.vecOut(stage(4), bus_2630_vector)))
    }
    val x6928_3 = StreamPipeline(name = "x6928_3", parent=x6928, deps=List(x6928_2)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2634 = CU.temp
      val x6499 = CounterChain.copy(x6928, "x6499")
      val bus_2630_fifo = FIFO(size = 4096, banking = Strided(1)).wtPort(bus_2630_vector)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(4)
      Stage(stage(1), operands=List(bus_2630_fifo.load, CU.ctr(stage(0), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(1), x6506_x6842_addr_vector)))
      Stage(stage(2), operands=List(CU.ctr(stage(1), x6499(0)), Const("48i")), op=FixMul, results=List(CU.temp(stage(2), tr2634)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr2634), CU.ctr(stage(2), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(3), x6507_x6845_addr_vector)))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x6499(0)), Const("48i")), op=FixMul, results=List(CU.vecOut(stage(4), bus_2638_vector)))
    }
    val x6928_4 = StreamPipeline(name = "x6928_4", parent=x6928, deps=List(x6928_3)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2642 = CU.temp
      val x6499 = CounterChain.copy(x6928, "x6499")
      val bus_2638_fifo = FIFO(size = 4096, banking = Strided(1)).wtPort(bus_2638_vector)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(4)
      Stage(stage(1), operands=List(bus_2638_fifo.load, CU.ctr(stage(0), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(1), x6508_x6848_addr_vector)))
      Stage(stage(2), operands=List(CU.ctr(stage(1), x6499(0)), Const("48i")), op=FixMul, results=List(CU.temp(stage(2), tr2642)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr2642), CU.ctr(stage(2), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(3), x6509_x6851_addr_vector)))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x6499(0)), Const("48i")), op=FixMul, results=List(CU.vecOut(stage(4), bus_2646_vector)))
    }
    val x6928_5 = StreamPipeline(name = "x6928_5", parent=x6928, deps=List(x6928_4)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2650 = CU.temp
      val x6499 = CounterChain.copy(x6928, "x6499")
      val bus_2646_fifo = FIFO(size = 4096, banking = Strided(1)).wtPort(bus_2646_vector)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(4)
      Stage(stage(1), operands=List(bus_2646_fifo.load, CU.ctr(stage(0), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(1), x6510_x6854_addr_vector)))
      Stage(stage(2), operands=List(CU.ctr(stage(1), x6499(0)), Const("48i")), op=FixMul, results=List(CU.temp(stage(2), tr2650)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr2650), CU.ctr(stage(2), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(3), x6511_x6857_addr_vector)))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x6499(0)), Const("48i")), op=FixMul, results=List(CU.vecOut(stage(4), bus_2654_vector)))
    }
    val x6928_6 = StreamPipeline(name = "x6928_6", parent=x6928, deps=List(x6928_5)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2658 = CU.temp
      val x6499 = CounterChain.copy(x6928, "x6499")
      val bus_2654_fifo = FIFO(size = 4096, banking = Strided(1)).wtPort(bus_2654_vector)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(4)
      Stage(stage(1), operands=List(bus_2654_fifo.load, CU.ctr(stage(0), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(1), x6512_x6860_addr_vector)))
      Stage(stage(2), operands=List(CU.ctr(stage(1), x6499(0)), Const("48i")), op=FixMul, results=List(CU.temp(stage(2), tr2658)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr2658), CU.ctr(stage(2), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(3), x6513_x6863_addr_vector)))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x6499(0)), Const("48i")), op=FixMul, results=List(CU.vecOut(stage(4), bus_2662_vector)))
    }
    val x6928_7 = StreamPipeline(name = "x6928_7", parent=x6928, deps=List(x6928_6)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2666 = CU.temp
      val x6499 = CounterChain.copy(x6928, "x6499")
      val bus_2662_fifo = FIFO(size = 4096, banking = Strided(1)).wtPort(bus_2662_vector)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(4)
      Stage(stage(1), operands=List(bus_2662_fifo.load, CU.ctr(stage(0), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(1), x6514_x6866_addr_vector)))
      Stage(stage(2), operands=List(CU.ctr(stage(1), x6499(0)), Const("48i")), op=FixMul, results=List(CU.temp(stage(2), tr2666)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr2666), CU.ctr(stage(2), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(3), x6515_x6869_addr_vector)))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x6499(0)), Const("48i")), op=FixMul, results=List(CU.vecOut(stage(4), bus_2670_vector)))
    }
    val x6928_8 = StreamPipeline(name = "x6928_8", parent=x6928, deps=List(x6928_7)) { implicit CU =>
      val stage0 = CU.emptyStage
      val x6499 = CounterChain.copy(x6928, "x6499")
      val bus_2670_fifo = FIFO(size = 4096, banking = Strided(1)).wtPort(bus_2670_vector)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(1)
      Stage(stage(1), operands=List(bus_2670_fifo.load, CU.ctr(stage(0), x6499(1))), op=FixAdd, results=List(CU.vecOut(stage(1), x6394_x6872_addr_vector)))
    }
    val x6928_9 = StreamPipeline(name = "x6928_9", parent=x6928, deps=List(x6928_0)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2604 = CU.temp
      val tr2603 = CU.temp
      val tr2565 = CU.temp
    ...
    val x6928_10 = StreamPipeline(name = "x6928_10", parent=x6928, deps=List(x6928_1)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2592 = CU.temp
      val tr2591 = CU.temp
      val tr2586 = CU.temp
    ...
    val x6928_11 = StreamPipeline(name = "x6928_11", parent=x6928, deps=List(x6928_9, x6928_10)) { implicit CU =>
      val stage0 = CU.emptyStage
    ...
    val x6928_12 = StreamPipeline(name = "x6928_12", parent=x6928, deps=List(x6928_2)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2601 = CU.temp
      val tr2600 = CU.temp
      val tr2559 = CU.temp
    ...
    val x6928_13 = StreamPipeline(name = "x6928_13", parent=x6928, deps=List(x6928_3)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2574 = CU.temp
      val tr2573 = CU.temp
      val tr2562 = CU.temp
    ...
    val x6928_14 = StreamPipeline(name = "x6928_14", parent=x6928, deps=List(x6928_12, x6928_13, x6928_11)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2699 = CU.temp
    ...
    val x6928_15 = StreamPipeline(name = "x6928_15", parent=x6928, deps=List(x6928_4)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2598 = CU.temp
      val tr2597 = CU.temp
      val tr2595 = CU.temp
    ...
    val x6928_16 = StreamPipeline(name = "x6928_16", parent=x6928, deps=List(x6928_5)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2583 = CU.temp
      val tr2582 = CU.temp
      val tr2577 = CU.temp
    ...
    val x6928_17 = StreamPipeline(name = "x6928_17", parent=x6928, deps=List(x6928_15, x6928_16)) { implicit CU =>
      val stage0 = CU.emptyStage
    ...
    val x6928_18 = StreamPipeline(name = "x6928_18", parent=x6928, deps=List(x6928_6)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2568 = CU.temp
      val tr2567 = CU.temp
      val tr2571 = CU.temp
    ...
    val x6928_19 = StreamPipeline(name = "x6928_19", parent=x6928, deps=List(x6928_7)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2589 = CU.temp
      val tr2588 = CU.temp
      val tr2580 = CU.temp
    ...
    val x6928_20 = StreamPipeline(name = "x6928_20", parent=x6928, deps=List(x6928_18, x6928_19, x6928_17, x6928_14)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2723 = CU.temp
      val tr2722 = CU.temp
    ...
    val x6928_21 = StreamPipeline(name = "x6928_21", parent=x6928, deps=List(x6928_8, x6928_20)) { implicit CU =>
      val stage0 = CU.emptyStage
      val tr2726 = CU.temp
      val x6499 = CounterChain.copy(x6928, "x6499")
