...
object MatMult_outer extends PIRApp {
  def main(args: String*)(top:Top) = {
    ...
    val x1460_dsp0 = MemoryPipeline(name = "x1460_dsp0") { implicit CU => 
      val stage0 = CU.emptyStage
      val tr295 = CU.temp
      val tr296 = CU.temp
      val tr298 = CU.temp
      ...
      Stage(stage(1), operands=List(x1523(0), Const("64i")), op=FixMul, results=List(CU.temp(stage(1), tr295)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr295), CU.ctr(stage(1), x1523(1))), op=FixAdd, results=List(x1460_x1546.writeAddr, CU.temp(stage(2), tr296)))
      stage = stage0 +: RAStages(2, List(x1460_x1546))
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1537(0)), Const("64i")), op=FixMul, results=List(CU.temp(stage(1), tr298)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr298), CU.ctr(stage(1), x1545(0))), op=FixAdd, results=List(x1460_x1546.readAddr, CU.temp(stage(2), tr299)))
    }
    val x1460_dsp1 = MemoryPipeline(name = "x1460_dsp1") { implicit CU => 
      val stage0 = CU.emptyStage
      val tr302 = CU.temp
      val tr303 = CU.temp
      val tr305 = CU.temp
      ...
      Stage(stage(1), operands=List(x1523(0), Const("64i")), op=FixMul, results=List(CU.temp(stage(1), tr302)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr302), CU.ctr(stage(1), x1523(1))), op=FixAdd, results=List(x1460_x1525.writeAddr, CU.temp(stage(2), tr303)))
      stage = stage0 +: RAStages(2, List(x1460_x1525))
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1523(0)), Const("64i")), op=FixMul, results=List(CU.temp(stage(1), tr305)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr305), CU.ctr(stage(1), x1523(1))), op=FixAdd, results=List(x1460_x1525.readAddr, CU.temp(stage(2), tr306)))
    }
    ...
    val x1464_dsp0 = MemoryPipeline(name = "x1464_dsp0") { implicit CU => 
      val stage0 = CU.emptyStage
      val tr310 = CU.temp
      val tr311 = CU.temp
      ...
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1512(0)), Const("64i")), op=FixMul, results=List(CU.temp(stage(1), tr310)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr310), CU.ctr(stage(1), x1508(0))), op=FixAdd, results=List(x1464_x1513.readAddr, CU.temp(stage(2), tr311)))
    }
    val x1465_dsp0 = MemoryPipeline(name = "x1465_dsp0") { implicit CU => 
      val stage0 = CU.emptyStage
      val tr314 = CU.temp
      val tr315 = CU.temp
      val x1512 = CounterChain.copy("x1520", "x1512")
      ...
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1508(0)), Const("64i")), op=FixMul, results=List(CU.temp(stage(1), tr314)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr314), CU.ctr(stage(1), x1512(1))), op=FixAdd, results=List(x1465_x1514.readAddr, CU.temp(stage(2), tr315)))
    }
    val x1485 = StreamController(name = "x1485", parent=x1534) { implicit CU => 
      val stage0 = CU.emptyStage
      val ctr4 = (Const("0i").out, Const("4i").out, Const("1i").out) // Counter
      val x1468 = CounterChain(name = "x1468", ctr4)
      var stage: List[Stage] = Nil
    }
    val x1474 = StreamPipeline(name = "x1474", parent=x1485) { implicit CU => 
      ...
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1459(0)), CU.ctr(stage(0), x1468(0))), op=FixAdd, results=List(CU.temp(stage(1), tr318)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr318), CU.scalarIn(stage(1), x1437_argin)), op=FixMul, results=List(CU.temp(stage(2), tr319)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr319), CU.ctr(stage(2), x1463(0))), op=FixAdd, results=List(CU.scalarOut(stage(3), x1477_mc.ofs), CU.temp(stage(3), tr320)))
    ...
    val x1494 = StreamPipeline(name = "x1494", parent=x1505) { implicit CU => 
      ...
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(4)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1463(0)), CU.ctr(stage(0), x1488(0))), op=FixAdd, results=List(CU.temp(stage(1), tr331)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr331), CU.scalarIn(stage(1), x1436_argin)), op=FixMul, results=List(CU.temp(stage(2), tr332)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr332), CU.ctr(stage(2), x1459(1))), op=FixAdd, results=List(CU.scalarOut(stage(3), x1497_mc.ofs), CU.temp(stage(3), tr333)))
    ...
    val x1533 = MetaPipeline(name = "x1533", parent=x1534) { implicit CU => 
      ...
      val x1508 = CounterChain(name = "x1508", ctr8)
      var stage: List[Stage] = Nil
    }
    val x1509_dsp0 = MemoryPipeline(name = "x1509_dsp0") { implicit CU => 
      val stage0 = CU.emptyStage
      val tr344 = CU.temp
      val tr345 = CU.temp
      val tr347 = CU.temp
      ...
      Stage(stage(1), operands=List(x1512(0), Const("64i")), op=FixMul, results=List(CU.temp(stage(1), tr344)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr344), CU.ctr(stage(1), x1512(1))), op=FixAdd, results=List(x1509_x1524.writeAddr, CU.temp(stage(2), tr345)))
      stage = stage0 +: RAStages(2, List(x1509_x1524))
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1523(0)), Const("64i")), op=FixMul, results=List(CU.temp(stage(1), tr347)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr347), CU.ctr(stage(1), x1523(1))), op=FixAdd, results=List(x1509_x1524.readAddr, CU.temp(stage(2), tr348)))
    }
    val x1520 = Pipeline(name = "x1520", parent=x1533) { implicit CU => 
      ...
      Stage(stage(1), operands=List(CU.vecIn(stage(0), x1464_0_rd_vector), CU.vecIn(stage(0), x1465_0_rd_vector)), op=FixMul, results=List(CU.vecOut(stage(1), x1509_0_wt_vector), CU.temp(stage(1), tr357)))
    }
    val x1532 = Pipeline(name = "x1532", parent=x1533) { implicit CU => 
      ...
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1508(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(1), tr365)))
      Stage(stage(2), operands=List(CU.vecIn(stage(1), x1509_0_rd_vector), CU.vecIn(stage(1), x1460_1_rd_vector)), op=FixAdd, results=List(CU.temp(stage(2), tr366)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr365), CU.vecIn(stage(2), x1509_0_rd_vector), CU.temp(stage(2), tr366)), op=Mux, results=List(CU.vecOut(stage(3), x1460_1_wt_vector), CU.vecOut(stage(3), x1460_0_wt_vector), CU.temp(stage(3), tr367)))
    }
    ...
    val x1543 = StreamPipeline(name = "x1543", parent=x1554) { implicit CU => 
      ...
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(4)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x1459(0)), CU.ctr(stage(0), x1537(0))), op=FixAdd, results=List(CU.temp(stage(1), tr371)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr371), CU.scalarIn(stage(1), x1436_argin)), op=FixMul, results=List(CU.temp(stage(2), tr372)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr372), CU.ctr(stage(2), x1459(1))), op=FixAdd, results=List(CU.scalarOut(stage(3), x1553_mc.ofs), CU.temp(stage(3), tr373)))
