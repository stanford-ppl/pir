...
object BlockReduce1D extends PIRApp {
  ...
  def main(top:Top) = {
    ...
    val x911_x933_x939_s = Scalar("x911_x933_x939")
    val x907_x938_s = Scalar("x907_x938")
    val x907_x934_x939_s = Scalar("x907_x934_x939")
    ...
    val x907_dsp0 = MemoryPipeline(name="x907_dsp0",parent="x941") { implicit CU => 
      val x938_x938 = ScalarFIFO(size=1).wtPort(x907_x938_s)
    ...
    val x907_dsp1 = MemoryPipeline(name="x907_dsp1",parent="x941") { implicit CU => 
      val x938_x938 = ScalarFIFO(size=1).wtPort(x907_x938_s)
      val x932 = CounterChain.copy("x939_0", "x932")
      val x907_x934 = SRAM(size=16,banking = NoBanking()).wtPort(x938_x938.readPort).rdPort(x907_x934_x939_s).rdAddr(x932(0)).wtAddr(x932(0))
    }
    ...
    val x911_dsp0 = MemoryPipeline(name="x911_dsp0",parent="x941") { implicit CU => 
      ...
      val x932 = CounterChain.copy("x939_0", "x932")
      val x911_x933 = SRAM(size=16,banking = Strided(1)).wtPort(x928_x928.readPort).rdPort(x911_x933_x939_s).rdAddr(x932(0)).wtAddr(x924(0))
    }
    ...
    val x939_0 = Pipeline(name="x939_0",parent=x941) { implicit CU => 
      val x934_x934 = ScalarFIFO(size=1).wtPort(x907_x934_x939_s)
      val x933_x933 = ScalarFIFO(size=1).wtPort(x911_x933_x939_s)
