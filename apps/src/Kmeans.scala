...
object Kmeans extends PIRApp {
  def main(args: String*)(top:Top) = {
    ...
    val x3516 = Sequential(name="x3516",parent=top) { implicit CU => 
      ...
      val x3516_unit = CounterChain(name = "x3516_unit", ctr1)
    }
    val x3515 = Sequential(name="x3515",parent=x3516) { implicit CU => 
      ...
      val x3515_unit = CounterChain(name = "x3515_unit", ctr2)
    }
    ...
    val x3344 = StreamController(name="x3344",parent=x3515) { implicit CU => 
      val ctr3 = Counter(min=Const(0), max=Const(20), step=Const(1), par=1) // Counter
      val x3324 = CounterChain(name = "x3324", ctr3)
    }
    val x3335_0 = Pipeline(name="x3335_0",parent=x3344) { implicit CU => 
      ...
      val x3335_unit = CounterChain(name = "x3335_unit", ctr4)
      var stage: List[Stage] = Nil
    ...
    val x3343 = Pipeline(name="x3343",parent=x3344) { implicit CU => 
      ...
      val x3338 = CounterChain(name = "x3338", ctr5)
      var stage: List[Stage] = Nil
    }
    val x3478 = Sequential(name="x3478",parent=x3515) { implicit CU => 
      val x3310_x3345 =  ScalarBuffer().wtPort(x3310_argin)
      val ctr6 = Counter(min=Const(0), max=x3310_x3345.load, step=Const(1), par=1) // Counter
      val x3347 = CounterChain(name = "x3347", ctr6)
    }
    val x3455 = MetaPipeline(name="x3455",parent=x3478) { implicit CU => 
      val x3311_x3348 =  ScalarBuffer().wtPort(x3311_argin)
      val ctr7 = Counter(min=Const(0), max=x3311_x3348.load, step=Const(1), par=1) // Counter
      val x3350 = CounterChain(name = "x3350", ctr7)
    }
    ...
    val x3378 = StreamController(name="x3378",parent=x3455) { implicit CU => 
      ...
      val x3353 = CounterChain(name = "x3353", ctr8)
    }
    val x3367_0 = Pipeline(name="x3367_0",parent=x3378) { implicit CU => 
      ...
      val x3367_unit = CounterChain(name = "x3367_unit", ctr9)
      var stage: List[Stage] = Nil
    ...
    val x3377 = Pipeline(name="x3377",parent=x3378) { implicit CU => 
      ...
      val x3370 = CounterChain(name = "x3370", ctr10)
      var stage: List[Stage] = Nil
    }
    val x3454 = MetaPipeline(name="x3454",parent=x3455) { implicit CU => 
      val ctr11 = Counter(min=Const(0), max=Const(1), step=Const(1), par=1) // Counter
      val x3380 = CounterChain(name = "x3380", ctr11)
    }
    val x3424 = MetaPipeline(name="x3424",parent=x3454) { implicit CU => 
      ...
      val x3384 = CounterChain(name = "x3384", ctr12)
    }
    val x3409 = StreamController(name="x3409",parent=x3424) { implicit CU => 
      ...
      val x3387 = CounterChain(name = "x3387", ctr13)
    }
    val x3409_0 = Pipeline(name="x3409_0",parent=x3409) { implicit CU => 
      ...
      Stage(operands=List(x3401, x3401), op=FixMul, results=List(CU.vecOut(bus_547_v)))
    }
    val x3409_1 = Pipeline(name="x3409_1",parent=x3409) { implicit CU => 
      val rr547 =  VectorFIFO(size=1).wtPort(bus_547_v)
      var stage: List[Stage] = Nil
      Stage(operands=List(CU.load(rr547)), op=Bypass, results=List(CU.reduce))
      val (_, rr549) = Stage.reduce(op=FixAdd, init=Const(0))
      Stage(operands=List(rr549), op=Bypass, results=List(CU.scalarOut(x3385_x3407_s)))
    }
    val x3423_0 = Pipeline(name="x3423_0",parent=x3424) { implicit CU => 
      ...
      val x3423_unit = CounterChain(name = "x3423_unit", ctr14)
      var stage: List[Stage] = Nil
    ...
    val x3439_0 = Pipeline(name="x3439_0",parent=x3454) { implicit CU => 
      ...
      val x3428 = CounterChain(name = "x3428", ctr15, ctr16)
      var stage: List[Stage] = Nil
    ...
    val x3452_0 = Pipeline(name="x3452_0",parent=x3454) { implicit CU => 
      ...
      val x3442 = CounterChain(name = "x3442", ctr17, ctr18)
      var stage: List[Stage] = Nil
    ...
    val x3464_0 = Pipeline(name="x3464_0",parent=x3478) { implicit CU => 
      ...
      val ctr19 = Counter(min=Const(0), max=Const(20), step=Const(1), par=1) // Counter
      val x3458 = CounterChain(name = "x3458", ctr19)
      var stage: List[Stage] = Nil
    ...
    val x3477_0 = Pipeline(name="x3477_0",parent=x3478) { implicit CU => 
      ...
      val x3467 = CounterChain(name = "x3467", ctr20, ctr21)
      var stage: List[Stage] = Nil
    ...
    val x3489 = Pipeline(name="x3489",parent=x3515) { implicit CU => 
      val ctr22 = Counter(min=Const(0), max=Const(20), step=Const(1), par=1) // Counter
      val ctr23 = Counter(min=Const(0), max=Const(96), step=Const(1), par=1) // Counter
      val x3482 = CounterChain(name = "x3482", ctr22, ctr23)
      var stage: List[Stage] = Nil
    }
    val x3514 = StreamController(name="x3514",parent=x3515) { implicit CU => 
      ...
      val x3514_unit = CounterChain(name = "x3514_unit", ctr24)
    }
    val x3507 = Sequential(name="x3507",parent=x3514) { implicit CU => 
      ...
      val x3507_unit = CounterChain(name = "x3507_unit", ctr25)
    }
    val x3499_0 = Pipeline(name="x3499_0",parent=x3507) { implicit CU => 
      ...
      val x3499_unit = CounterChain(name = "x3499_unit", ctr26)
      var stage: List[Stage] = Nil
    ...
    val x3506 = Pipeline(name="x3506",parent=x3507) { implicit CU => 
      val ctr27 = Counter(min=Const(0), max=Const(1920), step=Const(1), par=16) // Counter
      val x3501 = CounterChain(name = "x3501", ctr27)
      var stage: List[Stage] = Nil
    }
