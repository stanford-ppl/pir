...
object Kmeans_fissionDesign extends PIRApp {
  def main(args: String*)(top:Top) = {
    ...
    val x7244 = StreamController(name = "x7244", parent=x8434, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val ctr1 = (Const("0i").out, Const("20i").out, Const("1i").out) // Counter
      val x7200 = CounterChain(name = "x7200", ctr1)
      var stage: List[Stage] = Nil
    }
    val x7219_0 = UnitPipeline(name = "x7219_0", parent=x7244, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr6256 = CU.temp
      val tr6255 = CU.temp
      val tr6253 = CU.temp
      ...
      Stage(stage(6), operands=List(CU.temp(stage(5), tr6250), CU.temp(stage(5), tr6252)), op=FixSub, results=List(CU.temp(stage(6), tr6253)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6252), Const("0i")), op=FixNeq, results=List(CU.temp(stage(7), tr6255)))
      Stage(stage(8), operands=List(CU.temp(stage(7), tr6255), Const("64i"), Const("0i")), op=Mux, results=List(CU.temp(stage(8), tr6256)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6253), CU.temp(stage(8), tr6256)), op=FixAdd, results=List(CU.scalarOut(stage(9), x7223_mc.len)))
    }
    ...
    val x7298 = StreamController(name = "x7298", parent=x8362, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val ctr13 = (Const("0i").out, Const("20i").out, Const("1i").out) // Counter
      val x7254 = CounterChain(name = "x7254", ctr13)
      var stage: List[Stage] = Nil
    }
    val x7273_0 = UnitPipeline(name = "x7273_0", parent=x7298, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr6281 = CU.temp
      val tr6280 = CU.temp
      val tr6278 = CU.temp
      ...
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6275), CU.temp(stage(6), tr6277)), op=FixSub, results=List(CU.temp(stage(7), tr6278)))
      Stage(stage(8), operands=List(CU.temp(stage(7), tr6277), Const("0i")), op=FixNeq, results=List(CU.temp(stage(8), tr6280)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6280), Const("64i"), Const("0i")), op=Mux, results=List(CU.temp(stage(9), tr6281)))
      Stage(stage(10), operands=List(CU.temp(stage(9), tr6278), CU.temp(stage(9), tr6281)), op=FixAdd, results=List(CU.scalarOut(stage(10), x7277_mc.len)))
    }
    ...
    val x7390_1 = StreamPipeline(name = "x7390_1", parent=x7390, deps=List(x7390_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7352(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6305)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6305), CU.ctr(stage(2), x7370(0))), op=FixAdd, results=List(x7245_x7376.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6309)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6309), CU.ctr(stage(4), x7370(0))), op=FixAdd, results=List(x7251_x7379.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6313)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6313), CU.load(stage(6), x7197_x7373), CU.load(stage(6), x7245_x7376)), op=Mux, results=List(CU.temp(stage(7), tr6314)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7379), CU.temp(stage(7), tr6314)), op=FltSub, results=List(CU.temp(stage(8), tr6315)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6315), CU.temp(stage(8), tr6315)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6317_vector)))
    }
    val x7390_2 = StreamPipeline(name = "x7390_2", parent=x7390, deps=List(x7390_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7370 = CounterChain.copy(x7390, "x7370")
    ...
    val x7426_1 = StreamPipeline(name = "x7426_1", parent=x7426, deps=List(x7426_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7353(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6341)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6341), CU.ctr(stage(2), x7406(0))), op=FixAdd, results=List(x7245_x7412.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6345)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6345), CU.ctr(stage(4), x7406(0))), op=FixAdd, results=List(x7251_x7415.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6349)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6349), CU.load(stage(6), x7197_x7409), CU.load(stage(6), x7245_x7412)), op=Mux, results=List(CU.temp(stage(7), tr6350)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7415), CU.temp(stage(7), tr6350)), op=FltSub, results=List(CU.temp(stage(8), tr6351)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6351), CU.temp(stage(8), tr6351)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6353_vector)))
    }
    val x7426_2 = StreamPipeline(name = "x7426_2", parent=x7426, deps=List(x7426_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7406 = CounterChain.copy(x7426, "x7406")
    ...
    val x7462_1 = StreamPipeline(name = "x7462_1", parent=x7462, deps=List(x7462_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7354(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6377)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6377), CU.ctr(stage(2), x7442(0))), op=FixAdd, results=List(x7245_x7448.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6381)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6381), CU.ctr(stage(4), x7442(0))), op=FixAdd, results=List(x7251_x7451.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6385)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6385), CU.load(stage(6), x7197_x7445), CU.load(stage(6), x7245_x7448)), op=Mux, results=List(CU.temp(stage(7), tr6386)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7451), CU.temp(stage(7), tr6386)), op=FltSub, results=List(CU.temp(stage(8), tr6387)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6387), CU.temp(stage(8), tr6387)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6389_vector)))
    }
    val x7462_2 = StreamPipeline(name = "x7462_2", parent=x7462, deps=List(x7462_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7442 = CounterChain.copy(x7462, "x7442")
    ...
    val x7498_1 = StreamPipeline(name = "x7498_1", parent=x7498, deps=List(x7498_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7355(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6413)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6413), CU.ctr(stage(2), x7478(0))), op=FixAdd, results=List(x7245_x7484.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6417)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6417), CU.ctr(stage(4), x7478(0))), op=FixAdd, results=List(x7251_x7487.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6421)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6421), CU.load(stage(6), x7197_x7481), CU.load(stage(6), x7245_x7484)), op=Mux, results=List(CU.temp(stage(7), tr6422)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7487), CU.temp(stage(7), tr6422)), op=FltSub, results=List(CU.temp(stage(8), tr6423)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6423), CU.temp(stage(8), tr6423)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6425_vector)))
    }
    val x7498_2 = StreamPipeline(name = "x7498_2", parent=x7498, deps=List(x7498_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7478 = CounterChain.copy(x7498, "x7478")
    ...
    val x7534_1 = StreamPipeline(name = "x7534_1", parent=x7534, deps=List(x7534_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7356(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6449)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6449), CU.ctr(stage(2), x7514(0))), op=FixAdd, results=List(x7245_x7520.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6453)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6453), CU.ctr(stage(4), x7514(0))), op=FixAdd, results=List(x7251_x7523.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6457)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6457), CU.load(stage(6), x7197_x7517), CU.load(stage(6), x7245_x7520)), op=Mux, results=List(CU.temp(stage(7), tr6458)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7523), CU.temp(stage(7), tr6458)), op=FltSub, results=List(CU.temp(stage(8), tr6459)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6459), CU.temp(stage(8), tr6459)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6461_vector)))
    }
    val x7534_2 = StreamPipeline(name = "x7534_2", parent=x7534, deps=List(x7534_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7514 = CounterChain.copy(x7534, "x7514")
    ...
    val x7570_1 = StreamPipeline(name = "x7570_1", parent=x7570, deps=List(x7570_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7357(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6485)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6485), CU.ctr(stage(2), x7550(0))), op=FixAdd, results=List(x7245_x7556.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6489)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6489), CU.ctr(stage(4), x7550(0))), op=FixAdd, results=List(x7251_x7559.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6493)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6493), CU.load(stage(6), x7197_x7553), CU.load(stage(6), x7245_x7556)), op=Mux, results=List(CU.temp(stage(7), tr6494)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7559), CU.temp(stage(7), tr6494)), op=FltSub, results=List(CU.temp(stage(8), tr6495)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6495), CU.temp(stage(8), tr6495)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6497_vector)))
    }
    val x7570_2 = StreamPipeline(name = "x7570_2", parent=x7570, deps=List(x7570_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7550 = CounterChain.copy(x7570, "x7550")
    ...
    val x7606_1 = StreamPipeline(name = "x7606_1", parent=x7606, deps=List(x7606_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7358(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6521)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6521), CU.ctr(stage(2), x7586(0))), op=FixAdd, results=List(x7245_x7592.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6525)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6525), CU.ctr(stage(4), x7586(0))), op=FixAdd, results=List(x7251_x7595.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6529)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6529), CU.load(stage(6), x7197_x7589), CU.load(stage(6), x7245_x7592)), op=Mux, results=List(CU.temp(stage(7), tr6530)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7595), CU.temp(stage(7), tr6530)), op=FltSub, results=List(CU.temp(stage(8), tr6531)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6531), CU.temp(stage(8), tr6531)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6533_vector)))
    }
    val x7606_2 = StreamPipeline(name = "x7606_2", parent=x7606, deps=List(x7606_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7586 = CounterChain.copy(x7606, "x7586")
    ...
    val x7642_1 = StreamPipeline(name = "x7642_1", parent=x7642, deps=List(x7642_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7359(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6557)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6557), CU.ctr(stage(2), x7622(0))), op=FixAdd, results=List(x7245_x7628.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6561)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6561), CU.ctr(stage(4), x7622(0))), op=FixAdd, results=List(x7251_x7631.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6565)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6565), CU.load(stage(6), x7197_x7625), CU.load(stage(6), x7245_x7628)), op=Mux, results=List(CU.temp(stage(7), tr6566)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7631), CU.temp(stage(7), tr6566)), op=FltSub, results=List(CU.temp(stage(8), tr6567)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6567), CU.temp(stage(8), tr6567)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6569_vector)))
    }
    val x7642_2 = StreamPipeline(name = "x7642_2", parent=x7642, deps=List(x7642_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7622 = CounterChain.copy(x7642, "x7622")
    ...
    val x7678_1 = StreamPipeline(name = "x7678_1", parent=x7678, deps=List(x7678_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7360(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6593)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6593), CU.ctr(stage(2), x7658(0))), op=FixAdd, results=List(x7245_x7664.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6597)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6597), CU.ctr(stage(4), x7658(0))), op=FixAdd, results=List(x7251_x7667.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6601)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6601), CU.load(stage(6), x7197_x7661), CU.load(stage(6), x7245_x7664)), op=Mux, results=List(CU.temp(stage(7), tr6602)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7667), CU.temp(stage(7), tr6602)), op=FltSub, results=List(CU.temp(stage(8), tr6603)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6603), CU.temp(stage(8), tr6603)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6605_vector)))
    }
    val x7678_2 = StreamPipeline(name = "x7678_2", parent=x7678, deps=List(x7678_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7658 = CounterChain.copy(x7678, "x7658")
    ...
    val x7714_1 = StreamPipeline(name = "x7714_1", parent=x7714, deps=List(x7714_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7361(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6629)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6629), CU.ctr(stage(2), x7694(0))), op=FixAdd, results=List(x7245_x7700.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6633)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6633), CU.ctr(stage(4), x7694(0))), op=FixAdd, results=List(x7251_x7703.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6637)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6637), CU.load(stage(6), x7197_x7697), CU.load(stage(6), x7245_x7700)), op=Mux, results=List(CU.temp(stage(7), tr6638)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7703), CU.temp(stage(7), tr6638)), op=FltSub, results=List(CU.temp(stage(8), tr6639)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6639), CU.temp(stage(8), tr6639)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6641_vector)))
    }
    val x7714_2 = StreamPipeline(name = "x7714_2", parent=x7714, deps=List(x7714_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7694 = CounterChain.copy(x7714, "x7694")
    ...
    val x7750_1 = StreamPipeline(name = "x7750_1", parent=x7750, deps=List(x7750_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7362(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6665)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6665), CU.ctr(stage(2), x7730(0))), op=FixAdd, results=List(x7245_x7736.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6669)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6669), CU.ctr(stage(4), x7730(0))), op=FixAdd, results=List(x7251_x7739.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6673)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6673), CU.load(stage(6), x7197_x7733), CU.load(stage(6), x7245_x7736)), op=Mux, results=List(CU.temp(stage(7), tr6674)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7739), CU.temp(stage(7), tr6674)), op=FltSub, results=List(CU.temp(stage(8), tr6675)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6675), CU.temp(stage(8), tr6675)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6677_vector)))
    }
    val x7750_2 = StreamPipeline(name = "x7750_2", parent=x7750, deps=List(x7750_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7730 = CounterChain.copy(x7750, "x7730")
    ...
    val x7786_1 = StreamPipeline(name = "x7786_1", parent=x7786, deps=List(x7786_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7363(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6701)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6701), CU.ctr(stage(2), x7766(0))), op=FixAdd, results=List(x7245_x7772.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6705)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6705), CU.ctr(stage(4), x7766(0))), op=FixAdd, results=List(x7251_x7775.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6709)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6709), CU.load(stage(6), x7197_x7769), CU.load(stage(6), x7245_x7772)), op=Mux, results=List(CU.temp(stage(7), tr6710)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7775), CU.temp(stage(7), tr6710)), op=FltSub, results=List(CU.temp(stage(8), tr6711)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6711), CU.temp(stage(8), tr6711)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6713_vector)))
    }
    val x7786_2 = StreamPipeline(name = "x7786_2", parent=x7786, deps=List(x7786_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7766 = CounterChain.copy(x7786, "x7766")
    ...
    val x7822_1 = StreamPipeline(name = "x7822_1", parent=x7822, deps=List(x7822_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7364(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6737)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6737), CU.ctr(stage(2), x7802(0))), op=FixAdd, results=List(x7245_x7808.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6741)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6741), CU.ctr(stage(4), x7802(0))), op=FixAdd, results=List(x7251_x7811.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6745)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6745), CU.load(stage(6), x7197_x7805), CU.load(stage(6), x7245_x7808)), op=Mux, results=List(CU.temp(stage(7), tr6746)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7811), CU.temp(stage(7), tr6746)), op=FltSub, results=List(CU.temp(stage(8), tr6747)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6747), CU.temp(stage(8), tr6747)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6749_vector)))
    }
    val x7822_2 = StreamPipeline(name = "x7822_2", parent=x7822, deps=List(x7822_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7802 = CounterChain.copy(x7822, "x7802")
    ...
    val x7858_1 = StreamPipeline(name = "x7858_1", parent=x7858, deps=List(x7858_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7365(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6773)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6773), CU.ctr(stage(2), x7838(0))), op=FixAdd, results=List(x7245_x7844.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6777)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6777), CU.ctr(stage(4), x7838(0))), op=FixAdd, results=List(x7251_x7847.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6781)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6781), CU.load(stage(6), x7197_x7841), CU.load(stage(6), x7245_x7844)), op=Mux, results=List(CU.temp(stage(7), tr6782)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7847), CU.temp(stage(7), tr6782)), op=FltSub, results=List(CU.temp(stage(8), tr6783)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6783), CU.temp(stage(8), tr6783)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6785_vector)))
    }
    val x7858_2 = StreamPipeline(name = "x7858_2", parent=x7858, deps=List(x7858_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7838 = CounterChain.copy(x7858, "x7838")
    ...
    val x7894_1 = StreamPipeline(name = "x7894_1", parent=x7894, deps=List(x7894_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7366(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6809)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6809), CU.ctr(stage(2), x7874(0))), op=FixAdd, results=List(x7245_x7880.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6813)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6813), CU.ctr(stage(4), x7874(0))), op=FixAdd, results=List(x7251_x7883.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6817)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6817), CU.load(stage(6), x7197_x7877), CU.load(stage(6), x7245_x7880)), op=Mux, results=List(CU.temp(stage(7), tr6818)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7883), CU.temp(stage(7), tr6818)), op=FltSub, results=List(CU.temp(stage(8), tr6819)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6819), CU.temp(stage(8), tr6819)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6821_vector)))
    }
    val x7894_2 = StreamPipeline(name = "x7894_2", parent=x7894, deps=List(x7894_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7874 = CounterChain.copy(x7894, "x7874")
    ...
    val x7930_1 = StreamPipeline(name = "x7930_1", parent=x7930, deps=List(x7930_0)) { implicit CU => 
      ...
      Stage(stage(2), operands=List(CU.ctr(stage(1), x7367(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(2), tr6845)))
      Stage(stage(3), operands=List(CU.temp(stage(2), tr6845), CU.ctr(stage(2), x7910(0))), op=FixAdd, results=List(x7245_x7916.readAddr))
      Stage(stage(4), operands=List(CU.ctr(stage(3), x7300(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(4), tr6849)))
      Stage(stage(5), operands=List(CU.temp(stage(4), tr6849), CU.ctr(stage(4), x7910(0))), op=FixAdd, results=List(x7251_x7919.readAddr))
      Stage(stage(6), operands=List(CU.ctr(stage(5), x7247(0)), Const("0i")), op=FixEql, results=List(CU.temp(stage(6), tr6853)))
      Stage(stage(7), operands=List(CU.temp(stage(6), tr6853), CU.load(stage(6), x7197_x7913), CU.load(stage(6), x7245_x7916)), op=Mux, results=List(CU.temp(stage(7), tr6854)))
      Stage(stage(8), operands=List(CU.load(stage(7), x7251_x7919), CU.temp(stage(7), tr6854)), op=FltSub, results=List(CU.temp(stage(8), tr6855)))
      Stage(stage(9), operands=List(CU.temp(stage(8), tr6855), CU.temp(stage(8), tr6855)), op=FltMul, results=List(CU.vecOut(stage(9), bus_6857_vector)))
    }
    val x7930_2 = StreamPipeline(name = "x7930_2", parent=x7930, deps=List(x7930_1)) { implicit CU => 
      val stage0 = CU.emptyStage
      val x7910 = CounterChain.copy(x7930, "x7910")
    ...
    val x8249_0 = Pipeline(name = "x8249_0", parent=x8360, deps=List()) { implicit CU => 
      ...
      val x7303 = CounterChain.copy(x8360, "x7303")
      val x7251_x8237 = SemiFIFO(size = 1920, banking = Strided(1), buffering = MultiBuffer(2, swapRead = x7303(0))).wtPort(x7277_mc.vdata)
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(6)
    ...
    val x8358_1 = StreamPipeline(name = "x8358_1", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7226 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7226)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7226), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7947_x8257_addr_vector)))
    }
    val x8358_2 = StreamPipeline(name = "x8358_2", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7230 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7230)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7230), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7948_x8260_addr_vector)))
    }
    val x8358_3 = StreamPipeline(name = "x8358_3", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7234 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7234)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7234), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7949_x8263_addr_vector)))
    }
    val x8358_4 = StreamPipeline(name = "x8358_4", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7238 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7238)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7238), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7950_x8266_addr_vector)))
    }
    val x8358_5 = StreamPipeline(name = "x8358_5", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7242 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7242)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7242), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7951_x8269_addr_vector)))
    }
    val x8358_6 = StreamPipeline(name = "x8358_6", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7246 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7246)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7246), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7952_x8272_addr_vector)))
    }
    val x8358_7 = StreamPipeline(name = "x8358_7", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7250 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7250)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7250), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7953_x8275_addr_vector)))
    }
    val x8358_8 = StreamPipeline(name = "x8358_8", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7254 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7254)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7254), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7954_x8278_addr_vector)))
    }
    val x8358_9 = StreamPipeline(name = "x8358_9", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7258 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7258)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7258), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7955_x8281_addr_vector)))
    }
    val x8358_10 = StreamPipeline(name = "x8358_10", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7262 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7262)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7262), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7956_x8284_addr_vector)))
    }
    val x8358_11 = StreamPipeline(name = "x8358_11", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7266 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7266)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7266), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7957_x8287_addr_vector)))
    }
    val x8358_12 = StreamPipeline(name = "x8358_12", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7270 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7270)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7270), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7958_x8290_addr_vector)))
    }
    val x8358_13 = StreamPipeline(name = "x8358_13", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7274 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7274)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7274), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7959_x8293_addr_vector)))
    }
    val x8358_14 = StreamPipeline(name = "x8358_14", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7278 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7278)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7278), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7960_x8296_addr_vector)))
    }
    val x8358_15 = StreamPipeline(name = "x8358_15", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7282 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7282)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7282), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7961_x8299_addr_vector)))
    }
    val x8358_16 = StreamPipeline(name = "x8358_16", parent=x8358, deps=List()) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7286 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
      var stage: List[Stage] = Nil
      stage = stage0 +: Stages(2)
      Stage(stage(1), operands=List(CU.ctr(stage(0), x7303(0)), Const("96i")), op=FixMul, results=List(CU.temp(stage(1), tr7286)))
      Stage(stage(2), operands=List(CU.temp(stage(1), tr7286), CU.ctr(stage(1), x7303(1))), op=FixAdd, results=List(CU.vecOut(stage(2), x7248_x8302_addr_vector)))
    }
    val x8358_17 = StreamPipeline(name = "x8358_17", parent=x8358, deps=List(x8358_1, x8358_0)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7196 = CU.temp
      val tr7195 = CU.temp
      val tr7199 = CU.temp
    ...
    val x8358_18 = StreamPipeline(name = "x8358_18", parent=x8358, deps=List(x8358_2, x8358_3)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7190 = CU.temp
      val tr7189 = CU.temp
      val tr7193 = CU.temp
    ...
    val x8358_19 = StreamPipeline(name = "x8358_19", parent=x8358, deps=List(x8358_17, x8358_18)) { implicit CU => 
      val stage0 = CU.emptyStage
    ...
    val x8358_20 = StreamPipeline(name = "x8358_20", parent=x8358, deps=List(x8358_4, x8358_5)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7217 = CU.temp
      val tr7216 = CU.temp
      val tr7184 = CU.temp
    ...
    val x8358_21 = StreamPipeline(name = "x8358_21", parent=x8358, deps=List(x8358_6, x8358_7)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7202 = CU.temp
      val tr7201 = CU.temp
      val tr7175 = CU.temp
    ...
    val x8358_22 = StreamPipeline(name = "x8358_22", parent=x8358, deps=List(x8358_20, x8358_21, x8358_19)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7315 = CU.temp
    ...
    val x8358_23 = StreamPipeline(name = "x8358_23", parent=x8358, deps=List(x8358_8, x8358_9)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7214 = CU.temp
      val tr7213 = CU.temp
      val tr7178 = CU.temp
    ...
    val x8358_24 = StreamPipeline(name = "x8358_24", parent=x8358, deps=List(x8358_11, x8358_10)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7208 = CU.temp
      val tr7207 = CU.temp
      val tr7181 = CU.temp
    ...
    val x8358_25 = StreamPipeline(name = "x8358_25", parent=x8358, deps=List(x8358_23, x8358_24)) { implicit CU => 
      val stage0 = CU.emptyStage
    ...
    val x8358_26 = StreamPipeline(name = "x8358_26", parent=x8358, deps=List(x8358_12, x8358_13)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7205 = CU.temp
      val tr7204 = CU.temp
      val tr7187 = CU.temp
    ...
    val x8358_27 = StreamPipeline(name = "x8358_27", parent=x8358, deps=List(x8358_14, x8358_15)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7220 = CU.temp
      val tr7219 = CU.temp
      val tr7211 = CU.temp
    ...
    val x8358_28 = StreamPipeline(name = "x8358_28", parent=x8358, deps=List(x8358_26, x8358_27, x8358_25, x8358_22)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7339 = CU.temp
      val tr7338 = CU.temp
    ...
    val x8358_29 = StreamPipeline(name = "x8358_29", parent=x8358, deps=List(x8358_16, x8358_28)) { implicit CU => 
      val stage0 = CU.emptyStage
      val tr7342 = CU.temp
      val x7303 = CounterChain.copy("x8358", "x7303")
