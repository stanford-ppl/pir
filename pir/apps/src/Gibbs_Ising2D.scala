...
object Gibbs_Ising2D extends PIRApp {
  def main(top:Top) = {
    ...
    val b5623_b5621 = WriteMem(b5621, x5117).name("b5623_b5621").ctrl(x5120) // StreamWrite(x5110,x5118,Const(true))
    ...
    val x5124 = ReadMem(x5111).name("x5124").ctrl(x5127) // ParStreamRead(x5111,List(b2557))
    val x5125 = x5124 // x5125 = VectorApply(x5124,0)
    val x5126 = StoreBanks(List(x5108_d0_b0, x5108_d5_b0, x5108_d1_b0, x5108_d6_b0, x5108_d2_b0, x5108_d7_b0, x5108_d3_b0, x5108_d4_b0), List(b2556), x5125).name("x5126").ctrl(x5127) // ParSRAMStore(x5108,List(List(b2556)),List(x5125),List(b2557))
    ...
    val b5627_b5625 = WriteMem(b5625, x5141).name("b5627_b5625").ctrl(x5144) // StreamWrite(x5131,x5142,b2566)
    ...
    val b5631_b5629 = WriteMem(b5629, x5167).name("b5631_b5629").ctrl(x5170) // StreamWrite(x5157,x5168,b2596)
    ...
    val x5175 = ReadMem(x5158).name("x5175").ctrl(x5178) // ParStreamRead(x5158,List(x5174))
    val x5176 = x5175 // x5176 = VectorApply(x5175,0)
    val x5177 = StoreBanks(List(x5154_d0_b0, x5154_d0_b1, x5154_d0_b2, x5154_d0_b3), List(b2595, b2614), x5176).name("x5177").ctrl(x5178) // ParSRAMStore(x5154,List(List(b2595, b2614)),List(x5176),List(x5174))
    ...
    val b5635_b5633 = WriteMem(b5633, x5552).name("b5635_b5633").ctrl(x5555) // StreamWrite(x5541,x5553,b2964)
    ...
    val x5562_x5542 = WriteMem(x5542, x5560).name("x5562_x5542").ctrl(x5563) // ParStreamWrite(x5542,List(x5561),List(x5558))
    ...
    val x5565 = ReadMem(x5543).name("x5565").ctrl(x5566) // StreamRead(x5543,b2964)
