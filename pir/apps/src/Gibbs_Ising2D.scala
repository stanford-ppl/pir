...
object Gibbs_Ising2D extends PIRApp {
  def main(top:Top) = {
    ...
    val x5126 = StoreBanks(List(x5108_d0_b0, x5108_d5_b0, x5108_d1_b0, x5108_d6_b0, x5108_d2_b0, x5108_d7_b0, x5108_d3_b0, x5108_d4_b0), List(b2556), b5627).name("x5126").ctrl(x5127) // ParSRAMStore(x5108,List(List(b2556)),List(x5125),List(b2557))
    ...
    val x5177 = StoreBanks(List(x5154_d0_b0, x5154_d0_b1, x5154_d0_b2, x5154_d0_b3), List(b2595, b2614), b5641).name("x5177").ctrl(x5178) // ParSRAMStore(x5154,List(List(b2595, b2614)),List(x5176),List(x5174))
