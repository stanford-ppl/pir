...
object Gibbs_Ising2D extends PIRApp {
  def main(top:Top) = {
    ...
    val b5624 = StoreMem(List(b5621), None, x5117).name("b5624").ctrl(x5120) // StreamWrite(x5110,x5118,Const(true))
    val b5625 = StoreMem(List(b5622), None, Const(36)).name("b5625").ctrl(x5120) // StreamWrite(x5110,x5118,Const(true))
    ...
    val b5626 = LoadMem(b5623, None).name("b5626").ctrl(x5127) // ParStreamRead(x5111,List(b2557))
    val b5627 = b5626 // x5125 = VectorApply(x5124,0)
    val x5126 = StoreBanks(List(List(x5108_d0_b0), List(x5108_d5_b0), List(x5108_d1_b0), List(x5108_d6_b0), List(x5108_d2_b0), List(x5108_d7_b0), List(x5108_d3_b0), List(x5108_d4_b0)), List(b2556), b5627).name("x5126").ctrl(x5127) // ParSRAMStore(x5108,List(List(b2556)),List(x5125),List(b2557))
    ...
    val b5631 = StoreMem(List(b5628), None, x5141).name("b5631").ctrl(x5144) // StreamWrite(x5131,x5142,b2566)
    val b5632 = StoreMem(List(b5629), None, Const(256)).name("b5632").ctrl(x5144) // StreamWrite(x5131,x5142,b2566)
    ...
    val b5633 = LoadMem(b5630, None).name("b5633").ctrl(x5152) // ParStreamRead(x5132,List(x5148))
    val b5634 = b5633 // x5150 = VectorApply(x5149,0)
    val x5151 = StoreBanks(List(List(x5109_d0_b0, x5109_d0_b1, x5109_d0_b2, x5109_d0_b3), List(x5109_d5_b0, x5109_d5_b1, x5109_d5_b2, x5109_d5_b3), List(x5109_d10_b0, x5109_d10_b1, x5109_d10_b2, x5109_d10_b3), List(x5109_d1_b0, x5109_d1_b1, x5109_d1_b2, x5109_d1_b3), List(x5109_d6_b0, x5109_d6_b1, x5109_d6_b2, x5109_d6_b3), List(x5109_d9_b0, x5109_d9_b1, x5109_d9_b2, x5109_d9_b3), List(x5109_d2_b0, x5109_d2_b1, x5109_d2_b2, x5109_d2_b3), List(x5109_d7_b0, x5109_d7_b1, x5109_d7_b2, x5109_d7_b3), List(x5109_d3_b0, x5109_d3_b1, x5109_d3_b2, x5109_d3_b3), List(x5109_d11_b0, x5109_d11_b1, x5109_d11_b2, x5109_d11_b3), List(x5109_d8_b0, x5109_d8_b1, x5109_d8_b2, x5109_d8_b3), List(x5109_d4_b0, x5109_d4_b1, x5109_d4_b2, x5109_d4_b3)), List(b2565, b2584), b5634).name("x5151").ctrl(x5152) // ParSRAMStore(x5109,List(List(b2565, b2584)),List(x5150),List(x5148))
    ...
    val b5638 = StoreMem(List(b5635), None, x5167).name("b5638").ctrl(x5170) // StreamWrite(x5157,x5168,b2596)
    val b5639 = StoreMem(List(b5636), None, Const(256)).name("b5639").ctrl(x5170) // StreamWrite(x5157,x5168,b2596)
    ...
    val b5640 = LoadMem(b5637, None).name("b5640").ctrl(x5178) // ParStreamRead(x5158,List(x5174))
    val b5641 = b5640 // x5176 = VectorApply(x5175,0)
    val x5177 = StoreBanks(List(List(x5154_d0_b0, x5154_d0_b1, x5154_d0_b2, x5154_d0_b3)), List(b2595, b2614), b5641).name("x5177").ctrl(x5178) // ParSRAMStore(x5154,List(List(b2595, b2614)),List(x5176),List(x5174))
    val x5180 = LoadMem(x5090, None).name("x5180").ctrl(x5568) // RegRead(x5090)
    ...
    val x5194 = StoreMem(List(x5185), None, x5192).name("x5194").ctrl(x5195) // RegWrite(x5185,x5192,x5193)
    ...
    val x5201 = StoreMem(List(x5186), None, x5199).name("x5201").ctrl(x5202) // RegWrite(x5186,x5199,x5200)
    ...
    val x5208 = StoreMem(List(x5187), None, x5206).name("x5208").ctrl(x5209) // RegWrite(x5187,x5206,x5207)
    ...
    val x5215 = StoreMem(List(x5188), None, x5213).name("x5215").ctrl(x5216) // RegWrite(x5188,x5213,x5214)
    val x5217 = LoadMem(x5185, None).name("x5217").ctrl(x5537) // RegRead(x5185)
    ...
    val x5259 = LoadMem(x5092_d0, None).name("x5259").ctrl(x5280) // RegRead(x5092)
    val x5260 = LoadMem(x5091_d0, None).name("x5260").ctrl(x5280) // RegRead(x5091)
    ...
    val x5276 = StoreMem(List(x5220), None, x5246).name("x5276").ctrl(x5280) // RegWrite(x5220,x5246,x5229)
    val x5277 = StoreMem(List(x5221), None, x5271).name("x5277").ctrl(x5280) // RegWrite(x5221,x5271,x5229)
    val x5278 = StoreMem(List(x5222_d0, x5222_d1), None, x5274).name("x5278").ctrl(x5280) // RegWrite(x5222,x5274,x5229)
    val x5279 = StoreMem(List(x5223), None, x5275).name("x5279").ctrl(x5280) // RegWrite(x5223,x5275,x5229)
    val x5281 = LoadMem(x5223, None).name("x5281").ctrl(x5296) // RegRead(x5223)
    val x5282 = LoadMem(x5222_d1, None).name("x5282").ctrl(x5296) // RegRead(x5222)
    ...
    val x5283 = LoadMem(x5221, None).name("x5283").ctrl(x5293) // RegRead(x5221)
    val x5284 = OpDef(op=FixEql, inputs=List(x5283, Const(1).ctrl(x5293))).name("x5284").ctrl(x5293) // FixEql(x5283,Const(1))
    val x5285 = LoadMem(x5220, None).name("x5285").ctrl(x5293) // RegRead(x5220)
    ...
    val x5288 = LoadMem(x5222_d0, None).name("x5288").ctrl(x5293) // RegRead(x5222)
    ...
    val x5292 = StoreBanks(List(List(x5109_d0_b0), List(x5109_d5_b0), List(x5109_d10_b0), List(x5109_d1_b0), List(x5109_d6_b0), List(x5109_d9_b0), List(x5109_d2_b0), List(x5109_d7_b0), List(x5109_d3_b0), List(x5109_d11_b0), List(x5109_d8_b0), List(x5109_d4_b0)), List(b2629, b2674), x5287).name("x5292").ctrl(x5293) // SRAMStore(x5109,ArrayBuffer(Const(32), Const(64)),List(b2629, b2674),Const(0),x5287,x5291)
    val x5294 = UnitController(style=SeqPipe, level=InnerControl).name("x5294").ctrl(x5295) // //TODO SwitchCase(Block(Const(())))
    val x5297 = LoadMem(x5186, None).name("x5297").ctrl(x5537) // RegRead(x5186)
    ...
    val x5339 = LoadMem(x5092_d0, None).name("x5339").ctrl(x5360) // RegRead(x5092)
    val x5340 = LoadMem(x5091_d0, None).name("x5340").ctrl(x5360) // RegRead(x5091)
    ...
    val x5356 = StoreMem(List(x5300), None, x5326).name("x5356").ctrl(x5360) // RegWrite(x5300,x5326,x5309)
    val x5357 = StoreMem(List(x5301), None, x5351).name("x5357").ctrl(x5360) // RegWrite(x5301,x5351,x5309)
    val x5358 = StoreMem(List(x5302_d0, x5302_d1), None, x5354).name("x5358").ctrl(x5360) // RegWrite(x5302,x5354,x5309)
    val x5359 = StoreMem(List(x5303), None, x5355).name("x5359").ctrl(x5360) // RegWrite(x5303,x5355,x5309)
    val x5361 = LoadMem(x5303, None).name("x5361").ctrl(x5376) // RegRead(x5303)
    val x5362 = LoadMem(x5302_d1, None).name("x5362").ctrl(x5376) // RegRead(x5302)
    ...
    val x5363 = LoadMem(x5301, None).name("x5363").ctrl(x5373) // RegRead(x5301)
    val x5364 = OpDef(op=FixEql, inputs=List(x5363, Const(1).ctrl(x5373))).name("x5364").ctrl(x5373) // FixEql(x5363,Const(1))
    val x5365 = LoadMem(x5300, None).name("x5365").ctrl(x5373) // RegRead(x5300)
    ...
    val x5368 = LoadMem(x5302_d0, None).name("x5368").ctrl(x5373) // RegRead(x5302)
    ...
    val x5372 = StoreBanks(List(List(x5109_d0_b1), List(x5109_d5_b1), List(x5109_d10_b1), List(x5109_d1_b1), List(x5109_d6_b1), List(x5109_d9_b1), List(x5109_d2_b1), List(x5109_d7_b1), List(x5109_d3_b1), List(x5109_d11_b1), List(x5109_d8_b1), List(x5109_d4_b1)), List(b2630, b2745), x5367).name("x5372").ctrl(x5373) // SRAMStore(x5109,ArrayBuffer(Const(32), Const(64)),List(b2630, b2745),Const(0),x5367,x5371)
    val x5374 = UnitController(style=SeqPipe, level=InnerControl).name("x5374").ctrl(x5375) // //TODO SwitchCase(Block(Const(())))
    val x5377 = LoadMem(x5187, None).name("x5377").ctrl(x5537) // RegRead(x5187)
    ...
    val x5419 = LoadMem(x5092_d0, None).name("x5419").ctrl(x5440) // RegRead(x5092)
    val x5420 = LoadMem(x5091_d0, None).name("x5420").ctrl(x5440) // RegRead(x5091)
    ...
    val x5436 = StoreMem(List(x5380), None, x5406).name("x5436").ctrl(x5440) // RegWrite(x5380,x5406,x5389)
    val x5437 = StoreMem(List(x5381), None, x5431).name("x5437").ctrl(x5440) // RegWrite(x5381,x5431,x5389)
    val x5438 = StoreMem(List(x5382_d0, x5382_d1), None, x5434).name("x5438").ctrl(x5440) // RegWrite(x5382,x5434,x5389)
    val x5439 = StoreMem(List(x5383), None, x5435).name("x5439").ctrl(x5440) // RegWrite(x5383,x5435,x5389)
    val x5441 = LoadMem(x5383, None).name("x5441").ctrl(x5456) // RegRead(x5383)
    val x5442 = LoadMem(x5382_d1, None).name("x5442").ctrl(x5456) // RegRead(x5382)
    ...
    val x5443 = LoadMem(x5381, None).name("x5443").ctrl(x5453) // RegRead(x5381)
    val x5444 = OpDef(op=FixEql, inputs=List(x5443, Const(1).ctrl(x5453))).name("x5444").ctrl(x5453) // FixEql(x5443,Const(1))
    val x5445 = LoadMem(x5380, None).name("x5445").ctrl(x5453) // RegRead(x5380)
    ...
    val x5448 = LoadMem(x5382_d0, None).name("x5448").ctrl(x5453) // RegRead(x5382)
    ...
    val x5452 = StoreBanks(List(List(x5109_d0_b2), List(x5109_d5_b2), List(x5109_d10_b2), List(x5109_d1_b2), List(x5109_d6_b2), List(x5109_d9_b2), List(x5109_d2_b2), List(x5109_d7_b2), List(x5109_d3_b2), List(x5109_d11_b2), List(x5109_d8_b2), List(x5109_d4_b2)), List(b2631, b2816), x5447).name("x5452").ctrl(x5453) // SRAMStore(x5109,ArrayBuffer(Const(32), Const(64)),List(b2631, b2816),Const(0),x5447,x5451)
    val x5454 = UnitController(style=SeqPipe, level=InnerControl).name("x5454").ctrl(x5455) // //TODO SwitchCase(Block(Const(())))
    val x5457 = LoadMem(x5188, None).name("x5457").ctrl(x5537) // RegRead(x5188)
    ...
    val x5499 = LoadMem(x5092_d0, None).name("x5499").ctrl(x5520) // RegRead(x5092)
    val x5500 = LoadMem(x5091_d0, None).name("x5500").ctrl(x5520) // RegRead(x5091)
    ...
    val x5516 = StoreMem(List(x5460), None, x5486).name("x5516").ctrl(x5520) // RegWrite(x5460,x5486,x5469)
    val x5517 = StoreMem(List(x5461), None, x5511).name("x5517").ctrl(x5520) // RegWrite(x5461,x5511,x5469)
    val x5518 = StoreMem(List(x5462_d0, x5462_d1), None, x5514).name("x5518").ctrl(x5520) // RegWrite(x5462,x5514,x5469)
    val x5519 = StoreMem(List(x5463), None, x5515).name("x5519").ctrl(x5520) // RegWrite(x5463,x5515,x5469)
    val x5521 = LoadMem(x5463, None).name("x5521").ctrl(x5536) // RegRead(x5463)
    val x5522 = LoadMem(x5462_d1, None).name("x5522").ctrl(x5536) // RegRead(x5462)
    ...
    val x5523 = LoadMem(x5461, None).name("x5523").ctrl(x5533) // RegRead(x5461)
    val x5524 = OpDef(op=FixEql, inputs=List(x5523, Const(1).ctrl(x5533))).name("x5524").ctrl(x5533) // FixEql(x5523,Const(1))
    val x5525 = LoadMem(x5460, None).name("x5525").ctrl(x5533) // RegRead(x5460)
    ...
    val x5528 = LoadMem(x5462_d0, None).name("x5528").ctrl(x5533) // RegRead(x5462)
    ...
    val x5532 = StoreBanks(List(List(x5109_d0_b3), List(x5109_d5_b3), List(x5109_d10_b3), List(x5109_d1_b3), List(x5109_d6_b3), List(x5109_d9_b3), List(x5109_d2_b3), List(x5109_d7_b3), List(x5109_d3_b3), List(x5109_d11_b3), List(x5109_d8_b3), List(x5109_d4_b3)), List(b2632, b2887), x5527).name("x5532").ctrl(x5533) // SRAMStore(x5109,ArrayBuffer(Const(32), Const(64)),List(b2632, b2887),Const(0),x5527,x5531)
    ...
    val b5646 = StoreMem(List(b5642), None, x5552).name("b5646").ctrl(x5555) // StreamWrite(x5541,x5553,b2964)
    val b5647 = StoreMem(List(b5643), None, Const(256)).name("b5647").ctrl(x5555) // StreamWrite(x5541,x5553,b2964)
    ...
    val b5648 = StoreMem(List(b5644), None, x5560).name("b5648").ctrl(x5563) // ParStreamWrite(x5542,List(x5561),List(x5558))
    ...
    val b5649 = LoadMem(b5645, None).name("b5649").ctrl(x5566) // StreamRead(x5543,b2964)
