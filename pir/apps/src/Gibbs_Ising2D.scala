...
object Gibbs_Ising2D extends PIRApp {
  def main(top:Top) = {
    ...
    val b5624 = WriteMems(List(b5621), x5117).name("b5624").ctrl(x5120) // StreamWrite(x5110,x5118,Const(true))
    val b5625 = WriteMems(List(b5622), Const(36)).name("b5625").ctrl(x5120) // StreamWrite(x5110,x5118,Const(true))
    ...
    val b5626 = ReadMem(b5623).name("b5626").ctrl(x5127) // ParStreamRead(x5111,List(b2557))
    ...
    val b5631 = WriteMems(List(b5628), x5141).name("b5631").ctrl(x5144) // StreamWrite(x5131,x5142,b2566)
    val b5632 = WriteMems(List(b5629), Const(256)).name("b5632").ctrl(x5144) // StreamWrite(x5131,x5142,b2566)
    ...
    val b5633 = ReadMem(b5630).name("b5633").ctrl(x5152) // ParStreamRead(x5132,List(x5148))
    ...
    val b5638 = WriteMems(List(b5635), x5167).name("b5638").ctrl(x5170) // StreamWrite(x5157,x5168,b2596)
    val b5639 = WriteMems(List(b5636), Const(256)).name("b5639").ctrl(x5170) // StreamWrite(x5157,x5168,b2596)
    ...
    val b5640 = ReadMem(b5637).name("b5640").ctrl(x5178) // ParStreamRead(x5158,List(x5174))
    ...
    val x5194 = WriteMems(List(x5185), x5192).name("x5194").ctrl(x5195) // RegWrite(x5185,x5192,x5193)
    ...
    val x5201 = WriteMems(List(x5186), x5199).name("x5201").ctrl(x5202) // RegWrite(x5186,x5199,x5200)
    ...
    val x5208 = WriteMems(List(x5187), x5206).name("x5208").ctrl(x5209) // RegWrite(x5187,x5206,x5207)
    ...
    val x5215 = WriteMems(List(x5188), x5213).name("x5215").ctrl(x5216) // RegWrite(x5188,x5213,x5214)
    ...
    val x5276 = WriteMems(List(x5220), x5246).name("x5276").ctrl(x5280) // RegWrite(x5220,x5246,x5229)
    val x5277 = WriteMems(List(x5221), x5271).name("x5277").ctrl(x5280) // RegWrite(x5221,x5271,x5229)
    val x5278 = WriteMems(List(x5222_d0, x5222_d1), x5274).name("x5278").ctrl(x5280) // RegWrite(x5222,x5274,x5229)
    val x5279 = WriteMems(List(x5223), x5275).name("x5279").ctrl(x5280) // RegWrite(x5223,x5275,x5229)
    ...
    val x5356 = WriteMems(List(x5300), x5326).name("x5356").ctrl(x5360) // RegWrite(x5300,x5326,x5309)
    val x5357 = WriteMems(List(x5301), x5351).name("x5357").ctrl(x5360) // RegWrite(x5301,x5351,x5309)
    val x5358 = WriteMems(List(x5302_d0, x5302_d1), x5354).name("x5358").ctrl(x5360) // RegWrite(x5302,x5354,x5309)
    val x5359 = WriteMems(List(x5303), x5355).name("x5359").ctrl(x5360) // RegWrite(x5303,x5355,x5309)
    ...
    val x5436 = WriteMems(List(x5380), x5406).name("x5436").ctrl(x5440) // RegWrite(x5380,x5406,x5389)
    val x5437 = WriteMems(List(x5381), x5431).name("x5437").ctrl(x5440) // RegWrite(x5381,x5431,x5389)
    val x5438 = WriteMems(List(x5382_d0, x5382_d1), x5434).name("x5438").ctrl(x5440) // RegWrite(x5382,x5434,x5389)
    val x5439 = WriteMems(List(x5383), x5435).name("x5439").ctrl(x5440) // RegWrite(x5383,x5435,x5389)
    ...
    val x5516 = WriteMems(List(x5460), x5486).name("x5516").ctrl(x5520) // RegWrite(x5460,x5486,x5469)
    val x5517 = WriteMems(List(x5461), x5511).name("x5517").ctrl(x5520) // RegWrite(x5461,x5511,x5469)
    val x5518 = WriteMems(List(x5462_d0, x5462_d1), x5514).name("x5518").ctrl(x5520) // RegWrite(x5462,x5514,x5469)
    val x5519 = WriteMems(List(x5463), x5515).name("x5519").ctrl(x5520) // RegWrite(x5463,x5515,x5469)
    ...
    val b5646 = WriteMems(List(b5642), x5552).name("b5646").ctrl(x5555) // StreamWrite(x5541,x5553,b2964)
    val b5647 = WriteMems(List(b5643), Const(256)).name("b5647").ctrl(x5555) // StreamWrite(x5541,x5553,b2964)
    ...
    val b5648 = WriteMems(List(b5644), x5560).name("b5648").ctrl(x5563) // ParStreamWrite(x5542,List(x5561),List(x5558))
    ...
    val b5649 = ReadMem(b5645).name("b5649").ctrl(x5566) // StreamRead(x5543,b2964)
