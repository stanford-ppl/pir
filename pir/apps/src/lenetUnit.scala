...
object lenetUnit extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x5705 = DRAM(dims=List(Const(20), Const(1), Const(32))).name("x5705").ctrl(top).srcCtx("lenetUnit.scala:22:26:c0_DRAM") // x5705 = DRAMNew(ArrayBuffer(Const(20), Const(1), Const(32)),Const(0))
    val x5706 = DRAM(dims=List(Const(17), Const(28), Const(32))).name("x5706").ctrl(top).srcCtx("lenetUnit.scala:23:26:i0_DRAM") // x5706 = DRAMNew(ArrayBuffer(Const(17), Const(28), Const(32)),Const(0))
    val x5707 = DRAM(dims=List(Const(32))).name("x5707").ctrl(top).srcCtx("lenetUnit.scala:24:26:c1_DRAM") // x5707 = DRAMNew(ArrayBuffer(Const(32)),Const(0))
    val x5708 = DRAM(dims=List(Const(50), Const(512))).name("x5708").ctrl(top).srcCtx("lenetUnit.scala:25:26:c2_DRAM") // x5708 = DRAMNew(ArrayBuffer(Const(50), Const(512)),Const(0))
    val x5709 = DRAM(dims=List(Const(64))).name("x5709").ctrl(top).srcCtx("lenetUnit.scala:26:26:c3_DRAM") // x5709 = DRAMNew(ArrayBuffer(Const(64)),Const(0))
    val x5710 = DRAM(dims=List(Const(100), Const(4000))).name("x5710").ctrl(top).srcCtx("lenetUnit.scala:27:26:c4_DRAM") // x5710 = DRAMNew(ArrayBuffer(Const(100), Const(4000)),Const(0))
    val x5711 = DRAM(dims=List(Const(512))).name("x5711").ctrl(top).srcCtx("lenetUnit.scala:29:26:c5_DRAM") // x5711 = DRAMNew(ArrayBuffer(Const(512)),Const(0))
    val x5712 = DRAM(dims=List(Const(10), Const(512))).name("x5712").ctrl(top).srcCtx("lenetUnit.scala:30:26:c6_DRAM") // x5712 = DRAMNew(ArrayBuffer(Const(10), Const(512)),Const(0))
    val x5713 = DRAM(dims=List(Const(32))).name("x5713").ctrl(top).srcCtx("lenetUnit.scala:32:26:c7_DRAM") // x5713 = DRAMNew(ArrayBuffer(Const(32)),Const(0))
    val x5714 = DRAM(dims=List(Const(17), Const(32))).name("x5714").ctrl(top).srcCtx("lenetUnit.scala:33:28:tmp5_DRAM") // x5714 = DRAMNew(ArrayBuffer(Const(17), Const(32)),Const(0))
    ...
    val x5932 = Counter(min=Const(0), max=Const(12), step=Const(1), par=1).name("x5932").ctrl(x6005).srcCtx("lenetUnit.scala:106:31") // CounterNew(Const(0),Const(12),Const(1),Const(1))
    val x5933 = Counter(min=Const(0), max=Const(12), step=Const(1), par=1).name("x5933").ctrl(x6005).srcCtx("lenetUnit.scala:106:22") // CounterNew(Const(0),Const(12),Const(1),Const(1))
    val x5934 = CounterChain(List(x5933,x5932)).name("x5934").ctrl(x6005).srcCtx("lenetUnit.scala:106:37") // CounterChainNew(List(x5933, x5932))
    val x6004 = LoopController(style=MetaPipe, level=OuterControl, cchain=x5934).name("x6004").ctrl(x6005).srcCtx("lenetUnit.scala:106:37") // UnrolledForeach(List(b3664, b3617),x5934,Block(Const(())),List(List(b3712), List(b3713)),List(List(b3714), List(b3715)))
    ...
    val x5935_d0 = Reg(init=Some(0.0)).name("x5935_d0").ctrl(x6004).srcCtx("lenetUnit.scala:108:36:out") // x5935 = RegNew(Const(0))
    isAccum(x5935_d0) = false
    bufferDepthOf(x5935_d0) = 2
    val x5935_d1 = Reg(init=Some(0.0)).name("x5935_d1").ctrl(x6004).srcCtx("lenetUnit.scala:108:36:out") // x5935 = RegNew(Const(0))
    isAccum(x5935_d1) = true
    bufferDepthOf(x5935_d1) = 1
    val x5936 = Counter(min=Const(0), max=Const(2), step=Const(1), par=1).name("x5936").ctrl(x6004).srcCtx("lenetUnit.scala:108:57") // CounterNew(Const(0),Const(2),Const(1),Const(1))
    val x5937 = Counter(min=Const(0), max=Const(2), step=Const(1), par=1).name("x5937").ctrl(x6004).srcCtx("lenetUnit.scala:108:49") // CounterNew(Const(0),Const(2),Const(1),Const(1))
    val x5938 = CounterChain(List(x5937,x5936)).name("x5938").ctrl(x6004).srcCtx("lenetUnit.scala:115:15") // CounterChainNew(List(x5937, x5936))
    val x5997 = LoopController(style=MetaPipe, level=OuterControl, cchain=x5938).name("x5997").ctrl(x6004).srcCtx("lenetUnit.scala:115:15") // UnrolledReduce(List(b3714, b3715, b3664, b3617),x5938,x5935,Block((x5935) => Const(())),List(List(b3720), List(b3721)),List(List(b3722), List(b3723)))
    ...
    val x5939_d0 = Reg(init=Some(0.0)).name("x5939_d0").ctrl(x5997).srcCtx("lenetUnit.scala:109:41:window") // x5939 = RegNew(Const(0))
    isAccum(x5939_d0) = false
    bufferDepthOf(x5939_d0) = 2
    val x5939_d1 = Reg(init=Some(0.0)).name("x5939_d1").ctrl(x5997).srcCtx("lenetUnit.scala:109:41:window") // x5939 = RegNew(Const(0))
    isAccum(x5939_d1) = true
    bufferDepthOf(x5939_d1) = 1
    val x5940 = Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x5940").ctrl(x5997).srcCtx("lenetUnit.scala:109:81") // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x5941 = Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x5941").ctrl(x5997).srcCtx("lenetUnit.scala:109:63") // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x5942 = CounterChain(List(x5941,x5940)).name("x5942").ctrl(x5997).srcCtx("lenetUnit.scala:113:16") // CounterChainNew(List(x5941, x5940))
    val x5970 = LoopController(style=InnerPipe, level=InnerControl, cchain=x5942).name("x5970").ctrl(x5997).srcCtx("lenetUnit.scala:113:16") // UnrolledReduce(List(b3722, b3723, b3714, b3715, b3664, b3617),x5942,x5939,Block((x5939) => Const(())),List(List(b3728), List(b3729)),List(List(b3730), List(b3731)))
    ...
    val x5943 = OpDef(op=FixSla, inputs=List(b3712, Const(1))).name("x5943").ctrl(x5970).srcCtx("lenetUnit.scala:110:26") // FixLsh(b3712,Const(1))
    val x5944 = OpDef(op=FixAdd, inputs=List(x5943, b3720)).name("x5944").ctrl(x5970).srcCtx("lenetUnit.scala:110:29:r") // FixAdd(x5943,b3720)
    val x5945 = OpDef(op=FixSla, inputs=List(b3713, Const(1))).name("x5945").ctrl(x5970).srcCtx("lenetUnit.scala:111:26") // FixLsh(b3713,Const(1))
    val x5946 = OpDef(op=FixAdd, inputs=List(x5945, b3721)).name("x5946").ctrl(x5970).srcCtx("lenetUnit.scala:111:29:c") // FixAdd(x5945,b3721)
    val x5947 = OpDef(op=FixAdd, inputs=List(x5944, b3728)).name("x5947").ctrl(x5970).srcCtx("lenetUnit.scala:112:26") // FixAdd(x5944,b3728)
    val x5948 = OpDef(op=FixAdd, inputs=List(x5946, b3729)).name("x5948").ctrl(x5970).srcCtx("lenetUnit.scala:112:31") // FixAdd(x5946,b3729)
    ...
    val x5956 = LoadBanks(List(x5855_d0_b0), List(x5947, x5948)).name("x5956").ctrl(x5970).srcCtx("lenetUnit.scala:112:24") // ParSRAMLoad(x5855,List(List(x5947, x5948)),List(x5955))
    val x5957 = x5956 // x5957 = VectorApply(x5956,0)
    val x5958 = OpDef(op=FixMul, inputs=List(b3728, Const(5))).name("x5958").ctrl(x5970).srcCtx("lenetUnit.scala:112:46") // FixMul(b3728,Const(5))
    val x5959 = OpDef(op=FixAdd, inputs=List(x5958, b3713)).name("x5959").ctrl(x5970).srcCtx("lenetUnit.scala:112:48") // FixAdd(x5958,b3713)
    val x5960 = LoadBanks(List(x5894_d0_b0), List(x5959)).name("x5960").ctrl(x5970).srcCtx("lenetUnit.scala:112:43") // RegFileLoad(x5894,List(x5959),x5955)
    val x5961 = OpDef(op=FixMul, inputs=List(x5957, x5960)).name("x5961").ctrl(x5970).srcCtx("lenetUnit.scala:112:36") // FixMul(x5957,x5960)
    val x5962 = ReadMem(x5939_d1).name("x5962").ctrl(x5970).srcCtx("lenetUnit.scala:113:16") // RegRead(x5939)
    val x5963 = OpDef(op=FixEql, inputs=List(b3728, Const(0))).name("x5963").ctrl(x5970).srcCtx("lenetUnit.scala:113:16") // FixEql(b3728,Const(0))
    val x5964 = OpDef(op=FixEql, inputs=List(b3729, Const(0))).name("x5964").ctrl(x5970).srcCtx("lenetUnit.scala:113:16") // FixEql(b3729,Const(0))
    val x5965 = OpDef(op=BitAnd, inputs=List(x5963, x5964)).name("x5965").ctrl(x5970).srcCtx("lenetUnit.scala:113:16") // And(x5963,x5964)
    val x5966 = ReduceAccumOp(op=FixAdd, input=x5961, accum=x5962).name("x5966").ctrl(x5970).srcCtx("lenetUnit.scala:113:18") // FixAdd(x5961,x5962)
    ...
    val x5969_x5939_d0 = WriteMem(x5939_d0, x5966).name("x5969_x5939_d0").ctrl(x5970).srcCtx("lenetUnit.scala:113:16") // RegWrite(x5939,x5966,x5968)
    val x5969_x5939_d1 = WriteMem(x5939_d1, x5966).name("x5969_x5939_d1").ctrl(x5970).srcCtx("lenetUnit.scala:113:16") // RegWrite(x5939,x5966,x5968)
    val x5971 = Reg(init=Some(0.0)).name("x5971").ctrl(x5997).srcCtx("lenetUnit.scala:115:15") // x5971 = RegNew(Const(0))
    isAccum(x5971) = false
    bufferDepthOf(x5971) = 2
    val x5982 = UnitController(style=SeqPipe, level=InnerControl).name("x5982").ctrl(x5997).srcCtx("lenetUnit.scala:115:15") // UnitPipe(List(b3722, b3723, b3714, b3715, b3664, b3617),Block(Const(())))
    ...
    val x5977 = LoadBanks(List(x5834_d0_b0), List(b3663)).name("x5977").ctrl(x5982).srcCtx("lenetUnit.scala:114:50") // SRAMLoad(x5834,ArrayBuffer(Const(32)),List(b3663),Const(0),x5976)
    val x5978 = ReadMem(x5939_d0).name("x5978").ctrl(x5982).srcCtx("lenetUnit.scala:114:35") // RegRead(x5939)
    val x5979 = OpDef(op=FixAdd, inputs=List(x5978, x5977)).name("x5979").ctrl(x5982).srcCtx("lenetUnit.scala:114:41") // FixAdd(x5978,x5977)
    val x5980 = OpDef(op=FixMax, inputs=List(Const(0.0), x5979)).name("x5980").ctrl(x5982).srcCtx("lenetUnit.scala:114:18") // Max(Const(0),x5979)
    val x5981_x5971 = WriteMem(x5971, x5980).name("x5981_x5971").ctrl(x5982).srcCtx("lenetUnit.scala:115:15") // RegWrite(x5971,x5980,x5976)
    val x5996 = UnitController(style=SeqPipe, level=InnerControl).name("x5996").ctrl(x5997).srcCtx("lenetUnit.scala:115:15") // UnitPipe(List(b3714, b3715, b3664, b3617),Block(x5995))
    val x5983 = OpDef(op=BitAnd, inputs=List(b3722, b3723)).name("x5983").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // And(b3722,b3723)
    val x5984 = OpDef(op=BitAnd, inputs=List(b3714, b3715)).name("x5984").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // And(b3714,b3715)
    val x5985 = OpDef(op=BitAnd, inputs=List(b3664, b3617)).name("x5985").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // And(b3664,b3617)
    val x5986 = OpDef(op=BitAnd, inputs=List(x5983, x5984)).name("x5986").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // And(x5983,x5984)
    val x5987 = OpDef(op=BitAnd, inputs=List(x5986, x5985)).name("x5987").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // And(x5986,x5985)
    val x5988 = ReadMem(x5935_d1).name("x5988").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // RegRead(x5935)
    val x5989 = OpDef(op=FixEql, inputs=List(b3720, Const(0))).name("x5989").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // FixEql(b3720,Const(0))
    val x5990 = OpDef(op=FixEql, inputs=List(b3721, Const(0))).name("x5990").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // FixEql(b3721,Const(0))
    val x5991 = OpDef(op=BitAnd, inputs=List(x5989, x5990)).name("x5991").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // And(x5989,x5990)
    val x5992 = ReadMem(x5971).name("x5992").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // RegRead(x5971)
    val x5993 = ReduceAccumOp(op=FixMax, input=x5992, accum=x5988).name("x5993").ctrl(x5996).srcCtx("lenetUnit.scala:115:29") // Max(x5992,x5988)
    val x5994 = OpDef(op=BitAnd, inputs=List(x5984, x5985)).name("x5994").ctrl(x5996).srcCtx("UnrollingBase.scala:28:66") // And(x5984,x5985)
    val x5995_x5935_d0 = WriteMem(x5935_d0, x5993).name("x5995_x5935_d0").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // RegWrite(x5935,x5993,x5994)
    val x5995_x5935_d1 = WriteMem(x5935_d1, x5993).name("x5995_x5935_d1").ctrl(x5996).srcCtx("lenetUnit.scala:115:15") // RegWrite(x5935,x5993,x5994)
    val x6003 = UnitController(style=SeqPipe, level=InnerControl).name("x6003").ctrl(x6004).srcCtx("lenetUnit.scala:106:37") // UnitPipe(List(b3714, b3715, b3664, b3617),Block(Const(())))
    val x5998 = ReadMem(x5935_d0).name("x5998").ctrl(x6003).srcCtx("lenetUnit.scala:116:43") // RegRead(x5935)
    ...
    val x6002 = StoreBanks(List(x5891_d0_b0), List(b3663, b3712, b3713), x5998).name("x6002").ctrl(x6003).srcCtx("lenetUnit.scala:116:37") // SRAMStore(x5891,ArrayBuffer(Const(20), Const(12), Const(12)),List(b3663, b3712, b3713),Const(0),x5998,x6001)
    val x6006 = DRAM(dims=List(Const(20), Const(12), Const(12))).name("x6006").ctrl(x6080).srcCtx("lenetUnit.scala:124:31:tmp_DRAM") // x6006 = DRAMNew(ArrayBuffer(Const(20), Const(12), Const(12)),Const(0))
    ...
    val x6011 = StreamOut(field="data").name("x6011").ctrl(x6079).srcCtx("lenetUnit.scala:125:39") // x6011 = StreamOutNew(BurstFullDataBus())
    isAccum(x6011) = false
    bufferDepthOf(x6011) = 1
    val x6012 = StreamIn(field="ack").name("x6012").ctrl(x6079).srcCtx("lenetUnit.scala:125:39") // x6012 = StreamInNew(BurstAckBus)
    isAccum(x6012) = false
    ...
    val x6053 = ReadMem(x6015).name("x6053").ctrl(x6072).srcCtx("lenetUnit.scala:125:39") // RegRead(x6015)
    val x6054 = Counter(min=Const(0), max=x6053, step=Const(1), par=1).name("x6054").ctrl(x6072).srcCtx("lenetUnit.scala:125:39") // CounterNew(Const(0),x6053,Const(1),Const(1))
    val x6055 = CounterChain(List(x6054)).name("x6055").ctrl(x6072).srcCtx("lenetUnit.scala:125:39") // CounterChainNew(List(x6054))
    val x6071 = LoopController(style=InnerPipe, level=InnerControl, cchain=x6055).name("x6071").ctrl(x6072).srcCtx("lenetUnit.scala:125:39") // UnrolledForeach(List(b3801, b3802, b3617),x6055,Block(Const(())),List(List(b3845)),List(List(b3846)))
    val b3845 = CounterIter(x6054, None).name("b3845").ctrl(x6071) // b3845
    val b3846 = Const(true).name("b3846").ctrl(x6071) // b3846
    val x6056 = ReadMem(x6013).name("x6056").ctrl(x6071).srcCtx("lenetUnit.scala:125:39") // RegRead(x6013)
    val x6057 = OpDef(op=FixLeq, inputs=List(x6056, b3845)).name("x6057").ctrl(x6071).srcCtx("lenetUnit.scala:125:39") // FixLeq(x6056,b3845)
    val x6058 = ReadMem(x6014).name("x6058").ctrl(x6071).srcCtx("lenetUnit.scala:125:39") // RegRead(x6014)
    val x6059 = OpDef(op=FixLt, inputs=List(b3845, x6058)).name("x6059").ctrl(x6071).srcCtx("lenetUnit.scala:125:39") // FixLt(b3845,x6058)
    val x6069_x6060 = OpDef(op=BitAnd, inputs=List(x6057, x6059)).name("x6069_x6060").ctrl(x6071).srcCtx("lenetUnit.scala:125:39") // And(x6057,x6059)
    val x6061 = OpDef(op=FixSub, inputs=List(b3845, x6056)).name("x6061").ctrl(x6071).srcCtx("lenetUnit.scala:125:39") // FixSub(b3845,x6056)
    ...
    val x6066 = LoadBanks(List(x5891_d0_b0), List(b3799, b3800, x6061)).name("x6066").ctrl(x6071).srcCtx("lenetUnit.scala:125:39") // ParSRAMLoad(x5891,List(List(b3799, b3800, x6061)),List(x6065))
    val x6067 = x6066 // x6067 = VectorApply(x6066,0)
    val x6069_x6068 = OpDef(op=MuxOp, inputs=List(x6069_x6060, x6067, Const(0.0))).name("x6069_x6068").ctrl(x6071).srcCtx("lenetUnit.scala:125:39") // Mux(x6060,x6067,Const(0))
    // x6069 = SimpleStruct(ArrayBuffer((_1,x6068), (_2,x6060)))
    val x6070_x6070_x6011 = WriteMem(x6011, x6069_x6068).name("x6070_x6070_x6011").ctrl(x6071).srcCtx("lenetUnit.scala:125:39") // ParStreamWrite(x6011,List(x6069),List(x6064))
    val x6073 = FringeDenseStore(dram=List(x6006), cmdStream=List(b6131, b6132), dataStream=List(x6011), ackStream=List(x6012)).name("x6073").ctrl(x6078).srcCtx("lenetUnit.scala:125:39") // FringeDenseStore(x6006,x6010,x6011,x6012)
    val x6077 = UnitController(style=SeqPipe, level=InnerControl).name("x6077").ctrl(x6078).srcCtx("lenetUnit.scala:125:39") // UnitPipe(List(b3801, b3802, b3617),Block(Const(())))
    ...
    val x6076_x6076 = ReadMem(x6012).name("x6076_x6076").ctrl(x6077).srcCtx("lenetUnit.scala:125:39") // StreamRead(x6012,x6075)
