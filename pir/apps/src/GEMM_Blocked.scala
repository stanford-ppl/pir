...
object GEMM_Blocked extends PIRApp {
  def main(top:Top) = {
    ...
    val x4707 = LoadMem(x4701_d0, None).name("x4707").ctrl(top) // RegRead(x4701)
    val x4708 = LoadMem(x4701_d0, None).name("x4708").ctrl(top) // RegRead(x4701)
    val x4709 = DRAM().name("x4709").ctrl(top) // x4709 = DRAMNew(ArrayBuffer(x4708, x4707),Const(0))
    val x4710 = LoadMem(x4701_d0, None).name("x4710").ctrl(top) // RegRead(x4701)
    val x4711 = LoadMem(x4701_d0, None).name("x4711").ctrl(top) // RegRead(x4701)
    val x4712 = DRAM().name("x4712").ctrl(top) // x4712 = DRAMNew(ArrayBuffer(x4711, x4710),Const(0))
    val x4713 = LoadMem(x4701_d0, None).name("x4713").ctrl(top) // RegRead(x4701)
    val x4714 = LoadMem(x4701_d0, None).name("x4714").ctrl(top) // RegRead(x4701)
    ...
    val x4719 = LoadMem(x4701_d0, None).name("x4719").ctrl(x5084) // RegRead(x4701)
    ...
    val x4722 = LoadMem(x4701_d0, None).name("x4722").ctrl(x5083) // RegRead(x4701)
    ...
    val x4726 = LoadMem(x4701_d0, None).name("x4726").ctrl(x5082) // RegRead(x4701)
    ...
    val x4741 = StoreMem(List(x4731), None, x4737).name("x4741").ctrl(x4743) // RegWrite(x4731,x4737,x4740)
    val x4742 = StoreMem(List(x4732), None, x4738).name("x4742").ctrl(x4743) // RegWrite(x4732,x4738,x4740)
    val x4744 = LoadMem(x4731, None).name("x4744").ctrl(x4995) // RegRead(x4731)
    ...
    val x4752 = LoadMem(x4701_d0, None).name("x4752").ctrl(x4788) // RegRead(x4701)
    ...
    val x4760 = LoadMem(x4732, None).name("x4760").ctrl(x4788) // RegRead(x4732)
    ...
    val b5131 = StoreMem(List(b5125), None, x4780).name("b5131").ctrl(x4788) // StreamWrite(x4747,x4781,x4784)
    val b5132 = StoreMem(List(b5126), None, x4776).name("b5132").ctrl(x4788) // StreamWrite(x4747,x4781,x4784)
    // x4786 = SimpleStruct(ArrayBuffer((size,x4774), (start,x4770), (end,x4772)))
    val b5133 = StoreMem(List(b5127), None, x4774).name("b5133").ctrl(x4788) // FIFOEnq(x4748,x4786,x4784)
    val b5134 = StoreMem(List(b5128), None, x4770).name("b5134").ctrl(x4788) // FIFOEnq(x4748,x4786,x4784)
    val b5135 = StoreMem(List(b5129), None, x4772).name("b5135").ctrl(x4788) // FIFOEnq(x4748,x4786,x4784)
    ...
    val b5136 = LoadMem(b5127, None).name("b5136").ctrl(x4803) // FIFODeq(x4748,x4795)
    val b5137 = LoadMem(b5128, None).name("b5137").ctrl(x4803) // FIFODeq(x4748,x4795)
    val b5138 = LoadMem(b5129, None).name("b5138").ctrl(x4803) // FIFODeq(x4748,x4795)
    val x4797 = b5137 // x4797 = FieldApply(x4796,start)
    val x4798 = StoreMem(List(x4790), None, x4797).name("x4798").ctrl(x4803) // RegWrite(x4790,x4797,x4795)
    val x4799 = b5138 // x4799 = FieldApply(x4796,end)
    val x4800 = StoreMem(List(x4791), None, x4799).name("x4800").ctrl(x4803) // RegWrite(x4791,x4799,x4795)
    val x4801 = b5136 // x4801 = FieldApply(x4796,size)
    val x4802 = StoreMem(List(x4792), None, x4801).name("x4802").ctrl(x4803) // RegWrite(x4792,x4801,x4795)
    val x4804 = LoadMem(x4792, None).name("x4804").ctrl(x4822) // RegRead(x4792)
    ...
    val x4807 = LoadMem(x4790, None).name("x4807").ctrl(x4821) // RegRead(x4790)
    val x4808 = OpDef(op=FixLeq, inputs=List(x4807, b2710)).name("x4808").ctrl(x4821) // FixLeq(x4807,b2710)
    val x4809 = LoadMem(x4791, None).name("x4809").ctrl(x4821) // RegRead(x4791)
    ...
    val b5139 = LoadMem(b5130, None).name("b5139").ctrl(x4821) // ParStreamRead(x4749,List(x4816))
    ...
    val x4820 = StoreBanks(List(List(x4730_d0_b0)), List(b2652, x4812), b5140).name("x4820").ctrl(x4821) // ParSRAMStore(x4730,List(List(b2652, x4812)),List(x4818),List(x4819))
    ...
    val x4837 = StoreMem(List(x4827), None, x4829).name("x4837").ctrl(x4839) // RegWrite(x4827,x4829,x4836)
    val x4838 = StoreMem(List(x4828), None, x4833).name("x4838").ctrl(x4839) // RegWrite(x4828,x4833,x4836)
    ...
    val x4845 = LoadMem(x4827, None).name("x4845").ctrl(x4885) // RegRead(x4827)
    ...
    val x4848 = LoadMem(x4701_d0, None).name("x4848").ctrl(x4885) // RegRead(x4701)
    ...
    val x4856 = LoadMem(x4828, None).name("x4856").ctrl(x4885) // RegRead(x4828)
    ...
    val b5147 = StoreMem(List(b5141), None, x4876).name("b5147").ctrl(x4885) // StreamWrite(x4842,x4877,x4881)
    val b5148 = StoreMem(List(b5142), None, x4872).name("b5148").ctrl(x4885) // StreamWrite(x4842,x4877,x4881)
    // x4883 = SimpleStruct(ArrayBuffer((size,x4870), (start,x4866), (end,x4868)))
    val b5149 = StoreMem(List(b5143), None, x4870).name("b5149").ctrl(x4885) // FIFOEnq(x4843,x4883,x4881)
    val b5150 = StoreMem(List(b5144), None, x4866).name("b5150").ctrl(x4885) // FIFOEnq(x4843,x4883,x4881)
    val b5151 = StoreMem(List(b5145), None, x4868).name("b5151").ctrl(x4885) // FIFOEnq(x4843,x4883,x4881)
    ...
    val b5152 = LoadMem(b5143, None).name("b5152").ctrl(x4901) // FIFODeq(x4843,x4893)
    val b5153 = LoadMem(b5144, None).name("b5153").ctrl(x4901) // FIFODeq(x4843,x4893)
    val b5154 = LoadMem(b5145, None).name("b5154").ctrl(x4901) // FIFODeq(x4843,x4893)
    val x4895 = b5153 // x4895 = FieldApply(x4894,start)
    val x4896 = StoreMem(List(x4887), None, x4895).name("x4896").ctrl(x4901) // RegWrite(x4887,x4895,x4893)
    val x4897 = b5154 // x4897 = FieldApply(x4894,end)
    val x4898 = StoreMem(List(x4888), None, x4897).name("x4898").ctrl(x4901) // RegWrite(x4888,x4897,x4893)
    val x4899 = b5152 // x4899 = FieldApply(x4894,size)
    val x4900 = StoreMem(List(x4889), None, x4899).name("x4900").ctrl(x4901) // RegWrite(x4889,x4899,x4893)
    val x4902 = LoadMem(x4889, None).name("x4902").ctrl(x4921) // RegRead(x4889)
    ...
    val x4905 = LoadMem(x4887, None).name("x4905").ctrl(x4920) // RegRead(x4887)
    val x4906 = OpDef(op=FixLeq, inputs=List(x4905, b2810)).name("x4906").ctrl(x4920) // FixLeq(x4905,b2810)
    val x4907 = LoadMem(x4888, None).name("x4907").ctrl(x4920) // RegRead(x4888)
    ...
    val b5155 = LoadMem(b5146, None).name("b5155").ctrl(x4920) // ParStreamRead(x4844,List(x4915))
    ...
    val x4919 = StoreBanks(List(List(x4826_d0_b0)), List(x4910), b5156).name("x4919").ctrl(x4920) // ParSRAMStore(x4826,List(List(x4910)),List(x4917),List(x4918))
    ...
    val x4933 = StoreMem(List(x4927), None, x4932).name("x4933").ctrl(x4934) // RegWrite(x4927,x4932,x4931)
    ...
    val x4944 = LoadMem(x4927, None).name("x4944").ctrl(x4947) // RegRead(x4927)
    val x4945 = OpDef(op=FixMul, inputs=List(x4943, x4944)).name("x4945").ctrl(x4947) // FixMul(x4943,x4944)
    val x4946 = StoreBanks(List(List(x4926_d0_b0)), List(b2848), x4945).name("x4946").ctrl(x4947) // ParSRAMStore(x4926,List(List(b2848)),List(x4945),List(x4941))
    ...
    val x4963 = OpDef(op=FixAdd, inputs=List(x4955, x4957)).name("x4963").ctrl(x4965) // FixAdd(x4955,x4957)
    val x4964 = StoreBanks(List(List(x4923_d0_b0), List(x4923_d1_b0)), List(b2861), x4963).name("x4964").ctrl(x4965) // ParSRAMStore(x4923,List(ArrayBuffer(b2861)),List(x4963),List(x4953))
    ...
    val x4975 = StoreBanks(List(List(x4729_d0_b0)), List(b2731, b2882), x4974).name("x4975").ctrl(x4976) // ParSRAMStore(x4729,List(List(b2731, b2882)),List(x4974),List(x4972))
    ...
    val x4992 = OpDef(op=FixAdd, inputs=List(x4985, x4987)).name("x4992").ctrl(x4994) // FixAdd(x4985,x4987)
    val x4993 = StoreBanks(List(List(x4725_d0_b0), List(x4725_d1_b0)), List(b2893, b2894), x4992).name("x4993").ctrl(x4994) // ParSRAMStore(x4725,List(ArrayBuffer(b2893, b2894)),List(x4992),List(x4983))
    ...
    val x5005 = StoreMem(List(x4996), None, x5002).name("x5005").ctrl(x5007) // RegWrite(x4996,x5002,x5004)
    val x5006 = StoreMem(List(x4997), None, x5003).name("x5006").ctrl(x5007) // RegWrite(x4997,x5003,x5004)
    val x5008 = LoadMem(x4996, None).name("x5008").ctrl(x5082) // RegRead(x4996)
    ...
    val x5019 = LoadMem(x4701_d0, None).name("x5019").ctrl(x5055) // RegRead(x4701)
    ...
    val x5027 = LoadMem(x4997, None).name("x5027").ctrl(x5055) // RegRead(x4997)
    ...
    val b5161 = StoreMem(List(b5157), None, x5047).name("b5161").ctrl(x5055) // StreamWrite(x5011,x5048,x5050)
    val b5162 = StoreMem(List(b5158), None, x5043).name("b5162").ctrl(x5055) // StreamWrite(x5011,x5048,x5050)
    val x5052 = StoreMem(List(x5014), None, x5037).name("x5052").ctrl(x5055) // RegWrite(x5014,x5037,x5050)
    val x5053 = StoreMem(List(x5015), None, x5039).name("x5053").ctrl(x5055) // RegWrite(x5015,x5039,x5050)
    val x5054 = StoreMem(List(x5016), None, x5041).name("x5054").ctrl(x5055) // RegWrite(x5016,x5041,x5050)
    val x5056 = LoadMem(x5016, None).name("x5056").ctrl(x5075) // RegRead(x5016)
    ...
    val x5059 = LoadMem(x5014, None).name("x5059").ctrl(x5074) // RegRead(x5014)
    val x5060 = OpDef(op=FixLeq, inputs=List(x5059, b2973)).name("x5060").ctrl(x5074) // FixLeq(x5059,b2973)
    val x5061 = LoadMem(x5015, None).name("x5061").ctrl(x5074) // RegRead(x5015)
    ...
    val b5163 = StoreMem(List(b5159), None, x5071).name("b5163").ctrl(x5074) // ParStreamWrite(x5012,List(x5072),List(x5067))
    ...
    val b5164 = LoadMem(b5160, None).name("b5164").ctrl(x5080) // StreamRead(x5013,x5078)
