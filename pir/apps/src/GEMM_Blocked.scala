...
object GEMM_Blocked extends PIRApp {
  def main(top:Top) = {
    ...
    val x4820 = StoreBanks(List(x4730_d0_b0), List(b2652, x4812), b5140).name("x4820").ctrl(x4821) // ParSRAMStore(x4730,List(List(b2652, x4812)),List(x4818),List(x4819))
    ...
    val x4919 = StoreBanks(List(x4826_d0_b0), List(x4910), b5156).name("x4919").ctrl(x4920) // ParSRAMStore(x4826,List(List(x4910)),List(x4917),List(x4918))
