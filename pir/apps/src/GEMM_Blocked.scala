...
object GEMM_Blocked extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    boundOf(x3167_d0) = 32
    val x3167_d1 = ArgIn(init=0).name("x3167_d1").ctrl(top).srcCtx("GEMM_Blocked.scala:213:20") // ArgInNew(Const(0))
    isAccum(x3167_d1) = false
    bufferDepthOf(x3167_d1) = 1
    boundOf(x3167_d1) = 32
    val x3167_d2 = ArgIn(init=0).name("x3167_d2").ctrl(top).srcCtx("GEMM_Blocked.scala:213:20") // ArgInNew(Const(0))
    isAccum(x3167_d2) = false
    bufferDepthOf(x3167_d2) = 1
    boundOf(x3167_d2) = 32
    val x3167_d3 = ArgIn(init=0).name("x3167_d3").ctrl(top).srcCtx("GEMM_Blocked.scala:213:20") // ArgInNew(Const(0))
    isAccum(x3167_d3) = false
    bufferDepthOf(x3167_d3) = 1
    boundOf(x3167_d3) = 32
    val x3167_d4 = ArgIn(init=0).name("x3167_d4").ctrl(top).srcCtx("GEMM_Blocked.scala:213:20") // ArgInNew(Const(0))
    isAccum(x3167_d4) = false
    bufferDepthOf(x3167_d4) = 1
    boundOf(x3167_d4) = 32
    val x3167_d5 = ArgIn(init=0).name("x3167_d5").ctrl(top).srcCtx("GEMM_Blocked.scala:213:20") // ArgInNew(Const(0))
    ...
    val x3182 = Counter(min=Const(0), max=x3181, step=Const(16), par=1).name("x3182").ctrl(x3391).srcCtx("GEMM_Blocked.scala:224:26") // CounterNew(Const(0),x3181,Const(16),Const(1))
    ...
    val x3185 = Counter(min=Const(0), max=x3184, step=Const(16), par=1).name("x3185").ctrl(x3390).srcCtx("GEMM_Blocked.scala:225:27") // CounterNew(Const(0),x3184,Const(16),Const(1))
    ...
    val x3196 = Counter(min=Const(0), max=Const(16), step=Const(1), par=1).name("x3196").ctrl(x3349).srcCtx("GEMM_Blocked.scala:230:20") // CounterNew(Const(0),Const(16),Const(1),Const(1))
    ...
    val x3214_b3435_b3433 = WriteMem(b3433, Const(64)).name("x3214_b3435_b3433").ctrl(x3215).srcCtx("GEMM_Blocked.scala:230:20") // StreamWrite(x3198,x3210,x3213)
    ...
    val x3217 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x3217").ctrl(x3227).srcCtx("GEMM_Blocked.scala:230:20") // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x3225 = StoreBanks(List(List(x3192_d0_b0)), List(b1826, b1849), x3224_x3224).name("x3225").ctrl(x3226).srcCtx("GEMM_Blocked.scala:230:20") // ParSRAMStore(x3192,List(List(b1826, b1849)),List(x3224),List(x3222))
    val x3228 = Counter(min=Const(0), max=Const(16), step=Const(1), par=1).name("x3228").ctrl(x3349).srcCtx("GEMM_Blocked.scala:231:30") // CounterNew(Const(0),Const(16),Const(1),Const(1))
    ...
    val x3233 = OpDef(op=FixAdd, inputs=List(b1817, Const(16))).name("x3233").ctrl(x3239).srcCtx("GEMM_Blocked.scala:233:46") // FixAdd(b1817,Const(16))
    ...
    val x3260_b3439_b3437 = WriteMem(b3437, Const(64)).name("x3260_b3439_b3437").ctrl(x3261).srcCtx("GEMM_Blocked.scala:233:22") // StreamWrite(x3242,x3255,x3259)
    ...
    val x3263 = Counter(min=Const(0), max=Const(16), step=Const(1), par=1).name("x3263").ctrl(x3274).srcCtx("GEMM_Blocked.scala:233:22") // CounterNew(Const(0),Const(16),Const(1),Const(1))
    ...
    val x3272 = StoreBanks(List(List(x3230_d0_b0)), List(b1901), x3271_x3271).name("x3272").ctrl(x3273).srcCtx("GEMM_Blocked.scala:233:22") // ParSRAMStore(x3230,List(List(b1901)),List(x3271),List(x3269))
    ...
    val x3284 = LoadBanks(List(x3230_d0_b0), List(b1918)).name("x3284").ctrl(x3286).srcCtx("GEMM_Blocked.scala:237:36") // SRAMLoad(x3230,ArrayBuffer(Const(16)),List(b1918),Const(0),x3283)
    ...
    val x3287 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x3287").ctrl(x3319).srcCtx("GEMM_Blocked.scala:238:33") // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x3298 = StoreBanks(List(List(x3278_d0_b0)), List(b1931), x3297).name("x3298").ctrl(x3299).srcCtx("GEMM_Blocked.scala:239:36") // ParSRAMStore(x3278,List(List(b1931)),List(x3297),List(x3293))
    val x3300 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x3300").ctrl(x3319).srcCtx("GEMM_Blocked.scala:242:16") // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x3317 = StoreBanks(List(List(x3275_d0_b0), List(x3275_d1_b0)), List(b1944), x3316).name("x3317").ctrl(x3318).srcCtx("GEMM_Blocked.scala:242:16") // ParSRAMStore(x3275,List(ArrayBuffer(b1944)),List(x3316),List(x3305))
    ...
    val x3328 = StoreBanks(List(List(x3191_d0_b0)), List(b1862, b1966), x3327).name("x3328").ctrl(x3329).srcCtx("GEMM_Blocked.scala:243:60") // ParSRAMStore(x3191,List(List(b1862, b1966)),List(x3327),List(x3325))
    val x3331 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x3331").ctrl(x3349).srcCtx("GEMM_Blocked.scala:246:12") // CounterNew(Const(0),Const(16),Const(1),Const(16))
    val x3332 = Counter(min=Const(0), max=Const(16), step=Const(1), par=1).name("x3332").ctrl(x3349).srcCtx("GEMM_Blocked.scala:246:12") // CounterNew(Const(0),Const(16),Const(1),Const(1))
    ...
    val x3347 = StoreBanks(List(List(x3187_d0_b0), List(x3187_d1_b0)), List(b1977, b1978), x3346).name("x3347").ctrl(x3348).srcCtx("GEMM_Blocked.scala:246:12") // ParSRAMStore(x3187,List(ArrayBuffer(b1977, b1978)),List(x3346),List(x3336))
    ...
    val x3353 = Counter(min=Const(0), max=Const(16), step=Const(1), par=1).name("x3353").ctrl(x3389).srcCtx("GEMM_Blocked.scala:247:55") // CounterNew(Const(0),Const(16),Const(1),Const(1))
    ...
    val x3371_b3443_b3441 = WriteMem(b3441, Const(64)).name("x3371_b3443_b3441").ctrl(x3372).srcCtx("GEMM_Blocked.scala:247:55") // StreamWrite(x3355,x3368,x3370)
    val x3373 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x3373").ctrl(x3388).srcCtx("GEMM_Blocked.scala:247:55") // CounterNew(Const(0),Const(16),Const(1),Const(16))
