...
object GEMM_Blocked extends PIRApp {
  def main(top:Top) = {
    ...
    val x4733 = OpDef(op=FixConvert, inputs=List(b2632)).name("x4733").ctrl(x4743) // FixConvert(b2632,TRUE,_32,_0)
    val x4734 = OpDef(op=FixAdd, inputs=List(x4733, Const(16).ctrl(x4743))).name("x4734").ctrl(x4743) // FixAdd(x4733,Const(16))
    val x4735 = OpDef(op=FixConvert, inputs=List(b2623)).name("x4735").ctrl(x4743) // FixConvert(b2623,TRUE,_32,_0)
    ...
    val x4751 = OpDef(op=FixConvert, inputs=List(x4750)).name("x4751").ctrl(x4788) // FixConvert(x4750,TRUE,_32,_0)
    ...
    val x4754 = OpDef(op=FixConvert, inputs=List(b2623)).name("x4754").ctrl(x4788) // FixConvert(b2623,TRUE,_32,_0)
    ...
    val x4777 = OpDef(op=FixConvert, inputs=List(x4762)).name("x4777").ctrl(x4788) // FixConvert(x4762,TRUE,_64,_0)
    ...
    val x4780 = OpDef(op=FixConvert, inputs=List(x4779)).name("x4780").ctrl(x4788) // FixConvert(x4779,TRUE,_64,_0)
    ...
    val b5130_b5125 = WriteMem(b5125, x4780).name("b5130_b5125").ctrl(x4788) // StreamWrite(x4747,x4781,x4784)
    val b5131_b5126 = WriteMem(b5126, x4776).name("b5131_b5126").ctrl(x4788) // StreamWrite(x4747,x4781,x4784)
    // x4786 = SimpleStruct(ArrayBuffer((size,x4774), (start,x4770), (end,x4772)))
    val b5132_b5127 = WriteMem(b5127, x4774).name("b5132_b5127").ctrl(x4788) // FIFOEnq(x4748,x4786,x4784)
    val b5133_b5128 = WriteMem(b5128, x4770).name("b5133_b5128").ctrl(x4788) // FIFOEnq(x4748,x4786,x4784)
    val b5134_b5129 = WriteMem(b5129, x4772).name("b5134_b5129").ctrl(x4788) // FIFOEnq(x4748,x4786,x4784)
    ...
    val b5135 = ReadMem(b5127).name("b5135").ctrl(x4803) // FIFODeq(x4748,x4795)
    val b5136 = ReadMem(b5128).name("b5136").ctrl(x4803) // FIFODeq(x4748,x4795)
    val b5137 = ReadMem(b5129).name("b5137").ctrl(x4803) // FIFODeq(x4748,x4795)
    val x4797 = b5136 // x4797 = FieldApply(x4796,start)
    val x4798_x4790 = WriteMem(x4790, x4797).name("x4798_x4790").ctrl(x4803) // RegWrite(x4790,x4797,x4795)
    val x4799 = b5137 // x4799 = FieldApply(x4796,end)
    val x4800_x4791 = WriteMem(x4791, x4799).name("x4800_x4791").ctrl(x4803) // RegWrite(x4791,x4799,x4795)
    val x4801 = b5135 // x4801 = FieldApply(x4796,size)
    ...
    val x4817 = ReadMem(x4749).name("x4817").ctrl(x4821) // ParStreamRead(x4749,List(x4816))
    val x4818 = x4817 // x4818 = VectorApply(x4817,0)
    val x4819 = OpDef(op=BitAnd, inputs=List(x4811, x4816)).name("x4819").ctrl(x4821) // And(x4811,x4816)
    val x4820 = StoreBanks(List(x4730_d0_b0), List(b2652, x4812), x4818).name("x4820").ctrl(x4821) // ParSRAMStore(x4730,List(List(b2652, x4812)),List(x4818),List(x4819))
    ...
    val x4830 = OpDef(op=FixConvert, inputs=List(b2632)).name("x4830").ctrl(x4839) // FixConvert(b2632,TRUE,_32,_0)
    ...
    val x4847 = OpDef(op=FixConvert, inputs=List(x4846)).name("x4847").ctrl(x4885) // FixConvert(x4846,TRUE,_32,_0)
    ...
    val x4850 = OpDef(op=FixConvert, inputs=List(b2632)).name("x4850").ctrl(x4885) // FixConvert(b2632,TRUE,_32,_0)
    ...
    val x4873 = OpDef(op=FixConvert, inputs=List(x4858)).name("x4873").ctrl(x4885) // FixConvert(x4858,TRUE,_64,_0)
    ...
    val x4876 = OpDef(op=FixConvert, inputs=List(x4875)).name("x4876").ctrl(x4885) // FixConvert(x4875,TRUE,_64,_0)
    ...
    val b5143_b5138 = WriteMem(b5138, x4876).name("b5143_b5138").ctrl(x4885) // StreamWrite(x4842,x4877,x4881)
    val b5144_b5139 = WriteMem(b5139, x4872).name("b5144_b5139").ctrl(x4885) // StreamWrite(x4842,x4877,x4881)
    // x4883 = SimpleStruct(ArrayBuffer((size,x4870), (start,x4866), (end,x4868)))
    val b5145_b5140 = WriteMem(b5140, x4870).name("b5145_b5140").ctrl(x4885) // FIFOEnq(x4843,x4883,x4881)
    val b5146_b5141 = WriteMem(b5141, x4866).name("b5146_b5141").ctrl(x4885) // FIFOEnq(x4843,x4883,x4881)
    val b5147_b5142 = WriteMem(b5142, x4868).name("b5147_b5142").ctrl(x4885) // FIFOEnq(x4843,x4883,x4881)
    ...
    val b5148 = ReadMem(b5140).name("b5148").ctrl(x4901) // FIFODeq(x4843,x4893)
    val b5149 = ReadMem(b5141).name("b5149").ctrl(x4901) // FIFODeq(x4843,x4893)
    val b5150 = ReadMem(b5142).name("b5150").ctrl(x4901) // FIFODeq(x4843,x4893)
    val x4895 = b5149 // x4895 = FieldApply(x4894,start)
    val x4896_x4887 = WriteMem(x4887, x4895).name("x4896_x4887").ctrl(x4901) // RegWrite(x4887,x4895,x4893)
    val x4897 = b5150 // x4897 = FieldApply(x4894,end)
    val x4898_x4888 = WriteMem(x4888, x4897).name("x4898_x4888").ctrl(x4901) // RegWrite(x4888,x4897,x4893)
    val x4899 = b5148 // x4899 = FieldApply(x4894,size)
    ...
    val x4916 = ReadMem(x4844).name("x4916").ctrl(x4920) // ParStreamRead(x4844,List(x4915))
    val x4917 = x4916 // x4917 = VectorApply(x4916,0)
    val x4918 = OpDef(op=BitAnd, inputs=List(x4909, x4915)).name("x4918").ctrl(x4920) // And(x4909,x4915)
    val x4919 = StoreBanks(List(x4826_d0_b0), List(x4910), x4917).name("x4919").ctrl(x4920) // ParSRAMStore(x4826,List(List(x4910)),List(x4917),List(x4918))
    ...
    val x4963 = AccumOp(op=FixAdd, input=x4955, accum=x4957).name("x4963").ctrl(x4965) // FixAdd(x4955,x4957)
    ...
    val x4992 = AccumOp(op=FixAdd, input=x4985, accum=x4987).name("x4992").ctrl(x4994) // FixAdd(x4985,x4987)
    ...
    val x4998 = OpDef(op=FixConvert, inputs=List(b2618)).name("x4998").ctrl(x5007) // FixConvert(b2618,TRUE,_32,_0)
    val x4999 = OpDef(op=FixAdd, inputs=List(x4998, Const(64).ctrl(x5007))).name("x4999").ctrl(x5007) // FixAdd(x4998,Const(64))
    val x5000 = OpDef(op=FixConvert, inputs=List(b2623)).name("x5000").ctrl(x5007) // FixConvert(b2623,TRUE,_32,_0)
    ...
    val x5018 = OpDef(op=FixConvert, inputs=List(x5017)).name("x5018").ctrl(x5055) // FixConvert(x5017,TRUE,_32,_0)
    ...
    val x5021 = OpDef(op=FixConvert, inputs=List(b2623)).name("x5021").ctrl(x5055) // FixConvert(b2623,TRUE,_32,_0)
    ...
    val x5044 = OpDef(op=FixConvert, inputs=List(x5029)).name("x5044").ctrl(x5055) // FixConvert(x5029,TRUE,_64,_0)
    ...
    val x5047 = OpDef(op=FixConvert, inputs=List(x5046)).name("x5047").ctrl(x5055) // FixConvert(x5046,TRUE,_64,_0)
    ...
    val b5153_b5151 = WriteMem(b5151, x5047).name("b5153_b5151").ctrl(x5055) // StreamWrite(x5011,x5048,x5050)
    val b5154_b5152 = WriteMem(b5152, x5043).name("b5154_b5152").ctrl(x5055) // StreamWrite(x5011,x5048,x5050)
    ...
    val x5073_x5012 = WriteMem(x5012, x5071).name("x5073_x5012").ctrl(x5074) // ParStreamWrite(x5012,List(x5072),List(x5067))
    ...
    val x5079 = ReadMem(x5013).name("x5079").ctrl(x5080) // StreamRead(x5013,x5078)
