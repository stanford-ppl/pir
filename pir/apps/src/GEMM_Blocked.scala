...
object GEMM_Blocked extends PIRApp {
  def main(top:Top) = {
    ...
    val x4741 = WriteMems(List(x4731), x4737).name("x4741").ctrl(x4743) // RegWrite(x4731,x4737,x4740)
    val x4742 = WriteMems(List(x4732), x4738).name("x4742").ctrl(x4743) // RegWrite(x4732,x4738,x4740)
    ...
    val b5131 = WriteMems(List(b5125), x4780).name("b5131").ctrl(x4788) // StreamWrite(x4747,x4781,x4784)
    val b5132 = WriteMems(List(b5126), x4776).name("b5132").ctrl(x4788) // StreamWrite(x4747,x4781,x4784)
    // x4786 = SimpleStruct(ArrayBuffer((size,x4774), (start,x4770), (end,x4772)))
    val b5133 = WriteMems(List(b5127), x4774).name("b5133").ctrl(x4788) // FIFOEnq(x4748,x4786,x4784)
    val b5134 = WriteMems(List(b5128), x4770).name("b5134").ctrl(x4788) // FIFOEnq(x4748,x4786,x4784)
    val b5135 = WriteMems(List(b5129), x4772).name("b5135").ctrl(x4788) // FIFOEnq(x4748,x4786,x4784)
    ...
    val b5136 = ReadMem(b5127).name("b5136").ctrl(x4803) // FIFODeq(x4748,x4795)
    val b5137 = ReadMem(b5128).name("b5137").ctrl(x4803) // FIFODeq(x4748,x4795)
    val b5138 = ReadMem(b5129).name("b5138").ctrl(x4803) // FIFODeq(x4748,x4795)
    val x4797 = b5137 // x4797 = FieldApply(x4796,start)
    val x4798 = WriteMems(List(x4790), x4797).name("x4798").ctrl(x4803) // RegWrite(x4790,x4797,x4795)
    val x4799 = b5138 // x4799 = FieldApply(x4796,end)
    val x4800 = WriteMems(List(x4791), x4799).name("x4800").ctrl(x4803) // RegWrite(x4791,x4799,x4795)
    val x4801 = b5136 // x4801 = FieldApply(x4796,size)
    val x4802 = WriteMems(List(x4792), x4801).name("x4802").ctrl(x4803) // RegWrite(x4792,x4801,x4795)
    ...
    val b5139 = ReadMem(b5130).name("b5139").ctrl(x4821) // ParStreamRead(x4749,List(x4816))
    ...
    val x4837 = WriteMems(List(x4827), x4829).name("x4837").ctrl(x4839) // RegWrite(x4827,x4829,x4836)
    val x4838 = WriteMems(List(x4828), x4833).name("x4838").ctrl(x4839) // RegWrite(x4828,x4833,x4836)
    ...
    val b5147 = WriteMems(List(b5141), x4876).name("b5147").ctrl(x4885) // StreamWrite(x4842,x4877,x4881)
    val b5148 = WriteMems(List(b5142), x4872).name("b5148").ctrl(x4885) // StreamWrite(x4842,x4877,x4881)
    // x4883 = SimpleStruct(ArrayBuffer((size,x4870), (start,x4866), (end,x4868)))
    val b5149 = WriteMems(List(b5143), x4870).name("b5149").ctrl(x4885) // FIFOEnq(x4843,x4883,x4881)
    val b5150 = WriteMems(List(b5144), x4866).name("b5150").ctrl(x4885) // FIFOEnq(x4843,x4883,x4881)
    val b5151 = WriteMems(List(b5145), x4868).name("b5151").ctrl(x4885) // FIFOEnq(x4843,x4883,x4881)
    ...
    val b5152 = ReadMem(b5143).name("b5152").ctrl(x4901) // FIFODeq(x4843,x4893)
    val b5153 = ReadMem(b5144).name("b5153").ctrl(x4901) // FIFODeq(x4843,x4893)
    val b5154 = ReadMem(b5145).name("b5154").ctrl(x4901) // FIFODeq(x4843,x4893)
    val x4895 = b5153 // x4895 = FieldApply(x4894,start)
    val x4896 = WriteMems(List(x4887), x4895).name("x4896").ctrl(x4901) // RegWrite(x4887,x4895,x4893)
    val x4897 = b5154 // x4897 = FieldApply(x4894,end)
    val x4898 = WriteMems(List(x4888), x4897).name("x4898").ctrl(x4901) // RegWrite(x4888,x4897,x4893)
    val x4899 = b5152 // x4899 = FieldApply(x4894,size)
    val x4900 = WriteMems(List(x4889), x4899).name("x4900").ctrl(x4901) // RegWrite(x4889,x4899,x4893)
    ...
    val b5155 = ReadMem(b5146).name("b5155").ctrl(x4920) // ParStreamRead(x4844,List(x4915))
    ...
    val x4933 = WriteMems(List(x4927), x4932).name("x4933").ctrl(x4934) // RegWrite(x4927,x4932,x4931)
    ...
    val x5005 = WriteMems(List(x4996), x5002).name("x5005").ctrl(x5007) // RegWrite(x4996,x5002,x5004)
    val x5006 = WriteMems(List(x4997), x5003).name("x5006").ctrl(x5007) // RegWrite(x4997,x5003,x5004)
    ...
    val b5161 = WriteMems(List(b5157), x5047).name("b5161").ctrl(x5055) // StreamWrite(x5011,x5048,x5050)
    val b5162 = WriteMems(List(b5158), x5043).name("b5162").ctrl(x5055) // StreamWrite(x5011,x5048,x5050)
    val x5052 = WriteMems(List(x5014), x5037).name("x5052").ctrl(x5055) // RegWrite(x5014,x5037,x5050)
    val x5053 = WriteMems(List(x5015), x5039).name("x5053").ctrl(x5055) // RegWrite(x5015,x5039,x5050)
    val x5054 = WriteMems(List(x5016), x5041).name("x5054").ctrl(x5055) // RegWrite(x5016,x5041,x5050)
    ...
    val b5163 = WriteMems(List(b5159), x5071).name("b5163").ctrl(x5074) // ParStreamWrite(x5012,List(x5072),List(x5067))
    ...
    val b5164 = ReadMem(b5160).name("b5164").ctrl(x5080) // StreamRead(x5013,x5078)
