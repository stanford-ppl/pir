...
object TRSM extends PIRApp {
  def main(top:Top) = {
    ...
    val x4786 = StoreBanks(List(List(x4767_d0_b0)), List(b3167), b5068).name("x4786").ctrl(x4787) // ParSRAMStore(x4767,List(List(b3167)),List(x4785),List(b3168))
    ...
    val x4805 = StoreBanks(List(List(x4768_d0_b0)), List(b3188), b5075).name("x4805").ctrl(x4806) // ParSRAMStore(x4768,List(List(b3188)),List(x4804),List(b3189))
    ...
    val x4818 = StoreBanks(List(List(x4765_d0_b0), List(x4765_d5_b0), List(x4765_d1_b0), List(x4765_d2_b0), List(x4765_d3_b0), List(x4765_d4_b0)), List(b3199, b3200), x4817).name("x4818").ctrl(x4819) // ParSRAMStore(x4765,List(List(b3199, b3200)),List(x4817),List(x4815))
    ...
    val x4830 = StoreBanks(List(List(x4766_d0_b0), List(x4766_d1_b0), List(x4766_d2_b0)), List(b3215, b3216), x4829).name("x4830").ctrl(x4831) // ParSRAMStore(x4766,List(List(b3215, b3216)),List(x4829),List(x4827))
    ...
    val x4854 = StoreBanks(List(List(x4765_d0_b0), List(x4765_d5_b0), List(x4765_d1_b0), List(x4765_d2_b0), List(x4765_d3_b0), List(x4765_d4_b0)), List(x4840, b3240), x4853).name("x4854").ctrl(x4855) // ParSRAMStore(x4765,List(List(x4840, b3240)),List(x4853),List(x4845))
    ...
    val x4877 = StoreBanks(List(List(x4765_d0_b0), List(x4765_d5_b0), List(x4765_d1_b0), List(x4765_d2_b0), List(x4765_d3_b0), List(x4765_d4_b0)), List(x4870, b3276), x4876).name("x4877").ctrl(x4878) // ParSRAMStore(x4765,List(List(x4870, b3276)),List(x4876),List(x4872))
    ...
    val x4908 = StoreBanks(List(List(x4765_d0_b0), List(x4765_d5_b0), List(x4765_d1_b0), List(x4765_d2_b0), List(x4765_d3_b0), List(x4765_d4_b0)), List(x4894, b3300), x4907).name("x4908").ctrl(x4909) // ParSRAMStore(x4765,List(List(x4894, b3300)),List(x4907),List(x4899))
    ...
    val x4924 = StoreBanks(List(List(x4769_d0_b0)), List(x4920), x4923).name("x4924").ctrl(x4925) // ParSRAMStore(x4769,List(List(x4920)),List(x4923),List(x4921))
