...
object TRSM extends PIRApp {
  def main(top:Top) = {
    ...
    val b5065 = WriteMems(List(b5062), x4777).name("b5065").ctrl(x4780) // StreamWrite(x4770,x4778,Const(true))
    val b5066 = WriteMems(List(b5063), Const(256)).name("b5066").ctrl(x4780) // StreamWrite(x4770,x4778,Const(true))
    ...
    val b5067 = ReadMem(b5064).name("b5067").ctrl(x4787) // ParStreamRead(x4771,List(b3168))
    ...
    val b5072 = WriteMems(List(b5069), x4796).name("b5072").ctrl(x4799) // StreamWrite(x4789,x4797,Const(true))
    val b5073 = WriteMems(List(b5070), Const(256)).name("b5073").ctrl(x4799) // StreamWrite(x4789,x4797,Const(true))
    ...
    val b5074 = ReadMem(b5071).name("b5074").ctrl(x4806) // ParStreamRead(x4790,List(b3189))
    ...
    val x4865 = WriteMems(List(x4859_d0, x4859_d1), x4862).name("x4865").ctrl(x4867) // RegWrite(x4859,x4862,x4863)
    val x4866 = WriteMems(List(x4860), x4864).name("x4866").ctrl(x4867) // RegWrite(x4860,x4864,x4863)
    ...
    val x4883 = WriteMems(List(x4879_d0, x4879_d1), x4881).name("x4883").ctrl(x4884) // RegWrite(x4879,x4881,x4882)
    ...
    val b5080 = WriteMems(List(b5076), x4935).name("b5080").ctrl(x4938) // StreamWrite(x4927,x4936,Const(true))
    val b5081 = WriteMems(List(b5077), Const(256)).name("b5081").ctrl(x4938) // StreamWrite(x4927,x4936,Const(true))
    ...
    val b5082 = WriteMems(List(b5078), x4942).name("b5082").ctrl(x4945) // ParStreamWrite(x4928,List(x4943),List(b3358))
    ...
    val b5083 = ReadMem(b5079).name("b5083").ctrl(x4948) // StreamRead(x4929,Const(true))
