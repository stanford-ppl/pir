...
object BFS extends PIRApp {
  def main(top:Top) = {
    ...
    val b3503_b3501 = WriteMem(b3501, x3276).name("b3503_b3501").ctrl(x3279) // StreamWrite(x3269,x3277,Const(true))
    ...
    val x3283 = ReadMem(x3270).name("x3283").ctrl(x3286) // ParStreamRead(x3270,List(b1961))
    val x3284 = x3283 // x3284 = VectorApply(x3283,0)
    val x3285 = StoreBanks(List(x3254_d0_b0), List(b1960), x3284).name("x3285").ctrl(x3286) // ParSRAMStore(x3254,List(List(b1960)),List(x3284),List(b1961))
    ...
    val b3507_b3505 = WriteMem(b3505, x3295).name("b3507_b3505").ctrl(x3298) // StreamWrite(x3288,x3296,Const(true))
    ...
    val x3302 = ReadMem(x3289).name("x3302").ctrl(x3305) // ParStreamRead(x3289,List(b1982))
    val x3303 = x3302 // x3303 = VectorApply(x3302,0)
    val x3304 = StoreBanks(List(x3253_d0_b0), List(b1981), x3303).name("x3304").ctrl(x3305) // ParSRAMStore(x3253,List(List(b1981)),List(x3303),List(b1982))
    ...
    val b3514_b3509 = WriteMem(b3509, x3356).name("b3514_b3509").ctrl(x3362) // StreamWrite(x3327,x3357,x3358)
    val b3515_b3510 = WriteMem(b3510, x3352).name("b3515_b3510").ctrl(x3362) // StreamWrite(x3327,x3357,x3358)
    // x3360 = SimpleStruct(ArrayBuffer((size,x3350), (start,x3346), (end,x3348)))
    val b3516_b3511 = WriteMem(b3511, x3350).name("b3516_b3511").ctrl(x3362) // FIFOEnq(x3328,x3360,x3358)
    val b3517_b3512 = WriteMem(b3512, x3346).name("b3517_b3512").ctrl(x3362) // FIFOEnq(x3328,x3360,x3358)
    val b3518_b3513 = WriteMem(b3513, x3348).name("b3518_b3513").ctrl(x3362) // FIFOEnq(x3328,x3360,x3358)
    ...
    val b3519 = ReadMem(b3511).name("b3519").ctrl(x3375) // FIFODeq(x3328,x3367)
    val b3520 = ReadMem(b3512).name("b3520").ctrl(x3375) // FIFODeq(x3328,x3367)
    val b3521 = ReadMem(b3513).name("b3521").ctrl(x3375) // FIFODeq(x3328,x3367)
    val x3369 = b3520 // x3369 = FieldApply(x3368,start)
    val x3370_x3364 = WriteMem(x3364, x3369).name("x3370_x3364").ctrl(x3375) // RegWrite(x3364,x3369,x3367)
    val x3371 = b3521 // x3371 = FieldApply(x3368,end)
    val x3372_x3365 = WriteMem(x3365, x3371).name("x3372_x3365").ctrl(x3375) // RegWrite(x3365,x3371,x3367)
    val x3373 = b3519 // x3373 = FieldApply(x3368,size)
    ...
    val x3387 = ReadMem(x3329).name("x3387").ctrl(x3391) // ParStreamRead(x3329,List(x3386))
    val x3388 = x3387 // x3388 = VectorApply(x3387,0)
    val x3389 = OpDef(op=BitAnd, inputs=List(x3383, x3386)).name("x3389").ctrl(x3391) // And(x3383,x3386)
    val x3390 = StoreBanks(List(x3257_d0_b0), List(x3384), x3388).name("x3390").ctrl(x3391) // ParSRAMStore(x3257,List(List(x3384)),List(x3388),List(x3389))
    ...
    val x3467_x3441 = WriteMem(x3441, x3465).name("x3467_x3441").ctrl(x3468) // ParStreamWrite(x3441,List(x3466),List(x3449))
    ...
    val x3474 = ReadMem(x3442).name("x3474").ctrl(x3476) // ParStreamRead(x3442,List(x3473))
