...
object BFS extends PIRApp {
  def main(top:Top) = {
    ...
    val b3504 = WriteMems(List(b3501), x3276).name("b3504").ctrl(x3279) // StreamWrite(x3269,x3277,Const(true))
    val b3505 = WriteMems(List(b3502), Const(32000)).name("b3505").ctrl(x3279) // StreamWrite(x3269,x3277,Const(true))
    ...
    val b3506 = ReadMem(b3503).name("b3506").ctrl(x3286) // ParStreamRead(x3270,List(b1961))
    val b3507 = b3506 // x3284 = VectorApply(x3283,0)
    val x3285 = StoreBanks(List(x3254_d0_b0), List(b1960), b3507).name("x3285").ctrl(x3286) // ParSRAMStore(x3254,List(List(b1960)),List(x3284),List(b1961))
    ...
    val b3511 = WriteMems(List(b3508), x3295).name("b3511").ctrl(x3298) // StreamWrite(x3288,x3296,Const(true))
    val b3512 = WriteMems(List(b3509), Const(32000)).name("b3512").ctrl(x3298) // StreamWrite(x3288,x3296,Const(true))
    ...
    val b3513 = ReadMem(b3510).name("b3513").ctrl(x3305) // ParStreamRead(x3289,List(b1982))
    val b3514 = b3513 // x3303 = VectorApply(x3302,0)
    val x3304 = StoreBanks(List(x3253_d0_b0), List(b1981), b3514).name("x3304").ctrl(x3305) // ParSRAMStore(x3253,List(List(b1981)),List(x3303),List(b1982))
    ...
    val x3319 = WriteMems(List(x3311_d0, x3311_d1), x3318).name("x3319").ctrl(x3326) // RegWrite(x3311,x3318,x3316)
    ...
    val x3321 = WriteMems(List(x3310_d0, x3310_d1, x3310_d2), x3320).name("x3321").ctrl(x3326) // RegWrite(x3310,x3320,x3316)
    ...
    val x3325 = WriteMems(List(x3315), x3323).name("x3325").ctrl(x3326) // RegWrite(x3315,x3323,x3316)
    ...
    val b3521 = WriteMems(List(b3515), x3356).name("b3521").ctrl(x3362) // StreamWrite(x3327,x3357,x3358)
    val b3522 = WriteMems(List(b3516), x3352).name("b3522").ctrl(x3362) // StreamWrite(x3327,x3357,x3358)
    // x3360 = SimpleStruct(ArrayBuffer((size,x3350), (start,x3346), (end,x3348)))
    val b3523 = WriteMems(List(b3517), x3350).name("b3523").ctrl(x3362) // FIFOEnq(x3328,x3360,x3358)
    val b3524 = WriteMems(List(b3518), x3346).name("b3524").ctrl(x3362) // FIFOEnq(x3328,x3360,x3358)
    val b3525 = WriteMems(List(b3519), x3348).name("b3525").ctrl(x3362) // FIFOEnq(x3328,x3360,x3358)
    ...
    val b3526 = ReadMem(b3517).name("b3526").ctrl(x3375) // FIFODeq(x3328,x3367)
    val b3527 = ReadMem(b3518).name("b3527").ctrl(x3375) // FIFODeq(x3328,x3367)
    val b3528 = ReadMem(b3519).name("b3528").ctrl(x3375) // FIFODeq(x3328,x3367)
    val x3369 = b3527 // x3369 = FieldApply(x3368,start)
    val x3370 = WriteMems(List(x3364), x3369).name("x3370").ctrl(x3375) // RegWrite(x3364,x3369,x3367)
    val x3371 = b3528 // x3371 = FieldApply(x3368,end)
    val x3372 = WriteMems(List(x3365), x3371).name("x3372").ctrl(x3375) // RegWrite(x3365,x3371,x3367)
    val x3373 = b3526 // x3373 = FieldApply(x3368,size)
    val x3374 = WriteMems(List(x3366), x3373).name("x3374").ctrl(x3375) // RegWrite(x3366,x3373,x3367)
    ...
    val b3529 = ReadMem(b3520).name("b3529").ctrl(x3391) // ParStreamRead(x3329,List(x3386))
    ...
    val x3390 = StoreBanks(List(x3257_d0_b0), List(x3384), b3530).name("x3390").ctrl(x3391) // ParSRAMStore(x3257,List(List(x3384)),List(x3388),List(x3389))
    ...
    val x3410 = WriteMems(List(x3258_d0, x3258_d5, x3258_d1, x3258_d6, x3258_d2, x3258_d3, x3258_d4), x3408).name("x3410").ctrl(x3411) // RegWrite(x3258,x3408,x3409)
    ...
    val x3439 = WriteMems(List(x3428_d0, x3428_d1), x3438).name("x3439").ctrl(x3440) // RegWrite(x3428,x3438,b1993)
    ...
    val b3533 = WriteMems(List(b3531), x3465).name("b3533").ctrl(x3468) // ParStreamWrite(x3441,List(x3466),List(x3449))
    ...
    val b3534 = ReadMem(b3532).name("b3534").ctrl(x3476) // ParStreamRead(x3442,List(x3473))
    ...
    val x3479 = WriteMems(List(x3259), x3478).name("x3479").ctrl(x3481) // RegWrite(x3259,x3478,b1993)
    val x3480 = WriteMems(List(x3258_d0, x3258_d5, x3258_d1, x3258_d6, x3258_d2, x3258_d3, x3258_d4), Const(0)).name("x3480").ctrl(x3481) // RegWrite(x3258,Const(0),b1993)
