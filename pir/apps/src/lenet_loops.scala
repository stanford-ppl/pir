...
object lenet_loops extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x9248 = DRAM().name("x9248").ctrl(top).srcCtx("lenet_loops.scala:30:26:c0_DRAM") // x9248 = DRAMNew(ArrayBuffer(Const(20), Const(1), Const(32)),Const(0))
    val x9249 = DRAM().name("x9249").ctrl(top).srcCtx("lenet_loops.scala:31:26:i0_DRAM") // x9249 = DRAMNew(ArrayBuffer(Const(17), Const(28), Const(32)),Const(0))
    val x9250 = DRAM().name("x9250").ctrl(top).srcCtx("lenet_loops.scala:32:26:c1_DRAM") // x9250 = DRAMNew(ArrayBuffer(Const(32)),Const(0))
    val x9251 = DRAM().name("x9251").ctrl(top).srcCtx("lenet_loops.scala:33:26:c2_DRAM") // x9251 = DRAMNew(ArrayBuffer(Const(50), Const(512)),Const(0))
    val x9252 = DRAM().name("x9252").ctrl(top).srcCtx("lenet_loops.scala:34:26:c3_DRAM") // x9252 = DRAMNew(ArrayBuffer(Const(64)),Const(0))
    val x9253 = DRAM().name("x9253").ctrl(top).srcCtx("lenet_loops.scala:35:26:c4_DRAM") // x9253 = DRAMNew(ArrayBuffer(Const(100), Const(4000)),Const(0))
    val x9254 = DRAM().name("x9254").ctrl(top).srcCtx("lenet_loops.scala:37:26:c5_DRAM") // x9254 = DRAMNew(ArrayBuffer(Const(512)),Const(0))
    val x9255 = DRAM().name("x9255").ctrl(top).srcCtx("lenet_loops.scala:38:26:c6_DRAM") // x9255 = DRAMNew(ArrayBuffer(Const(10), Const(512)),Const(0))
    val x9256 = DRAM().name("x9256").ctrl(top).srcCtx("lenet_loops.scala:40:26:c7_DRAM") // x9256 = DRAMNew(ArrayBuffer(Const(32)),Const(0))
    val x9257 = DRAM().name("x9257").ctrl(top).srcCtx("lenet_loops.scala:41:28:tmp5_DRAM") // x9257 = DRAMNew(ArrayBuffer(Const(17), Const(32)),Const(0))
    ...
    val x9572_d0 = Reg(init=Some(0.0)).name("x9572_d0").ctrl(x9604).srcCtx("lenet_loops.scala:109:36:out") // x9572 = RegNew(Const(0))
    isAccum(x9572_d0) = false
    bufferDepthOf(x9572_d0) = 2
    val x9572_d1 = Reg(init=Some(0.0)).name("x9572_d1").ctrl(x9604).srcCtx("lenet_loops.scala:109:36:out") // x9572 = RegNew(Const(0))
    isAccum(x9572_d1) = true
    bufferDepthOf(x9572_d1) = 1
    val x9573 = Counter(min=Const(0), max=Const(2), step=Const(1), par=1).name("x9573").ctrl(x9604).srcCtx("lenet_loops.scala:109:57") // CounterNew(Const(0),Const(2),Const(1),Const(1))
    val x9574 = Counter(min=Const(0), max=Const(2), step=Const(1), par=1).name("x9574").ctrl(x9604).srcCtx("lenet_loops.scala:109:49") // CounterNew(Const(0),Const(2),Const(1),Const(1))
    val x9575 = CounterChain(List(x9574,x9573)).name("x9575").ctrl(x9604).srcCtx("lenet_loops.scala:111:15") // CounterChainNew(List(x9574, x9573))
    val x9597 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9575).name("x9597").ctrl(x9604).srcCtx("lenet_loops.scala:111:15") // UnrolledReduce(List(b5819, b5820, b5724, b5677),x9575,x9572,Block((x9572) => Const(())),List(List(b5825), List(b5826)),List(List(b5827), List(b5828)))
    ...
    val x9576 = OpDef(op=FixSla, inputs=List(b5817, Const(1))).name("x9576").ctrl(x9597).srcCtx("lenet_loops.scala:110:44") // FixLsh(b5817,Const(1))
    val x9577 = OpDef(op=FixAdd, inputs=List(x9576, b5825)).name("x9577").ctrl(x9597).srcCtx("lenet_loops.scala:110:47") // FixAdd(x9576,b5825)
    val x9578 = OpDef(op=FixSla, inputs=List(b5818, Const(1))).name("x9578").ctrl(x9597).srcCtx("lenet_loops.scala:110:54") // FixLsh(b5818,Const(1))
    val x9579 = OpDef(op=FixAdd, inputs=List(x9578, b5826)).name("x9579").ctrl(x9597).srcCtx("lenet_loops.scala:110:57") // FixAdd(x9578,b5826)
    ...
    val x9585 = LoadBanks(List(x9494_d0_b0), List(x9577, x9579)).name("x9585").ctrl(x9597).srcCtx("lenet_loops.scala:110:42") // ParSRAMLoad(x9494,List(List(x9577, x9579)),List(x9584))
    val x9586 = x9585 // x9586 = VectorApply(x9585,0)
    val x9587 = LoadBanks(List(x9377_d0_b0), List(b5723)).name("x9587").ctrl(x9597).srcCtx("lenet_loops.scala:110:72") // SRAMLoad(x9377,ArrayBuffer(Const(32)),List(b5723),Const(0),x9584)
    val x9588 = OpDef(op=FixAdd, inputs=List(x9586, x9587)).name("x9588").ctrl(x9597).srcCtx("lenet_loops.scala:110:63") // FixAdd(x9586,x9587)
    val x9589 = OpDef(op=FixMax, inputs=List(Const(0.0), x9588)).name("x9589").ctrl(x9597).srcCtx("lenet_loops.scala:110:18") // Max(Const(0),x9588)
    val x9590 = ReadMem(x9572_d1).name("x9590").ctrl(x9597).srcCtx("lenet_loops.scala:111:15") // RegRead(x9572)
    val x9591 = OpDef(op=FixEql, inputs=List(b5825, Const(0))).name("x9591").ctrl(x9597).srcCtx("lenet_loops.scala:111:15") // FixEql(b5825,Const(0))
    val x9592 = OpDef(op=FixEql, inputs=List(b5826, Const(0))).name("x9592").ctrl(x9597).srcCtx("lenet_loops.scala:111:15") // FixEql(b5826,Const(0))
    val x9593 = OpDef(op=BitAnd, inputs=List(x9591, x9592)).name("x9593").ctrl(x9597).srcCtx("lenet_loops.scala:111:15") // And(x9591,x9592)
    val x9594 = ReduceAccumOp(op=FixMax, input=x9589, accum=x9590).name("x9594").ctrl(x9597).srcCtx("lenet_loops.scala:111:29") // Max(x9589,x9590)
    val x9595 = OpDef(op=BitAnd, inputs=List(x9581, x9582)).name("x9595").ctrl(x9597).srcCtx("UnrollingBase.scala:28:66") // And(x9581,x9582)
    val x9596_x9572_d0 = WriteMem(x9572_d0, x9594).name("x9596_x9572_d0").ctrl(x9597).srcCtx("lenet_loops.scala:111:15") // RegWrite(x9572,x9594,x9595)
    val x9596_x9572_d1 = WriteMem(x9572_d1, x9594).name("x9596_x9572_d1").ctrl(x9597).srcCtx("lenet_loops.scala:111:15") // RegWrite(x9572,x9594,x9595)
    ...
    val x9598 = ReadMem(x9572_d0).name("x9598").ctrl(x9603).srcCtx("lenet_loops.scala:112:43") // RegRead(x9572)
    ...
    val x9602 = StoreBanks(List(x9491_d0_b0), List(b5723, b5817, b5818), x9598).name("x9602").ctrl(x9603).srcCtx("lenet_loops.scala:112:37") // SRAMStore(x9491,ArrayBuffer(Const(20), Const(12), Const(12)),List(b5723, b5817, b5818),Const(0),x9598,x9601)
    val x9606_d0_b0 = SRAM(size=800, banking=Strided(banks=1, stride=16)).name("x9606_d0_b0").ctrl(x9917).srcCtx("lenet_loops.scala:120:32:tmp2_SRAM") // x9606 = SRAMNew(ArrayBuffer(Const(50), Const(4), Const(4)))
    isAccum(x9606_d0_b0) = false
    bufferDepthOf(x9606_d0_b0) = 2
    val x9607 = Counter(min=Const(0), max=Const(50), step=Const(1), par=1).name("x9607").ctrl(x9917).srcCtx("lenet_loops.scala:121:25") // CounterNew(Const(0),Const(50),Const(1),Const(1))
    val x9608 = CounterChain(List(x9607)).name("x9608").ctrl(x9917).srcCtx("lenet_loops.scala:121:40") // CounterChainNew(List(x9607))
    val x9740 = LoopController(style=MetaPipe, level=OuterControl, cchain=x9608).name("x9740").ctrl(x9917).srcCtx("lenet_loops.scala:121:40") // UnrolledForeach(List(b5677),x9608,Block(Const(())),List(List(b5862)),List(List(b5863)))
    val b5862 = CounterIter(x9607, Some(0)).name("b5862").ctrl(x9740) // b5862
    val b5863 = Const(true).name("b5863").ctrl(x9740) // b5863
    val x9609_d0_b0 = SRAM(size=64, banking=Strided(banks=1, stride=8)).name("x9609_d0_b0").ctrl(x9740).srcCtx("lenet_loops.scala:129:39:tmp2_SRAM_conv") // x9609 = SRAMNew(ArrayBuffer(Const(8), Const(8)))
    isAccum(x9609_d0_b0) = false
    bufferDepthOf(x9609_d0_b0) = 2
    val x9609_d1_b0 = SRAM(size=64, banking=Strided(banks=1, stride=8)).name("x9609_d1_b0").ctrl(x9740).srcCtx("lenet_loops.scala:129:39:tmp2_SRAM_conv") // x9609 = SRAMNew(ArrayBuffer(Const(8), Const(8)))
    isAccum(x9609_d1_b0) = true
    bufferDepthOf(x9609_d1_b0) = 1
    val x9610_d0_b0 = SRAM(size=512, banking=Strided(banks=1, stride=1)).name("x9610_d0_b0").ctrl(x9740).srcCtx("lenet_loops.scala:130:30:c2_RF") // x9610 = SRAMNew(ArrayBuffer(Const(512)))
    isAccum(x9610_d0_b0) = false
    bufferDepthOf(x9610_d0_b0) = 2
    val x9612 = UnitController(style=SeqPipe, level=InnerControl).name("x9612").ctrl(x9740).srcCtx("lenet_loops.scala:121:40") // UnitPipe(List(b5863, b5677),Block(Const(())))
    val x9611 = OpDef(op=FixAdd, inputs=List(b5862, Const(1))).name("x9611").ctrl(x9612).srcCtx("lenet_loops.scala:131:29") // FixAdd(b5862,Const(1))
    val x9613 = Counter(min=Const(0), max=Const(1), step=Const(1), par=1).name("x9613").ctrl(x9740).srcCtx("lenet_loops.scala:131:17") // CounterNew(Const(0),Const(1),Const(1),Const(1))
    val x9614 = CounterChain(List(x9613)).name("x9614").ctrl(x9740).srcCtx("lenet_loops.scala:131:17") // CounterChainNew(List(x9613))
    val x9641 = LoopController(style=StreamPipe, level=OuterControl, cchain=x9614).name("x9641").ctrl(x9740).srcCtx("lenet_loops.scala:131:17") // UnrolledForeach(List(b5863, b5677),x9614,Block(Const(())),List(List(b5870)),List(List(b5871)))
    val b5870 = CounterIter(x9613, Some(0)).name("b5870").ctrl(x9641) // b5870
    val b5871 = Const(true).name("b5871").ctrl(x9641) // b5871
    val b9980 = StreamOut(field="offset").name("b9980").ctrl(x9641).srcCtx("lenet_loops.scala:131:17") // x9615 = StreamOutNew(BurstCmdBus)
    isAccum(b9980) = false
    bufferDepthOf(b9980) = 1
    val b9981 = StreamOut(field="size").name("b9981").ctrl(x9641).srcCtx("lenet_loops.scala:131:17") // x9615 = StreamOutNew(BurstCmdBus)
    isAccum(b9981) = false
    bufferDepthOf(b9981) = 1
    val x9616 = StreamIn(field="data").name("x9616").ctrl(x9641).srcCtx("lenet_loops.scala:131:17") // x9616 = StreamInNew(BurstDataBus())
    isAccum(x9616) = false
    bufferDepthOf(x9616) = 1
    val x9630 = UnitController(style=SeqPipe, level=InnerControl).name("x9630").ctrl(x9641).srcCtx("lenet_loops.scala:131:17") // UnitPipe(List(b5871, b5863, b5677),Block(x9629))
    val x9617 = OpDef(op=FixAdd, inputs=List(b5862, b5870)).name("x9617").ctrl(x9630).srcCtx("lenet_loops.scala:131:17") // FixAdd(b5862,b5870)
    val x9618 = x9617 // FixConvert(x9617,TRUE,_32,_0) (Same Type. No op)
    val x9619 = OpDef(op=FixSla, inputs=List(x9618, Const(9))).name("x9619").ctrl(x9630).srcCtx("lenet_loops.scala:131:17") // FixLsh(x9618,Const(9))
    val x9620 = Const(0) // FixConvert(Const(0),TRUE,_32,_0) (Same Type. No op)
    val x9621 = OpDef(op=FixAdd, inputs=List(x9619, x9620)).name("x9621").ctrl(x9630).srcCtx("lenet_loops.scala:131:17") // FixAdd(x9619,x9620)
    val x9622 = OpDef(op=FixSla, inputs=List(x9621, Const(1))).name("x9622").ctrl(x9630).srcCtx("lenet_loops.scala:131:17") // FixLsh(x9621,Const(1))
    val x9623 = x9622 // FixConvert(x9622,TRUE,_64,_0)
    val x9624 = DramAddress(x9251).name("x9624").ctrl(x9630).srcCtx("lenet_loops.scala:131:17") // GetDRAMAddress(x9251)
    val x9626_x9625 = OpDef(op=FixAdd, inputs=List(x9623, x9624)).name("x9626_x9625").ctrl(x9630).srcCtx("lenet_loops.scala:131:17") // FixAdd(x9623,x9624)
    ...
    val x9629_b9982_b9980 = WriteMem(b9980, x9626_x9625).name("x9629_b9982_b9980").ctrl(x9630).srcCtx("lenet_loops.scala:131:17") // StreamWrite(x9615,x9626,x9628)
    val x9629_b9983_b9981 = WriteMem(b9981, Const(1024)).name("x9629_b9983_b9981").ctrl(x9630).srcCtx("lenet_loops.scala:131:17") // StreamWrite(x9615,x9626,x9628)
    val x9631 = FringeDenseLoad(dram=List(x9251), cmdStream=List(b9980, b9981), dataStream=List(x9616)).name("x9631").ctrl(x9641).srcCtx("lenet_loops.scala:131:17") // FringeDenseLoad(x9251,x9615,x9616)
    val x9632 = Counter(min=Const(0), max=Const(512), step=Const(1), par=1).name("x9632").ctrl(x9641).srcCtx("lenet_loops.scala:131:17") // CounterNew(Const(0),Const(512),Const(1),Const(1))
    val x9633 = CounterChain(List(x9632)).name("x9633").ctrl(x9641).srcCtx("lenet_loops.scala:131:17") // CounterChainNew(List(x9632))
    val x9640 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9633).name("x9640").ctrl(x9641).srcCtx("lenet_loops.scala:131:17") // UnrolledForeach(List(b5871, b5863, b5677),x9633,Block(Const(())),List(List(b5891)),List(List(b5892)))
    ...
    val x9637_x9637 = ReadMem(x9616).name("x9637_x9637").ctrl(x9640).srcCtx("lenet_loops.scala:131:17") // ParStreamRead(x9616,List(x9636))
    val x9638_x9638 = x9637_x9637 // x9638 = VectorApply(x9637,0)
    val x9639 = StoreBanks(List(x9610_d0_b0), List(b5891), x9638_x9638).name("x9639").ctrl(x9640).srcCtx("lenet_loops.scala:131:17") // ParSRAMStore(x9610,List(List(b5891)),List(x9638),List(x9636))
    val x9642 = Counter(min=Const(0), max=Const(20), step=Const(1), par=1).name("x9642").ctrl(x9740).srcCtx("lenet_loops.scala:132:44") // CounterNew(Const(0),Const(20),Const(1),Const(1))
    val x9643 = CounterChain(List(x9642)).name("x9643").ctrl(x9740).srcCtx("lenet_loops.scala:141:12") // CounterChainNew(List(x9642))
    val x9703 = LoopController(style=MetaPipe, level=OuterControl, cchain=x9643).name("x9703").ctrl(x9740).srcCtx("lenet_loops.scala:141:12") // UnrolledReduce(List(b5863, b5677),x9643,x9609,Block((x9609) => Const(())),List(List(b5906)),List(List(b5907)))
    val b5906 = CounterIter(x9642, Some(0)).name("b5906").ctrl(x9703) // b5906
    val b5907 = Const(true).name("b5907").ctrl(x9703) // b5907
    val x9644_d0_b0 = SRAM(size=64, banking=Strided(banks=1, stride=8)).name("x9644_d0_b0").ctrl(x9703).srcCtx("lenet_loops.scala:133:33:result") // x9644 = SRAMNew(ArrayBuffer(Const(8), Const(8)))
    isAccum(x9644_d0_b0) = false
    bufferDepthOf(x9644_d0_b0) = 2
    val x9645 = Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x9645").ctrl(x9703).srcCtx("lenet_loops.scala:134:44") // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x9646 = Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x9646").ctrl(x9703).srcCtx("lenet_loops.scala:134:23") // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x9647 = CounterChain(List(x9646,x9645)).name("x9647").ctrl(x9703).srcCtx("lenet_loops.scala:134:51") // CounterChainNew(List(x9646, x9645))
    val x9685 = LoopController(style=MetaPipe, level=OuterControl, cchain=x9647).name("x9685").ctrl(x9703).srcCtx("lenet_loops.scala:134:51") // UnrolledForeach(List(b5907, b5863, b5677),x9647,Block(Const(())),List(List(b5912), List(b5913)),List(List(b5914), List(b5915)))
    ...
    val x9648_d0 = Reg(init=Some(0.0)).name("x9648_d0").ctrl(x9685).srcCtx("lenet_loops.scala:135:41:window") // x9648 = RegNew(Const(0))
    isAccum(x9648_d0) = false
    bufferDepthOf(x9648_d0) = 2
    val x9648_d1 = Reg(init=Some(0.0)).name("x9648_d1").ctrl(x9685).srcCtx("lenet_loops.scala:135:41:window") // x9648 = RegNew(Const(0))
    isAccum(x9648_d1) = true
    bufferDepthOf(x9648_d1) = 1
    val x9649 = Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x9649").ctrl(x9685).srcCtx("lenet_loops.scala:135:81") // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x9650 = Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x9650").ctrl(x9685).srcCtx("lenet_loops.scala:135:63") // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x9651 = CounterChain(List(x9650,x9649)).name("x9651").ctrl(x9685).srcCtx("lenet_loops.scala:137:16") // CounterChainNew(List(x9650, x9649))
    val x9677 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9651).name("x9677").ctrl(x9685).srcCtx("lenet_loops.scala:137:16") // UnrolledReduce(List(b5914, b5915, b5907, b5863, b5677),x9651,x9648,Block((x9648) => Const(())),List(List(b5920), List(b5921)),List(List(b5922), List(b5923)))
    ...
    val x9652 = OpDef(op=FixAdd, inputs=List(b5912, b5920)).name("x9652").ctrl(x9677).srcCtx("lenet_loops.scala:136:35") // FixAdd(b5912,b5920)
    val x9653 = OpDef(op=FixAdd, inputs=List(b5913, b5921)).name("x9653").ctrl(x9677).srcCtx("lenet_loops.scala:136:39") // FixAdd(b5913,b5921)
    ...
    val x9660 = LoadBanks(List(x9491_d0_b0), List(b5906, x9652, x9653)).name("x9660").ctrl(x9677).srcCtx("lenet_loops.scala:136:26") // ParSRAMLoad(x9491,List(List(b5906, x9652, x9653)),List(x9659))
    val x9661 = x9660 // x9661 = VectorApply(x9660,0)
    val x9662 = OpDef(op=FixMul, inputs=List(b5906, Const(25))).name("x9662").ctrl(x9677).srcCtx("lenet_loops.scala:136:56") // FixMul(b5906,Const(25))
    val x9663 = OpDef(op=FixMul, inputs=List(b5920, Const(5))).name("x9663").ctrl(x9677).srcCtx("lenet_loops.scala:136:63") // FixMul(b5920,Const(5))
    val x9664 = OpDef(op=FixAdd, inputs=List(x9662, x9663)).name("x9664").ctrl(x9677).srcCtx("lenet_loops.scala:136:60") // FixAdd(x9662,x9663)
    val x9665 = OpDef(op=FixAdd, inputs=List(x9664, b5921)).name("x9665").ctrl(x9677).srcCtx("lenet_loops.scala:136:66") // FixAdd(x9664,b5921)
    val x9666 = LoadBanks(List(x9610_d0_b0), List(x9665)).name("x9666").ctrl(x9677).srcCtx("lenet_loops.scala:136:50") // ParSRAMLoad(x9610,List(List(x9665)),List(x9659))
    val x9667 = x9666 // x9667 = VectorApply(x9666,0)
    val x9668 = OpDef(op=FixMul, inputs=List(x9661, x9667)).name("x9668").ctrl(x9677).srcCtx("lenet_loops.scala:136:43") // FixMul(x9661,x9667)
    val x9669 = ReadMem(x9648_d1).name("x9669").ctrl(x9677).srcCtx("lenet_loops.scala:137:16") // RegRead(x9648)
    val x9670 = OpDef(op=FixEql, inputs=List(b5920, Const(0))).name("x9670").ctrl(x9677).srcCtx("lenet_loops.scala:137:16") // FixEql(b5920,Const(0))
    val x9671 = OpDef(op=FixEql, inputs=List(b5921, Const(0))).name("x9671").ctrl(x9677).srcCtx("lenet_loops.scala:137:16") // FixEql(b5921,Const(0))
    val x9672 = OpDef(op=BitAnd, inputs=List(x9670, x9671)).name("x9672").ctrl(x9677).srcCtx("lenet_loops.scala:137:16") // And(x9670,x9671)
    val x9673 = ReduceAccumOp(op=FixAdd, input=x9668, accum=x9669).name("x9673").ctrl(x9677).srcCtx("lenet_loops.scala:137:18") // FixAdd(x9668,x9669)
    ...
    val x9676_x9648_d0 = WriteMem(x9648_d0, x9673).name("x9676_x9648_d0").ctrl(x9677).srcCtx("lenet_loops.scala:137:16") // RegWrite(x9648,x9673,x9675)
    val x9676_x9648_d1 = WriteMem(x9648_d1, x9673).name("x9676_x9648_d1").ctrl(x9677).srcCtx("lenet_loops.scala:137:16") // RegWrite(x9648,x9673,x9675)
    val x9684 = UnitController(style=SeqPipe, level=InnerControl).name("x9684").ctrl(x9685).srcCtx("lenet_loops.scala:134:51") // UnitPipe(List(b5914, b5915, b5907, b5863, b5677),Block(Const(())))
    val x9678 = ReadMem(x9648_d0).name("x9678").ctrl(x9684).srcCtx("lenet_loops.scala:138:37") // RegRead(x9648)
    ...
    val x9683 = StoreBanks(List(x9644_d0_b0), List(b5912, b5913), x9678).name("x9683").ctrl(x9684).srcCtx("lenet_loops.scala:138:28") // SRAMStore(x9644,ArrayBuffer(Const(8), Const(8)),List(b5912, b5913),Const(0),x9678,x9682)
    val x9686 = Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x9686").ctrl(x9703).srcCtx("lenet_loops.scala:141:12") // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x9687 = Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x9687").ctrl(x9703).srcCtx("lenet_loops.scala:141:12") // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x9688 = CounterChain(List(x9687,x9686)).name("x9688").ctrl(x9703).srcCtx("lenet_loops.scala:141:12") // CounterChainNew(ArrayBuffer(x9687, x9686))
    val x9702 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9688).name("x9702").ctrl(x9703).srcCtx("lenet_loops.scala:141:12") // UnrolledForeach(List(),x9688,Block(Const(())),ArrayBuffer(List(b5958), List(b5959)),ArrayBuffer(List(b5960), List(b5961)))
    ...
    val x9692 = LoadBanks(List(x9644_d0_b0), List(b5958, b5959)).name("x9692").ctrl(x9702).srcCtx("lenet_loops.scala:141:12") // ParSRAMLoad(x9644,List(ArrayBuffer(b5958, b5959)),List(x9691))
    val x9693 = x9692 // x9693 = VectorApply(x9692,0)
    val x9694 = LoadBanks(List(x9609_d1_b0), List(b5958, b5959)).name("x9694").ctrl(x9702).srcCtx("lenet_loops.scala:141:12") // ParSRAMLoad(x9609,List(ArrayBuffer(b5958, b5959)),List(x9691))
    val x9695 = x9694 // x9695 = VectorApply(x9694,0)
    val x9696 = OpDef(op=BitAnd, inputs=List(b5907, b5863)).name("x9696").ctrl(x9702).srcCtx("lenet_loops.scala:141:12") // And(b5907,b5863)
    val x9697 = OpDef(op=BitAnd, inputs=List(x9696, b5677)).name("x9697").ctrl(x9702).srcCtx("lenet_loops.scala:141:12") // And(x9696,b5677)
    val x9698 = OpDef(op=BitAnd, inputs=List(x9697, x9691)).name("x9698").ctrl(x9702).srcCtx("lenet_loops.scala:141:12") // And(x9697,x9691)
    val x9699 = OpDef(op=FixEql, inputs=List(b5906, Const(0))).name("x9699").ctrl(x9702).srcCtx("lenet_loops.scala:141:12") // FixEql(b5906,Const(0))
    val x9700 = ReduceAccumOp(op=FixAdd, input=x9693, accum=x9695).name("x9700").ctrl(x9702).srcCtx("lenet_loops.scala:141:14") // FixAdd(x9693,x9695)
    val x9701 = StoreBanks(List(x9609_d0_b0, x9609_d1_b0), List(b5958, b5959), x9700).name("x9701").ctrl(x9702).srcCtx("lenet_loops.scala:141:12") // ParSRAMStore(x9609,List(ArrayBuffer(b5958, b5959)),List(x9700),List(x9691))
    val x9704 = Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x9704").ctrl(x9740).srcCtx("lenet_loops.scala:143:29") // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x9705 = Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x9705").ctrl(x9740).srcCtx("lenet_loops.scala:143:21") // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x9706 = CounterChain(List(x9705,x9704)).name("x9706").ctrl(x9740).srcCtx("lenet_loops.scala:143:35") // CounterChainNew(List(x9705, x9704))
    val x9739 = LoopController(style=MetaPipe, level=OuterControl, cchain=x9706).name("x9739").ctrl(x9740).srcCtx("lenet_loops.scala:143:35") // UnrolledForeach(List(b5863, b5677),x9706,Block(Const(())),List(List(b5980), List(b5981)),List(List(b5982), List(b5983)))
    ...
    val x9707_d0 = Reg(init=Some(0.0)).name("x9707_d0").ctrl(x9739).srcCtx("lenet_loops.scala:144:36:out") // x9707 = RegNew(Const(0))
    isAccum(x9707_d0) = false
    bufferDepthOf(x9707_d0) = 2
    val x9707_d1 = Reg(init=Some(0.0)).name("x9707_d1").ctrl(x9739).srcCtx("lenet_loops.scala:144:36:out") // x9707 = RegNew(Const(0))
    isAccum(x9707_d1) = true
    bufferDepthOf(x9707_d1) = 1
    val x9708 = Counter(min=Const(0), max=Const(2), step=Const(1), par=1).name("x9708").ctrl(x9739).srcCtx("lenet_loops.scala:144:57") // CounterNew(Const(0),Const(2),Const(1),Const(1))
    val x9709 = Counter(min=Const(0), max=Const(2), step=Const(1), par=1).name("x9709").ctrl(x9739).srcCtx("lenet_loops.scala:144:49") // CounterNew(Const(0),Const(2),Const(1),Const(1))
    val x9710 = CounterChain(List(x9709,x9708)).name("x9710").ctrl(x9739).srcCtx("lenet_loops.scala:146:15") // CounterChainNew(List(x9709, x9708))
    val x9732 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9710).name("x9732").ctrl(x9739).srcCtx("lenet_loops.scala:146:15") // UnrolledReduce(List(b5982, b5983, b5863, b5677),x9710,x9707,Block((x9707) => Const(())),List(List(b5988), List(b5989)),List(List(b5990), List(b5991)))
    ...
    val x9711 = OpDef(op=FixSla, inputs=List(b5980, Const(1))).name("x9711").ctrl(x9732).srcCtx("lenet_loops.scala:145:44") // FixLsh(b5980,Const(1))
    val x9712 = OpDef(op=FixAdd, inputs=List(x9711, b5988)).name("x9712").ctrl(x9732).srcCtx("lenet_loops.scala:145:47") // FixAdd(x9711,b5988)
    val x9713 = OpDef(op=FixSla, inputs=List(b5981, Const(1))).name("x9713").ctrl(x9732).srcCtx("lenet_loops.scala:145:54") // FixLsh(b5981,Const(1))
    val x9714 = OpDef(op=FixAdd, inputs=List(x9713, b5989)).name("x9714").ctrl(x9732).srcCtx("lenet_loops.scala:145:57") // FixAdd(x9713,b5989)
    ...
    val x9720 = LoadBanks(List(x9609_d0_b0), List(x9712, x9714)).name("x9720").ctrl(x9732).srcCtx("lenet_loops.scala:145:42") // ParSRAMLoad(x9609,List(List(x9712, x9714)),List(x9719))
    val x9721 = x9720 // x9721 = VectorApply(x9720,0)
    val x9722 = LoadBanks(List(x9396_d0_b0), List(b5862)).name("x9722").ctrl(x9732).srcCtx("lenet_loops.scala:145:72") // SRAMLoad(x9396,ArrayBuffer(Const(64)),List(b5862),Const(0),x9719)
    val x9723 = OpDef(op=FixAdd, inputs=List(x9721, x9722)).name("x9723").ctrl(x9732).srcCtx("lenet_loops.scala:145:63") // FixAdd(x9721,x9722)
    val x9724 = OpDef(op=FixMax, inputs=List(Const(0.0), x9723)).name("x9724").ctrl(x9732).srcCtx("lenet_loops.scala:145:18") // Max(Const(0),x9723)
    val x9725 = ReadMem(x9707_d1).name("x9725").ctrl(x9732).srcCtx("lenet_loops.scala:146:15") // RegRead(x9707)
    val x9726 = OpDef(op=FixEql, inputs=List(b5988, Const(0))).name("x9726").ctrl(x9732).srcCtx("lenet_loops.scala:146:15") // FixEql(b5988,Const(0))
    val x9727 = OpDef(op=FixEql, inputs=List(b5989, Const(0))).name("x9727").ctrl(x9732).srcCtx("lenet_loops.scala:146:15") // FixEql(b5989,Const(0))
    val x9728 = OpDef(op=BitAnd, inputs=List(x9726, x9727)).name("x9728").ctrl(x9732).srcCtx("lenet_loops.scala:146:15") // And(x9726,x9727)
    val x9729 = ReduceAccumOp(op=FixMax, input=x9724, accum=x9725).name("x9729").ctrl(x9732).srcCtx("lenet_loops.scala:146:29") // Max(x9724,x9725)
    val x9730 = OpDef(op=BitAnd, inputs=List(x9716, x9717)).name("x9730").ctrl(x9732).srcCtx("UnrollingBase.scala:28:66") // And(x9716,x9717)
    val x9731_x9707_d0 = WriteMem(x9707_d0, x9729).name("x9731_x9707_d0").ctrl(x9732).srcCtx("lenet_loops.scala:146:15") // RegWrite(x9707,x9729,x9730)
    val x9731_x9707_d1 = WriteMem(x9707_d1, x9729).name("x9731_x9707_d1").ctrl(x9732).srcCtx("lenet_loops.scala:146:15") // RegWrite(x9707,x9729,x9730)
    val x9738 = UnitController(style=SeqPipe, level=InnerControl).name("x9738").ctrl(x9739).srcCtx("lenet_loops.scala:143:35") // UnitPipe(List(b5982, b5983, b5863, b5677),Block(Const(())))
    val x9733 = ReadMem(x9707_d0).name("x9733").ctrl(x9738).srcCtx("lenet_loops.scala:147:43") // RegRead(x9707)
    ...
    val x9737 = StoreBanks(List(x9606_d0_b0), List(b5862, b5980, b5981), x9733).name("x9737").ctrl(x9738).srcCtx("lenet_loops.scala:147:37") // SRAMStore(x9606,ArrayBuffer(Const(50), Const(4), Const(4)),List(b5862, b5980, b5981),Const(0),x9733,x9736)
    val x9741_d0_b0 = SRAM(size=800, banking=Strided(banks=1, stride=1)).name("x9741_d0_b0").ctrl(x9917).srcCtx("lenet_loops.scala:155:32:tmp3_SRAM") // x9741 = SRAMNew(ArrayBuffer(Const(800)))
    isAccum(x9741_d0_b0) = false
    bufferDepthOf(x9741_d0_b0) = 2
    val x9742 = Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x9742").ctrl(x9917).srcCtx("lenet_loops.scala:156:36") // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x9743 = Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x9743").ctrl(x9917).srcCtx("lenet_loops.scala:156:28") // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x9744 = Counter(min=Const(0), max=Const(50), step=Const(1), par=1).name("x9744").ctrl(x9917).srcCtx("lenet_loops.scala:156:20") // CounterNew(Const(0),Const(50),Const(1),Const(1))
    val x9745 = CounterChain(List(x9744,x9743,x9742)).name("x9745").ctrl(x9917).srcCtx("lenet_loops.scala:156:42") // CounterChainNew(List(x9744, x9743, x9742))
    val x9757 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9745).name("x9757").ctrl(x9917).srcCtx("lenet_loops.scala:156:42") // UnrolledForeach(List(b5677),x9745,Block(Const(())),List(List(b6027), List(b6028), List(b6029)),List(List(b6030), List(b6031), List(b6032)))
    ...
    val x9746 = OpDef(op=FixMul, inputs=List(b6029, Const(50))).name("x9746").ctrl(x9757).srcCtx("lenet_loops.scala:157:22") // FixMul(b6029,Const(50))
    val x9747 = OpDef(op=FixSla, inputs=List(b6028, Const(2))).name("x9747").ctrl(x9757).srcCtx("lenet_loops.scala:157:29") // FixLsh(b6028,Const(2))
    val x9748 = OpDef(op=FixMul, inputs=List(x9747, Const(50))).name("x9748").ctrl(x9757).srcCtx("lenet_loops.scala:157:31") // FixMul(x9747,Const(50))
    val x9749 = OpDef(op=FixAdd, inputs=List(x9746, x9748)).name("x9749").ctrl(x9757).srcCtx("lenet_loops.scala:157:26") // FixAdd(x9746,x9748)
    val x9750 = OpDef(op=FixAdd, inputs=List(x9749, b6027)).name("x9750").ctrl(x9757).srcCtx("lenet_loops.scala:157:35") // FixAdd(x9749,b6027)
    ...
    val x9754 = LoadBanks(List(x9606_d0_b0), List(b6027, b6028, b6029)).name("x9754").ctrl(x9757).srcCtx("lenet_loops.scala:157:51") // ParSRAMLoad(x9606,List(List(b6027, b6028, b6029)),List(x9753))
    val x9755 = x9754 // x9755 = VectorApply(x9754,0)
    val x9756 = StoreBanks(List(x9741_d0_b0), List(x9750), x9755).name("x9756").ctrl(x9757).srcCtx("lenet_loops.scala:157:40") // ParSRAMStore(x9741,List(List(x9750)),List(x9755),List(x9753))
    val x9758_d0_b0 = SRAM(size=500, banking=Strided(banks=1, stride=1)).name("x9758_d0_b0").ctrl(x9917).srcCtx("lenet_loops.scala:161:32:tmp4_SRAM") // x9758 = SRAMNew(ArrayBuffer(Const(500)))
    isAccum(x9758_d0_b0) = false
    bufferDepthOf(x9758_d0_b0) = 2
    val x9759 = Counter(min=Const(0), max=Const(100), step=Const(1), par=1).name("x9759").ctrl(x9917).srcCtx("lenet_loops.scala:162:26") // CounterNew(Const(0),Const(100),Const(1),Const(1))
    val x9760 = CounterChain(List(x9759)).name("x9760").ctrl(x9917).srcCtx("lenet_loops.scala:162:39") // CounterChainNew(List(x9759))
    val x9826 = LoopController(style=MetaPipe, level=OuterControl, cchain=x9760).name("x9826").ctrl(x9917).srcCtx("lenet_loops.scala:162:39") // UnrolledForeach(List(b5677),x9760,Block(Const(())),List(List(b6048)),List(List(b6049)))
    val b6048 = CounterIter(x9759, Some(0)).name("b6048").ctrl(x9826) // b6048
    val b6049 = Const(true).name("b6049").ctrl(x9826) // b6049
    val x9761_d0_b0 = SRAM(size=4000, banking=Strided(banks=16, stride=1)).name("x9761_d0_b0").ctrl(x9826).srcCtx("lenet_loops.scala:163:36:c4_row_SRAM") // x9761 = SRAMNew(ArrayBuffer(Const(4000)))
    isAccum(x9761_d0_b0) = false
    bufferDepthOf(x9761_d0_b0) = 2
    val x9763 = UnitController(style=SeqPipe, level=InnerControl).name("x9763").ctrl(x9826).srcCtx("lenet_loops.scala:162:39") // UnitPipe(List(b6049, b5677),Block(Const(())))
    val x9762 = OpDef(op=FixAdd, inputs=List(b6048, Const(1))).name("x9762").ctrl(x9763).srcCtx("lenet_loops.scala:164:35") // FixAdd(b6048,Const(1))
    val x9764 = Counter(min=Const(0), max=Const(1), step=Const(1), par=1).name("x9764").ctrl(x9826).srcCtx("lenet_loops.scala:164:23") // CounterNew(Const(0),Const(1),Const(1),Const(1))
    val x9765 = CounterChain(List(x9764)).name("x9765").ctrl(x9826).srcCtx("lenet_loops.scala:164:23") // CounterChainNew(List(x9764))
    val x9792 = LoopController(style=StreamPipe, level=OuterControl, cchain=x9765).name("x9792").ctrl(x9826).srcCtx("lenet_loops.scala:164:23") // UnrolledForeach(List(b6049, b5677),x9765,Block(Const(())),List(List(b6055)),List(List(b6056)))
    val b6055 = CounterIter(x9764, Some(0)).name("b6055").ctrl(x9792) // b6055
    val b6056 = Const(true).name("b6056").ctrl(x9792) // b6056
    val b9984 = StreamOut(field="offset").name("b9984").ctrl(x9792).srcCtx("lenet_loops.scala:164:23") // x9766 = StreamOutNew(BurstCmdBus)
    isAccum(b9984) = false
    bufferDepthOf(b9984) = 1
    val b9985 = StreamOut(field="size").name("b9985").ctrl(x9792).srcCtx("lenet_loops.scala:164:23") // x9766 = StreamOutNew(BurstCmdBus)
    isAccum(b9985) = false
    bufferDepthOf(b9985) = 1
    val x9767 = StreamIn(field="data").name("x9767").ctrl(x9792).srcCtx("lenet_loops.scala:164:23") // x9767 = StreamInNew(BurstDataBus())
    isAccum(x9767) = false
    bufferDepthOf(x9767) = 1
    val x9781 = UnitController(style=SeqPipe, level=InnerControl).name("x9781").ctrl(x9792).srcCtx("lenet_loops.scala:164:23") // UnitPipe(List(b6056, b6049, b5677),Block(x9780))
    val x9768 = OpDef(op=FixAdd, inputs=List(b6048, b6055)).name("x9768").ctrl(x9781).srcCtx("lenet_loops.scala:164:23") // FixAdd(b6048,b6055)
    val x9769 = x9768 // FixConvert(x9768,TRUE,_32,_0) (Same Type. No op)
    val x9770 = OpDef(op=FixMul, inputs=List(x9769, Const(4000))).name("x9770").ctrl(x9781).srcCtx("lenet_loops.scala:164:23") // FixMul(x9769,Const(4000))
    val x9771 = Const(0) // FixConvert(Const(0),TRUE,_32,_0) (Same Type. No op)
    val x9772 = OpDef(op=FixAdd, inputs=List(x9770, x9771)).name("x9772").ctrl(x9781).srcCtx("lenet_loops.scala:164:23") // FixAdd(x9770,x9771)
    val x9773 = OpDef(op=FixSla, inputs=List(x9772, Const(1))).name("x9773").ctrl(x9781).srcCtx("lenet_loops.scala:164:23") // FixLsh(x9772,Const(1))
    val x9774 = x9773 // FixConvert(x9773,TRUE,_64,_0)
    val x9775 = DramAddress(x9253).name("x9775").ctrl(x9781).srcCtx("lenet_loops.scala:164:23") // GetDRAMAddress(x9253)
    val x9777_x9776 = OpDef(op=FixAdd, inputs=List(x9774, x9775)).name("x9777_x9776").ctrl(x9781).srcCtx("lenet_loops.scala:164:23") // FixAdd(x9774,x9775)
    ...
    val x9780_b9986_b9984 = WriteMem(b9984, x9777_x9776).name("x9780_b9986_b9984").ctrl(x9781).srcCtx("lenet_loops.scala:164:23") // StreamWrite(x9766,x9777,x9779)
    val x9780_b9987_b9985 = WriteMem(b9985, Const(8000)).name("x9780_b9987_b9985").ctrl(x9781).srcCtx("lenet_loops.scala:164:23") // StreamWrite(x9766,x9777,x9779)
    val x9782 = FringeDenseLoad(dram=List(x9253), cmdStream=List(b9984, b9985), dataStream=List(x9767)).name("x9782").ctrl(x9792).srcCtx("lenet_loops.scala:164:23") // FringeDenseLoad(x9253,x9766,x9767)
    val x9783 = Counter(min=Const(0), max=Const(4000), step=Const(1), par=16).name("x9783").ctrl(x9792).srcCtx("lenet_loops.scala:164:23") // CounterNew(Const(0),Const(4000),Const(1),Const(16))
    val x9784 = CounterChain(List(x9783)).name("x9784").ctrl(x9792).srcCtx("lenet_loops.scala:164:23") // CounterChainNew(List(x9783))
    val x9791 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9784).name("x9791").ctrl(x9792).srcCtx("lenet_loops.scala:164:23") // UnrolledForeach(List(b6056, b6049, b5677),x9784,Block(Const(())),List(List(b6076)),List(List(b6077)))
    ...
    val x9788_x9788 = ReadMem(x9767).name("x9788_x9788").ctrl(x9791).srcCtx("lenet_loops.scala:164:23") // ParStreamRead(x9767,List(x9787))
    val x9789_x9789 = x9788_x9788 // x9789 = VectorApply(x9788,0)
    val x9790 = StoreBanks(List(x9761_d0_b0), List(b6076), x9789_x9789).name("x9790").ctrl(x9791).srcCtx("lenet_loops.scala:164:23") // ParSRAMStore(x9761,List(List(b6076)),List(x9789),List(x9787))
    val x9793 = Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x9793").ctrl(x9826).srcCtx("lenet_loops.scala:165:21") // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x9794 = CounterChain(List(x9793)).name("x9794").ctrl(x9826).srcCtx("lenet_loops.scala:165:26") // CounterChainNew(List(x9793))
    val x9825 = LoopController(style=MetaPipe, level=OuterControl, cchain=x9794).name("x9825").ctrl(x9826).srcCtx("lenet_loops.scala:165:26") // UnrolledForeach(List(b6049, b5677),x9794,Block(Const(())),List(List(b6088)),List(List(b6089)))
    val b6088 = CounterIter(x9793, Some(0)).name("b6088").ctrl(x9825) // b6088
    val b6089 = Const(true).name("b6089").ctrl(x9825) // b6089
    val x9795_d0 = Reg(init=Some(0.0)).name("x9795_d0").ctrl(x9825).srcCtx("lenet_loops.scala:166:37:prod") // x9795 = RegNew(Const(0))
    isAccum(x9795_d0) = false
    bufferDepthOf(x9795_d0) = 2
    val x9795_d1 = Reg(init=Some(0.0)).name("x9795_d1").ctrl(x9825).srcCtx("lenet_loops.scala:166:37:prod") // x9795 = RegNew(Const(0))
    isAccum(x9795_d1) = true
    bufferDepthOf(x9795_d1) = 1
    val x9796 = Counter(min=Const(0), max=Const(800), step=Const(1), par=1).name("x9796").ctrl(x9825).srcCtx("lenet_loops.scala:166:57") // CounterNew(Const(0),Const(800),Const(1),Const(1))
    val x9797 = CounterChain(List(x9796)).name("x9797").ctrl(x9825).srcCtx("lenet_loops.scala:168:14") // CounterChainNew(List(x9796))
    val x9814 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9797).name("x9814").ctrl(x9825).srcCtx("lenet_loops.scala:168:14") // UnrolledReduce(List(b6089, b6049, b5677),x9797,x9795,Block((x9795) => Const(())),List(List(b6093)),List(List(b6094)))
    ...
    val x9801 = LoadBanks(List(x9741_d0_b0), List(b6093)).name("x9801").ctrl(x9814).srcCtx("lenet_loops.scala:167:24") // ParSRAMLoad(x9741,List(List(b6093)),List(x9800))
    val x9802 = x9801 // x9802 = VectorApply(x9801,0)
    val x9803 = OpDef(op=FixMul, inputs=List(b6088, Const(800))).name("x9803").ctrl(x9814).srcCtx("lenet_loops.scala:167:52") // FixMul(b6088,Const(800))
    val x9804 = OpDef(op=FixAdd, inputs=List(x9803, b6093)).name("x9804").ctrl(x9814).srcCtx("lenet_loops.scala:167:57") // FixAdd(x9803,b6093)
    val x9805 = LoadBanks(List(x9761_d0_b0), List(x9804)).name("x9805").ctrl(x9814).srcCtx("lenet_loops.scala:167:44") // ParSRAMLoad(x9761,List(List(x9804)),List(x9800))
    val x9806 = x9805 // x9806 = VectorApply(x9805,0)
    val x9807 = OpDef(op=FixMul, inputs=List(x9802, x9806)).name("x9807").ctrl(x9814).srcCtx("lenet_loops.scala:167:31") // FixMul(x9802,x9806)
    val x9808 = ReadMem(x9795_d1).name("x9808").ctrl(x9814).srcCtx("lenet_loops.scala:168:14") // RegRead(x9795)
    val x9809 = OpDef(op=FixEql, inputs=List(b6093, Const(0))).name("x9809").ctrl(x9814).srcCtx("lenet_loops.scala:168:14") // FixEql(b6093,Const(0))
    val x9810 = ReduceAccumOp(op=FixAdd, input=x9807, accum=x9808).name("x9810").ctrl(x9814).srcCtx("lenet_loops.scala:168:16") // FixAdd(x9807,x9808)
    ...
    val x9813_x9795_d0 = WriteMem(x9795_d0, x9810).name("x9813_x9795_d0").ctrl(x9814).srcCtx("lenet_loops.scala:168:14") // RegWrite(x9795,x9810,x9812)
    val x9813_x9795_d1 = WriteMem(x9795_d1, x9810).name("x9813_x9795_d1").ctrl(x9814).srcCtx("lenet_loops.scala:168:14") // RegWrite(x9795,x9810,x9812)
    val x9824 = UnitController(style=SeqPipe, level=InnerControl).name("x9824").ctrl(x9825).srcCtx("lenet_loops.scala:165:26") // UnitPipe(List(b6089, b6049, b5677),Block(Const(())))
    val x9815 = OpDef(op=FixMul, inputs=List(b6048, Const(5))).name("x9815").ctrl(x9824).srcCtx("lenet_loops.scala:169:28") // FixMul(b6048,Const(5))
    val x9816 = OpDef(op=FixAdd, inputs=List(x9815, b6088)).name("x9816").ctrl(x9824).srcCtx("lenet_loops.scala:169:31") // FixAdd(x9815,b6088)
    val x9817 = ReadMem(x9795_d0).name("x9817").ctrl(x9824).srcCtx("lenet_loops.scala:169:62") // RegRead(x9795)
    ...
    val x9820 = LoadBanks(List(x9415_d0_b0), List(x9816)).name("x9820").ctrl(x9824).srcCtx("lenet_loops.scala:169:77") // SRAMLoad(x9415,ArrayBuffer(Const(512)),List(x9816),Const(0),x9819)
    val x9821 = OpDef(op=FixAdd, inputs=List(x9817, x9820)).name("x9821").ctrl(x9824).srcCtx("lenet_loops.scala:169:68") // FixAdd(x9817,x9820)
    val x9822 = OpDef(op=FixMax, inputs=List(Const(0.0), x9821)).name("x9822").ctrl(x9824).srcCtx("lenet_loops.scala:169:47") // Max(Const(0),x9821)
    val x9823 = StoreBanks(List(x9758_d0_b0), List(x9816), x9822).name("x9823").ctrl(x9824).srcCtx("lenet_loops.scala:169:42") // SRAMStore(x9758,ArrayBuffer(Const(500)),List(x9816),Const(0),x9822,x9819)
    val x9827_d0_b0 = SRAM(size=32, banking=Strided(banks=1, stride=1)).name("x9827_d0_b0").ctrl(x9917).srcCtx("lenet_loops.scala:176:32:tmp5_SRAM") // x9827 = SRAMNew(ArrayBuffer(Const(32)))
    isAccum(x9827_d0_b0) = false
    bufferDepthOf(x9827_d0_b0) = 2
    val x9828 = Counter(min=Const(0), max=Const(10), step=Const(1), par=1).name("x9828").ctrl(x9917).srcCtx("lenet_loops.scala:177:25") // CounterNew(Const(0),Const(10),Const(1),Const(1))
    val x9829 = CounterChain(List(x9828)).name("x9829").ctrl(x9917).srcCtx("lenet_loops.scala:177:38") // CounterChainNew(List(x9828))
    val x9884 = LoopController(style=MetaPipe, level=OuterControl, cchain=x9829).name("x9884").ctrl(x9917).srcCtx("lenet_loops.scala:177:38") // UnrolledForeach(List(b5677),x9829,Block(Const(())),List(List(b6127)),List(List(b6128)))
    val b6127 = CounterIter(x9828, Some(0)).name("b6127").ctrl(x9884) // b6127
    val b6128 = Const(true).name("b6128").ctrl(x9884) // b6128
    val x9830_d0_b0 = SRAM(size=512, banking=Strided(banks=1, stride=1)).name("x9830_d0_b0").ctrl(x9884).srcCtx("lenet_loops.scala:178:36:c6_row_SRAM") // x9830 = SRAMNew(ArrayBuffer(Const(512)))
    isAccum(x9830_d0_b0) = false
    bufferDepthOf(x9830_d0_b0) = 2
    val x9832 = UnitController(style=SeqPipe, level=InnerControl).name("x9832").ctrl(x9884).srcCtx("lenet_loops.scala:177:38") // UnitPipe(List(b6128, b5677),Block(Const(())))
    val x9831 = OpDef(op=FixAdd, inputs=List(b6127, Const(1))).name("x9831").ctrl(x9832).srcCtx("lenet_loops.scala:179:35") // FixAdd(b6127,Const(1))
    val x9833 = Counter(min=Const(0), max=Const(1), step=Const(1), par=1).name("x9833").ctrl(x9884).srcCtx("lenet_loops.scala:179:23") // CounterNew(Const(0),Const(1),Const(1),Const(1))
    val x9834 = CounterChain(List(x9833)).name("x9834").ctrl(x9884).srcCtx("lenet_loops.scala:179:23") // CounterChainNew(List(x9833))
    val x9861 = LoopController(style=StreamPipe, level=OuterControl, cchain=x9834).name("x9861").ctrl(x9884).srcCtx("lenet_loops.scala:179:23") // UnrolledForeach(List(b6128, b5677),x9834,Block(Const(())),List(List(b6134)),List(List(b6135)))
    val b6134 = CounterIter(x9833, Some(0)).name("b6134").ctrl(x9861) // b6134
    val b6135 = Const(true).name("b6135").ctrl(x9861) // b6135
    val b9988 = StreamOut(field="offset").name("b9988").ctrl(x9861).srcCtx("lenet_loops.scala:179:23") // x9835 = StreamOutNew(BurstCmdBus)
    isAccum(b9988) = false
    bufferDepthOf(b9988) = 1
    val b9989 = StreamOut(field="size").name("b9989").ctrl(x9861).srcCtx("lenet_loops.scala:179:23") // x9835 = StreamOutNew(BurstCmdBus)
    isAccum(b9989) = false
    bufferDepthOf(b9989) = 1
    val x9836 = StreamIn(field="data").name("x9836").ctrl(x9861).srcCtx("lenet_loops.scala:179:23") // x9836 = StreamInNew(BurstDataBus())
    isAccum(x9836) = false
    bufferDepthOf(x9836) = 1
    val x9850 = UnitController(style=SeqPipe, level=InnerControl).name("x9850").ctrl(x9861).srcCtx("lenet_loops.scala:179:23") // UnitPipe(List(b6135, b6128, b5677),Block(x9849))
    val x9837 = OpDef(op=FixAdd, inputs=List(b6127, b6134)).name("x9837").ctrl(x9850).srcCtx("lenet_loops.scala:179:23") // FixAdd(b6127,b6134)
    val x9838 = x9837 // FixConvert(x9837,TRUE,_32,_0) (Same Type. No op)
    val x9839 = OpDef(op=FixSla, inputs=List(x9838, Const(9))).name("x9839").ctrl(x9850).srcCtx("lenet_loops.scala:179:23") // FixLsh(x9838,Const(9))
    val x9840 = Const(0) // FixConvert(Const(0),TRUE,_32,_0) (Same Type. No op)
    val x9841 = OpDef(op=FixAdd, inputs=List(x9839, x9840)).name("x9841").ctrl(x9850).srcCtx("lenet_loops.scala:179:23") // FixAdd(x9839,x9840)
    val x9842 = OpDef(op=FixSla, inputs=List(x9841, Const(1))).name("x9842").ctrl(x9850).srcCtx("lenet_loops.scala:179:23") // FixLsh(x9841,Const(1))
    val x9843 = x9842 // FixConvert(x9842,TRUE,_64,_0)
    val x9844 = DramAddress(x9255).name("x9844").ctrl(x9850).srcCtx("lenet_loops.scala:179:23") // GetDRAMAddress(x9255)
    val x9846_x9845 = OpDef(op=FixAdd, inputs=List(x9843, x9844)).name("x9846_x9845").ctrl(x9850).srcCtx("lenet_loops.scala:179:23") // FixAdd(x9843,x9844)
    ...
    val x9849_b9990_b9988 = WriteMem(b9988, x9846_x9845).name("x9849_b9990_b9988").ctrl(x9850).srcCtx("lenet_loops.scala:179:23") // StreamWrite(x9835,x9846,x9848)
    val x9849_b9991_b9989 = WriteMem(b9989, Const(1024)).name("x9849_b9991_b9989").ctrl(x9850).srcCtx("lenet_loops.scala:179:23") // StreamWrite(x9835,x9846,x9848)
    val x9851 = FringeDenseLoad(dram=List(x9255), cmdStream=List(b9988, b9989), dataStream=List(x9836)).name("x9851").ctrl(x9861).srcCtx("lenet_loops.scala:179:23") // FringeDenseLoad(x9255,x9835,x9836)
    val x9852 = Counter(min=Const(0), max=Const(512), step=Const(1), par=1).name("x9852").ctrl(x9861).srcCtx("lenet_loops.scala:179:23") // CounterNew(Const(0),Const(512),Const(1),Const(1))
    val x9853 = CounterChain(List(x9852)).name("x9853").ctrl(x9861).srcCtx("lenet_loops.scala:179:23") // CounterChainNew(List(x9852))
    val x9860 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9853).name("x9860").ctrl(x9861).srcCtx("lenet_loops.scala:179:23") // UnrolledForeach(List(b6135, b6128, b5677),x9853,Block(Const(())),List(List(b6155)),List(List(b6156)))
    ...
    val x9857_x9857 = ReadMem(x9836).name("x9857_x9857").ctrl(x9860).srcCtx("lenet_loops.scala:179:23") // ParStreamRead(x9836,List(x9856))
    val x9858_x9858 = x9857_x9857 // x9858 = VectorApply(x9857,0)
    val x9859 = StoreBanks(List(x9830_d0_b0), List(b6155), x9858_x9858).name("x9859").ctrl(x9860).srcCtx("lenet_loops.scala:179:23") // ParSRAMStore(x9830,List(List(b6155)),List(x9858),List(x9856))
    val x9862_d0 = Reg(init=Some(0.0)).name("x9862_d0").ctrl(x9884).srcCtx("lenet_loops.scala:180:35:prod") // x9862 = RegNew(Const(0))
    isAccum(x9862_d0) = false
    bufferDepthOf(x9862_d0) = 2
    val x9862_d1 = Reg(init=Some(0.0)).name("x9862_d1").ctrl(x9884).srcCtx("lenet_loops.scala:180:35:prod") // x9862 = RegNew(Const(0))
    isAccum(x9862_d1) = true
    bufferDepthOf(x9862_d1) = 1
    val x9863 = Counter(min=Const(0), max=Const(500), step=Const(1), par=1).name("x9863").ctrl(x9884).srcCtx("lenet_loops.scala:180:55") // CounterNew(Const(0),Const(500),Const(1),Const(1))
    val x9864 = CounterChain(List(x9863)).name("x9864").ctrl(x9884).srcCtx("lenet_loops.scala:180:108") // CounterChainNew(List(x9863))
    val x9877 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9864).name("x9877").ctrl(x9884).srcCtx("lenet_loops.scala:180:108") // UnrolledReduce(List(b6128, b5677),x9864,x9862,Block((x9862) => Const(())),List(List(b6168)),List(List(b6169)))
    ...
    val x9867 = LoadBanks(List(x9758_d0_b0), List(b6168)).name("x9867").ctrl(x9877).srcCtx("lenet_loops.scala:180:80") // ParSRAMLoad(x9758,List(List(b6168)),List(x9866))
    val x9868 = x9867 // x9868 = VectorApply(x9867,0)
    val x9869 = LoadBanks(List(x9830_d0_b0), List(b6168)).name("x9869").ctrl(x9877).srcCtx("lenet_loops.scala:180:100") // ParSRAMLoad(x9830,List(List(b6168)),List(x9866))
    val x9870 = x9869 // x9870 = VectorApply(x9869,0)
    val x9871 = OpDef(op=FixMul, inputs=List(x9868, x9870)).name("x9871").ctrl(x9877).srcCtx("lenet_loops.scala:180:87") // FixMul(x9868,x9870)
    val x9872 = ReadMem(x9862_d1).name("x9872").ctrl(x9877).srcCtx("lenet_loops.scala:180:108") // RegRead(x9862)
    val x9873 = OpDef(op=FixEql, inputs=List(b6168, Const(0))).name("x9873").ctrl(x9877).srcCtx("lenet_loops.scala:180:108") // FixEql(b6168,Const(0))
    val x9874 = ReduceAccumOp(op=FixAdd, input=x9871, accum=x9872).name("x9874").ctrl(x9877).srcCtx("lenet_loops.scala:180:110") // FixAdd(x9871,x9872)
    val x9875 = OpDef(op=BitAnd, inputs=List(b6128, b5677)).name("x9875").ctrl(x9877).srcCtx("UnrollingBase.scala:28:66") // And(b6128,b5677)
    val x9876_x9862_d0 = WriteMem(x9862_d0, x9874).name("x9876_x9862_d0").ctrl(x9877).srcCtx("lenet_loops.scala:180:108") // RegWrite(x9862,x9874,x9875)
    val x9876_x9862_d1 = WriteMem(x9862_d1, x9874).name("x9876_x9862_d1").ctrl(x9877).srcCtx("lenet_loops.scala:180:108") // RegWrite(x9862,x9874,x9875)
    val x9883 = UnitController(style=SeqPipe, level=InnerControl).name("x9883").ctrl(x9884).srcCtx("lenet_loops.scala:177:38") // UnitPipe(List(b6128, b5677),Block(Const(())))
    val x9878 = OpDef(op=BitAnd, inputs=List(b6128, b5677)).name("x9878").ctrl(x9883).srcCtx("UnrollingBase.scala:28:66") // And(b6128,b5677)
    val x9879 = LoadBanks(List(x9434_d0_b0), List(b6127)).name("x9879").ctrl(x9883).srcCtx("lenet_loops.scala:181:50") // SRAMLoad(x9434,ArrayBuffer(Const(32)),List(b6127),Const(0),x9878)
    val x9880 = ReadMem(x9862_d0).name("x9880").ctrl(x9883).srcCtx("lenet_loops.scala:181:35") // RegRead(x9862)
    val x9881 = OpDef(op=FixAdd, inputs=List(x9880, x9879)).name("x9881").ctrl(x9883).srcCtx("lenet_loops.scala:181:41") // FixAdd(x9880,x9879)
    val x9882 = StoreBanks(List(x9827_d0_b0), List(b6127), x9881).name("x9882").ctrl(x9883).srcCtx("lenet_loops.scala:181:28") // SRAMStore(x9827,ArrayBuffer(Const(32)),List(b6127),Const(0),x9881,x9878)
    val x9885 = Counter(min=Const(0), max=Const(1), step=Const(1), par=1).name("x9885").ctrl(x9917).srcCtx("lenet_loops.scala:186:37") // CounterNew(Const(0),Const(1),Const(1),Const(1))
    val x9886 = CounterChain(List(x9885)).name("x9886").ctrl(x9917).srcCtx("lenet_loops.scala:186:37") // CounterChainNew(List(x9885))
    val x9916 = LoopController(style=StreamPipe, level=OuterControl, cchain=x9886).name("x9916").ctrl(x9917).srcCtx("lenet_loops.scala:186:37") // UnrolledForeach(List(b5677),x9886,Block(Const(())),List(List(b6192)),List(List(b6193)))
    val b6192 = CounterIter(x9885, Some(0)).name("b6192").ctrl(x9916) // b6192
    val b6193 = Const(true).name("b6193").ctrl(x9916) // b6193
    val b9992 = StreamOut(field="offset").name("b9992").ctrl(x9916).srcCtx("lenet_loops.scala:186:37") // x9887 = StreamOutNew(BurstCmdBus)
    isAccum(b9992) = false
    bufferDepthOf(b9992) = 1
    val b9993 = StreamOut(field="size").name("b9993").ctrl(x9916).srcCtx("lenet_loops.scala:186:37") // x9887 = StreamOutNew(BurstCmdBus)
    isAccum(b9993) = false
    bufferDepthOf(b9993) = 1
    val x9888 = StreamOut(field="data").name("x9888").ctrl(x9916).srcCtx("lenet_loops.scala:186:37") // x9888 = StreamOutNew(BurstFullDataBus())
    isAccum(x9888) = false
    bufferDepthOf(x9888) = 1
    val x9889 = StreamIn(field="ack").name("x9889").ctrl(x9916).srcCtx("lenet_loops.scala:186:37") // x9889 = StreamInNew(BurstAckBus)
    isAccum(x9889) = false
    bufferDepthOf(x9889) = 1
    val x9902 = UnitController(style=SeqPipe, level=InnerControl).name("x9902").ctrl(x9916).srcCtx("lenet_loops.scala:186:37") // UnitPipe(List(b6193, b5677),Block(x9901))
    val x9890 = OpDef(op=FixAdd, inputs=List(b5676, b6192)).name("x9890").ctrl(x9902).srcCtx("lenet_loops.scala:186:37") // FixAdd(b5676,b6192)
    val x9891 = x9890 // FixConvert(x9890,TRUE,_32,_0) (Same Type. No op)
    val x9892 = OpDef(op=FixSla, inputs=List(x9891, Const(5))).name("x9892").ctrl(x9902).srcCtx("lenet_loops.scala:186:37") // FixLsh(x9891,Const(5))
    val x9893 = Const(0) // FixConvert(Const(0),TRUE,_32,_0) (Same Type. No op)
    val x9894 = OpDef(op=FixAdd, inputs=List(x9892, x9893)).name("x9894").ctrl(x9902).srcCtx("lenet_loops.scala:186:37") // FixAdd(x9892,x9893)
    val x9895 = OpDef(op=FixSla, inputs=List(x9894, Const(1))).name("x9895").ctrl(x9902).srcCtx("lenet_loops.scala:186:37") // FixLsh(x9894,Const(1))
    val x9896 = x9895 // FixConvert(x9895,TRUE,_64,_0)
    val x9897 = DramAddress(x9257).name("x9897").ctrl(x9902).srcCtx("lenet_loops.scala:186:37") // GetDRAMAddress(x9257)
    val x9899_x9898 = OpDef(op=FixAdd, inputs=List(x9896, x9897)).name("x9899_x9898").ctrl(x9902).srcCtx("lenet_loops.scala:186:37") // FixAdd(x9896,x9897)
    ...
    val x9901_b9994_b9992 = WriteMem(b9992, x9899_x9898).name("x9901_b9994_b9992").ctrl(x9902).srcCtx("lenet_loops.scala:186:37") // StreamWrite(x9887,x9899,x9900)
    val x9901_b9995_b9993 = WriteMem(b9993, Const(64)).name("x9901_b9995_b9993").ctrl(x9902).srcCtx("lenet_loops.scala:186:37") // StreamWrite(x9887,x9899,x9900)
    val x9903 = Counter(min=Const(0), max=Const(32), step=Const(1), par=1).name("x9903").ctrl(x9916).srcCtx("lenet_loops.scala:186:37") // CounterNew(Const(0),Const(32),Const(1),Const(1))
    val x9904 = CounterChain(List(x9903)).name("x9904").ctrl(x9916).srcCtx("lenet_loops.scala:186:37") // CounterChainNew(List(x9903))
    val x9911 = LoopController(style=InnerPipe, level=InnerControl, cchain=x9904).name("x9911").ctrl(x9916).srcCtx("lenet_loops.scala:186:37") // UnrolledForeach(List(b6193, b5677),x9904,Block(Const(())),List(List(b6212)),List(List(b6213)))
    ...
    val x9907 = LoadBanks(List(x9827_d0_b0), List(b6212)).name("x9907").ctrl(x9911).srcCtx("lenet_loops.scala:186:37") // ParSRAMLoad(x9827,List(List(b6212)),List(x9906))
    val x9909_x9908 = x9907 // x9908 = VectorApply(x9907,0)
    // x9909 = SimpleStruct(ArrayBuffer((_1,x9908), (_2,Const(true))))
    val x9910_x9910_x9888 = WriteMem(x9888, x9909_x9908).name("x9910_x9910_x9888").ctrl(x9911).srcCtx("lenet_loops.scala:186:37") // ParStreamWrite(x9888,List(x9909),List(x9906))
    val x9912 = FringeDenseStore(dram=List(x9257), cmdStream=List(b9992, b9993), dataStream=List(x9888), ackStream=List(x9889)).name("x9912").ctrl(x9916).srcCtx("lenet_loops.scala:186:37") // FringeDenseStore(x9257,x9887,x9888,x9889)
    val x9915 = UnitController(style=SeqPipe, level=InnerControl).name("x9915").ctrl(x9916).srcCtx("lenet_loops.scala:186:37") // UnitPipe(List(b6193, b5677),Block(Const(())))
    def split1 = {
    val x9913 = OpDef(op=BitAnd, inputs=List(b6193, b5677)).name("x9913").ctrl(x9915).srcCtx("UnrollingBase.scala:28:66") // And(b6193,b5677)
    val x9914_x9914 = ReadMem(x9889).name("x9914_x9914").ctrl(x9915).srcCtx("lenet_loops.scala:186:37") // StreamRead(x9889,x9913)
    }; split1
