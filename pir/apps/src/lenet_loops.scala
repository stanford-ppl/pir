...
object lenet_loops extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x9945 = withCtrl(x10326) { Counter(min=Const(0), max=Const(64), step=Const(1), par=2).name("x9945").srcCtx("lenet_loops.scala:125:25") } // CounterNew(Const(0),Const(64),Const(1),Const(2))
    val x9946 = withCtrl(x10326) { CounterChain(List(x9945)).name("x9946").srcCtx("lenet_loops.scala:125:40") } // CounterChainNew(List(x9945))
    val x10141 = withCtrl(x10326) { LoopController(style=MetaPipe, level=OuterControl, cchain=x9946).name("x10141").srcCtx("lenet_loops.scala:125:40") } // UnrolledForeach(List(b5444),x9946,Block(Const(())),List(List(b5672, b5673)),List(List(b5674, b5675)))
    ...
    val x9947_d0_b0 = withCtrl(x10141) { SRAM(size=64, banking=Strided(banks=1, stride=8)).name("x9947_d0_b0").srcCtx("lenet_loops.scala:133:39:tmp2_SRAM_conv") } // x9947 = SRAMNew(ArrayBuffer(Const(8), Const(8)))
    isAccum(x9947_d0_b0) = false
    bufferDepthOf(x9947_d0_b0) = 2
    staticDimsOf(x9947_d0_b0) = List(8, 8)
    val x9947_d1_b0 = withCtrl(x10141) { SRAM(size=64, banking=Strided(banks=1, stride=8)).name("x9947_d1_b0").srcCtx("lenet_loops.scala:133:39:tmp2_SRAM_conv") } // x9947 = SRAMNew(ArrayBuffer(Const(8), Const(8)))
    isAccum(x9947_d1_b0) = true
    bufferDepthOf(x9947_d1_b0) = 1
    staticDimsOf(x9947_d1_b0) = List(8, 8)
    val x9948_d0_b0 = withCtrl(x10141) { SRAM(size=64, banking=Strided(banks=1, stride=8)).name("x9948_d0_b0").srcCtx("lenet_loops.scala:133:39:tmp2_SRAM_conv") } // x9948 = SRAMNew(ArrayBuffer(Const(8), Const(8)))
    isAccum(x9948_d0_b0) = false
    bufferDepthOf(x9948_d0_b0) = 2
    staticDimsOf(x9948_d0_b0) = List(8, 8)
    val x9948_d1_b0 = withCtrl(x10141) { SRAM(size=64, banking=Strided(banks=1, stride=8)).name("x9948_d1_b0").srcCtx("lenet_loops.scala:133:39:tmp2_SRAM_conv") } // x9948 = SRAMNew(ArrayBuffer(Const(8), Const(8)))
    ...
    val x9949 = withCtrl(x10067) { Counter(min=Const(0), max=Const(20), step=Const(1), par=1).name("x9949").srcCtx("lenet_loops.scala:134:44") } // CounterNew(Const(0),Const(20),Const(1),Const(1))
    val x9950 = withCtrl(x10067) { CounterChain(List(x9949)).name("x9950").srcCtx("lenet_loops.scala:143:12") } // CounterChainNew(List(x9949))
    val x10007 = withCtrl(x10067) { LoopController(style=MetaPipe, level=OuterControl, cchain=x9950).name("x10007").srcCtx("lenet_loops.scala:143:12") } // UnrolledReduce(List(b5674, b5444),x9950,x9947,Block((x9947) => Const(())),List(List(b5688)),List(List(b5689)))
    val b5688 = withCtrl(x10007) { CounterIter(x9949, Some(0)).name("b5688") } // b5688
    val b5689 = withCtrl(x10007) { Const(true).name("b5689") } // b5689
    val x9951_d0_b0 = withCtrl(x10007) { SRAM(size=64, banking=Strided(banks=1, stride=8)).name("x9951_d0_b0").srcCtx("lenet_loops.scala:135:33:result") } // x9951 = SRAMNew(ArrayBuffer(Const(8), Const(8)))
    isAccum(x9951_d0_b0) = false
    bufferDepthOf(x9951_d0_b0) = 2
    staticDimsOf(x9951_d0_b0) = List(8, 8)
    val x9952 = withCtrl(x10007) { Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x9952").srcCtx("lenet_loops.scala:136:44") } // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x9953 = withCtrl(x10007) { Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x9953").srcCtx("lenet_loops.scala:136:23") } // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x9954 = withCtrl(x10007) { CounterChain(List(x9953,x9952)).name("x9954").srcCtx("lenet_loops.scala:136:51") } // CounterChainNew(List(x9953, x9952))
    val x9988 = withCtrl(x10007) { LoopController(style=MetaPipe, level=OuterControl, cchain=x9954).name("x9988").srcCtx("lenet_loops.scala:136:51") } // UnrolledForeach(List(b5689, b5674, b5444),x9954,Block(Const(())),List(List(b5694), List(b5695)),List(List(b5696), List(b5697)))
    ...
    val x9955_d0 = withCtrl(x9988) { Reg(init=Some(0.0)).name("x9955_d0").srcCtx("lenet_loops.scala:137:41:window") } // x9955 = RegNew(Const(0))
    isAccum(x9955_d0) = false
    bufferDepthOf(x9955_d0) = 2
    val x9955_d1 = withCtrl(x9988) { Reg(init=Some(0.0)).name("x9955_d1").srcCtx("lenet_loops.scala:137:41:window") } // x9955 = RegNew(Const(0))
    isAccum(x9955_d1) = true
    bufferDepthOf(x9955_d1) = 1
    val x9956 = withCtrl(x9988) { Counter(min=Const(0), max=Const(5), step=Const(1), par=5).name("x9956").srcCtx("lenet_loops.scala:137:81") } // CounterNew(Const(0),Const(5),Const(1),Const(5))
    val x9957 = withCtrl(x9988) { Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x9957").srcCtx("lenet_loops.scala:137:63") } // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x9958 = withCtrl(x9988) { CounterChain(List(x9957,x9956)).name("x9958").srcCtx("lenet_loops.scala:139:16") } // CounterChainNew(List(x9957, x9956))
    val x9980 = withCtrl(x9988) { LoopController(style=InnerPipe, level=InnerControl, cchain=x9958).name("x9980").srcCtx("lenet_loops.scala:139:16") } // UnrolledReduce(List(b5696, b5697, b5689, b5674, b5444),x9958,x9955,Block((x9955) => Const(())),List(List(b5702), List(b5703)),List(List(b5704), List(b5705)))
    ...
    val x9959 = withCtrl(x9980) { OpDef(op=FixAdd, inputs=List(b5694, b5702)).name("x9959").srcCtx("lenet_loops.scala:138:35") } // FixAdd(b5694,b5702)
    val x9960 = withCtrl(x9980) { OpDef(op=FixAdd, inputs=List(b5695, b5703)).name("x9960").srcCtx("lenet_loops.scala:138:39") } // FixAdd(b5695,b5703)
    ...
    val x9967 = withCtrl(x9980) { LoadBanks(List(x9796_d0_b0), List(b5688, x9959, x9960)).name("x9967").srcCtx("lenet_loops.scala:138:26") } // ParSRAMLoad(x9796,List(List(b5688, x9959, x9960)),List(x9966))
    val x9968 = withCtrl(x9980) { x9967 } // VectorApply(x9967,0)
    val x9969 = withCtrl(x9980) { LoadBanks(List(x9912_d0_b0), List(b5688, b5702, b5703)).name("x9969").srcCtx("lenet_loops.scala:138:50") } // ParSRAMLoad(x9912,List(List(b5688, b5702, b5703)),List(x9966))
    val x9970 = withCtrl(x9980) { x9969 } // VectorApply(x9969,0)
    val x9971 = withCtrl(x9980) { OpDef(op=FixMul, inputs=List(x9968, x9970)).name("x9971").srcCtx("lenet_loops.scala:138:43") } // FixMul(x9968,x9970)
    val x9972 = withCtrl(x9980) { ReadMem(x9955_d1).name("x9972").srcCtx("lenet_loops.scala:139:16") } // RegRead(x9955)
    val x9973 = withCtrl(x9980) { OpDef(op=FixEql, inputs=List(b5702, Const(0))).name("x9973").srcCtx("lenet_loops.scala:139:16") } // FixEql(b5702,Const(0))
    val x9974 = withCtrl(x9980) { OpDef(op=FixEql, inputs=List(b5703, Const(0))).name("x9974").srcCtx("lenet_loops.scala:139:16") } // FixEql(b5703,Const(0))
    val x9975 = withCtrl(x9980) { OpDef(op=BitAnd, inputs=List(x9973, x9974)).name("x9975").srcCtx("lenet_loops.scala:139:16") } // And(x9973,x9974)
    val x9976 = withCtrl(x9980) { ReduceAccumOp(op=FixAdd, input=x9971, accum=x9972).name("x9976").srcCtx("lenet_loops.scala:139:18") } // FixAdd(x9971,x9972)
    ...
    val x9979_x9955_d0 = withCtrl(x9980) { WriteMem(x9955_d0, x9976).name("x9979_x9955_d0").srcCtx("lenet_loops.scala:139:16") } // RegWrite(x9955,x9976,x9978)
    antiDepsOf(x9979_x9955_d0)=List(x9972)
    val x9979_x9955_d1 = withCtrl(x9980) { WriteMem(x9955_d1, x9976).name("x9979_x9955_d1").srcCtx("lenet_loops.scala:139:16") } // RegWrite(x9955,x9976,x9978)
    antiDepsOf(x9979_x9955_d1)=List(x9972)
    val x9987 = withCtrl(x9988) { UnitController(style=SeqPipe, level=InnerControl).name("x9987").srcCtx("lenet_loops.scala:136:51") } // UnitPipe(List(b5696, b5697, b5689, b5674, b5444),Block(Const(())))
    val x9981 = withCtrl(x9987) { ReadMem(x9955_d0).name("x9981").srcCtx("lenet_loops.scala:140:37") } // RegRead(x9955)
    ...
    val x9986 = withCtrl(x9987) { StoreBanks(List(List(x9951_d0_b0)), List(b5694, b5695), x9981).name("x9986").srcCtx("lenet_loops.scala:140:28") } // SRAMStore(x9951,ArrayBuffer(Const(8), Const(8)),List(b5694, b5695),Const(0),x9981,x9985)
    val x9989 = withCtrl(x10007) { Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x9989").srcCtx("lenet_loops.scala:143:12") } // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x9990 = withCtrl(x10007) { Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x9990").srcCtx("lenet_loops.scala:143:12") } // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x9991 = withCtrl(x10007) { CounterChain(List(x9990,x9989)).name("x9991").srcCtx("lenet_loops.scala:143:12") } // CounterChainNew(ArrayBuffer(x9990, x9989))
    val x10006 = withCtrl(x10007) { LoopController(style=InnerPipe, level=InnerControl, cchain=x9991).name("x10006").srcCtx("lenet_loops.scala:143:12") } // UnrolledForeach(List(),x9991,Block(Const(())),ArrayBuffer(List(b5736), List(b5737)),ArrayBuffer(List(b5738), List(b5739)))
    ...
    val x9995 = withCtrl(x10006) { LoadBanks(List(x9951_d0_b0), List(b5736, b5737)).name("x9995").srcCtx("lenet_loops.scala:143:12") } // ParSRAMLoad(x9951,List(ArrayBuffer(b5736, b5737)),List(x9994))
    val x9996 = withCtrl(x10006) { x9995 } // VectorApply(x9995,0)
    val x9997 = withCtrl(x10006) { LoadBanks(List(x9947_d1_b0), List(b5736, b5737)).name("x9997").srcCtx("lenet_loops.scala:143:12") } // ParSRAMLoad(x9947,List(ArrayBuffer(b5736, b5737)),List(x9994))
    val x9998 = withCtrl(x10006) { x9997 } // VectorApply(x9997,0)
    val x9999 = withCtrl(x10006) { OpDef(op=BitAnd, inputs=List(b5689, b5674)).name("x9999").srcCtx("lenet_loops.scala:143:12") } // And(b5689,b5674)
    val x10000 = withCtrl(x10006) { OpDef(op=BitAnd, inputs=List(x9999, b5444)).name("x10000").srcCtx("lenet_loops.scala:143:12") } // And(x9999,b5444)
    val x10001 = withCtrl(x10006) { OpDef(op=BitAnd, inputs=List(x10000, x9994)).name("x10001").srcCtx("lenet_loops.scala:143:12") } // And(x10000,x9994)
    val x10002 = withCtrl(x10006) { OpDef(op=FixEql, inputs=List(b5688, Const(0))).name("x10002").srcCtx("lenet_loops.scala:143:12") } // FixEql(b5688,Const(0))
    val x10003 = withCtrl(x10006) { OpDef(op=FixAdd, inputs=List(x9996, x9998)).name("x10003").srcCtx("lenet_loops.scala:143:14") } // FixAdd(x9996,x9998)
    val x10004 = withCtrl(x10006) { OpDef(op=MuxOp, inputs=List(x10002, x9996, x10003)).name("x10004").srcCtx("lenet_loops.scala:143:12") } // Mux(x10002,x9996,x10003)
    val x10005 = withCtrl(x10006) { StoreBanks(List(List(x9947_d0_b0), List(x9947_d1_b0)), List(b5736, b5737), x10004).name("x10005").srcCtx("lenet_loops.scala:143:12") } // ParSRAMStore(x9947,List(ArrayBuffer(b5736, b5737)),List(x10004),List(x9994))
    antiDepsOf(x10005)=List(x9997)
    val x10008 = withCtrl(x10067) { Counter(min=Const(0), max=Const(20), step=Const(1), par=1).name("x10008").srcCtx("lenet_loops.scala:134:44") } // CounterNew(Const(0),Const(20),Const(1),Const(1))
    val x10009 = withCtrl(x10067) { CounterChain(List(x10008)).name("x10009").srcCtx("lenet_loops.scala:143:12") } // CounterChainNew(List(x10008))
    val x10066 = withCtrl(x10067) { LoopController(style=MetaPipe, level=OuterControl, cchain=x10009).name("x10066").srcCtx("lenet_loops.scala:143:12") } // UnrolledReduce(List(b5675, b5444),x10009,x9948,Block((x9948) => Const(())),List(List(b5756)),List(List(b5757)))
    ...
    val x10010_d0_b0 = withCtrl(x10066) { SRAM(size=64, banking=Strided(banks=1, stride=8)).name("x10010_d0_b0").srcCtx("lenet_loops.scala:135:33:result") } // x10010 = SRAMNew(ArrayBuffer(Const(8), Const(8)))
    isAccum(x10010_d0_b0) = false
    bufferDepthOf(x10010_d0_b0) = 2
    staticDimsOf(x10010_d0_b0) = List(8, 8)
    val x10011 = withCtrl(x10066) { Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x10011").srcCtx("lenet_loops.scala:136:44") } // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x10012 = withCtrl(x10066) { Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x10012").srcCtx("lenet_loops.scala:136:23") } // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x10013 = withCtrl(x10066) { CounterChain(List(x10012,x10011)).name("x10013").srcCtx("lenet_loops.scala:136:51") } // CounterChainNew(List(x10012, x10011))
    val x10047 = withCtrl(x10066) { LoopController(style=MetaPipe, level=OuterControl, cchain=x10013).name("x10047").srcCtx("lenet_loops.scala:136:51") } // UnrolledForeach(List(b5757, b5675, b5444),x10013,Block(Const(())),List(List(b5762), List(b5763)),List(List(b5764), List(b5765)))
    ...
    val x10014_d0 = withCtrl(x10047) { Reg(init=Some(0.0)).name("x10014_d0").srcCtx("lenet_loops.scala:137:41:window") } // x10014 = RegNew(Const(0))
    isAccum(x10014_d0) = false
    bufferDepthOf(x10014_d0) = 2
    val x10014_d1 = withCtrl(x10047) { Reg(init=Some(0.0)).name("x10014_d1").srcCtx("lenet_loops.scala:137:41:window") } // x10014 = RegNew(Const(0))
    isAccum(x10014_d1) = true
    bufferDepthOf(x10014_d1) = 1
    val x10015 = withCtrl(x10047) { Counter(min=Const(0), max=Const(5), step=Const(1), par=5).name("x10015").srcCtx("lenet_loops.scala:137:81") } // CounterNew(Const(0),Const(5),Const(1),Const(5))
    val x10016 = withCtrl(x10047) { Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x10016").srcCtx("lenet_loops.scala:137:63") } // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x10017 = withCtrl(x10047) { CounterChain(List(x10016,x10015)).name("x10017").srcCtx("lenet_loops.scala:139:16") } // CounterChainNew(List(x10016, x10015))
    val x10039 = withCtrl(x10047) { LoopController(style=InnerPipe, level=InnerControl, cchain=x10017).name("x10039").srcCtx("lenet_loops.scala:139:16") } // UnrolledReduce(List(b5764, b5765, b5757, b5675, b5444),x10017,x10014,Block((x10014) => Const(())),List(List(b5770), List(b5771)),List(List(b5772), List(b5773)))
    ...
    val x10018 = withCtrl(x10039) { OpDef(op=FixAdd, inputs=List(b5762, b5770)).name("x10018").srcCtx("lenet_loops.scala:138:35") } // FixAdd(b5762,b5770)
    val x10019 = withCtrl(x10039) { OpDef(op=FixAdd, inputs=List(b5763, b5771)).name("x10019").srcCtx("lenet_loops.scala:138:39") } // FixAdd(b5763,b5771)
    ...
    val x10026 = withCtrl(x10039) { LoadBanks(List(x9796_d1_b0), List(b5756, x10018, x10019)).name("x10026").srcCtx("lenet_loops.scala:138:26") } // ParSRAMLoad(x9796,List(List(b5756, x10018, x10019)),List(x10025))
    val x10027 = withCtrl(x10039) { x10026 } // VectorApply(x10026,0)
    val x10028 = withCtrl(x10039) { LoadBanks(List(x9912_d1_b0), List(b5756, b5770, b5771)).name("x10028").srcCtx("lenet_loops.scala:138:50") } // ParSRAMLoad(x9912,List(List(b5756, b5770, b5771)),List(x10025))
    val x10029 = withCtrl(x10039) { x10028 } // VectorApply(x10028,0)
    val x10030 = withCtrl(x10039) { OpDef(op=FixMul, inputs=List(x10027, x10029)).name("x10030").srcCtx("lenet_loops.scala:138:43") } // FixMul(x10027,x10029)
    val x10031 = withCtrl(x10039) { ReadMem(x10014_d1).name("x10031").srcCtx("lenet_loops.scala:139:16") } // RegRead(x10014)
    val x10032 = withCtrl(x10039) { OpDef(op=FixEql, inputs=List(b5770, Const(0))).name("x10032").srcCtx("lenet_loops.scala:139:16") } // FixEql(b5770,Const(0))
    val x10033 = withCtrl(x10039) { OpDef(op=FixEql, inputs=List(b5771, Const(0))).name("x10033").srcCtx("lenet_loops.scala:139:16") } // FixEql(b5771,Const(0))
    val x10034 = withCtrl(x10039) { OpDef(op=BitAnd, inputs=List(x10032, x10033)).name("x10034").srcCtx("lenet_loops.scala:139:16") } // And(x10032,x10033)
    val x10035 = withCtrl(x10039) { ReduceAccumOp(op=FixAdd, input=x10030, accum=x10031).name("x10035").srcCtx("lenet_loops.scala:139:18") } // FixAdd(x10030,x10031)
    ...
    val x10038_x10014_d0 = withCtrl(x10039) { WriteMem(x10014_d0, x10035).name("x10038_x10014_d0").srcCtx("lenet_loops.scala:139:16") } // RegWrite(x10014,x10035,x10037)
    antiDepsOf(x10038_x10014_d0)=List(x10031)
    val x10038_x10014_d1 = withCtrl(x10039) { WriteMem(x10014_d1, x10035).name("x10038_x10014_d1").srcCtx("lenet_loops.scala:139:16") } // RegWrite(x10014,x10035,x10037)
    antiDepsOf(x10038_x10014_d1)=List(x10031)
    val x10046 = withCtrl(x10047) { UnitController(style=SeqPipe, level=InnerControl).name("x10046").srcCtx("lenet_loops.scala:136:51") } // UnitPipe(List(b5764, b5765, b5757, b5675, b5444),Block(Const(())))
    val x10040 = withCtrl(x10046) { ReadMem(x10014_d0).name("x10040").srcCtx("lenet_loops.scala:140:37") } // RegRead(x10014)
    ...
    val x10045 = withCtrl(x10046) { StoreBanks(List(List(x10010_d0_b0)), List(b5762, b5763), x10040).name("x10045").srcCtx("lenet_loops.scala:140:28") } // SRAMStore(x10010,ArrayBuffer(Const(8), Const(8)),List(b5762, b5763),Const(0),x10040,x10044)
    val x10048 = withCtrl(x10066) { Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x10048").srcCtx("lenet_loops.scala:143:12") } // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x10049 = withCtrl(x10066) { Counter(min=Const(0), max=Const(8), step=Const(1), par=1).name("x10049").srcCtx("lenet_loops.scala:143:12") } // CounterNew(Const(0),Const(8),Const(1),Const(1))
    val x10050 = withCtrl(x10066) { CounterChain(List(x10049,x10048)).name("x10050").srcCtx("lenet_loops.scala:143:12") } // CounterChainNew(ArrayBuffer(x10049, x10048))
    val x10065 = withCtrl(x10066) { LoopController(style=InnerPipe, level=InnerControl, cchain=x10050).name("x10065").srcCtx("lenet_loops.scala:143:12") } // UnrolledForeach(List(),x10050,Block(Const(())),ArrayBuffer(List(b5804), List(b5805)),ArrayBuffer(List(b5806), List(b5807)))
    ...
    val x10054 = withCtrl(x10065) { LoadBanks(List(x10010_d0_b0), List(b5804, b5805)).name("x10054").srcCtx("lenet_loops.scala:143:12") } // ParSRAMLoad(x10010,List(ArrayBuffer(b5804, b5805)),List(x10053))
    val x10055 = withCtrl(x10065) { x10054 } // VectorApply(x10054,0)
    val x10056 = withCtrl(x10065) { LoadBanks(List(x9948_d1_b0), List(b5804, b5805)).name("x10056").srcCtx("lenet_loops.scala:143:12") } // ParSRAMLoad(x9948,List(ArrayBuffer(b5804, b5805)),List(x10053))
    val x10057 = withCtrl(x10065) { x10056 } // VectorApply(x10056,0)
    val x10058 = withCtrl(x10065) { OpDef(op=BitAnd, inputs=List(b5757, b5675)).name("x10058").srcCtx("lenet_loops.scala:143:12") } // And(b5757,b5675)
    val x10059 = withCtrl(x10065) { OpDef(op=BitAnd, inputs=List(x10058, b5444)).name("x10059").srcCtx("lenet_loops.scala:143:12") } // And(x10058,b5444)
    val x10060 = withCtrl(x10065) { OpDef(op=BitAnd, inputs=List(x10059, x10053)).name("x10060").srcCtx("lenet_loops.scala:143:12") } // And(x10059,x10053)
    val x10061 = withCtrl(x10065) { OpDef(op=FixEql, inputs=List(b5756, Const(0))).name("x10061").srcCtx("lenet_loops.scala:143:12") } // FixEql(b5756,Const(0))
    val x10062 = withCtrl(x10065) { OpDef(op=FixAdd, inputs=List(x10055, x10057)).name("x10062").srcCtx("lenet_loops.scala:143:14") } // FixAdd(x10055,x10057)
    val x10063 = withCtrl(x10065) { OpDef(op=MuxOp, inputs=List(x10061, x10055, x10062)).name("x10063").srcCtx("lenet_loops.scala:143:12") } // Mux(x10061,x10055,x10062)
    val x10064 = withCtrl(x10065) { StoreBanks(List(List(x9948_d0_b0), List(x9948_d1_b0)), List(b5804, b5805), x10063).name("x10064").srcCtx("lenet_loops.scala:143:12") } // ParSRAMStore(x9948,List(ArrayBuffer(b5804, b5805)),List(x10063),List(x10053))
    ...
    val x10068 = withCtrl(x10140) { Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x10068").srcCtx("lenet_loops.scala:145:29") } // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x10069 = withCtrl(x10140) { Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x10069").srcCtx("lenet_loops.scala:145:21") } // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x10070 = withCtrl(x10140) { CounterChain(List(x10069,x10068)).name("x10070").srcCtx("lenet_loops.scala:145:35") } // CounterChainNew(List(x10069, x10068))
    val x10103 = withCtrl(x10140) { LoopController(style=MetaPipe, level=OuterControl, cchain=x10070).name("x10103").srcCtx("lenet_loops.scala:145:35") } // UnrolledForeach(List(b5674, b5444),x10070,Block(Const(())),List(List(b5831), List(b5832)),List(List(b5833), List(b5834)))
    ...
    val x10071_d0 = withCtrl(x10103) { Reg(init=Some(0.0)).name("x10071_d0").srcCtx("lenet_loops.scala:146:36:out") } // x10071 = RegNew(Const(0))
    isAccum(x10071_d0) = false
    bufferDepthOf(x10071_d0) = 2
    val x10071_d1 = withCtrl(x10103) { Reg(init=Some(0.0)).name("x10071_d1").srcCtx("lenet_loops.scala:146:36:out") } // x10071 = RegNew(Const(0))
    isAccum(x10071_d1) = true
    bufferDepthOf(x10071_d1) = 1
    val x10072 = withCtrl(x10103) { Counter(min=Const(0), max=Const(2), step=Const(2), par=1).name("x10072").srcCtx("lenet_loops.scala:146:67") } // CounterNew(Const(0),Const(2),Const(2),Const(1))
    val x10073 = withCtrl(x10103) { Counter(min=Const(0), max=Const(2), step=Const(2), par=1).name("x10073").srcCtx("lenet_loops.scala:146:54") } // CounterNew(Const(0),Const(2),Const(2),Const(1))
    val x10074 = withCtrl(x10103) { CounterChain(List(x10073,x10072)).name("x10074").srcCtx("lenet_loops.scala:148:15") } // CounterChainNew(List(x10073, x10072))
    val x10096 = withCtrl(x10103) { LoopController(style=InnerPipe, level=InnerControl, cchain=x10074).name("x10096").srcCtx("lenet_loops.scala:148:15") } // UnrolledReduce(List(b5833, b5834, b5674, b5444),x10074,x10071,Block((x10071) => Const(())),List(List(b5839), List(b5840)),List(List(b5841), List(b5842)))
    ...
    val x10075 = withCtrl(x10096) { OpDef(op=FixSla, inputs=List(b5831, Const(1))).name("x10075").srcCtx("lenet_loops.scala:147:44") } // FixLsh(b5831,Const(1))
    val x10076 = withCtrl(x10096) { OpDef(op=FixAdd, inputs=List(x10075, b5839)).name("x10076").srcCtx("lenet_loops.scala:147:47") } // FixAdd(x10075,b5839)
    val x10077 = withCtrl(x10096) { OpDef(op=FixSla, inputs=List(b5832, Const(1))).name("x10077").srcCtx("lenet_loops.scala:147:54") } // FixLsh(b5832,Const(1))
    val x10078 = withCtrl(x10096) { OpDef(op=FixAdd, inputs=List(x10077, b5840)).name("x10078").srcCtx("lenet_loops.scala:147:57") } // FixAdd(x10077,b5840)
    ...
    val x10084 = withCtrl(x10096) { LoadBanks(List(x9947_d0_b0), List(x10076, x10078)).name("x10084").srcCtx("lenet_loops.scala:147:42") } // ParSRAMLoad(x9947,List(List(x10076, x10078)),List(x10083))
    val x10085 = withCtrl(x10096) { x10084 } // VectorApply(x10084,0)
    val x10086 = withCtrl(x10096) { LoadBanks(List(x9695_d0_b0), List(b5672)).name("x10086").srcCtx("lenet_loops.scala:147:72") } // SRAMLoad(x9695,ArrayBuffer(Const(64)),List(b5672),Const(0),x10083)
    val x10087 = withCtrl(x10096) { OpDef(op=FixAdd, inputs=List(x10085, x10086)).name("x10087").srcCtx("lenet_loops.scala:147:63") } // FixAdd(x10085,x10086)
    val x10088 = withCtrl(x10096) { OpDef(op=FixMax, inputs=List(Const(0.0), x10087)).name("x10088").srcCtx("lenet_loops.scala:147:18") } // Max(Const(0),x10087)
    val x10089 = withCtrl(x10096) { ReadMem(x10071_d1).name("x10089").srcCtx("lenet_loops.scala:148:15") } // RegRead(x10071)
    val x10090 = withCtrl(x10096) { OpDef(op=FixEql, inputs=List(b5839, Const(0))).name("x10090").srcCtx("lenet_loops.scala:148:15") } // FixEql(b5839,Const(0))
    val x10091 = withCtrl(x10096) { OpDef(op=FixEql, inputs=List(b5840, Const(0))).name("x10091").srcCtx("lenet_loops.scala:148:15") } // FixEql(b5840,Const(0))
    val x10092 = withCtrl(x10096) { OpDef(op=BitAnd, inputs=List(x10090, x10091)).name("x10092").srcCtx("lenet_loops.scala:148:15") } // And(x10090,x10091)
    val x10093 = withCtrl(x10096) { ReduceAccumOp(op=FixMax, input=x10088, accum=x10089).name("x10093").srcCtx("lenet_loops.scala:148:29") } // Max(x10088,x10089)
    ...
    val x10095_x10071_d0 = withCtrl(x10096) { WriteMem(x10071_d0, x10093).name("x10095_x10071_d0").srcCtx("lenet_loops.scala:148:15") } // RegWrite(x10071,x10093,x10094)
    antiDepsOf(x10095_x10071_d0)=List(x10089)
    val x10095_x10071_d1 = withCtrl(x10096) { WriteMem(x10071_d1, x10093).name("x10095_x10071_d1").srcCtx("lenet_loops.scala:148:15") } // RegWrite(x10071,x10093,x10094)
    antiDepsOf(x10095_x10071_d1)=List(x10089)
    val x10102 = withCtrl(x10103) { UnitController(style=SeqPipe, level=InnerControl).name("x10102").srcCtx("lenet_loops.scala:145:35") } // UnitPipe(List(b5833, b5834, b5674, b5444),Block(Const(())))
    val x10097 = withCtrl(x10102) { ReadMem(x10071_d0).name("x10097").srcCtx("lenet_loops.scala:149:43") } // RegRead(x10071)
    ...
    val x10101 = withCtrl(x10102) { StoreBanks(List(List(x9911_d0_b0)), List(b5672, b5831, b5832), x10097).name("x10101").srcCtx("lenet_loops.scala:149:37") } // SRAMStore(x9911,ArrayBuffer(Const(50), Const(4), Const(4)),List(b5672, b5831, b5832),Const(0),x10097,x10100)
    val x10104 = withCtrl(x10140) { Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x10104").srcCtx("lenet_loops.scala:145:29") } // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x10105 = withCtrl(x10140) { Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x10105").srcCtx("lenet_loops.scala:145:21") } // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x10106 = withCtrl(x10140) { CounterChain(List(x10105,x10104)).name("x10106").srcCtx("lenet_loops.scala:145:35") } // CounterChainNew(List(x10105, x10104))
    val x10139 = withCtrl(x10140) { LoopController(style=MetaPipe, level=OuterControl, cchain=x10106).name("x10139").srcCtx("lenet_loops.scala:145:35") } // UnrolledForeach(List(b5675, b5444),x10106,Block(Const(())),List(List(b5872), List(b5873)),List(List(b5874), List(b5875)))
    ...
    val x10107_d0 = withCtrl(x10139) { Reg(init=Some(0.0)).name("x10107_d0").srcCtx("lenet_loops.scala:146:36:out") } // x10107 = RegNew(Const(0))
    isAccum(x10107_d0) = false
    bufferDepthOf(x10107_d0) = 2
    val x10107_d1 = withCtrl(x10139) { Reg(init=Some(0.0)).name("x10107_d1").srcCtx("lenet_loops.scala:146:36:out") } // x10107 = RegNew(Const(0))
    isAccum(x10107_d1) = true
    bufferDepthOf(x10107_d1) = 1
    val x10108 = withCtrl(x10139) { Counter(min=Const(0), max=Const(2), step=Const(2), par=1).name("x10108").srcCtx("lenet_loops.scala:146:67") } // CounterNew(Const(0),Const(2),Const(2),Const(1))
    val x10109 = withCtrl(x10139) { Counter(min=Const(0), max=Const(2), step=Const(2), par=1).name("x10109").srcCtx("lenet_loops.scala:146:54") } // CounterNew(Const(0),Const(2),Const(2),Const(1))
    val x10110 = withCtrl(x10139) { CounterChain(List(x10109,x10108)).name("x10110").srcCtx("lenet_loops.scala:148:15") } // CounterChainNew(List(x10109, x10108))
    val x10132 = withCtrl(x10139) { LoopController(style=InnerPipe, level=InnerControl, cchain=x10110).name("x10132").srcCtx("lenet_loops.scala:148:15") } // UnrolledReduce(List(b5874, b5875, b5675, b5444),x10110,x10107,Block((x10107) => Const(())),List(List(b5880), List(b5881)),List(List(b5882), List(b5883)))
    ...
    val x10111 = withCtrl(x10132) { OpDef(op=FixSla, inputs=List(b5872, Const(1))).name("x10111").srcCtx("lenet_loops.scala:147:44") } // FixLsh(b5872,Const(1))
    val x10112 = withCtrl(x10132) { OpDef(op=FixAdd, inputs=List(x10111, b5880)).name("x10112").srcCtx("lenet_loops.scala:147:47") } // FixAdd(x10111,b5880)
    val x10113 = withCtrl(x10132) { OpDef(op=FixSla, inputs=List(b5873, Const(1))).name("x10113").srcCtx("lenet_loops.scala:147:54") } // FixLsh(b5873,Const(1))
    val x10114 = withCtrl(x10132) { OpDef(op=FixAdd, inputs=List(x10113, b5881)).name("x10114").srcCtx("lenet_loops.scala:147:57") } // FixAdd(x10113,b5881)
    ...
    val x10120 = withCtrl(x10132) { LoadBanks(List(x9948_d0_b0), List(x10112, x10114)).name("x10120").srcCtx("lenet_loops.scala:147:42") } // ParSRAMLoad(x9948,List(List(x10112, x10114)),List(x10119))
    val x10121 = withCtrl(x10132) { x10120 } // VectorApply(x10120,0)
    val x10122 = withCtrl(x10132) { LoadBanks(List(x9695_d0_b0), List(b5673)).name("x10122").srcCtx("lenet_loops.scala:147:72") } // SRAMLoad(x9695,ArrayBuffer(Const(64)),List(b5673),Const(0),x10119)
    val x10123 = withCtrl(x10132) { OpDef(op=FixAdd, inputs=List(x10121, x10122)).name("x10123").srcCtx("lenet_loops.scala:147:63") } // FixAdd(x10121,x10122)
    val x10124 = withCtrl(x10132) { OpDef(op=FixMax, inputs=List(Const(0.0), x10123)).name("x10124").srcCtx("lenet_loops.scala:147:18") } // Max(Const(0),x10123)
    val x10125 = withCtrl(x10132) { ReadMem(x10107_d1).name("x10125").srcCtx("lenet_loops.scala:148:15") } // RegRead(x10107)
    val x10126 = withCtrl(x10132) { OpDef(op=FixEql, inputs=List(b5880, Const(0))).name("x10126").srcCtx("lenet_loops.scala:148:15") } // FixEql(b5880,Const(0))
    val x10127 = withCtrl(x10132) { OpDef(op=FixEql, inputs=List(b5881, Const(0))).name("x10127").srcCtx("lenet_loops.scala:148:15") } // FixEql(b5881,Const(0))
    val x10128 = withCtrl(x10132) { OpDef(op=BitAnd, inputs=List(x10126, x10127)).name("x10128").srcCtx("lenet_loops.scala:148:15") } // And(x10126,x10127)
    val x10129 = withCtrl(x10132) { ReduceAccumOp(op=FixMax, input=x10124, accum=x10125).name("x10129").srcCtx("lenet_loops.scala:148:29") } // Max(x10124,x10125)
    ...
    val x10131_x10107_d0 = withCtrl(x10132) { WriteMem(x10107_d0, x10129).name("x10131_x10107_d0").srcCtx("lenet_loops.scala:148:15") } // RegWrite(x10107,x10129,x10130)
    antiDepsOf(x10131_x10107_d0)=List(x10125)
    val x10131_x10107_d1 = withCtrl(x10132) { WriteMem(x10107_d1, x10129).name("x10131_x10107_d1").srcCtx("lenet_loops.scala:148:15") } // RegWrite(x10107,x10129,x10130)
    antiDepsOf(x10131_x10107_d1)=List(x10125)
    val x10138 = withCtrl(x10139) { UnitController(style=SeqPipe, level=InnerControl).name("x10138").srcCtx("lenet_loops.scala:145:35") } // UnitPipe(List(b5874, b5875, b5675, b5444),Block(Const(())))
    val x10133 = withCtrl(x10138) { ReadMem(x10107_d0).name("x10133").srcCtx("lenet_loops.scala:149:43") } // RegRead(x10107)
    ...
    val x10137 = withCtrl(x10138) { StoreBanks(List(List(x9911_d0_b0)), List(b5673, b5872, b5873), x10133).name("x10137").srcCtx("lenet_loops.scala:149:37") } // SRAMStore(x9911,ArrayBuffer(Const(50), Const(4), Const(4)),List(b5673, b5872, b5873),Const(0),x10133,x10136)
    val x10142_d0_b0 = withCtrl(x10326) { SRAM(size=640, banking=Strided(banks=1, stride=128)).name("x10142_d0_b0").srcCtx("lenet_loops.scala:163:32:tmp4_SRAM") } // x10142 = SRAMNew(ArrayBuffer(Const(5), Const(128)))
    isAccum(x10142_d0_b0) = false
    bufferDepthOf(x10142_d0_b0) = 3
    staticDimsOf(x10142_d0_b0) = List(5, 128)
    val x10143 = withCtrl(x10326) { Counter(min=Const(0), max=Const(128), step=Const(1), par=1).name("x10143").srcCtx("lenet_loops.scala:164:26") } // CounterNew(Const(0),Const(128),Const(1),Const(1))
    val x10144 = withCtrl(x10326) { CounterChain(List(x10143)).name("x10144").srcCtx("lenet_loops.scala:164:39") } // CounterChainNew(List(x10143))
    val x10231 = withCtrl(x10326) { LoopController(style=MetaPipe, level=OuterControl, cchain=x10144).name("x10231").srcCtx("lenet_loops.scala:164:39") } // UnrolledForeach(List(b5444),x10144,Block(Const(())),List(List(b5918)),List(List(b5919)))
    ...
    val x10145_d0_b0 = withCtrl(x10231) { SRAM(size=5120, banking=Strided(banks=16, stride=1)).name("x10145_d0_b0").srcCtx("lenet_loops.scala:165:36:c4_row_SRAM") } // x10145 = SRAMNew(ArrayBuffer(Const(5), Const(4), Const(4), Const(64)))
    isAccum(x10145_d0_b0) = false
    bufferDepthOf(x10145_d0_b0) = 2
    staticDimsOf(x10145_d0_b0) = List(5, 4, 4, 64)
    val x10147 = withCtrl(x10231) { UnitController(style=SeqPipe, level=InnerControl).name("x10147").srcCtx("lenet_loops.scala:164:39") } // UnitPipe(List(b5919, b5444),Block(Const(())))
    val x10146 = withCtrl(x10147) { OpDef(op=FixAdd, inputs=List(b5918, Const(1))).name("x10146").srcCtx("lenet_loops.scala:166:35") } // FixAdd(b5918,Const(1))
    val x10148 = withCtrl(x10231) { Counter(min=Const(0), max=Const(1), step=Const(1), par=1).name("x10148").srcCtx("lenet_loops.scala:166:23") } // CounterNew(Const(0),Const(1),Const(1),Const(1))
    val x10149 = withCtrl(x10231) { Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x10149").srcCtx("lenet_loops.scala:166:23") } // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x10150 = withCtrl(x10231) { Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x10150").srcCtx("lenet_loops.scala:166:23") } // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x10151 = withCtrl(x10231) { Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x10151").srcCtx("lenet_loops.scala:166:23") } // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x10152 = withCtrl(x10231) { CounterChain(List(x10148,x10149,x10150,x10151)).name("x10152").srcCtx("lenet_loops.scala:166:23") } // CounterChainNew(List(x10148, x10149, x10150, x10151))
    val x10194 = withCtrl(x10231) { LoopController(style=StreamPipe, level=OuterControl, cchain=x10152).name("x10194").srcCtx("lenet_loops.scala:166:23") } // UnrolledForeach(List(b5919, b5444),x10152,Block(Const(())),List(List(b5928), List(b5929), List(b5930), List(b5931)),List(List(b5932), List(b5933), List(b5934), List(b5935)))
    ...
    val b10393 = withCtrl(x10194) { StreamOut(field="offset").name("b10393").srcCtx("lenet_loops.scala:166:23") } // x10153 = StreamOutNew(BurstCmdBus)
    isAccum(b10393) = false
    bufferDepthOf(b10393) = 1
    val b10394 = withCtrl(x10194) { StreamOut(field="size").name("b10394").srcCtx("lenet_loops.scala:166:23") } // x10153 = StreamOutNew(BurstCmdBus)
    isAccum(b10394) = false
    bufferDepthOf(b10394) = 1
    val x10154 = withCtrl(x10194) { StreamIn(field="data").name("x10154").srcCtx("lenet_loops.scala:166:23") } // x10154 = StreamInNew(BurstDataBus())
    isAccum(x10154) = false
    bufferDepthOf(x10154) = 1
    val x10180 = withCtrl(x10194) { UnitController(style=SeqPipe, level=InnerControl).name("x10180").srcCtx("lenet_loops.scala:166:23") } // UnitPipe(List(b5932, b5933, b5934, b5935, b5919, b5444),Block(x10179))
    val x10155 = withCtrl(x10180) { OpDef(op=FixAdd, inputs=List(b5918, b5928)).name("x10155").srcCtx("lenet_loops.scala:166:23") } // FixAdd(b5918,b5928)
    val x10156 = withCtrl(x10180) { x10155 } // FixConvert(x10155,TRUE,_32,_0) (Same Type. No op)
    val x10157 = withCtrl(x10180) { OpDef(op=FixSla, inputs=List(x10156, Const(12))).name("x10157").srcCtx("lenet_loops.scala:166:23") } // FixLsh(x10156,Const(12))
    val x10158 = withCtrl(x10180) { b5929 } // FixConvert(b5929,TRUE,_32,_0) (Same Type. No op)
    val x10159 = withCtrl(x10180) { OpDef(op=FixSla, inputs=List(x10158, Const(10))).name("x10159").srcCtx("lenet_loops.scala:166:23") } // FixLsh(x10158,Const(10))
    val x10160 = withCtrl(x10180) { b5930 } // FixConvert(b5930,TRUE,_32,_0) (Same Type. No op)
    val x10161 = withCtrl(x10180) { OpDef(op=FixSla, inputs=List(x10160, Const(8))).name("x10161").srcCtx("lenet_loops.scala:166:23") } // FixLsh(x10160,Const(8))
    val x10162 = withCtrl(x10180) { b5931 } // FixConvert(b5931,TRUE,_32,_0) (Same Type. No op)
    val x10163 = withCtrl(x10180) { OpDef(op=FixSla, inputs=List(x10162, Const(6))).name("x10163").srcCtx("lenet_loops.scala:166:23") } // FixLsh(x10162,Const(6))
    val x10164 = withCtrl(x10180) { Const(0) } // FixConvert(Const(0),TRUE,_32,_0) (Same Type. No op)
    val x10165 = withCtrl(x10180) { OpDef(op=FixAdd, inputs=List(x10157, x10159)).name("x10165").srcCtx("lenet_loops.scala:166:23") } // FixAdd(x10157,x10159)
    val x10166 = withCtrl(x10180) { OpDef(op=FixAdd, inputs=List(x10161, x10163)).name("x10166").srcCtx("lenet_loops.scala:166:23") } // FixAdd(x10161,x10163)
    val x10167 = withCtrl(x10180) { OpDef(op=FixAdd, inputs=List(x10165, x10166)).name("x10167").srcCtx("lenet_loops.scala:166:23") } // FixAdd(x10165,x10166)
    val x10168 = withCtrl(x10180) { OpDef(op=FixAdd, inputs=List(x10167, x10164)).name("x10168").srcCtx("lenet_loops.scala:166:23") } // FixAdd(x10167,x10164)
    val x10169 = withCtrl(x10180) { OpDef(op=FixSla, inputs=List(x10168, Const(2))).name("x10169").srcCtx("lenet_loops.scala:166:23") } // FixLsh(x10168,Const(2))
    val x10170 = withCtrl(x10180) { x10169 } // FixConvert(x10169,TRUE,_64,_0)
    val x10171 = withCtrl(x10180) { DramAddress(x9562).name("x10171").srcCtx("lenet_loops.scala:166:23") } // GetDRAMAddress(x9562)
    val x10173_x10172 = withCtrl(x10180) { OpDef(op=FixAdd, inputs=List(x10170, x10171)).name("x10173_x10172").srcCtx("lenet_loops.scala:166:23") } // FixAdd(x10170,x10171)
    ...
    val x10179_b10395_b10393 = withCtrl(x10180) { WriteMem(b10393, x10173_x10172).name("x10179_b10395_b10393").srcCtx("lenet_loops.scala:166:23") } // StreamWrite(x10153,x10173,x10178)
    val x10179_b10396_b10394 = withCtrl(x10180) { WriteMem(b10394, Const(256)).name("x10179_b10396_b10394").srcCtx("lenet_loops.scala:166:23") } // StreamWrite(x10153,x10173,x10178)
    val x10181 = withCtrl(x10194) { FringeDenseLoad(dram=List(x9562), cmdStream=List(b10393, b10394), dataStream=List(x10154)).name("x10181").srcCtx("lenet_loops.scala:166:23") } // FringeDenseLoad(x9562,x10153,x10154)
    val x10182 = withCtrl(x10194) { Counter(min=Const(0), max=Const(64), step=Const(1), par=16).name("x10182").srcCtx("lenet_loops.scala:166:23") } // CounterNew(Const(0),Const(64),Const(1),Const(16))
    val x10183 = withCtrl(x10194) { CounterChain(List(x10182)).name("x10183").srcCtx("lenet_loops.scala:166:23") } // CounterChainNew(List(x10182))
    val x10193 = withCtrl(x10194) { LoopController(style=InnerPipe, level=InnerControl, cchain=x10183).name("x10193").srcCtx("lenet_loops.scala:166:23") } // UnrolledForeach(List(b5932, b5933, b5934, b5935, b5919, b5444),x10183,Block(Const(())),List(List(b5967)),List(List(b5968)))
    ...
    val x10190_x10190 = withCtrl(x10193) { ReadMem(x10154).name("x10190_x10190").srcCtx("lenet_loops.scala:166:23") } // ParStreamRead(x10154,List(x10189))
    val x10191_x10191 = withCtrl(x10193) { x10190_x10190 } // VectorApply(x10190,0)
    val x10192 = withCtrl(x10193) { StoreBanks(List(List(x10145_d0_b0)), List(b5929, b5930, b5931, b5967), x10191_x10191).name("x10192").srcCtx("lenet_loops.scala:166:23") } // ParSRAMStore(x10145,List(List(b5929, b5930, b5931, b5967)),List(x10191),List(x10189))
    val x10195 = withCtrl(x10231) { Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x10195").srcCtx("lenet_loops.scala:167:21") } // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x10196 = withCtrl(x10231) { CounterChain(List(x10195)).name("x10196").srcCtx("lenet_loops.scala:167:26") } // CounterChainNew(List(x10195))
    val x10230 = withCtrl(x10231) { LoopController(style=MetaPipe, level=OuterControl, cchain=x10196).name("x10230").srcCtx("lenet_loops.scala:167:26") } // UnrolledForeach(List(b5919, b5444),x10196,Block(Const(())),List(List(b5982)),List(List(b5983)))
    ...
    val x10197_d0 = withCtrl(x10230) { Reg(init=Some(0.0)).name("x10197_d0").srcCtx("lenet_loops.scala:168:37:prod") } // x10197 = RegNew(Const(0))
    isAccum(x10197_d0) = false
    bufferDepthOf(x10197_d0) = 2
    val x10197_d1 = withCtrl(x10230) { Reg(init=Some(0.0)).name("x10197_d1").srcCtx("lenet_loops.scala:168:37:prod") } // x10197 = RegNew(Const(0))
    isAccum(x10197_d1) = true
    bufferDepthOf(x10197_d1) = 1
    val x10198 = withCtrl(x10230) { Counter(min=Const(0), max=Const(4), step=Const(1), par=4).name("x10198").srcCtx("lenet_loops.scala:168:72") } // CounterNew(Const(0),Const(4),Const(1),Const(4))
    val x10199 = withCtrl(x10230) { Counter(min=Const(0), max=Const(4), step=Const(1), par=1).name("x10199").srcCtx("lenet_loops.scala:168:59") } // CounterNew(Const(0),Const(4),Const(1),Const(1))
    val x10200 = withCtrl(x10230) { Counter(min=Const(0), max=Const(50), step=Const(1), par=1).name("x10200").srcCtx("lenet_loops.scala:168:51") } // CounterNew(Const(0),Const(50),Const(1),Const(1))
    val x10201 = withCtrl(x10230) { CounterChain(List(x10200,x10199,x10198)).name("x10201").srcCtx("lenet_loops.scala:171:14") } // CounterChainNew(List(x10200, x10199, x10198))
    val x10221 = withCtrl(x10230) { LoopController(style=InnerPipe, level=InnerControl, cchain=x10201).name("x10221").srcCtx("lenet_loops.scala:171:14") } // UnrolledReduce(List(b5983, b5919, b5444),x10201,x10197,Block((x10197) => Const(())),List(List(b5989), List(b5990), List(b5991)),List(List(b5992), List(b5993), List(b5994)))
    ...
    val x10207 = withCtrl(x10221) { LoadBanks(List(x9911_d0_b0), List(b5990, b5990, b5989)).name("x10207").srcCtx("lenet_loops.scala:170:24") } // SRAMLoad(x9911,ArrayBuffer(Const(50), Const(4), Const(4)),List(b5990, b5990, b5989),Const(0),x10206)
    val x10208 = withCtrl(x10221) { LoadBanks(List(x10145_d0_b0), List(b5982, b5989, b5990, b5991)).name("x10208").srcCtx("lenet_loops.scala:170:45") } // ParSRAMLoad(x10145,List(List(b5982, b5989, b5990, b5991)),List(x10206))
    val x10209 = withCtrl(x10221) { x10208 } // VectorApply(x10208,0)
    val x10210 = withCtrl(x10221) { OpDef(op=FixMul, inputs=List(x10207, x10209)).name("x10210").srcCtx("lenet_loops.scala:170:32") } // FixMul(x10207,x10209)
    val x10211 = withCtrl(x10221) { ReadMem(x10197_d1).name("x10211").srcCtx("lenet_loops.scala:171:14") } // RegRead(x10197)
    val x10212 = withCtrl(x10221) { OpDef(op=FixEql, inputs=List(b5989, Const(0))).name("x10212").srcCtx("lenet_loops.scala:171:14") } // FixEql(b5989,Const(0))
    val x10213 = withCtrl(x10221) { OpDef(op=FixEql, inputs=List(b5990, Const(0))).name("x10213").srcCtx("lenet_loops.scala:171:14") } // FixEql(b5990,Const(0))
    val x10214 = withCtrl(x10221) { OpDef(op=FixEql, inputs=List(b5991, Const(0))).name("x10214").srcCtx("lenet_loops.scala:171:14") } // FixEql(b5991,Const(0))
    val x10215 = withCtrl(x10221) { OpDef(op=BitAnd, inputs=List(x10212, x10213)).name("x10215").srcCtx("lenet_loops.scala:171:14") } // And(x10212,x10213)
    val x10216 = withCtrl(x10221) { OpDef(op=BitAnd, inputs=List(x10215, x10214)).name("x10216").srcCtx("lenet_loops.scala:171:14") } // And(x10215,x10214)
    val x10217 = withCtrl(x10221) { ReduceAccumOp(op=FixAdd, input=x10210, accum=x10211).name("x10217").srcCtx("lenet_loops.scala:171:16") } // FixAdd(x10210,x10211)
    ...
    val x10220_x10197_d0 = withCtrl(x10221) { WriteMem(x10197_d0, x10217).name("x10220_x10197_d0").srcCtx("lenet_loops.scala:171:14") } // RegWrite(x10197,x10217,x10219)
    antiDepsOf(x10220_x10197_d0)=List(x10211)
    val x10220_x10197_d1 = withCtrl(x10221) { WriteMem(x10197_d1, x10217).name("x10220_x10197_d1").srcCtx("lenet_loops.scala:171:14") } // RegWrite(x10197,x10217,x10219)
    antiDepsOf(x10220_x10197_d1)=List(x10211)
    val x10229 = withCtrl(x10230) { UnitController(style=SeqPipe, level=InnerControl).name("x10229").srcCtx("lenet_loops.scala:167:26") } // UnitPipe(List(b5983, b5919, b5444),Block(Const(())))
    ...
    val x10224 = withCtrl(x10229) { LoadBanks(List(x9714_d0_b0), List(b5982, b5918)).name("x10224").srcCtx("lenet_loops.scala:172:73") } // SRAMLoad(x9714,ArrayBuffer(Const(5), Const(128)),List(b5982, b5918),Const(0),x10223)
    val x10225 = withCtrl(x10229) { ReadMem(x10197_d0).name("x10225").srcCtx("lenet_loops.scala:172:58") } // RegRead(x10197)
    val x10226 = withCtrl(x10229) { OpDef(op=FixAdd, inputs=List(x10225, x10224)).name("x10226").srcCtx("lenet_loops.scala:172:64") } // FixAdd(x10225,x10224)
    val x10227 = withCtrl(x10229) { OpDef(op=FixMax, inputs=List(Const(0.0), x10226)).name("x10227").srcCtx("lenet_loops.scala:172:43") } // Max(Const(0),x10226)
    val x10228 = withCtrl(x10229) { StoreBanks(List(List(x10142_d0_b0)), List(b5982, b5918), x10227).name("x10228").srcCtx("lenet_loops.scala:172:38") } // SRAMStore(x10142,ArrayBuffer(Const(5), Const(128)),List(b5982, b5918),Const(0),x10227,x10223)
    val x10232_d0_b0 = withCtrl(x10326) { SRAM(size=32, banking=Strided(banks=16, stride=1)).name("x10232_d0_b0").srcCtx("lenet_loops.scala:179:32:tmp5_SRAM") } // x10232 = SRAMNew(ArrayBuffer(Const(32)))
    isAccum(x10232_d0_b0) = false
    bufferDepthOf(x10232_d0_b0) = 2
    staticDimsOf(x10232_d0_b0) = List(32)
    val x10233_d0_b0 = withCtrl(x10326) { SRAM(size=6400, banking=Strided(banks=16, stride=1)).name("x10233_d0_b0").srcCtx("lenet_loops.scala:180:34:c6_row_SRAM") } // x10233 = SRAMNew(ArrayBuffer(Const(10), Const(5), Const(128)))
    isAccum(x10233_d0_b0) = false
    bufferDepthOf(x10233_d0_b0) = 2
    staticDimsOf(x10233_d0_b0) = List(10, 5, 128)
    val x10234 = withCtrl(x10326) { Counter(min=Const(0), max=Const(10), step=Const(1), par=1).name("x10234").srcCtx("lenet_loops.scala:181:21") } // CounterNew(Const(0),Const(10),Const(1),Const(1))
    val x10235 = withCtrl(x10326) { Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x10235").srcCtx("lenet_loops.scala:181:21") } // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x10236 = withCtrl(x10326) { CounterChain(List(x10234,x10235)).name("x10236").srcCtx("lenet_loops.scala:181:21") } // CounterChainNew(List(x10234, x10235))
    val x10265 = withCtrl(x10326) { LoopController(style=StreamPipe, level=OuterControl, cchain=x10236).name("x10265").srcCtx("lenet_loops.scala:181:21") } // UnrolledForeach(List(b5444),x10236,Block(Const(())),List(List(b6030), List(b6031)),List(List(b6032), List(b6033)))
    ...
    val b10397 = withCtrl(x10265) { StreamOut(field="offset").name("b10397").srcCtx("lenet_loops.scala:181:21") } // x10237 = StreamOutNew(BurstCmdBus)
    isAccum(b10397) = false
    bufferDepthOf(b10397) = 1
    val b10398 = withCtrl(x10265) { StreamOut(field="size").name("b10398").srcCtx("lenet_loops.scala:181:21") } // x10237 = StreamOutNew(BurstCmdBus)
    isAccum(b10398) = false
    bufferDepthOf(b10398) = 1
    val x10238 = withCtrl(x10265) { StreamIn(field="data").name("x10238").srcCtx("lenet_loops.scala:181:21") } // x10238 = StreamInNew(BurstDataBus())
    isAccum(x10238) = false
    bufferDepthOf(x10238) = 1
    val x10254 = withCtrl(x10265) { UnitController(style=SeqPipe, level=InnerControl).name("x10254").srcCtx("lenet_loops.scala:181:21") } // UnitPipe(List(b6032, b6033, b5444),Block(x10253))
    val x10239 = withCtrl(x10254) { b6030 } // FixConvert(b6030,TRUE,_32,_0) (Same Type. No op)
    val x10240 = withCtrl(x10254) { OpDef(op=FixMul, inputs=List(x10239, Const(500))).name("x10240").srcCtx("lenet_loops.scala:181:21") } // FixMul(x10239,Const(500))
    val x10241 = withCtrl(x10254) { b6031 } // FixConvert(b6031,TRUE,_32,_0) (Same Type. No op)
    val x10242 = withCtrl(x10254) { OpDef(op=FixMul, inputs=List(x10241, Const(5))).name("x10242").srcCtx("lenet_loops.scala:181:21") } // FixMul(x10241,Const(5))
    val x10243 = withCtrl(x10254) { Const(0) } // FixConvert(Const(0),TRUE,_32,_0) (Same Type. No op)
    val x10244 = withCtrl(x10254) { OpDef(op=FixAdd, inputs=List(x10240, x10242)).name("x10244").srcCtx("lenet_loops.scala:181:21") } // FixAdd(x10240,x10242)
    val x10245 = withCtrl(x10254) { OpDef(op=FixAdd, inputs=List(x10244, x10243)).name("x10245").srcCtx("lenet_loops.scala:181:21") } // FixAdd(x10244,x10243)
    val x10246 = withCtrl(x10254) { OpDef(op=FixSla, inputs=List(x10245, Const(2))).name("x10246").srcCtx("lenet_loops.scala:181:21") } // FixLsh(x10245,Const(2))
    val x10247 = withCtrl(x10254) { x10246 } // FixConvert(x10246,TRUE,_64,_0)
    val x10248 = withCtrl(x10254) { DramAddress(x9564).name("x10248").srcCtx("lenet_loops.scala:181:21") } // GetDRAMAddress(x9564)
    val x10250_x10249 = withCtrl(x10254) { OpDef(op=FixAdd, inputs=List(x10247, x10248)).name("x10250_x10249").srcCtx("lenet_loops.scala:181:21") } // FixAdd(x10247,x10248)
    ...
    val x10253_b10399_b10397 = withCtrl(x10254) { WriteMem(b10397, x10250_x10249).name("x10253_b10399_b10397").srcCtx("lenet_loops.scala:181:21") } // StreamWrite(x10237,x10250,x10252)
    val x10253_b10400_b10398 = withCtrl(x10254) { WriteMem(b10398, Const(512)).name("x10253_b10400_b10398").srcCtx("lenet_loops.scala:181:21") } // StreamWrite(x10237,x10250,x10252)
    val x10255 = withCtrl(x10265) { FringeDenseLoad(dram=List(x9564), cmdStream=List(b10397, b10398), dataStream=List(x10238)).name("x10255").srcCtx("lenet_loops.scala:181:21") } // FringeDenseLoad(x9564,x10237,x10238)
    val x10256 = withCtrl(x10265) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x10256").srcCtx("lenet_loops.scala:181:21") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    val x10257 = withCtrl(x10265) { CounterChain(List(x10256)).name("x10257").srcCtx("lenet_loops.scala:181:21") } // CounterChainNew(List(x10256))
    val x10264 = withCtrl(x10265) { LoopController(style=InnerPipe, level=InnerControl, cchain=x10257).name("x10264").srcCtx("lenet_loops.scala:181:21") } // UnrolledForeach(List(b6032, b6033, b5444),x10257,Block(Const(())),List(List(b6055)),List(List(b6056)))
    ...
    val x10261_x10261 = withCtrl(x10264) { ReadMem(x10238).name("x10261_x10261").srcCtx("lenet_loops.scala:181:21") } // ParStreamRead(x10238,List(x10260))
    val x10262_x10262 = withCtrl(x10264) { x10261_x10261 } // VectorApply(x10261,0)
    val x10263 = withCtrl(x10264) { StoreBanks(List(List(x10233_d0_b0)), List(b6030, b6031, b6055), x10262_x10262).name("x10263").srcCtx("lenet_loops.scala:181:21") } // ParSRAMStore(x10233,List(List(b6030, b6031, b6055)),List(x10262),List(x10260))
    val x10266 = withCtrl(x10326) { Counter(min=Const(0), max=Const(10), step=Const(1), par=1).name("x10266").srcCtx("lenet_loops.scala:182:25") } // CounterNew(Const(0),Const(10),Const(1),Const(1))
    val x10267 = withCtrl(x10326) { CounterChain(List(x10266)).name("x10267").srcCtx("lenet_loops.scala:182:38") } // CounterChainNew(List(x10266))
    val x10293 = withCtrl(x10326) { LoopController(style=MetaPipe, level=OuterControl, cchain=x10267).name("x10293").srcCtx("lenet_loops.scala:182:38") } // UnrolledForeach(List(b5444),x10267,Block(Const(())),List(List(b6067)),List(List(b6068)))
    ...
    val x10268_d0 = withCtrl(x10293) { Reg(init=Some(0.0)).name("x10268_d0").srcCtx("lenet_loops.scala:183:35:prod") } // x10268 = RegNew(Const(0))
    isAccum(x10268_d0) = false
    bufferDepthOf(x10268_d0) = 2
    val x10268_d1 = withCtrl(x10293) { Reg(init=Some(0.0)).name("x10268_d1").srcCtx("lenet_loops.scala:183:35:prod") } // x10268 = RegNew(Const(0))
    isAccum(x10268_d1) = true
    bufferDepthOf(x10268_d1) = 1
    val x10269 = withCtrl(x10293) { Counter(min=Const(0), max=Const(128), step=Const(16), par=1).name("x10269").srcCtx("lenet_loops.scala:183:58") } // CounterNew(Const(0),Const(128),Const(16),Const(1))
    val x10270 = withCtrl(x10293) { Counter(min=Const(0), max=Const(5), step=Const(1), par=1).name("x10270").srcCtx("lenet_loops.scala:183:48") } // CounterNew(Const(0),Const(5),Const(1),Const(1))
    val x10271 = withCtrl(x10293) { CounterChain(List(x10270,x10269)).name("x10271").srcCtx("lenet_loops.scala:185:12") } // CounterChainNew(List(x10270, x10269))
    val x10286 = withCtrl(x10293) { LoopController(style=InnerPipe, level=InnerControl, cchain=x10271).name("x10286").srcCtx("lenet_loops.scala:185:12") } // UnrolledReduce(List(b6068, b5444),x10271,x10268,Block((x10268) => Const(())),List(List(b6073), List(b6074)),List(List(b6075), List(b6076)))
    ...
    val x10275 = withCtrl(x10286) { LoadBanks(List(x10142_d0_b0), List(b6073, b6074)).name("x10275").srcCtx("lenet_loops.scala:184:22") } // ParSRAMLoad(x10142,List(List(b6073, b6074)),List(x10274))
    val x10276 = withCtrl(x10286) { x10275 } // VectorApply(x10275,0)
    val x10277 = withCtrl(x10286) { LoadBanks(List(x10233_d0_b0), List(b6067, b6073, b6074)).name("x10277").srcCtx("lenet_loops.scala:184:47") } // ParSRAMLoad(x10233,List(List(b6067, b6073, b6074)),List(x10274))
    val x10278 = withCtrl(x10286) { x10277 } // VectorApply(x10277,0)
    val x10279 = withCtrl(x10286) { OpDef(op=FixMul, inputs=List(x10276, x10278)).name("x10279").srcCtx("lenet_loops.scala:184:34") } // FixMul(x10276,x10278)
    val x10280 = withCtrl(x10286) { ReadMem(x10268_d1).name("x10280").srcCtx("lenet_loops.scala:185:12") } // RegRead(x10268)
    val x10281 = withCtrl(x10286) { OpDef(op=FixEql, inputs=List(b6073, Const(0))).name("x10281").srcCtx("lenet_loops.scala:185:12") } // FixEql(b6073,Const(0))
    val x10282 = withCtrl(x10286) { OpDef(op=FixEql, inputs=List(b6074, Const(0))).name("x10282").srcCtx("lenet_loops.scala:185:12") } // FixEql(b6074,Const(0))
    val x10283 = withCtrl(x10286) { OpDef(op=BitAnd, inputs=List(x10281, x10282)).name("x10283").srcCtx("lenet_loops.scala:185:12") } // And(x10281,x10282)
    val x10284 = withCtrl(x10286) { ReduceAccumOp(op=FixAdd, input=x10279, accum=x10280).name("x10284").srcCtx("lenet_loops.scala:185:14") } // FixAdd(x10279,x10280)
    val x10285_x10268_d0 = withCtrl(x10286) { WriteMem(x10268_d0, x10284).name("x10285_x10268_d0").srcCtx("lenet_loops.scala:185:12") } // RegWrite(x10268,x10284,x10273)
    antiDepsOf(x10285_x10268_d0)=List(x10280)
    val x10285_x10268_d1 = withCtrl(x10286) { WriteMem(x10268_d1, x10284).name("x10285_x10268_d1").srcCtx("lenet_loops.scala:185:12") } // RegWrite(x10268,x10284,x10273)
    antiDepsOf(x10285_x10268_d1)=List(x10280)
    val x10292 = withCtrl(x10293) { UnitController(style=SeqPipe, level=InnerControl).name("x10292").srcCtx("lenet_loops.scala:182:38") } // UnitPipe(List(b6068, b5444),Block(Const(())))
    ...
    val x10288 = withCtrl(x10292) { LoadBanks(List(x9739_d0_b0), List(b6067)).name("x10288").srcCtx("lenet_loops.scala:186:50") } // SRAMLoad(x9739,ArrayBuffer(Const(32)),List(b6067),Const(0),x10287)
    val x10289 = withCtrl(x10292) { ReadMem(x10268_d0).name("x10289").srcCtx("lenet_loops.scala:186:35") } // RegRead(x10268)
    val x10290 = withCtrl(x10292) { OpDef(op=FixAdd, inputs=List(x10289, x10288)).name("x10290").srcCtx("lenet_loops.scala:186:41") } // FixAdd(x10289,x10288)
    val x10291 = withCtrl(x10292) { StoreBanks(List(List(x10232_d0_b0)), List(b6067), x10290).name("x10291").srcCtx("lenet_loops.scala:186:28") } // SRAMStore(x10232,ArrayBuffer(Const(32)),List(b6067),Const(0),x10290,x10287)
    val x10294 = withCtrl(x10326) { Counter(min=Const(0), max=Const(1), step=Const(1), par=1).name("x10294").srcCtx("lenet_loops.scala:191:44") } // CounterNew(Const(0),Const(1),Const(1),Const(1))
    val x10295 = withCtrl(x10326) { CounterChain(List(x10294)).name("x10295").srcCtx("lenet_loops.scala:191:44") } // CounterChainNew(List(x10294))
    val x10325 = withCtrl(x10326) { LoopController(style=StreamPipe, level=OuterControl, cchain=x10295).name("x10325").srcCtx("lenet_loops.scala:191:44") } // UnrolledForeach(List(b5444),x10295,Block(Const(())),List(List(b6101)),List(List(b6102)))
    ...
    val b10401 = withCtrl(x10325) { StreamOut(field="offset").name("b10401").srcCtx("lenet_loops.scala:191:44") } // x10296 = StreamOutNew(BurstCmdBus)
    isAccum(b10401) = false
    bufferDepthOf(b10401) = 1
    val b10402 = withCtrl(x10325) { StreamOut(field="size").name("b10402").srcCtx("lenet_loops.scala:191:44") } // x10296 = StreamOutNew(BurstCmdBus)
    isAccum(b10402) = false
    bufferDepthOf(b10402) = 1
    val x10297 = withCtrl(x10325) { StreamOut(field="data").name("x10297").srcCtx("lenet_loops.scala:191:44") } // x10297 = StreamOutNew(BurstFullDataBus())
    isAccum(x10297) = false
    bufferDepthOf(x10297) = 1
    val x10298 = withCtrl(x10325) { StreamIn(field="ack").name("x10298").srcCtx("lenet_loops.scala:191:44") } // x10298 = StreamInNew(BurstAckBus)
    isAccum(x10298) = false
    bufferDepthOf(x10298) = 1
    val x10311 = withCtrl(x10325) { UnitController(style=SeqPipe, level=InnerControl).name("x10311").srcCtx("lenet_loops.scala:191:44") } // UnitPipe(List(b6102, b5444),Block(x10310))
    val x10299 = withCtrl(x10311) { OpDef(op=FixAdd, inputs=List(b5443, b6101)).name("x10299").srcCtx("lenet_loops.scala:191:44") } // FixAdd(b5443,b6101)
    val x10300 = withCtrl(x10311) { x10299 } // FixConvert(x10299,TRUE,_32,_0) (Same Type. No op)
    val x10301 = withCtrl(x10311) { OpDef(op=FixSla, inputs=List(x10300, Const(5))).name("x10301").srcCtx("lenet_loops.scala:191:44") } // FixLsh(x10300,Const(5))
    val x10302 = withCtrl(x10311) { Const(0) } // FixConvert(Const(0),TRUE,_32,_0) (Same Type. No op)
    val x10303 = withCtrl(x10311) { OpDef(op=FixAdd, inputs=List(x10301, x10302)).name("x10303").srcCtx("lenet_loops.scala:191:44") } // FixAdd(x10301,x10302)
    val x10304 = withCtrl(x10311) { OpDef(op=FixSla, inputs=List(x10303, Const(2))).name("x10304").srcCtx("lenet_loops.scala:191:44") } // FixLsh(x10303,Const(2))
    val x10305 = withCtrl(x10311) { x10304 } // FixConvert(x10304,TRUE,_64,_0)
    val x10306 = withCtrl(x10311) { DramAddress(x9566).name("x10306").srcCtx("lenet_loops.scala:191:44") } // GetDRAMAddress(x9566)
    val x10308_x10307 = withCtrl(x10311) { OpDef(op=FixAdd, inputs=List(x10305, x10306)).name("x10308_x10307").srcCtx("lenet_loops.scala:191:44") } // FixAdd(x10305,x10306)
    ...
    val x10310_b10403_b10401 = withCtrl(x10311) { WriteMem(b10401, x10308_x10307).name("x10310_b10403_b10401").srcCtx("lenet_loops.scala:191:44") } // StreamWrite(x10296,x10308,x10309)
    val x10310_b10404_b10402 = withCtrl(x10311) { WriteMem(b10402, Const(128)).name("x10310_b10404_b10402").srcCtx("lenet_loops.scala:191:44") } // StreamWrite(x10296,x10308,x10309)
    val x10312 = withCtrl(x10325) { Counter(min=Const(0), max=Const(32), step=Const(1), par=16).name("x10312").srcCtx("lenet_loops.scala:191:44") } // CounterNew(Const(0),Const(32),Const(1),Const(16))
    def split2 = {
    val x10313 = withCtrl(x10325) { CounterChain(List(x10312)).name("x10313").srcCtx("lenet_loops.scala:191:44") } // CounterChainNew(List(x10312))
    val x10320 = withCtrl(x10325) { LoopController(style=InnerPipe, level=InnerControl, cchain=x10313).name("x10320").srcCtx("lenet_loops.scala:191:44") } // UnrolledForeach(List(b6102, b5444),x10313,Block(Const(())),List(List(b6121)),List(List(b6122)))
    ...
    val x10316 = withCtrl(x10320) { LoadBanks(List(x10232_d0_b0), List(b6121)).name("x10316").srcCtx("lenet_loops.scala:191:44") } // ParSRAMLoad(x10232,List(List(b6121)),List(x10315))
    val x10318_x10317 = withCtrl(x10320) { x10316 } // VectorApply(x10316,0)
    // x10318 = SimpleStruct(ArrayBuffer((_1,x10317), (_2,Const(true))))
    val x10319_x10319_x10297 = withCtrl(x10320) { WriteMem(x10297, x10318_x10317).name("x10319_x10319_x10297").srcCtx("lenet_loops.scala:191:44") } // ParStreamWrite(x10297,List(x10318),List(x10315))
    val x10321 = withCtrl(x10325) { FringeDenseStore(dram=List(x9566), cmdStream=List(b10401, b10402), dataStream=List(x10297), ackStream=List(x10298)).name("x10321").srcCtx("lenet_loops.scala:191:44") } // FringeDenseStore(x9566,x10296,x10297,x10298)
    val x10324 = withCtrl(x10325) { UnitController(style=SeqPipe, level=InnerControl).name("x10324").srcCtx("lenet_loops.scala:191:44") } // UnitPipe(List(b6102, b5444),Block(Const(())))
    ...
    val x10323_x10323 = withCtrl(x10324) { ReadMem(x10298).name("x10323_x10323").srcCtx("lenet_loops.scala:191:44") } // StreamRead(x10298,x10322)
    }; split2
    }; split1
