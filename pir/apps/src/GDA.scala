...
object GDA extends PIRApp {
  def main(top:Top) = {
    ...
    val b4415 = WriteMems(List(b4412), x4060).name("b4415").ctrl(x4063) // StreamWrite(x4053,x4061,Const(true))
    val b4416 = WriteMems(List(b4413), Const(384)).name("b4416").ctrl(x4063) // StreamWrite(x4053,x4061,Const(true))
    ...
    val b4417 = ReadMem(b4414).name("b4417").ctrl(x4070) // ParStreamRead(x4054,List(b2103))
    ...
    val b4422 = WriteMems(List(b4419), x4079).name("b4422").ctrl(x4082) // StreamWrite(x4072,x4080,Const(true))
    val b4423 = WriteMems(List(b4420), Const(384)).name("b4423").ctrl(x4082) // StreamWrite(x4072,x4080,Const(true))
    ...
    val b4424 = ReadMem(b4421).name("b4424").ctrl(x4089) // ParStreamRead(x4073,List(b2124))
    ...
    val b4429 = WriteMems(List(b4426), x4110).name("b4429").ctrl(x4113) // StreamWrite(x4103,x4111,b2140)
    val b4430 = WriteMems(List(b4427), Const(80)).name("b4430").ctrl(x4113) // StreamWrite(x4103,x4111,b2140)
    ...
    val b4431 = ReadMem(b4428).name("b4431").ctrl(x4121) // ParStreamRead(x4104,List(x4117))
    ...
    val b4436 = WriteMems(List(b4433), x4136).name("b4436").ctrl(x4140) // StreamWrite(x4125,x4137,x4138)
    val b4437 = WriteMems(List(b4434), Const(384)).name("b4437").ctrl(x4140) // StreamWrite(x4125,x4137,x4138)
    ...
    val b4438 = ReadMem(b4435).name("b4438").ctrl(x4149) // ParStreamRead(x4126,List(x4145))
    ...
    val x4154 = WriteMems(List(x4099), x4153).name("x4154").ctrl(x4155) // RegWrite(x4099,x4153,b2140)
    ...
    val b4443 = WriteMems(List(b4440), x4165).name("b4443").ctrl(x4168) // StreamWrite(x4158,x4166,b2141)
    val b4444 = WriteMems(List(b4441), Const(80)).name("b4444").ctrl(x4168) // StreamWrite(x4158,x4166,b2141)
    ...
    val b4445 = ReadMem(b4442).name("b4445").ctrl(x4176) // ParStreamRead(x4159,List(x4172))
    ...
    val b4450 = WriteMems(List(b4447), x4191).name("b4450").ctrl(x4195) // StreamWrite(x4180,x4192,x4193)
    val b4451 = WriteMems(List(b4448), Const(384)).name("b4451").ctrl(x4195) // StreamWrite(x4180,x4192,x4193)
    ...
    val b4452 = ReadMem(b4449).name("b4452").ctrl(x4204) // ParStreamRead(x4181,List(x4200))
    ...
    val x4209 = WriteMems(List(x4100), x4208).name("x4209").ctrl(x4210) // RegWrite(x4100,x4208,b2141)
    ...
    val b4458 = WriteMems(List(b4454), x4344).name("b4458").ctrl(x4347) // StreamWrite(x4333,x4345,b2422)
    val b4459 = WriteMems(List(b4455), Const(384)).name("b4459").ctrl(x4347) // StreamWrite(x4333,x4345,b2422)
    ...
    val b4460 = WriteMems(List(b4456), x4352).name("b4460").ctrl(x4355) // ParStreamWrite(x4334,List(x4353),List(x4350))
    ...
    val b4461 = ReadMem(b4457).name("b4461").ctrl(x4358) // StreamRead(x4335,b2422)
