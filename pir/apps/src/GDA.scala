...
object GDA extends PIRApp {
  def main(top:Top) = {
    ...
    val x4069 = StoreBanks(List(x4051_d0_b0, x4051_d1_b0), List(b2102), b4418).name("x4069").ctrl(x4070) // ParSRAMStore(x4051,List(List(b2102)),List(x4068),List(b2103))
    ...
    val x4088 = StoreBanks(List(x4052_d0_b0, x4052_d1_b0), List(b2123), b4425).name("x4088").ctrl(x4089) // ParSRAMStore(x4052,List(List(b2123)),List(x4087),List(b2124))
    ...
    val x4120 = StoreBanks(List(x4095_d0_b0), List(b2164), b4432).name("x4120").ctrl(x4121) // ParSRAMStore(x4095,List(List(b2164)),List(x4119),List(x4117))
    ...
    val x4148 = StoreBanks(List(x4097_d0_b0), List(b2174, b2195), b4439).name("x4148").ctrl(x4149) // ParSRAMStore(x4097,List(List(b2174, b2195)),List(x4147),List(x4145))
    ...
    val x4175 = StoreBanks(List(x4096_d0_b0), List(b2226), b4446).name("x4175").ctrl(x4176) // ParSRAMStore(x4096,List(List(b2226)),List(x4174),List(x4172))
    ...
    val x4203 = StoreBanks(List(x4098_d0_b0), List(b2236, b2257), b4453).name("x4203").ctrl(x4204) // ParSRAMStore(x4098,List(List(b2236, b2257)),List(x4202),List(x4200))
