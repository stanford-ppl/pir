...
object GDA extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x3162 = withCtrl(design.top.topController) { DRAM(dims=List(x3161, Const(128))).name("x3162").srcCtx("GDA.scala:25:20:x") } // x3162 = DRAMNew(ArrayBuffer(x3161, Const(128)),Const(0))
    ...
    val x3165 = withCtrl(design.top.topController) { DRAM(dims=List(Const(128))).name("x3165").srcCtx("GDA.scala:27:22:mu0") } // x3165 = DRAMNew(ArrayBuffer(Const(128)),Const(0))
    val x3166 = withCtrl(design.top.topController) { DRAM(dims=List(Const(128))).name("x3166").srcCtx("GDA.scala:28:22:mu1") } // x3166 = DRAMNew(ArrayBuffer(Const(128)),Const(0))
    val x3167 = withCtrl(design.top.topController) { DRAM(dims=List(Const(128), Const(128))).name("x3167").srcCtx("GDA.scala:29:24:sigma") } // x3167 = DRAMNew(ArrayBuffer(Const(128), Const(128)),Const(0))
    ...
    val x3172_d0_b0 = withCtrl(x3359) { SRAM(size=128, banking=Strided(banks=16, stride=1)).name("x3172_d0_b0").srcCtx("GDA.scala:37:28:mu0Tile") } // x3172 = SRAMNew(ArrayBuffer(Const(128)))
    isAccum(x3172_d0_b0) = false
    bufferDepthOf(x3172_d0_b0) = 1
    staticDimsOf(x3172_d0_b0) = List(128)
    val x3173_d0_b0 = withCtrl(x3359) { SRAM(size=128, banking=Strided(banks=16, stride=1)).name("x3173_d0_b0").srcCtx("GDA.scala:38:28:mu1Tile") } // x3173 = SRAMNew(ArrayBuffer(Const(128)))
    ...
    val x3182_b3414_b3412 = withCtrl(x3183) { WriteMem(b3412, Const(512)).name("x3182_b3414_b3412").srcCtx("GDA.scala:40:17") } // StreamWrite(x3174,x3181,Const(true))
    ...
    val x3185 = withCtrl(x3191) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3185").srcCtx("GDA.scala:40:17") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    ...
    val x3200_b3418_b3416 = withCtrl(x3201) { WriteMem(b3416, Const(512)).name("x3200_b3418_b3416").srcCtx("GDA.scala:41:17") } // StreamWrite(x3192,x3199,Const(true))
    ...
    val x3203 = withCtrl(x3209) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3203").srcCtx("GDA.scala:41:17") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    ...
    val x3211_d0_b0 = withCtrl(x3359) { SRAM(size=16384, banking=Strided(banks=16, stride=1)).name("x3211_d0_b0").srcCtx("GDA.scala:44:29:sigmaOut") } // x3211 = SRAMNew(ArrayBuffer(Const(128), Const(128)))
    isAccum(x3211_d0_b0) = false
    bufferDepthOf(x3211_d0_b0) = 1
    staticDimsOf(x3211_d0_b0) = List(128, 128)
    val x3211_d1_b0 = withCtrl(x3359) { SRAM(size=16384, banking=Strided(banks=1, stride=128)).name("x3211_d1_b0").srcCtx("GDA.scala:44:29:sigmaOut") } // x3211 = SRAMNew(ArrayBuffer(Const(128), Const(128)))
    isAccum(x3211_d1_b0) = true
    bufferDepthOf(x3211_d1_b0) = 1
    staticDimsOf(x3211_d1_b0) = List(128, 128)
    val x3212 = withCtrl(x3359) { ReadMem(x3159).name("x3212").srcCtx("GDA.scala:46:27") } // RegRead(x3159)
    val x3213 = withCtrl(x3359) { Counter(min=Const(0), max=x3212, step=Const(32), par=1).name("x3213").srcCtx("GDA.scala:46:35") } // CounterNew(Const(0),x3212,Const(32),Const(1))
    ...
    val x3216_d0_b0 = withCtrl(x3330) { SRAM(size=4096, banking=Strided(banks=16, stride=1)).name("x3216_d0_b0").srcCtx("GDA.scala:48:31:gdaXtile") } // x3216 = SRAMNew(ArrayBuffer(Const(32), Const(128)))
    ...
    val x3244 = withCtrl(x3254) { OpDef(op=FixSla, inputs=List(x3243, Const(7))).name("x3244").srcCtx("GDA.scala:52:20") } // FixLsh(x3243,Const(7))
    ...
    val x3253_b3426_b3424 = withCtrl(x3254) { WriteMem(b3424, Const(512)).name("x3253_b3426_b3424").srcCtx("GDA.scala:52:20") } // StreamWrite(x3240,x3251,x3252)
    ...
    val x3256 = withCtrl(x3264) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3256").srcCtx("GDA.scala:52:20") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    ...
    val x3266_d0_b0 = withCtrl(x3330) { SRAM(size=16384, banking=Strided(banks=1, stride=128)).name("x3266_d0_b0").srcCtx("GDA.scala:55:31:sigmaBlk") } // x3266 = SRAMNew(ArrayBuffer(Const(128), Const(128)))
    isAccum(x3266_d0_b0) = false
    bufferDepthOf(x3266_d0_b0) = 2
    staticDimsOf(x3266_d0_b0) = List(128, 128)
    val x3266_d1_b0 = withCtrl(x3330) { SRAM(size=16384, banking=Strided(banks=1, stride=128)).name("x3266_d1_b0").srcCtx("GDA.scala:55:31:sigmaBlk") } // x3266 = SRAMNew(ArrayBuffer(Const(128), Const(128)))
    isAccum(x3266_d1_b0) = true
    bufferDepthOf(x3266_d1_b0) = 1
    staticDimsOf(x3266_d1_b0) = List(128, 128)
    val x3267 = withCtrl(x3330) { Counter(min=Const(0), max=Const(32), step=Const(1), par=1).name("x3267").srcCtx("GDA.scala:57:32") } // CounterNew(Const(0),Const(32),Const(1),Const(1))
    ...
    val x3269_d0_b0 = withCtrl(x3315) { SRAM(size=128, banking=Strided(banks=16, stride=1)).name("x3269_d0_b0").srcCtx("GDA.scala:58:32:subTile") } // x3269 = SRAMNew(ArrayBuffer(Const(128)))
    isAccum(x3269_d0_b0) = false
    bufferDepthOf(x3269_d0_b0) = 2
    staticDimsOf(x3269_d0_b0) = List(128)
    val x3269_d1_b0 = withCtrl(x3315) { SRAM(size=128, banking=Strided(banks=16, stride=1)).name("x3269_d1_b0").srcCtx("GDA.scala:58:32:subTile") } // x3269 = SRAMNew(ArrayBuffer(Const(128)))
    isAccum(x3269_d1_b0) = false
    bufferDepthOf(x3269_d1_b0) = 2
    staticDimsOf(x3269_d1_b0) = List(128)
    val x3270_d0_b0 = withCtrl(x3315) { SRAM(size=16384, banking=Strided(banks=16, stride=1)).name("x3270_d0_b0").srcCtx("GDA.scala:59:34:sigmaTile") } // x3270 = SRAMNew(ArrayBuffer(Const(128), Const(128)))
    isAccum(x3270_d0_b0) = false
    bufferDepthOf(x3270_d0_b0) = 2
    staticDimsOf(x3270_d0_b0) = List(128, 128)
    val x3271 = withCtrl(x3315) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3271").srcCtx("GDA.scala:60:21") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    ...
    val x3287 = withCtrl(x3315) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3287").srcCtx("GDA.scala:63:29") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    val x3288 = withCtrl(x3315) { Counter(min=Const(0), max=Const(128), step=Const(1), par=1).name("x3288").srcCtx("GDA.scala:63:21") } // CounterNew(Const(0),Const(128),Const(1),Const(1))
    ...
    val x3293 = withCtrl(x3298) { LoadBanks(List(x3269_d1_b0), List(b1997)).name("x3293").srcCtx("GDA.scala:64:40") } // SRAMLoad(x3269,ArrayBuffer(Const(128)),List(b1997),Const(0),x3292)
    ...
    val x3299 = withCtrl(x3315) { Counter(min=Const(0), max=Const(128), step=Const(1), par=1).name("x3299").srcCtx("GDA.scala:67:10") } // CounterNew(Const(0),Const(128),Const(1),Const(1))
    val x3300 = withCtrl(x3315) { Counter(min=Const(0), max=Const(128), step=Const(1), par=1).name("x3300").srcCtx("GDA.scala:67:10") } // CounterNew(Const(0),Const(128),Const(1),Const(1))
    ...
    val x3316 = withCtrl(x3330) { Counter(min=Const(0), max=Const(128), step=Const(1), par=1).name("x3316").srcCtx("GDA.scala:68:8") } // CounterNew(Const(0),Const(128),Const(1),Const(1))
    val x3317 = withCtrl(x3330) { Counter(min=Const(0), max=Const(128), step=Const(1), par=1).name("x3317").srcCtx("GDA.scala:68:8") } // CounterNew(Const(0),Const(128),Const(1),Const(1))
    ...
    val x3331 = withCtrl(x3359) { Counter(min=Const(0), max=Const(128), step=Const(1), par=1).name("x3331").srcCtx("GDA.scala:70:36") } // CounterNew(Const(0),Const(128),Const(1),Const(1))
    ...
    val x3337 = withCtrl(x3346) { OpDef(op=FixSla, inputs=List(x3336, Const(7))).name("x3337").srcCtx("GDA.scala:70:36") } // FixLsh(x3336,Const(7))
    ...
    val x3345_b3430_b3428 = withCtrl(x3346) { WriteMem(b3428, Const(512)).name("x3345_b3430_b3428").srcCtx("GDA.scala:70:36") } // StreamWrite(x3333,x3344,b2047)
    val x3347 = withCtrl(x3358) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3347").srcCtx("GDA.scala:70:36") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
