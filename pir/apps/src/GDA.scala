...
object GDA extends PIRApp {
  def main(top:Top) = {
    ...
    val x4258 = AccumOp(op=FixAdd, input=x4252, accum=x4254).name("x4258").ctrl(x4260) // FixAdd(x4252,x4254)
    ...
    val x4307 = AccumOp(op=FixAdd, input=x4301, accum=x4303).name("x4307").ctrl(x4309) // FixAdd(x4301,x4303)
    ...
    val x4327 = AccumOp(op=FixAdd, input=x4324, accum=x4320).name("x4327").ctrl(x4329) // FixAdd(x4324,x4320)
