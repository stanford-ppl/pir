...
object GDA extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x4061_x4060 = x4059 // FixConvert(x4059,TRUE,_64,_0)
    // x4061 = SimpleStruct(ArrayBuffer((offset,x4060), (size,Const(384)), (isLoad,Const(true))))
    val b4414_b4412 = WriteMem(b4412, x4061_x4060).name("b4414_b4412").ctrl(x4063) // StreamWrite(x4053,x4061,Const(true))
    ...
    val x4065 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16).name("x4065").ctrl(x4071) // CounterNew(Const(0),Const(96),Const(1),Const(16))
    ...
    val x4067_x4067 = ReadMem(x4054).name("x4067").ctrl(x4070) // ParStreamRead(x4054,List(b2103))
    val x4068_x4068 = x4067_x4067 // x4068 = VectorApply(x4067,0)
    val x4069 = StoreBanks(List(x4051_d0_b0, x4051_d1_b0), List(b2102), x4068_x4068).name("x4069").ctrl(x4070) // ParSRAMStore(x4051,List(List(b2102)),List(x4068),List(b2103))
    ...
    val x4080_x4079 = x4078 // FixConvert(x4078,TRUE,_64,_0)
    // x4080 = SimpleStruct(ArrayBuffer((offset,x4079), (size,Const(384)), (isLoad,Const(true))))
    val b4418_b4416 = WriteMem(b4416, x4080_x4079).name("b4418_b4416").ctrl(x4082) // StreamWrite(x4072,x4080,Const(true))
    ...
    val x4084 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16).name("x4084").ctrl(x4090) // CounterNew(Const(0),Const(96),Const(1),Const(16))
    ...
    val x4086_x4086 = ReadMem(x4073).name("x4086").ctrl(x4089) // ParStreamRead(x4073,List(b2124))
    val x4087_x4087 = x4086_x4086 // x4087 = VectorApply(x4086,0)
    val x4088 = StoreBanks(List(x4052_d0_b0, x4052_d1_b0), List(b2123), x4087_x4087).name("x4088").ctrl(x4089) // ParSRAMStore(x4052,List(List(b2123)),List(x4087),List(b2124))
    ...
    val x4093 = Counter(min=Const(0), max=x4092, step=Const(20), par=2).name("x4093").ctrl(x4360) // CounterNew(Const(0),x4092,Const(20),Const(2))
    ...
    val x4111_x4110 = x4109 // FixConvert(x4109,TRUE,_64,_0)
    // x4111 = SimpleStruct(ArrayBuffer((offset,x4110), (size,Const(80)), (isLoad,Const(true))))
    val b4422_b4420 = WriteMem(b4420, x4111_x4110).name("b4422_b4420").ctrl(x4113) // StreamWrite(x4103,x4111,b2140)
    ...
    val x4115 = Counter(min=Const(0), max=Const(20), step=Const(1), par=16).name("x4115").ctrl(x4122) // CounterNew(Const(0),Const(20),Const(1),Const(16))
    ...
    val x4118_x4118 = ReadMem(x4104).name("x4118").ctrl(x4121) // ParStreamRead(x4104,List(x4117))
    val x4119_x4119 = x4118_x4118 // x4119 = VectorApply(x4118,0)
    val x4120 = StoreBanks(List(x4095_d0_b0), List(b2164), x4119_x4119).name("x4120").ctrl(x4121) // ParSRAMStore(x4095,List(List(b2164)),List(x4119),List(x4117))
    val x4123 = Counter(min=Const(0), max=Const(20), step=Const(1), par=1).name("x4123").ctrl(x4330) // CounterNew(Const(0),Const(20),Const(1),Const(1))
    ...
    val x4137_x4136 = x4135 // FixConvert(x4135,TRUE,_64,_0)
    ...
    val b4426_b4424 = WriteMem(b4424, x4137_x4136).name("b4426_b4424").ctrl(x4140) // StreamWrite(x4125,x4137,x4138)
    ...
    val x4142 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16).name("x4142").ctrl(x4150) // CounterNew(Const(0),Const(96),Const(1),Const(16))
    ...
    val x4146_x4146 = ReadMem(x4126).name("x4146").ctrl(x4149) // ParStreamRead(x4126,List(x4145))
    val x4147_x4147 = x4146_x4146 // x4147 = VectorApply(x4146,0)
    val x4148 = StoreBanks(List(x4097_d0_b0), List(b2174, b2195), x4147_x4147).name("x4148").ctrl(x4149) // ParSRAMStore(x4097,List(List(b2174, b2195)),List(x4147),List(x4145))
    ...
    val x4166_x4165 = x4164 // FixConvert(x4164,TRUE,_64,_0)
    // x4166 = SimpleStruct(ArrayBuffer((offset,x4165), (size,Const(80)), (isLoad,Const(true))))
    val b4430_b4428 = WriteMem(b4428, x4166_x4165).name("b4430_b4428").ctrl(x4168) // StreamWrite(x4158,x4166,b2141)
    ...
    val x4170 = Counter(min=Const(0), max=Const(20), step=Const(1), par=16).name("x4170").ctrl(x4177) // CounterNew(Const(0),Const(20),Const(1),Const(16))
    ...
    val x4173_x4173 = ReadMem(x4159).name("x4173").ctrl(x4176) // ParStreamRead(x4159,List(x4172))
    val x4174_x4174 = x4173_x4173 // x4174 = VectorApply(x4173,0)
    val x4175 = StoreBanks(List(x4096_d0_b0), List(b2226), x4174_x4174).name("x4175").ctrl(x4176) // ParSRAMStore(x4096,List(List(b2226)),List(x4174),List(x4172))
    val x4178 = Counter(min=Const(0), max=Const(20), step=Const(1), par=1).name("x4178").ctrl(x4330) // CounterNew(Const(0),Const(20),Const(1),Const(1))
    ...
    val x4192_x4191 = x4190 // FixConvert(x4190,TRUE,_64,_0)
    ...
    val b4434_b4432 = WriteMem(b4432, x4192_x4191).name("b4434_b4432").ctrl(x4195) // StreamWrite(x4180,x4192,x4193)
    ...
    val x4197 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16).name("x4197").ctrl(x4205) // CounterNew(Const(0),Const(96),Const(1),Const(16))
    ...
    val x4201_x4201 = ReadMem(x4181).name("x4201").ctrl(x4204) // ParStreamRead(x4181,List(x4200))
    val x4202_x4202 = x4201_x4201 // x4202 = VectorApply(x4201,0)
    val x4203 = StoreBanks(List(x4098_d0_b0), List(b2236, b2257), x4202_x4202).name("x4203").ctrl(x4204) // ParSRAMStore(x4098,List(List(b2236, b2257)),List(x4202),List(x4200))
    ...
    val x4214 = Counter(min=Const(0), max=x4213, step=Const(1), par=1).name("x4214").ctrl(x4330) // CounterNew(Const(0),x4213,Const(1),Const(1))
    ...
    val x4218 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16).name("x4218").ctrl(x4261) // CounterNew(Const(0),Const(96),Const(1),Const(16))
    ...
    val x4234 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16).name("x4234").ctrl(x4261) // CounterNew(Const(0),Const(96),Const(1),Const(16))
    val x4235 = Counter(min=Const(0), max=Const(96), step=Const(1), par=1).name("x4235").ctrl(x4261) // CounterNew(Const(0),Const(96),Const(1),Const(1))
    ...
    val x4246 = Counter(min=Const(0), max=Const(96), step=Const(1), par=1).name("x4246").ctrl(x4261) // CounterNew(Const(0),Const(96),Const(1),Const(1))
    val x4247 = Counter(min=Const(0), max=Const(96), step=Const(1), par=1).name("x4247").ctrl(x4261) // CounterNew(Const(0),Const(96),Const(1),Const(1))
    ...
    val x4263 = Counter(min=Const(0), max=x4262, step=Const(1), par=1).name("x4263").ctrl(x4330) // CounterNew(Const(0),x4262,Const(1),Const(1))
    ...
    val x4267 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16).name("x4267").ctrl(x4310) // CounterNew(Const(0),Const(96),Const(1),Const(16))
    ...
    val x4283 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16).name("x4283").ctrl(x4310) // CounterNew(Const(0),Const(96),Const(1),Const(16))
    val x4284 = Counter(min=Const(0), max=Const(96), step=Const(1), par=1).name("x4284").ctrl(x4310) // CounterNew(Const(0),Const(96),Const(1),Const(1))
    ...
    val x4295 = Counter(min=Const(0), max=Const(96), step=Const(1), par=1).name("x4295").ctrl(x4310) // CounterNew(Const(0),Const(96),Const(1),Const(1))
    val x4296 = Counter(min=Const(0), max=Const(96), step=Const(1), par=1).name("x4296").ctrl(x4310) // CounterNew(Const(0),Const(96),Const(1),Const(1))
    ...
    val x4311 = Counter(min=Const(0), max=Const(96), step=Const(1), par=1).name("x4311").ctrl(x4330) // CounterNew(Const(0),Const(96),Const(1),Const(1))
    val x4312 = Counter(min=Const(0), max=Const(96), step=Const(1), par=1).name("x4312").ctrl(x4330) // CounterNew(Const(0),Const(96),Const(1),Const(1))
    ...
    val x4331 = Counter(min=Const(0), max=Const(96), step=Const(1), par=1).name("x4331").ctrl(x4360) // CounterNew(Const(0),Const(96),Const(1),Const(1))
    ...
    val x4345_x4344 = x4343 // FixConvert(x4343,TRUE,_64,_0)
    // x4345 = SimpleStruct(ArrayBuffer((offset,x4344), (size,Const(384)), (isLoad,Const(false))))
    val b4438_b4436 = WriteMem(b4436, x4345_x4344).name("b4438_b4436").ctrl(x4347) // StreamWrite(x4333,x4345,b2422)
    val b4439_b4437 = WriteMem(b4437, Const(384)).name("b4439_b4437").ctrl(x4347) // StreamWrite(x4333,x4345,b2422)
    val x4348 = Counter(min=Const(0), max=Const(96), step=Const(1), par=16).name("x4348").ctrl(x4359) // CounterNew(Const(0),Const(96),Const(1),Const(16))
    ...
    val x4353_x4352 = x4351 // x4352 = VectorApply(x4351,0)
    // x4353 = SimpleStruct(ArrayBuffer((_1,x4352), (_2,Const(true))))
    val x4354_x4334 = WriteMem(x4334, x4353_x4352).name("x4354_x4334").ctrl(x4355) // ParStreamWrite(x4334,List(x4353),List(x4350))
    ...
    val x4357_x4357 = ReadMem(x4335).name("x4357").ctrl(x4358) // StreamRead(x4335,b2422)
