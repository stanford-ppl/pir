...
object GDA extends PIRApp {
  def main(top:Top) = {
    ...
    val x4040 = LoadMem(x4038_d0, None).name("x4040").ctrl(top) // RegRead(x4038)
    val x4041 = DRAM().name("x4041").ctrl(top) // x4041 = DRAMNew(ArrayBuffer(x4040, Const(96)),Const(0))
    val x4042 = LoadMem(x4038_d0, None).name("x4042").ctrl(top) // RegRead(x4038)
    ...
    val b4415 = StoreMem(List(b4412), None, x4060).name("b4415").ctrl(x4063) // StreamWrite(x4053,x4061,Const(true))
    val b4416 = StoreMem(List(b4413), None, Const(384)).name("b4416").ctrl(x4063) // StreamWrite(x4053,x4061,Const(true))
    ...
    val b4417 = LoadMem(b4414, None).name("b4417").ctrl(x4070) // ParStreamRead(x4054,List(b2103))
    val b4418 = b4417 // x4068 = VectorApply(x4067,0)
    val x4069 = StoreBanks(List(List(x4051_d0_b0), List(x4051_d1_b0)), List(b2102), b4418).name("x4069").ctrl(x4070) // ParSRAMStore(x4051,List(List(b2102)),List(x4068),List(b2103))
    ...
    val b4422 = StoreMem(List(b4419), None, x4079).name("b4422").ctrl(x4082) // StreamWrite(x4072,x4080,Const(true))
    val b4423 = StoreMem(List(b4420), None, Const(384)).name("b4423").ctrl(x4082) // StreamWrite(x4072,x4080,Const(true))
    ...
    val b4424 = LoadMem(b4421, None).name("b4424").ctrl(x4089) // ParStreamRead(x4073,List(b2124))
    val b4425 = b4424 // x4087 = VectorApply(x4086,0)
    val x4088 = StoreBanks(List(List(x4052_d0_b0), List(x4052_d1_b0)), List(b2123), b4425).name("x4088").ctrl(x4089) // ParSRAMStore(x4052,List(List(b2123)),List(x4087),List(b2124))
    ...
    val x4092 = LoadMem(x4038_d0, None).name("x4092").ctrl(x4360) // RegRead(x4038)
    ...
    val b4429 = StoreMem(List(b4426), None, x4110).name("b4429").ctrl(x4113) // StreamWrite(x4103,x4111,b2140)
    val b4430 = StoreMem(List(b4427), None, Const(80)).name("b4430").ctrl(x4113) // StreamWrite(x4103,x4111,b2140)
    ...
    val b4431 = LoadMem(b4428, None).name("b4431").ctrl(x4121) // ParStreamRead(x4104,List(x4117))
    val b4432 = b4431 // x4119 = VectorApply(x4118,0)
    val x4120 = StoreBanks(List(List(x4095_d0_b0)), List(b2164), b4432).name("x4120").ctrl(x4121) // ParSRAMStore(x4095,List(List(b2164)),List(x4119),List(x4117))
    ...
    val b4436 = StoreMem(List(b4433), None, x4136).name("b4436").ctrl(x4140) // StreamWrite(x4125,x4137,x4138)
    val b4437 = StoreMem(List(b4434), None, Const(384)).name("b4437").ctrl(x4140) // StreamWrite(x4125,x4137,x4138)
    ...
    val b4438 = LoadMem(b4435, None).name("b4438").ctrl(x4149) // ParStreamRead(x4126,List(x4145))
    val b4439 = b4438 // x4147 = VectorApply(x4146,0)
    val x4148 = StoreBanks(List(List(x4097_d0_b0)), List(b2174, b2195), b4439).name("x4148").ctrl(x4149) // ParSRAMStore(x4097,List(List(b2174, b2195)),List(x4147),List(x4145))
    val x4155 = UnitController(style=SeqPipe, level=InnerControl).name("x4155").ctrl(x4330) // UnitPipe(List(b2140),Block(x4154))
    val x4151 = LoadMem(x4038_d0, None).name("x4151").ctrl(x4155) // RegRead(x4038)
    ...
    val x4154 = StoreMem(List(x4099), None, x4153).name("x4154").ctrl(x4155) // RegWrite(x4099,x4153,b2140)
    ...
    val b4443 = StoreMem(List(b4440), None, x4165).name("b4443").ctrl(x4168) // StreamWrite(x4158,x4166,b2141)
    val b4444 = StoreMem(List(b4441), None, Const(80)).name("b4444").ctrl(x4168) // StreamWrite(x4158,x4166,b2141)
    ...
    val b4445 = LoadMem(b4442, None).name("b4445").ctrl(x4176) // ParStreamRead(x4159,List(x4172))
    val b4446 = b4445 // x4174 = VectorApply(x4173,0)
    val x4175 = StoreBanks(List(List(x4096_d0_b0)), List(b2226), b4446).name("x4175").ctrl(x4176) // ParSRAMStore(x4096,List(List(b2226)),List(x4174),List(x4172))
    ...
    val b4450 = StoreMem(List(b4447), None, x4191).name("b4450").ctrl(x4195) // StreamWrite(x4180,x4192,x4193)
    val b4451 = StoreMem(List(b4448), None, Const(384)).name("b4451").ctrl(x4195) // StreamWrite(x4180,x4192,x4193)
    ...
    val b4452 = LoadMem(b4449, None).name("b4452").ctrl(x4204) // ParStreamRead(x4181,List(x4200))
    val b4453 = b4452 // x4202 = VectorApply(x4201,0)
    val x4203 = StoreBanks(List(List(x4098_d0_b0)), List(b2236, b2257), b4453).name("x4203").ctrl(x4204) // ParSRAMStore(x4098,List(List(b2236, b2257)),List(x4202),List(x4200))
    val x4210 = UnitController(style=SeqPipe, level=InnerControl).name("x4210").ctrl(x4330) // UnitPipe(List(b2141),Block(x4209))
    val x4206 = LoadMem(x4038_d0, None).name("x4206").ctrl(x4210) // RegRead(x4038)
    ...
    val x4209 = StoreMem(List(x4100), None, x4208).name("x4209").ctrl(x4210) // RegWrite(x4100,x4208,b2141)
    ...
    val x4213 = LoadMem(x4099, None).name("x4213").ctrl(x4330) // RegRead(x4099)
    ...
    val x4232 = StoreBanks(List(List(x4216_d0_b0), List(x4216_d1_b0)), List(b2293), x4231).name("x4232").ctrl(x4233) // ParSRAMStore(x4216,List(List(b2293)),List(x4231),List(x4221))
    ...
    val x4244 = StoreBanks(List(List(x4217_d0_b0)), List(b2312, b2313), x4243).name("x4244").ctrl(x4245) // ParSRAMStore(x4217,List(List(b2312, b2313)),List(x4243),List(x4239))
    ...
    val x4259 = StoreBanks(List(List(x4211_d0_b0), List(x4211_d1_b0)), List(b2325, b2326), x4258).name("x4259").ctrl(x4260) // ParSRAMStore(x4211,List(ArrayBuffer(b2325, b2326)),List(x4258),List(x4250))
    val x4262 = LoadMem(x4100, None).name("x4262").ctrl(x4330) // RegRead(x4100)
    ...
    val x4281 = StoreBanks(List(List(x4265_d0_b0), List(x4265_d1_b0)), List(b2348), x4280).name("x4281").ctrl(x4282) // ParSRAMStore(x4265,List(List(b2348)),List(x4280),List(x4270))
    ...
    val x4293 = StoreBanks(List(List(x4266_d0_b0)), List(b2367, b2368), x4292).name("x4293").ctrl(x4294) // ParSRAMStore(x4266,List(List(b2367, b2368)),List(x4292),List(x4288))
    ...
    val x4308 = StoreBanks(List(List(x4212_d0_b0), List(x4212_d1_b0)), List(b2380, b2381), x4307).name("x4308").ctrl(x4309) // ParSRAMStore(x4212,List(ArrayBuffer(b2380, b2381)),List(x4307),List(x4299))
    ...
    val x4328 = StoreBanks(List(List(x4091_d0_b0), List(x4091_d1_b0)), List(b2398, b2399), x4327).name("x4328").ctrl(x4329) // ParSRAMStore(x4091,List(ArrayBuffer(b2398, b2399)),List(x4327),List(x4314))
    ...
    val b4458 = StoreMem(List(b4454), None, x4344).name("b4458").ctrl(x4347) // StreamWrite(x4333,x4345,b2422)
    val b4459 = StoreMem(List(b4455), None, Const(384)).name("b4459").ctrl(x4347) // StreamWrite(x4333,x4345,b2422)
    ...
    val b4460 = StoreMem(List(b4456), None, x4352).name("b4460").ctrl(x4355) // ParStreamWrite(x4334,List(x4353),List(x4350))
    ...
    val b4461 = LoadMem(b4457, None).name("b4461").ctrl(x4358) // StreamRead(x4335,b2422)
