...
object GEMM_NCubed extends PIRApp {
  def main(top:Top) = {
    ...
    val b2838 = StoreMem(List(b2835), None, x2695).name("b2838").ctrl(x2698) // StreamWrite(x2685,x2696,b1708)
    val b2839 = StoreMem(List(b2836), None, Const(256)).name("b2839").ctrl(x2698) // StreamWrite(x2685,x2696,b1708)
    ...
    val b2840 = LoadMem(b2837, None).name("b2840").ctrl(x2706) // ParStreamRead(x2686,List(x2702))
    val b2841 = b2840 // x2704 = VectorApply(x2703,0)
    val x2705 = StoreBanks(List(List(x2680_d0_b0)), List(b1707, b1726), b2841).name("x2705").ctrl(x2706) // ParSRAMStore(x2680,List(List(b1707, b1726)),List(x2704),List(x2702))
    ...
    val b2845 = StoreMem(List(b2842), None, x2720).name("b2845").ctrl(x2723) // StreamWrite(x2710,x2721,b1737)
    val b2846 = StoreMem(List(b2843), None, Const(256)).name("b2846").ctrl(x2723) // StreamWrite(x2710,x2721,b1737)
    ...
    val b2847 = LoadMem(b2844, None).name("b2847").ctrl(x2731) // ParStreamRead(x2711,List(x2727))
    val b2848 = b2847 // x2729 = VectorApply(x2728,0)
    val x2730 = StoreBanks(List(List(x2681_d0_b0)), List(b1736, b1755), b2848).name("x2730").ctrl(x2731) // ParSRAMStore(x2681,List(List(b1736, b1755)),List(x2729),List(x2727))
    ...
    val x2747 = LoadMem(x2737_d1, None).name("x2747").ctrl(x2752) // RegRead(x2737)
    ...
    val x2751 = StoreMem(List(x2737_d0, x2737_d1), None, x2749).name("x2751").ctrl(x2752) // RegWrite(x2737,x2749,x2750)
    val x2756 = UnitController(style=SeqPipe, level=InnerControl).name("x2756").ctrl(x2757) // UnitPipe(List(b1770, b1766),Block(Const(())))
    val x2753 = LoadMem(x2737_d0, None).name("x2753").ctrl(x2756) // RegRead(x2737)
    val x2754 = OpDef(op=BitAnd, inputs=List(b1770, b1766)).name("x2754").ctrl(x2756) // And(b1770,b1766)
    val x2755 = StoreBanks(List(List(x2682_d0_b0)), List(b1765, b1769), x2753).name("x2755").ctrl(x2756) // SRAMStore(x2682,ArrayBuffer(Const(64), Const(64)),List(b1765, b1769),Const(0),x2753,x2754)
    ...
    val b2853 = StoreMem(List(b2849), None, x2772).name("b2853").ctrl(x2775) // StreamWrite(x2761,x2773,b1798)
    val b2854 = StoreMem(List(b2850), None, Const(256)).name("b2854").ctrl(x2775) // StreamWrite(x2761,x2773,b1798)
    ...
    val b2855 = StoreMem(List(b2851), None, x2780).name("b2855").ctrl(x2783) // ParStreamWrite(x2762,List(x2781),List(x2778))
    ...
    val b2856 = LoadMem(b2852, None).name("b2856").ctrl(x2786) // StreamRead(x2763,b1798)
