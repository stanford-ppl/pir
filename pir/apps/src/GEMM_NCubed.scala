...
object GEMM_NCubed extends PIRApp {
  def main(top:Top) = {
    ...
    val b2837_b2835 = WriteMem(b2835, x2695).name("b2837_b2835").ctrl(x2698) // StreamWrite(x2685,x2696,b1708)
    ...
    val x2703 = ReadMem(x2686).name("x2703").ctrl(x2706) // ParStreamRead(x2686,List(x2702))
    val x2704 = x2703 // x2704 = VectorApply(x2703,0)
    val x2705 = StoreBanks(List(x2680_d0_b0), List(b1707, b1726), x2704).name("x2705").ctrl(x2706) // ParSRAMStore(x2680,List(List(b1707, b1726)),List(x2704),List(x2702))
    ...
    val b2841_b2839 = WriteMem(b2839, x2720).name("b2841_b2839").ctrl(x2723) // StreamWrite(x2710,x2721,b1737)
    ...
    val x2728 = ReadMem(x2711).name("x2728").ctrl(x2731) // ParStreamRead(x2711,List(x2727))
    val x2729 = x2728 // x2729 = VectorApply(x2728,0)
    val x2730 = StoreBanks(List(x2681_d0_b0), List(b1736, b1755), x2729).name("x2730").ctrl(x2731) // ParSRAMStore(x2681,List(List(b1736, b1755)),List(x2729),List(x2727))
    ...
    val x2749 = AccumOp(op=FixAdd, input=x2746, accum=x2747).name("x2749").ctrl(x2752) // FixAdd(x2746,x2747)
    ...
    val b2845_b2843 = WriteMem(b2843, x2772).name("b2845_b2843").ctrl(x2775) // StreamWrite(x2761,x2773,b1798)
    ...
    val x2782_x2762 = WriteMem(x2762, x2780).name("x2782_x2762").ctrl(x2783) // ParStreamWrite(x2762,List(x2781),List(x2778))
    ...
    val x2785 = ReadMem(x2763).name("x2785").ctrl(x2786) // StreamRead(x2763,b1798)
