...
object GEMM_NCubed extends PIRApp {
  def main(top:Top) = {
    ...
    val x2705 = StoreBanks(List(x2680_d0_b0), List(b1707, b1726), b2841).name("x2705").ctrl(x2706) // ParSRAMStore(x2680,List(List(b1707, b1726)),List(x2704),List(x2702))
    ...
    val x2730 = StoreBanks(List(x2681_d0_b0), List(b1736, b1755), b2848).name("x2730").ctrl(x2731) // ParSRAMStore(x2681,List(List(b1736, b1755)),List(x2729),List(x2727))
