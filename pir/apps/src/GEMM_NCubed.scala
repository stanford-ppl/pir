...
object GEMM_NCubed extends PIRApp {
  def main(top:Top) = {
    ...
    val b2838 = WriteMems(List(b2835), x2695).name("b2838").ctrl(x2698) // StreamWrite(x2685,x2696,b1708)
    val b2839 = WriteMems(List(b2836), Const(256)).name("b2839").ctrl(x2698) // StreamWrite(x2685,x2696,b1708)
    ...
    val b2840 = ReadMem(b2837).name("b2840").ctrl(x2706) // ParStreamRead(x2686,List(x2702))
    ...
    val b2845 = WriteMems(List(b2842), x2720).name("b2845").ctrl(x2723) // StreamWrite(x2710,x2721,b1737)
    val b2846 = WriteMems(List(b2843), Const(256)).name("b2846").ctrl(x2723) // StreamWrite(x2710,x2721,b1737)
    ...
    val b2847 = ReadMem(b2844).name("b2847").ctrl(x2731) // ParStreamRead(x2711,List(x2727))
    ...
    val x2751 = WriteMems(List(x2737_d0, x2737_d1), x2749).name("x2751").ctrl(x2752) // RegWrite(x2737,x2749,x2750)
    ...
    val b2853 = WriteMems(List(b2849), x2772).name("b2853").ctrl(x2775) // StreamWrite(x2761,x2773,b1798)
    val b2854 = WriteMems(List(b2850), Const(256)).name("b2854").ctrl(x2775) // StreamWrite(x2761,x2773,b1798)
    ...
    val b2855 = WriteMems(List(b2851), x2780).name("b2855").ctrl(x2783) // ParStreamWrite(x2762,List(x2781),List(x2778))
    ...
    val b2856 = ReadMem(b2852).name("b2856").ctrl(x2786) // StreamRead(x2763,b1798)
