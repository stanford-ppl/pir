...
object OuterProduct extends PIRApp {
  def main(top:Top) = {
    ...
    val x2348 = OpDef(op=FixConvert, inputs=List(b1049)).name("x2348").ctrl(x2357) // FixConvert(b1049,TRUE,_32,_0)
    val x2349 = OpDef(op=FixSla, inputs=List(x2348, Const(2).ctrl(x2357))).name("x2349").ctrl(x2357) // FixLsh(x2348,Const(2))
    val x2350 = OpDef(op=FixConvert, inputs=List(x2349)).name("x2350").ctrl(x2357) // FixConvert(x2349,TRUE,_64,_0)
    ...
    val x2353 = OpDef(op=FixConvert, inputs=List(x2352)).name("x2353").ctrl(x2357) // FixConvert(x2352,TRUE,_64,_0)
    ...
    val x2372 = OpDef(op=FixConvert, inputs=List(b1050)).name("x2372").ctrl(x2381) // FixConvert(b1050,TRUE,_32,_0)
    val x2373 = OpDef(op=FixSla, inputs=List(x2372, Const(2).ctrl(x2381))).name("x2373").ctrl(x2381) // FixLsh(x2372,Const(2))
    val x2374 = OpDef(op=FixConvert, inputs=List(x2373)).name("x2374").ctrl(x2381) // FixConvert(x2373,TRUE,_64,_0)
    ...
    val x2377 = OpDef(op=FixConvert, inputs=List(x2376)).name("x2377").ctrl(x2381) // FixConvert(x2376,TRUE,_64,_0)
    ...
    val x2396 = OpDef(op=FixConvert, inputs=List(b1049)).name("x2396").ctrl(x2405) // FixConvert(b1049,TRUE,_32,_0)
    val x2397 = OpDef(op=FixSla, inputs=List(x2396, Const(2).ctrl(x2405))).name("x2397").ctrl(x2405) // FixLsh(x2396,Const(2))
    val x2398 = OpDef(op=FixConvert, inputs=List(x2397)).name("x2398").ctrl(x2405) // FixConvert(x2397,TRUE,_64,_0)
    ...
    val x2401 = OpDef(op=FixConvert, inputs=List(x2400)).name("x2401").ctrl(x2405) // FixConvert(x2400,TRUE,_64,_0)
    ...
    val x2420 = OpDef(op=FixConvert, inputs=List(b1051)).name("x2420").ctrl(x2429) // FixConvert(b1051,TRUE,_32,_0)
    val x2421 = OpDef(op=FixSla, inputs=List(x2420, Const(2).ctrl(x2429))).name("x2421").ctrl(x2429) // FixLsh(x2420,Const(2))
    val x2422 = OpDef(op=FixConvert, inputs=List(x2421)).name("x2422").ctrl(x2429) // FixConvert(x2421,TRUE,_64,_0)
    ...
    val x2425 = OpDef(op=FixConvert, inputs=List(x2424)).name("x2425").ctrl(x2429) // FixConvert(x2424,TRUE,_64,_0)
    ...
    val x2476 = OpDef(op=FixConvert, inputs=List(x2475)).name("x2476").ctrl(x2490) // FixConvert(x2475,TRUE,_32,_0)
    ...
    val x2479 = OpDef(op=FixConvert, inputs=List(b1050)).name("x2479").ctrl(x2490) // FixConvert(b1050,TRUE,_32,_0)
    ...
    val x2482 = OpDef(op=FixConvert, inputs=List(x2481)).name("x2482").ctrl(x2490) // FixConvert(x2481,TRUE,_64,_0)
    ...
    val x2485 = OpDef(op=FixConvert, inputs=List(x2484)).name("x2485").ctrl(x2490) // FixConvert(x2484,TRUE,_64,_0)
    ...
    val x2513 = OpDef(op=FixConvert, inputs=List(x2512)).name("x2513").ctrl(x2527) // FixConvert(x2512,TRUE,_32,_0)
    ...
    val x2516 = OpDef(op=FixConvert, inputs=List(b1051)).name("x2516").ctrl(x2527) // FixConvert(b1051,TRUE,_32,_0)
    ...
    val x2519 = OpDef(op=FixConvert, inputs=List(x2518)).name("x2519").ctrl(x2527) // FixConvert(x2518,TRUE,_64,_0)
    ...
    val x2522 = OpDef(op=FixConvert, inputs=List(x2521)).name("x2522").ctrl(x2527) // FixConvert(x2521,TRUE,_64,_0)
