...
object OuterProduct extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x2320 = top.argFringe.argIn(init=0).name("x2320").ctrl(top) // ArgInNew(Const(0))
    val x2321_d0 = top.argFringe.argIn(init=0).name("x2321_d0").ctrl(top) // ArgInNew(Const(0))
    ...
    val x2334 = Counter(min=Const(0), max=x2333, step=Const(16), par=2).name("x2334").ctrl(x2545) // CounterNew(Const(0),x2333,Const(16),Const(2))
    val x2335 = ReadMem(x2320).name("x2335").ctrl(x2545) // RegRead(x2320)
    val x2336 = Counter(min=Const(0), max=x2335, step=Const(16), par=1).name("x2336").ctrl(x2545) // CounterNew(Const(0),x2335,Const(16),Const(1))
    ...
    val x2351 = top.argFringe.dramAddress(x2325).name("x2351").ctrl(x2357) // GetDRAMAddress(x2325)
    val x2352 = OpDef(op=FixAdd, inputs=List(x2350, x2351)).name("x2352").ctrl(x2357) // FixAdd(x2350,x2351)
    val x2354_x2353 = x2352 // FixConvert(x2352,TRUE,_64,_0)
    ...
    val b2564_b2562 = WriteMem(b2562, x2354_x2353).name("b2564_b2562").ctrl(x2357) // StreamWrite(x2346,x2354,x2355)
    ...
    val x2359 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x2359").ctrl(x2367) // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x2363_x2363 = ReadMem(x2347).name("x2363").ctrl(x2366) // ParStreamRead(x2347,List(x2362))
    val x2364_x2364 = x2363_x2363 // x2364 = VectorApply(x2363,0)
    val x2365 = StoreBanks(List(x2338_d0_b0), List(b1078), x2364_x2364).name("x2365").ctrl(x2366) // ParSRAMStore(x2338,List(List(b1078)),List(x2364),List(x2362))
    ...
    val x2375 = top.argFringe.dramAddress(x2327).name("x2375").ctrl(x2381) // GetDRAMAddress(x2327)
    val x2376 = OpDef(op=FixAdd, inputs=List(x2374, x2375)).name("x2376").ctrl(x2381) // FixAdd(x2374,x2375)
    val x2378_x2377 = x2376 // FixConvert(x2376,TRUE,_64,_0)
    ...
    val b2568_b2566 = WriteMem(b2566, x2378_x2377).name("b2568_b2566").ctrl(x2381) // StreamWrite(x2370,x2378,x2379)
    ...
    val x2383 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x2383").ctrl(x2391) // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x2387_x2387 = ReadMem(x2371).name("x2387").ctrl(x2390) // ParStreamRead(x2371,List(x2386))
    val x2388_x2388 = x2387_x2387 // x2388 = VectorApply(x2387,0)
    val x2389 = StoreBanks(List(x2340_d0_b0), List(b1104), x2388_x2388).name("x2389").ctrl(x2390) // ParSRAMStore(x2340,List(List(b1104)),List(x2388),List(x2386))
    ...
    val x2399 = top.argFringe.dramAddress(x2325).name("x2399").ctrl(x2405) // GetDRAMAddress(x2325)
    val x2400 = OpDef(op=FixAdd, inputs=List(x2398, x2399)).name("x2400").ctrl(x2405) // FixAdd(x2398,x2399)
    val x2402_x2401 = x2400 // FixConvert(x2400,TRUE,_64,_0)
    ...
    val b2572_b2570 = WriteMem(b2570, x2402_x2401).name("b2572_b2570").ctrl(x2405) // StreamWrite(x2394,x2402,x2403)
    ...
    val x2407 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x2407").ctrl(x2415) // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x2411_x2411 = ReadMem(x2395).name("x2411").ctrl(x2414) // ParStreamRead(x2395,List(x2410))
    val x2412_x2412 = x2411_x2411 // x2412 = VectorApply(x2411,0)
    val x2413 = StoreBanks(List(x2339_d0_b0), List(b1131), x2412_x2412).name("x2413").ctrl(x2414) // ParSRAMStore(x2339,List(List(b1131)),List(x2412),List(x2410))
    ...
    val x2423 = top.argFringe.dramAddress(x2327).name("x2423").ctrl(x2429) // GetDRAMAddress(x2327)
    val x2424 = OpDef(op=FixAdd, inputs=List(x2422, x2423)).name("x2424").ctrl(x2429) // FixAdd(x2422,x2423)
    val x2426_x2425 = x2424 // FixConvert(x2424,TRUE,_64,_0)
    ...
    val b2576_b2574 = WriteMem(b2574, x2426_x2425).name("b2576_b2574").ctrl(x2429) // StreamWrite(x2418,x2426,x2427)
    ...
    val x2431 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x2431").ctrl(x2439) // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x2435_x2435 = ReadMem(x2419).name("x2435").ctrl(x2438) // ParStreamRead(x2419,List(x2434))
    val x2436_x2436 = x2435_x2435 // x2436 = VectorApply(x2435,0)
    val x2437 = StoreBanks(List(x2341_d0_b0), List(b1157), x2436_x2436).name("x2437").ctrl(x2438) // ParSRAMStore(x2341,List(List(b1157)),List(x2436),List(x2434))
    val x2440 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x2440").ctrl(x2544) // CounterNew(Const(0),Const(16),Const(1),Const(16))
    val x2441 = Counter(min=Const(0), max=Const(16), step=Const(1), par=1).name("x2441").ctrl(x2544) // CounterNew(Const(0),Const(16),Const(1),Const(1))
    ...
    val x2452 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x2452").ctrl(x2544) // CounterNew(Const(0),Const(16),Const(1),Const(16))
    val x2453 = Counter(min=Const(0), max=Const(16), step=Const(1), par=1).name("x2453").ctrl(x2544) // CounterNew(Const(0),Const(16),Const(1),Const(1))
    ...
    val x2470 = Counter(min=Const(0), max=Const(16), step=Const(1), par=1).name("x2470").ctrl(x2544) // CounterNew(Const(0),Const(16),Const(1),Const(1))
    ...
    val x2483 = top.argFringe.dramAddress(x2330).name("x2483").ctrl(x2490) // GetDRAMAddress(x2330)
    val x2484 = OpDef(op=FixAdd, inputs=List(x2482, x2483)).name("x2484").ctrl(x2490) // FixAdd(x2482,x2483)
    val x2486_x2485 = x2484 // FixConvert(x2484,TRUE,_64,_0)
    ...
    val b2580_b2578 = WriteMem(b2578, x2486_x2485).name("b2580_b2578").ctrl(x2490) // StreamWrite(x2472,x2486,x2488)
    val b2581_b2579 = WriteMem(b2579, Const(64)).name("b2581_b2579").ctrl(x2490) // StreamWrite(x2472,x2486,x2488)
    val x2491 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x2491").ctrl(x2506) // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x2498_x2497 = x2496 // x2497 = VectorApply(x2496,0)
    // x2498 = SimpleStruct(ArrayBuffer((_1,x2497), (_2,Const(true))))
    val x2499_x2473 = WriteMem(x2473, x2498_x2497).name("x2499_x2473").ctrl(x2500) // ParStreamWrite(x2473,List(x2498),List(x2495))
    ...
    val x2504_x2504 = ReadMem(x2474).name("x2504").ctrl(x2505) // StreamRead(x2474,x2503)
    val x2507 = Counter(min=Const(0), max=Const(16), step=Const(1), par=1).name("x2507").ctrl(x2544) // CounterNew(Const(0),Const(16),Const(1),Const(1))
    ...
    val x2520 = top.argFringe.dramAddress(x2330).name("x2520").ctrl(x2527) // GetDRAMAddress(x2330)
    val x2521 = OpDef(op=FixAdd, inputs=List(x2519, x2520)).name("x2521").ctrl(x2527) // FixAdd(x2519,x2520)
    val x2523_x2522 = x2521 // FixConvert(x2521,TRUE,_64,_0)
    ...
    val b2584_b2582 = WriteMem(b2582, x2523_x2522).name("b2584_b2582").ctrl(x2527) // StreamWrite(x2509,x2523,x2525)
    val b2585_b2583 = WriteMem(b2583, Const(64)).name("b2585_b2583").ctrl(x2527) // StreamWrite(x2509,x2523,x2525)
    val x2528 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x2528").ctrl(x2543) // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x2535_x2534 = x2533 // x2534 = VectorApply(x2533,0)
    // x2535 = SimpleStruct(ArrayBuffer((_1,x2534), (_2,Const(true))))
    val x2536_x2510 = WriteMem(x2510, x2535_x2534).name("x2536_x2510").ctrl(x2537) // ParStreamWrite(x2510,List(x2535),List(x2532))
    ...
    val x2541_x2541 = ReadMem(x2511).name("x2541").ctrl(x2542) // StreamRead(x2511,x2540)
