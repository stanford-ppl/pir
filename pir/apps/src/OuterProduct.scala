...
object OuterProduct extends PIRApp {
  def main(top:Top) = {
    ...
    val b2565 = WriteMems(List(b2562), x2353).name("b2565").ctrl(x2357) // StreamWrite(x2346,x2354,x2355)
    val b2566 = WriteMems(List(b2563), Const(64)).name("b2566").ctrl(x2357) // StreamWrite(x2346,x2354,x2355)
    ...
    val b2567 = ReadMem(b2564).name("b2567").ctrl(x2366) // ParStreamRead(x2347,List(x2362))
    ...
    val b2572 = WriteMems(List(b2569), x2377).name("b2572").ctrl(x2381) // StreamWrite(x2370,x2378,x2379)
    val b2573 = WriteMems(List(b2570), Const(64)).name("b2573").ctrl(x2381) // StreamWrite(x2370,x2378,x2379)
    ...
    val b2574 = ReadMem(b2571).name("b2574").ctrl(x2390) // ParStreamRead(x2371,List(x2386))
    ...
    val b2579 = WriteMems(List(b2576), x2401).name("b2579").ctrl(x2405) // StreamWrite(x2394,x2402,x2403)
    val b2580 = WriteMems(List(b2577), Const(64)).name("b2580").ctrl(x2405) // StreamWrite(x2394,x2402,x2403)
    ...
    val b2581 = ReadMem(b2578).name("b2581").ctrl(x2414) // ParStreamRead(x2395,List(x2410))
    ...
    val b2586 = WriteMems(List(b2583), x2425).name("b2586").ctrl(x2429) // StreamWrite(x2418,x2426,x2427)
    val b2587 = WriteMems(List(b2584), Const(64)).name("b2587").ctrl(x2429) // StreamWrite(x2418,x2426,x2427)
    ...
    val b2588 = ReadMem(b2585).name("b2588").ctrl(x2438) // ParStreamRead(x2419,List(x2434))
    ...
    val b2594 = WriteMems(List(b2590), x2485).name("b2594").ctrl(x2490) // StreamWrite(x2472,x2486,x2488)
    val b2595 = WriteMems(List(b2591), Const(64)).name("b2595").ctrl(x2490) // StreamWrite(x2472,x2486,x2488)
    ...
    val b2596 = WriteMems(List(b2592), x2497).name("b2596").ctrl(x2500) // ParStreamWrite(x2473,List(x2498),List(x2495))
    ...
    val b2597 = ReadMem(b2593).name("b2597").ctrl(x2505) // StreamRead(x2474,x2503)
    ...
    val b2602 = WriteMems(List(b2598), x2522).name("b2602").ctrl(x2527) // StreamWrite(x2509,x2523,x2525)
    val b2603 = WriteMems(List(b2599), Const(64)).name("b2603").ctrl(x2527) // StreamWrite(x2509,x2523,x2525)
    ...
    val b2604 = WriteMems(List(b2600), x2534).name("b2604").ctrl(x2537) // ParStreamWrite(x2510,List(x2535),List(x2532))
    ...
    val b2605 = ReadMem(b2601).name("b2605").ctrl(x2542) // StreamRead(x2511,x2540)
