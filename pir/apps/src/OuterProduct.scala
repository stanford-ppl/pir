...
object OuterProduct extends PIRApp {
  def main(top:Top) = {
    ...
    val x2324 = LoadMem(x2320, None).name("x2324").ctrl(top) // RegRead(x2320)
    val x2325 = DRAM().name("x2325").ctrl(top) // x2325 = DRAMNew(ArrayBuffer(x2324),Const(0))
    val x2326 = LoadMem(x2321_d0, None).name("x2326").ctrl(top) // RegRead(x2321)
    val x2327 = DRAM().name("x2327").ctrl(top) // x2327 = DRAMNew(ArrayBuffer(x2326),Const(0))
    val x2328 = LoadMem(x2321_d0, None).name("x2328").ctrl(top) // RegRead(x2321)
    val x2329 = LoadMem(x2320, None).name("x2329").ctrl(top) // RegRead(x2320)
    ...
    val x2333 = LoadMem(x2321_d0, None).name("x2333").ctrl(x2545) // RegRead(x2321)
    ...
    val x2335 = LoadMem(x2320, None).name("x2335").ctrl(x2545) // RegRead(x2320)
    ...
    val b2565 = StoreMem(List(b2562), None, x2353).name("b2565").ctrl(x2357) // StreamWrite(x2346,x2354,x2355)
    val b2566 = StoreMem(List(b2563), None, Const(64)).name("b2566").ctrl(x2357) // StreamWrite(x2346,x2354,x2355)
    ...
    val b2567 = LoadMem(b2564, None).name("b2567").ctrl(x2366) // ParStreamRead(x2347,List(x2362))
    val b2568 = b2567 // x2364 = VectorApply(x2363,0)
    val x2365 = StoreBanks(List(List(x2338_d0_b0)), List(b1078), b2568).name("x2365").ctrl(x2366) // ParSRAMStore(x2338,List(List(b1078)),List(x2364),List(x2362))
    ...
    val b2572 = StoreMem(List(b2569), None, x2377).name("b2572").ctrl(x2381) // StreamWrite(x2370,x2378,x2379)
    val b2573 = StoreMem(List(b2570), None, Const(64)).name("b2573").ctrl(x2381) // StreamWrite(x2370,x2378,x2379)
    ...
    val b2574 = LoadMem(b2571, None).name("b2574").ctrl(x2390) // ParStreamRead(x2371,List(x2386))
    val b2575 = b2574 // x2388 = VectorApply(x2387,0)
    val x2389 = StoreBanks(List(List(x2340_d0_b0)), List(b1104), b2575).name("x2389").ctrl(x2390) // ParSRAMStore(x2340,List(List(b1104)),List(x2388),List(x2386))
    ...
    val b2579 = StoreMem(List(b2576), None, x2401).name("b2579").ctrl(x2405) // StreamWrite(x2394,x2402,x2403)
    val b2580 = StoreMem(List(b2577), None, Const(64)).name("b2580").ctrl(x2405) // StreamWrite(x2394,x2402,x2403)
    ...
    val b2581 = LoadMem(b2578, None).name("b2581").ctrl(x2414) // ParStreamRead(x2395,List(x2410))
    val b2582 = b2581 // x2412 = VectorApply(x2411,0)
    val x2413 = StoreBanks(List(List(x2339_d0_b0)), List(b1131), b2582).name("x2413").ctrl(x2414) // ParSRAMStore(x2339,List(List(b1131)),List(x2412),List(x2410))
    ...
    val b2586 = StoreMem(List(b2583), None, x2425).name("b2586").ctrl(x2429) // StreamWrite(x2418,x2426,x2427)
    val b2587 = StoreMem(List(b2584), None, Const(64)).name("b2587").ctrl(x2429) // StreamWrite(x2418,x2426,x2427)
    ...
    val b2588 = LoadMem(b2585, None).name("b2588").ctrl(x2438) // ParStreamRead(x2419,List(x2434))
    val b2589 = b2588 // x2436 = VectorApply(x2435,0)
    val x2437 = StoreBanks(List(List(x2341_d0_b0)), List(b1157), b2589).name("x2437").ctrl(x2438) // ParSRAMStore(x2341,List(List(b1157)),List(x2436),List(x2434))
    ...
    val x2450 = StoreBanks(List(List(x2342_d0_b0)), List(b1174, b1175), x2449).name("x2450").ctrl(x2451) // ParSRAMStore(x2342,List(List(b1174, b1175)),List(x2449),List(x2445))
    ...
    val x2462 = StoreBanks(List(List(x2343_d0_b0)), List(b1187, b1188), x2461).name("x2462").ctrl(x2463) // ParSRAMStore(x2343,List(List(b1187, b1188)),List(x2461),List(x2457))
    ...
    val x2477 = LoadMem(x2321_d0, None).name("x2477").ctrl(x2490) // RegRead(x2321)
    ...
    val b2594 = StoreMem(List(b2590), None, x2485).name("b2594").ctrl(x2490) // StreamWrite(x2472,x2486,x2488)
    val b2595 = StoreMem(List(b2591), None, Const(64)).name("b2595").ctrl(x2490) // StreamWrite(x2472,x2486,x2488)
    ...
    val b2596 = StoreMem(List(b2592), None, x2497).name("b2596").ctrl(x2500) // ParStreamWrite(x2473,List(x2498),List(x2495))
    ...
    val b2597 = LoadMem(b2593, None).name("b2597").ctrl(x2505) // StreamRead(x2474,x2503)
    ...
    val x2514 = LoadMem(x2321_d0, None).name("x2514").ctrl(x2527) // RegRead(x2321)
    ...
    val b2602 = StoreMem(List(b2598), None, x2522).name("b2602").ctrl(x2527) // StreamWrite(x2509,x2523,x2525)
    val b2603 = StoreMem(List(b2599), None, Const(64)).name("b2603").ctrl(x2527) // StreamWrite(x2509,x2523,x2525)
    ...
    val b2604 = StoreMem(List(b2600), None, x2534).name("b2604").ctrl(x2537) // ParStreamWrite(x2510,List(x2535),List(x2532))
    ...
    val b2605 = LoadMem(b2601, None).name("b2605").ctrl(x2542) // StreamRead(x2511,x2540)
