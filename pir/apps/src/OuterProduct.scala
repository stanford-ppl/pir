...
object OuterProduct extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x1687 = withCtrl(x1694) { b966 } // FixConvert(b966,TRUE,_32,_0) (Same Type. No op)
    ...
    val x1689 = withCtrl(x1694) { x1688 } // FixConvert(x1688,TRUE,_64,_0)
    ...
    val x1700_x1700 = withCtrl(x1702) { x1699_x1699 } // VectorApply(x1699,0)
    ...
    val x1712 = withCtrl(x1720) { b995 } // FixConvert(b995,TRUE,_32,_0) (Same Type. No op)
    ...
    val x1714 = withCtrl(x1720) { x1713 } // FixConvert(x1713,TRUE,_64,_0)
    ...
    val x1727_x1727 = withCtrl(x1729) { x1726_x1726 } // VectorApply(x1726,0)
    ...
    val x1740 = withCtrl(x1743) { x1739 } // VectorApply(x1739,0)
    ...
    val x1752 = withCtrl(x1765) { x1751 } // FixConvert(x1751,TRUE,_32,_0) (Same Type. No op)
    ...
    val x1755 = withCtrl(x1765) { b995 } // FixConvert(b995,TRUE,_32,_0) (Same Type. No op)
    ...
    val x1758 = withCtrl(x1765) { x1757 } // FixConvert(x1757,TRUE,_64,_0)
    ...
    val x1773_x1772 = withCtrl(x1775) { x1771 } // VectorApply(x1771,0)
