...
object OuterProduct extends PIRApp {
  def main(top:Top) = {
    ...
    val x2365 = StoreBanks(List(x2338_d0_b0), List(b1078), b2568).name("x2365").ctrl(x2366) // ParSRAMStore(x2338,List(List(b1078)),List(x2364),List(x2362))
    ...
    val x2389 = StoreBanks(List(x2340_d0_b0), List(b1104), b2575).name("x2389").ctrl(x2390) // ParSRAMStore(x2340,List(List(b1104)),List(x2388),List(x2386))
    ...
    val x2413 = StoreBanks(List(x2339_d0_b0), List(b1131), b2582).name("x2413").ctrl(x2414) // ParSRAMStore(x2339,List(List(b1131)),List(x2412),List(x2410))
    ...
    val x2437 = StoreBanks(List(x2341_d0_b0), List(b1157), b2589).name("x2437").ctrl(x2438) // ParSRAMStore(x2341,List(List(b1157)),List(x2436),List(x2434))
