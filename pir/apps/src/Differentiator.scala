...
object Differentiator extends PIRApp {
  def main(top:Top) = {
    ...
    val b2293_b2291 = WriteMem(b2291, x2173).name("b2293_b2291").ctrl(x2176) // StreamWrite(x2166,x2174,b1393)
    ...
    val x2181 = ReadMem(x2167).name("x2181").ctrl(x2184) // ParStreamRead(x2167,List(x2180))
    val x2182 = x2181 // x2182 = VectorApply(x2181,0)
    val x2183 = StoreBanks(List(x2155_d0_b0), List(b1410), x2182).name("x2183").ctrl(x2184) // ParSRAMStore(x2155,List(List(b1410)),List(x2182),List(x2180))
    ...
    val x2201 = AccumOp(op=FixAdd, input=x2196, accum=x2199).name("x2201").ctrl(x2204) // FixAdd(x2196,x2199)
    ...
    val x2221 = AccumOp(op=FixAdd, input=x2216, accum=x2219).name("x2221").ctrl(x2224) // FixAdd(x2216,x2219)
    ...
    val b2297_b2295 = WriteMem(b2295, x2245).name("b2297_b2295").ctrl(x2248) // StreamWrite(x2237,x2246,b1393)
    ...
    val x2255_x2238 = WriteMem(x2238, x2253).name("x2255_x2238").ctrl(x2256) // ParStreamWrite(x2238,List(x2254),List(x2251))
    ...
    val x2258 = ReadMem(x2239).name("x2258").ctrl(x2259) // StreamRead(x2239,b1393)
