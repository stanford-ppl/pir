...
object SPMV_CRS extends PIRApp {
  def main(top:Top) = {
    ...
    val x5372_b5515_x5406_b5517_s = Scalar("x5372_b5515_x5406_b5517")
    ...
    val x5143_b5486_x5175_b5494_s = Scalar("x5143_b5486_x5175_b5494")
    ...
    val x5372_b5514_x5406_b5516_s = Scalar("x5372_b5514_x5406_b5516")
    ...
    val x5210_b5500_x5242_b5508_s = Scalar("x5210_b5500_x5242_b5508")
    ...
    val x5045_dsp0_bank0 = MemoryPipeline(name="x5045_dsp0_bank0",parent="x5433") { implicit CU => 
      val b5484 = ScalarFIFO(size=1,name="b5484")
        .store(x5045_x5118_wa_s, None, None)
      val x5118 = ScalarFIFO(size=1,name="x5118")
        .store(x5060_x5093_data_s, None, None)
      val b5485 = ScalarFIFO(size=1,name="b5485")
        .store(x5045_x5132_ra_s, None, None)
      val x5045 = SRAM(size=495,name="x5045",banking = NoBanking())
        .buffering(1)
        .store(x5118.readPort, Some(b5484.readPort), None)
        .load(x5045_x5045_dsp0_bank0_data_s, Some(b5485.readPort), None)
    }
    val x5045_dsp1_bank0 = MemoryPipeline(name="x5045_dsp1_bank0",parent="x5433") { implicit CU => 
      ...
      val x5118 = ScalarFIFO(size=1,name="x5118")
        .store(x5060_x5093_data_s, None, None)
      val x5123 = CounterChain.copy("x5362", "x5123")
      val x5045 = SRAM(size=495,name="x5045",banking = NoBanking())
        .buffering(1)
        .store(x5118.readPort, Some(b5484.readPort), None)
        .load(x5045_x5045_dsp1_bank0_data_s, Some(x5123(0)), None)
    }
    val x5046_dsp0_bank0 = MemoryPipeline(name="x5046_dsp0_bank0",parent="x5433") { implicit CU => 
      val x5360 = ScalarFIFO(size=1,name="x5360")
        .store(x5333_x5356_s, None, None)
      val b5518 = ScalarFIFO(size=1,name="b5518")
        .store(x5046_x5422_ra_s, None, None)
      val x5123 = CounterChain.copy("x5362", "x5123")
      val x5046 = SRAM(size=494,name="x5046",banking = NoBanking())
        .buffering(1)
        .store(x5360.readPort, Some(x5123(0)), None)
        .load(x5046_x5046_dsp0_bank0_data_s, Some(b5518.readPort), None)
    }
    ...
    val x5092 = Pipeline(name="x5092",parent="x5121") { implicit CU => 
      ...
      val x5047 = ScalarBuffer(name="x5047")
        .buffering(1)
        .store(x5047_x5054_s, None, None)
      val x5085 = ScalarBuffer(name="x5085")
        .buffering(1)
        .store(rowid_dram_da, None, None)
      val x5049 = ScalarBuffer(name="x5049")
        .buffering(1)
        .store(x5049_x5056_s, None, None)
      ...
      Stage(operands=List(x5065, Const(2)), op=FixSra, results=List(x5090_x5077))
    ...
    val x5093 = MemoryController(name="x5093",parent="x5121",offchip=rowid_dram_oc, mctpe=TileLoad) { implicit CU => 
      val x5058_b5472 = ScalarFIFO(size=1,name="size")
        .store(x5058_b5472_x5089_b5480_s, None, None)
      val x5058_b5471 = ScalarFIFO(size=1,name="offset")
        .store(x5058_b5471_x5089_b5479_s, None, None)
    ...
    val x5124_dsp0_bank0 = MemoryPipeline(name="x5124_dsp0_bank0",parent="x5362") { implicit CU => 
      val x5206 = ScalarFIFO(size=1,name="x5206")
        .store(x5145_x5179_data_s, None, None)
      val b5499 = ScalarFIFO(size=1,name="b5499")
        .store(x5124_x5206_wa_s, None, None)
      val x5302 = CounterChain.copy("x5316", "x5302")
      val x5124 = SRAM(size=494,name="x5124",banking = NoBanking())
        .buffering(4)
        .store(x5206.readPort, Some(b5499.readPort), Some("x5209"))
        .load(x5124_x5124_dsp0_bank0_data_s, Some(x5302(0)), Some("x5330"))
    }
    val x5125_dsp0_bank0 = MemoryPipeline(name="x5125_dsp0_bank0",parent="x5362") { implicit CU => 
      val b5513 = ScalarFIFO(size=1,name="b5513")
        .store(x5125_x5273_wa_s, None, None)
      val x5273 = ScalarFIFO(size=1,name="x5273")
        .store(x5212_x5246_data_s, None, None)
      val x5344 = CounterChain.copy("x5357", "x5344")
      val x5125 = SRAM(size=247,name="x5125",banking = Strided(1,2))
        .buffering(6)
        .store(x5273.readPort, Some(b5513.readPort), Some("x5276"))
        .load(x5125_x5125_dsp0_bank0_data_v, Some(x5344(0)), Some("x5357"))
    }
    val x5126_dsp0_bank0 = MemoryPipeline(name="x5126_dsp0_bank0",parent="x5362") { implicit CU => 
      val x5328 = ScalarFIFO(size=1,name="x5328")
        .store(x5299_x5317_data_s, None, None)
      val x5320 = CounterChain.copy("x5329", "x5320")
      val x5344 = CounterChain.copy("x5357", "x5344")
      val x5126 = SRAM(size=247,name="x5126",banking = Strided(1,2))
        .buffering(3)
        .store(x5328.readPort, Some(x5320(0)), Some("x5330"))
        .load(x5126_x5126_dsp0_bank0_data_v, Some(x5344(0)), Some("x5357"))
    }
    val x5142 = Pipeline(name="x5142",parent="x5362") { implicit CU => 
      val x5128 = ScalarBuffer(name="x5128")
        .buffering(2)
        .store(x5045_x5045_dsp0_bank0_data_s, None, Some("x5045_dsp0_bank0"))
      val x5127 = ScalarBuffer(name="x5127")
        .buffering(2)
        .store(x5045_x5045_dsp1_bank0_data_s, None, Some("x5045_dsp1_bank0"))
    ...
    val x5178 = Pipeline(name="x5178",parent="x5209") { implicit CU => 
      ...
      val x5170 = ScalarBuffer(name="x5170")
        .buffering(1)
        .store(cols_dram_da, None, None)
      val x5136 = ScalarBuffer(name="x5136")
        .buffering(1)
        .store(x5136_x5141_s, None, None)
      val x5127 = ScalarBuffer(name="x5127")
        .buffering(2)
        .store(x5045_x5045_dsp1_bank0_data_s, None, Some("x5045_dsp1_bank0"))
      ...
      Stage(operands=List(x5150, Const(2)), op=FixSra, results=List(x5176_x5162))
      ...
      Stage(operands=List(x5167, x5161), op=FixAdd, results=List(CU.scalarOut(x5143_b5487_x5175_b5495_s)))
      Stage(operands=List(x5148, x5150), op=FixSub, results=List(x5154))
      Stage(operands=List(x5154, x5170), op=FixAdd, results=List(CU.scalarOut(x5143_b5486_x5175_b5494_s)))
    }
    val x5179 = MemoryController(name="x5179",parent="x5209",offchip=cols_dram_oc, mctpe=TileLoad) { implicit CU => 
      val x5143_b5487 = ScalarFIFO(size=1,name="size")
        .store(x5143_b5487_x5175_b5495_s, None, None)
      val x5143_b5486 = ScalarFIFO(size=1,name="offset")
        .store(x5143_b5486_x5175_b5494_s, None, None)
    ...
    val x5245 = Pipeline(name="x5245",parent="x5276") { implicit CU => 
      ...
      val x5127 = ScalarBuffer(name="x5127")
        .buffering(2)
        .store(x5045_x5045_dsp1_bank0_data_s, None, Some("x5045_dsp1_bank0"))
      val x5237 = ScalarBuffer(name="x5237")
        .buffering(1)
        .store(values_dram_da, None, None)
      ...
      Stage(operands=List(x5217, Const(2)), op=FixSra, results=List(x5243_x5229))
      ...
      Stage(operands=List(x5234, x5228), op=FixAdd, results=List(CU.scalarOut(x5210_b5501_x5242_b5509_s)))
      Stage(operands=List(x5215, x5217), op=FixSub, results=List(x5221))
      Stage(operands=List(x5221, x5237), op=FixAdd, results=List(CU.scalarOut(x5210_b5500_x5242_b5508_s)))
    }
    val x5246 = MemoryController(name="x5246",parent="x5276",offchip=values_dram_oc, mctpe=TileLoad) { implicit CU => 
      val x5210_b5501 = ScalarFIFO(size=1,name="size")
        .store(x5210_b5501_x5242_b5509_s, None, None)
      val x5210_b5500 = ScalarFIFO(size=1,name="offset")
        .store(x5210_b5500_x5242_b5508_s, None, None)
    ...
    val x5297 = Pipeline(name="x5297",parent="x5362") { implicit CU => 
      ...
      val x5277 = ScalarBuffer(name="x5277")
        .buffering(2)
        .store(x5277_x5282_s, None, Some("x5283"))
    ...
    val x5316 = Pipeline(name="x5316",parent="x5330") { implicit CU => 
      ...
      val x5305 = ScalarBuffer(name="x5305")
        .buffering(1)
        .store(vec_dram_da, None, None)
      val x5277 = ScalarBuffer(name="x5277")
        .buffering(3)
        .store(x5277_x5282_s, None, Some("x5283"))
      val x5309 = ScalarFIFO(size=1,name="x5309")
        .store(x5124_x5124_dsp0_bank0_data_s, None, None)
      val x5284 = ScalarBuffer(name="x5284")
        .buffering(2)
        .store(x5284_x5296_s, None, Some("x5297"))
    ...
    val x5317 = MemoryController(name="x5317",parent="x5330",offchip=vec_dram_oc, mctpe=Gather) { implicit CU => 
      val x5298 = ScalarFIFO(size=1,name="addr")
        .store(x5298_x5315_s, None, None)
    ...
    val x5357 = Pipeline(name="x5357",parent="x5362") { implicit CU => 
      ...
      val x5349 = VectorFIFO(size=1,name="x5349")
        .store(x5126_x5126_dsp0_bank0_data_v, None, None)
      val x5277 = ScalarBuffer(name="x5277")
        .buffering(5)
        .store(x5277_x5282_s, None, Some("x5283"))
      val x5347 = VectorFIFO(size=1,name="x5347")
        .store(x5125_x5125_dsp0_bank0_data_v, None, None)
      ...
      val (_, rr408) = Stage.reduce(op=FixAdd, init=Const(0.0), accumParent="x5357")
      Stage(operands=List(rr408), op=Bypass, results=List(CU.scalarOut(x5333_x5356_s)))
    }
    val x5371 = Pipeline(name="x5371",parent="x5433") { implicit CU => 
      val x5365 = CU.temp(None).name("x5365")
      val x5367 = CU.temp(None).name("x5367")
      val x5048 = ScalarBuffer(name="x5048")
        .buffering(1)
        .store(x5048_x5055_s, None, None)
      val x5044 = CounterChain.copy("x5433", "x5044").iterIdx(0, 0)
    ...
    val x5410 = Pipeline(name="x5410",parent="x5428") { implicit CU => 
      ...
      val x5364 = ScalarBuffer(name="x5364")
        .buffering(1)
        .store(x5364_x5370_s, None, None)
      val x5363 = ScalarBuffer(name="x5363")
        .buffering(1)
        .store(x5363_x5369_s, None, None)
      val x5402 = ScalarBuffer(name="x5402")
        .buffering(1)
        .store(result_dram_da, None, None)
      ...
      Stage(operands=List(x5399, x5393), op=FixAdd, results=List(CU.scalarOut(x5372_b5515_x5406_b5517_s)))
      Stage(operands=List(x5380, x5382), op=FixSub, results=List(x5386))
      Stage(operands=List(x5386, x5402), op=FixAdd, results=List(CU.scalarOut(x5372_b5514_x5406_b5516_s)))
    }
    val x5427 = Pipeline(name="x5427",parent="x5428") { implicit CU => 
      ...
      val x5376 = ScalarBuffer(name="x5376")
        .buffering(1)
        .store(x5376_x5408_s, None, None)
      val x5375 = ScalarBuffer(name="x5375")
        .buffering(1)
        .store(x5375_x5407_s, None, None)
      val x5422 = ScalarFIFO(size=1,name="x5422")
        .store(x5046_x5046_dsp0_bank0_data_s, None, None)
      val x5377 = ScalarBuffer(name="x5377")
        .buffering(1)
        .store(x5377_x5409_s, None, None)
    ...
    val x5429 = MemoryController(name="x5429",parent="x5432",offchip=result_dram_oc, mctpe=TileStore) { implicit CU => 
      val x5372_b5514 = ScalarFIFO(size=1,name="offset")
        .store(x5372_b5514_x5406_b5516_s, None, None)
      val x5373 = ScalarFIFO(size=1,name="data")
        .store(x5373_x5426_s, None, None)
      val x5372_b5515 = ScalarFIFO(size=1,name="size")
        .store(x5372_b5515_x5406_b5517_s, None, None)
    }
