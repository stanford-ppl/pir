...
object SPMV_CRS extends PIRApp {
  def main(top:Top) = {
    ...
    val b5476_b5471 = WriteMem(b5471, x5087).name("b5476_b5471").ctrl(x5092) // StreamWrite(x5058,x5088,b2791)
    val b5477_b5472 = WriteMem(b5472, x5083).name("b5477_b5472").ctrl(x5092) // StreamWrite(x5058,x5088,b2791)
    // x5090 = SimpleStruct(ArrayBuffer((size,x5081), (start,x5077), (end,x5079)))
    val b5478_b5473 = WriteMem(b5473, x5081).name("b5478_b5473").ctrl(x5092) // FIFOEnq(x5059,x5090,b2791)
    val b5479_b5474 = WriteMem(b5474, x5077).name("b5479_b5474").ctrl(x5092) // FIFOEnq(x5059,x5090,b2791)
    val b5480_b5475 = WriteMem(b5475, x5079).name("b5480_b5475").ctrl(x5092) // FIFOEnq(x5059,x5090,b2791)
    ...
    val b5481 = ReadMem(b5473).name("b5481").ctrl(x5104) // FIFODeq(x5059,b2791)
    val b5482 = ReadMem(b5474).name("b5482").ctrl(x5104) // FIFODeq(x5059,b2791)
    val b5483 = ReadMem(b5475).name("b5483").ctrl(x5104) // FIFODeq(x5059,b2791)
    val x5098 = b5482 // x5098 = FieldApply(x5097,start)
    val x5099_x5094 = WriteMem(x5094, x5098).name("x5099_x5094").ctrl(x5104) // RegWrite(x5094,x5098,b2791)
    val x5100 = b5483 // x5100 = FieldApply(x5097,end)
    val x5101_x5095 = WriteMem(x5095, x5100).name("x5101_x5095").ctrl(x5104) // RegWrite(x5095,x5100,b2791)
    val x5102 = b5481 // x5102 = FieldApply(x5097,size)
    ...
    val x5115 = ReadMem(x5060).name("x5115").ctrl(x5119) // ParStreamRead(x5060,List(x5114))
    ...
    val x5118 = StoreBanks(List(x5045_d0_b0, x5045_d1_b0), List(x5113), x5116).name("x5118").ctrl(x5119) // ParSRAMStore(x5045,List(List(x5113)),List(x5116),List(x5117))
    ...
    val b5489_b5484 = WriteMem(b5484, x5172).name("b5489_b5484").ctrl(x5178) // StreamWrite(x5143,x5173,x5174)
    val b5490_b5485 = WriteMem(b5485, x5168).name("b5490_b5485").ctrl(x5178) // StreamWrite(x5143,x5173,x5174)
    // x5176 = SimpleStruct(ArrayBuffer((size,x5166), (start,x5162), (end,x5164)))
    val b5491_b5486 = WriteMem(b5486, x5166).name("b5491_b5486").ctrl(x5178) // FIFOEnq(x5144,x5176,x5174)
    val b5492_b5487 = WriteMem(b5487, x5162).name("b5492_b5487").ctrl(x5178) // FIFOEnq(x5144,x5176,x5174)
    val b5493_b5488 = WriteMem(b5488, x5164).name("b5493_b5488").ctrl(x5178) // FIFOEnq(x5144,x5176,x5174)
    ...
    val b5494 = ReadMem(b5486).name("b5494").ctrl(x5191) // FIFODeq(x5144,x5183)
    val b5495 = ReadMem(b5487).name("b5495").ctrl(x5191) // FIFODeq(x5144,x5183)
    val b5496 = ReadMem(b5488).name("b5496").ctrl(x5191) // FIFODeq(x5144,x5183)
    val x5185 = b5495 // x5185 = FieldApply(x5184,start)
    val x5186_x5180 = WriteMem(x5180, x5185).name("x5186_x5180").ctrl(x5191) // RegWrite(x5180,x5185,x5183)
    val x5187 = b5496 // x5187 = FieldApply(x5184,end)
    val x5188_x5181 = WriteMem(x5181, x5187).name("x5188_x5181").ctrl(x5191) // RegWrite(x5181,x5187,x5183)
    val x5189 = b5494 // x5189 = FieldApply(x5184,size)
    ...
    val x5203 = ReadMem(x5145).name("x5203").ctrl(x5207) // ParStreamRead(x5145,List(x5202))
    val x5204 = x5203 // x5204 = VectorApply(x5203,0)
    val x5205 = OpDef(op=BitAnd, inputs=List(x5199, x5202)).name("x5205").ctrl(x5207) // And(x5199,x5202)
    val x5206 = StoreBanks(List(x5124_d0_b0), List(x5200), x5204).name("x5206").ctrl(x5207) // ParSRAMStore(x5124,List(List(x5200)),List(x5204),List(x5205))
    ...
    val b5502_b5497 = WriteMem(b5497, x5239).name("b5502_b5497").ctrl(x5245) // StreamWrite(x5210,x5240,x5241)
    val b5503_b5498 = WriteMem(b5498, x5235).name("b5503_b5498").ctrl(x5245) // StreamWrite(x5210,x5240,x5241)
    // x5243 = SimpleStruct(ArrayBuffer((size,x5233), (start,x5229), (end,x5231)))
    val b5504_b5499 = WriteMem(b5499, x5233).name("b5504_b5499").ctrl(x5245) // FIFOEnq(x5211,x5243,x5241)
    val b5505_b5500 = WriteMem(b5500, x5229).name("b5505_b5500").ctrl(x5245) // FIFOEnq(x5211,x5243,x5241)
    val b5506_b5501 = WriteMem(b5501, x5231).name("b5506_b5501").ctrl(x5245) // FIFOEnq(x5211,x5243,x5241)
    ...
    val b5507 = ReadMem(b5499).name("b5507").ctrl(x5258) // FIFODeq(x5211,x5250)
    val b5508 = ReadMem(b5500).name("b5508").ctrl(x5258) // FIFODeq(x5211,x5250)
    val b5509 = ReadMem(b5501).name("b5509").ctrl(x5258) // FIFODeq(x5211,x5250)
    val x5252 = b5508 // x5252 = FieldApply(x5251,start)
    val x5253_x5247 = WriteMem(x5247, x5252).name("x5253_x5247").ctrl(x5258) // RegWrite(x5247,x5252,x5250)
    val x5254 = b5509 // x5254 = FieldApply(x5251,end)
    val x5255_x5248 = WriteMem(x5248, x5254).name("x5255_x5248").ctrl(x5258) // RegWrite(x5248,x5254,x5250)
    val x5256 = b5507 // x5256 = FieldApply(x5251,size)
    ...
    val x5270 = ReadMem(x5212).name("x5270").ctrl(x5274) // ParStreamRead(x5212,List(x5269))
    val x5271 = x5270 // x5271 = VectorApply(x5270,0)
    val x5272 = OpDef(op=BitAnd, inputs=List(x5266, x5269)).name("x5272").ctrl(x5274) // And(x5266,x5269)
    val x5273 = StoreBanks(List(x5125_d0_b0), List(x5267), x5271).name("x5273").ctrl(x5274) // ParSRAMStore(x5125,List(List(x5267)),List(x5271),List(x5272))
    ...
    val x5323 = ReadMem(x5299).name("x5323").ctrl(x5329) // ParStreamRead(x5299,List(x5322))
    val x5324 = x5323 // x5324 = VectorApply(x5323,0)
    ...
    val x5328 = StoreBanks(List(x5126_d0_b0), List(b3065), x5324).name("x5328").ctrl(x5329) // ParSRAMStore(x5126,List(List(b3065)),List(x5324),List(x5327))
    ...
    val x5351_0 = ReduceOp(op=FixAdd, input=x5351).name("x5351_0").ctrl(x5357) // FixAdd(x5351,x5352)
    val x5354 = AccumOp(op=FixAdd, input=x5351_0, accum=x5352).name("x5354").ctrl(x5357) // FixAdd(x5351,x5352)
    ...
    val b5512_b5510 = WriteMem(b5510, x5404).name("b5512_b5510").ctrl(x5410) // StreamWrite(x5372,x5405,b2791)
    val b5513_b5511 = WriteMem(b5511, x5400).name("b5513_b5511").ctrl(x5410) // StreamWrite(x5372,x5405,b2791)
    ...
    val x5426_x5373 = WriteMem(x5373, x5424).name("x5426_x5373").ctrl(x5427) // ParStreamWrite(x5373,List(x5425),List(x5420))
    ...
    val x5430 = ReadMem(x5374).name("x5430").ctrl(x5431) // StreamRead(x5374,b2791)
