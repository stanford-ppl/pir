...
object SGD extends PIRApp {
  def main(top:Top) = {
    ...
    val b2912_b2910 = WriteMem(b2910, x2754).name("b2912_b2910").ctrl(x2758) // StreamWrite(x2747,x2755,x2756)
    ...
    val x2764 = ReadMem(x2748).name("x2764").ctrl(x2767) // ParStreamRead(x2748,List(x2763))
    val x2765 = x2764 // x2765 = VectorApply(x2764,0)
    val x2766 = StoreBanks(List(x2733_d0_b0), List(b1729), x2765).name("x2766").ctrl(x2767) // ParSRAMStore(x2733,List(List(b1729)),List(x2765),List(x2763))
    ...
    val b2916_b2914 = WriteMem(b2914, x2794).name("b2916_b2914").ctrl(x2800) // StreamWrite(x2782,x2795,x2798)
    ...
    val x2808 = ReadMem(x2783).name("x2808").ctrl(x2811) // ParStreamRead(x2783,List(x2807))
    val x2809 = x2808 // x2809 = VectorApply(x2808,0)
    val x2810 = StoreBanks(List(x2772_d0_b0, x2772_d1_b0), List(b1777), x2809).name("x2810").ctrl(x2811) // ParSRAMStore(x2772,List(List(b1777)),List(x2809),List(x2807))
    ...
    val x2824_0 = ReduceOp(op=FixAdd, input=x2824).name("x2824_0").ctrl(x2831) // FixAdd(x2824,x2825)
    val x2824_1 = ReduceOp(op=FixAdd, input=x2824_0).name("x2824_1").ctrl(x2831) // FixAdd(x2824,x2825)
    val x2824_2 = ReduceOp(op=FixAdd, input=x2824_1).name("x2824_2").ctrl(x2831) // FixAdd(x2824,x2825)
    val x2824_3 = ReduceOp(op=FixAdd, input=x2824_2).name("x2824_3").ctrl(x2831) // FixAdd(x2824,x2825)
    val x2827 = AccumOp(op=FixAdd, input=x2824_3, accum=x2825).name("x2827").ctrl(x2831) // FixAdd(x2824,x2825)
    ...
    val b2920_b2918 = WriteMem(b2918, x2869).name("b2920_b2918").ctrl(x2872) // StreamWrite(x2861,x2870,Const(true))
    ...
    val x2878_x2862 = WriteMem(x2862, x2876).name("x2878_x2862").ctrl(x2879) // ParStreamWrite(x2862,List(x2877),List(b1856))
    ...
    val x2881 = ReadMem(x2863).name("x2881").ctrl(x2882) // StreamRead(x2863,Const(true))
