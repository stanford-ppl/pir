...
object SGD extends PIRApp {
  def main(top:Top) = {
    ...
    val x2717 = LoadMem(x2712, None).name("x2717").ctrl(top) // RegRead(x2712)
    val x2718 = DRAM().name("x2718").ctrl(top) // x2718 = DRAMNew(ArrayBuffer(x2717, Const(16)),Const(0))
    val x2719 = LoadMem(x2712, None).name("x2719").ctrl(top) // RegRead(x2712)
    ...
    val x2737 = StoreBanks(List(List(x2734_d0_b0), List(x2734_d1_b0), List(x2734_d2_b0)), List(b1698), Const(0)).name("x2737").ctrl(x2738) // ParSRAMStore(x2734,List(List(b1698)),List(Const(0)),List(b1699))
    val x2739 = LoadMem(x2711, None).name("x2739").ctrl(x2884) // RegRead(x2711)
    ...
    val x2742 = LoadMem(x2712, None).name("x2742").ctrl(x2860) // RegRead(x2712)
    ...
    val b2913 = StoreMem(List(b2910), None, x2754).name("b2913").ctrl(x2758) // StreamWrite(x2747,x2755,x2756)
    val b2914 = StoreMem(List(b2911), None, Const(64)).name("b2914").ctrl(x2758) // StreamWrite(x2747,x2755,x2756)
    ...
    val b2915 = LoadMem(b2912, None).name("b2915").ctrl(x2767) // ParStreamRead(x2748,List(x2763))
    val b2916 = b2915 // x2765 = VectorApply(x2764,0)
    val x2766 = StoreBanks(List(List(x2733_d0_b0)), List(b1729), b2916).name("x2766").ctrl(x2767) // ParSRAMStore(x2733,List(List(b1729)),List(x2765),List(x2763))
    ...
    val x2778 = StoreMem(List(x2773), None, x2774).name("x2778").ctrl(x2779) // RegWrite(x2773,x2774,x2777)
    ...
    val x2784 = LoadMem(x2773, None).name("x2784").ctrl(x2800) // RegRead(x2773)
    ...
    val b2920 = StoreMem(List(b2917), None, x2794).name("b2920").ctrl(x2800) // StreamWrite(x2782,x2795,x2798)
    val b2921 = StoreMem(List(b2918), None, Const(64)).name("b2921").ctrl(x2800) // StreamWrite(x2782,x2795,x2798)
    ...
    val b2922 = LoadMem(b2919, None).name("b2922").ctrl(x2811) // ParStreamRead(x2783,List(x2807))
    val b2923 = b2922 // x2809 = VectorApply(x2808,0)
    val x2810 = StoreBanks(List(List(x2772_d0_b0), List(x2772_d1_b0)), List(b1777), b2923).name("x2810").ctrl(x2811) // ParSRAMStore(x2772,List(List(b1777)),List(x2809),List(x2807))
    ...
    val x2825 = LoadMem(x2813_d1, None).name("x2825").ctrl(x2831) // RegRead(x2813)
    ...
    val x2830 = StoreMem(List(x2813_d0, x2813_d1), None, x2827).name("x2830").ctrl(x2831) // RegWrite(x2813,x2827,x2829)
    ...
    val x2835 = LoadMem(x2813_d0, None).name("x2835").ctrl(x2838) // RegRead(x2813)
    val x2836 = OpDef(op=FixSub, inputs=List(x2834, x2835)).name("x2836").ctrl(x2838) // FixSub(x2834,x2835)
    val x2837 = StoreMem(List(x2771), None, x2836).name("x2837").ctrl(x2838) // RegWrite(x2771,x2836,x2833)
    ...
    val x2850 = LoadMem(x2771, None).name("x2850").ctrl(x2857) // RegRead(x2771)
    ...
    val x2853 = LoadMem(x2713, None).name("x2853").ctrl(x2857) // RegRead(x2713)
    ...
    val x2856 = StoreBanks(List(List(x2734_d0_b0), List(x2734_d1_b0), List(x2734_d2_b0)), List(b1820), x2855).name("x2856").ctrl(x2857) // ParSRAMStore(x2734,List(List(b1820)),List(x2855),List(x2844))
    ...
    val b2928 = StoreMem(List(b2924), None, x2869).name("b2928").ctrl(x2872) // StreamWrite(x2861,x2870,Const(true))
    val b2929 = StoreMem(List(b2925), None, Const(64)).name("b2929").ctrl(x2872) // StreamWrite(x2861,x2870,Const(true))
    ...
    val b2930 = StoreMem(List(b2926), None, x2876).name("b2930").ctrl(x2879) // ParStreamWrite(x2862,List(x2877),List(b1856))
    ...
    val b2931 = LoadMem(b2927, None).name("b2931").ctrl(x2882) // StreamRead(x2863,Const(true))
