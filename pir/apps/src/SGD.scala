...
object SGD extends PIRApp {
  def main(top:Top) = {
    ...
    val x2861_b2927_x2871_b2929_s = Scalar("x2861_b2927_x2871_b2929")
    ...
    val x2733_x2834_ra_s = Scalar("x2733_x2834_ra")
    ...
    val A_argin = ArgIn("A")
    val x2861_b2928_x2871_b2930_s = Scalar("x2861_b2928_x2871_b2930")
    ...
    val x2782_b2917_x2799_b2919_s = Scalar("x2782_b2917_x2799_b2919")
    ...
    val x2772_x2810_wa_v = Vector("x2772_x2810_wa")
    ...
    val x2733_x2766_wa_v = Vector("x2733_x2766_wa")
    val x2733_dsp0_bank0 = MemoryPipeline(name="x2733_dsp0_bank0",parent="top") { implicit CU => 
      ...
      val b2915 = VectorFIFO(size=1,name="b2915")
        .store(x2733_x2766_wa_v, None, None)
      val b2923 = ScalarFIFO(size=1,name="b2923")
        .store(x2733_x2834_ra_s, None, None)
      val x2733 = SRAM(size=1,name="x2733",banking = Strided(1,16))
        .buffering(1)
        .store(x2766.readPort, Some(b2915.readPort), None)
        .load(x2733_x2733_dsp0_bank0_data_s, Some(b2923.readPort), None)
    }
    val x2734_dsp0_bank0 = MemoryPipeline(name="x2734_dsp0_bank0",parent="top") { implicit CU => 
      ...
      val b2926 = VectorFIFO(size=1,name="b2926")
        .store(x2734_x2856_wa_v, None, None)
      val b2931 = VectorFIFO(size=1,name="b2931")
      ...
      val x2734 = SRAM(size=1,name="x2734",banking = Strided(1,16))
        ...
        .store(x2856.readPort, Some(b2926.readPort), None)
        .load(x2734_x2734_dsp0_bank0_data_v, Some(b2931.readPort), None)
    }
    val x2734_dsp1_bank0 = MemoryPipeline(name="x2734_dsp1_bank0",parent="top") { implicit CU => 
      ...
      val b2910 = VectorFIFO(size=1,name="b2910")
        .store(x2734_x2737_wa_v, None, None)
      val b2924 = VectorFIFO(size=1,name="b2924")
      ...
      val x2734 = SRAM(size=1,name="x2734",banking = Strided(1,16))
        ...
        .store(x2737.readPort, Some(b2910.readPort), None)
        .store(x2856.readPort, Some(b2926.readPort), None)
        .load(x2734_x2734_dsp1_bank0_data_v, Some(b2924.readPort), None)
    }
    val x2734_dsp2_bank0 = MemoryPipeline(name="x2734_dsp2_bank0",parent="top") { implicit CU => 
      ...
      val x2734 = SRAM(size=1,name="x2734",banking = Strided(1,16))
        ...
        .store(x2737.readPort, Some(b2910.readPort), None)
        .store(x2856.readPort, Some(b2926.readPort), None)
        .load(x2734_x2734_dsp2_bank0_data_v, Some(b2922.readPort), None)
    }
    val x2738 = Pipeline(name="x2738",parent="top") { implicit CU => 
    ...
    val x2758 = Pipeline(name="x2758",parent="x2768") { implicit CU => 
    ...
    val x2767 = Pipeline(name="x2767",parent="x2768") { implicit CU => 
      ...
      Stage(operands=List(x2761(0)), op=Bypass, results=List(CU.vecOut(x2733_x2766_wa_v)))
    }
    ...
    val x2772_dsp1_bank0 = MemoryPipeline(name="x2772_dsp1_bank0",parent="x2858") { implicit CU => 
      ...
      val b2920 = VectorFIFO(size=1,name="b2920")
        .store(x2772_x2810_wa_v, None, None)
      val x2772 = SRAM(size=1,name="x2772",banking = Strided(1,16))
        .buffering(1)
        .store(x2810.readPort, Some(b2920.readPort), None)
        .load(x2772_x2772_dsp1_bank0_data_v, Some(b2921.readPort), None)
    }
    val x2772_dsp0_bank0 = MemoryPipeline(name="x2772_dsp0_bank0",parent="x2858") { implicit CU => 
      ...
      val b2920 = VectorFIFO(size=1,name="b2920")
        .store(x2772_x2810_wa_v, None, None)
      val b2925 = VectorFIFO(size=1,name="b2925")
        .store(x2772_x2847_ra_v, None, None)
      val x2772 = SRAM(size=1,name="x2772",banking = Strided(1,16))
        .buffering(1)
        .store(x2810.readPort, Some(b2920.readPort), None)
        .load(x2772_x2772_dsp0_bank0_data_v, Some(b2925.readPort), None)
    }
    val x2779 = Pipeline(name="x2779",parent="x2858") { implicit CU => 
      val x2744 = CounterChain.copy("x2859", "x2744").iterIdx(0, 0)
    ...
    val x2800 = Pipeline(name="x2800",parent="x2812") { implicit CU => 
      ...
      Stage(operands=List(x2790, x2792), op=FixAdd, results=List(CU.scalarOut(x2782_b2916_x2799_b2918_s)))
      Stage(operands=List(Const(64)), op=Bypass, results=List(CU.scalarOut(x2782_b2917_x2799_b2919_s)))
    }
    val x2801 = MemoryController(name="x2801",parent="x2812",offchip=x_oc, mctpe=TileLoad) { implicit CU => 
      val x2782_b2917 = ScalarFIFO(size=1,name="size")
        .store(x2782_b2917_x2799_b2919_s, None, None)
      val x2782_b2916 = ScalarFIFO(size=1,name="offset")
    ...
    val x2811 = Pipeline(name="x2811",parent="x2812") { implicit CU => 
      ...
      Stage(operands=List(x2803(0)), op=Bypass, results=List(CU.vecOut(x2772_x2810_wa_v)))
    }
    ...
    val x2831 = Pipeline(name="x2831",parent="x2839") { implicit CU => 
      val x2813 = CU.temp(Some(0.0)).name("x2813")
      ...
      val (_, rr245) = Stage.reduce(op=FixAdd, init=Const(0.0), accumParent="x2831")
      Stage(operands=List(rr245), op=Bypass, results=List(CU.scalarOut(x2813_x2830_s)))
    }
    val x2819 = Pipeline(name="x2819",parent="x2839") { implicit CU => 
      val x2815 = CounterChain.copy("x2831", "x2815").iterIdx(0, 0)
      Stage(operands=List(x2815(0)), op=Bypass, results=List(CU.vecOut(x2772_x2819_ra_v)))
    }
    val x2821 = Pipeline(name="x2821",parent="x2839") { implicit CU => 
      val x2815 = CounterChain.copy("x2831", "x2815").iterIdx(0, 0)
      Stage(operands=List(x2815(0)), op=Bypass, results=List(CU.vecOut(x2734_x2821_ra_v)))
    }
    val x2838 = Pipeline(name="x2838",parent="x2839") { implicit CU => 
    ...
    val x2834 = Pipeline(name="x2834",parent="x2839") { implicit CU => 
      val x2770 = CounterChain.copy("x2858", "x2770").iterIdx(0, 0)
      Stage(operands=List(x2770(0)), op=Bypass, results=List(CU.scalarOut(x2733_x2834_ra_s)))
    }
    val x2857 = Pipeline(name="x2857",parent="x2858") { implicit CU => 
    ...
    val x2845 = Pipeline(name="x2845",parent="x2858") { implicit CU => 
      val x2841 = CounterChain.copy("x2857", "x2841").iterIdx(0, 0)
      Stage(operands=List(x2841(0)), op=Bypass, results=List(CU.vecOut(x2734_x2845_ra_v)))
    }
    val x2847 = Pipeline(name="x2847",parent="x2858") { implicit CU => 
      val x2841 = CounterChain.copy("x2857", "x2841").iterIdx(0, 0)
    ...
    val x2872 = Pipeline(name="x2872",parent="x2883") { implicit CU => 
      ...
      Stage(operands=List(x2865, x2867), op=FixAdd, results=List(CU.scalarOut(x2861_b2927_x2871_b2929_s)))
      Stage(operands=List(Const(64)), op=Bypass, results=List(CU.scalarOut(x2861_b2928_x2871_b2930_s)))
    }
    ...
    val x2875 = Pipeline(name="x2875",parent="x2883") { implicit CU => 
    ...
    val x2880 = MemoryController(name="x2880",parent="x2883",offchip=result_oc, mctpe=TileStore) { implicit CU => 
      val x2861_b2927 = ScalarFIFO(size=1,name="offset")
        .store(x2861_b2927_x2871_b2929_s, None, None)
      val x2861_b2928 = ScalarFIFO(size=1,name="size")
        .store(x2861_b2928_x2871_b2930_s, None, None)
