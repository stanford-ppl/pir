...
object SGD extends PIRApp {
  def main(top:Top) = {
    ...
    val b2913 = WriteMems(List(b2910), x2754).name("b2913").ctrl(x2758) // StreamWrite(x2747,x2755,x2756)
    val b2914 = WriteMems(List(b2911), Const(64)).name("b2914").ctrl(x2758) // StreamWrite(x2747,x2755,x2756)
    ...
    val b2915 = ReadMem(b2912).name("b2915").ctrl(x2767) // ParStreamRead(x2748,List(x2763))
    ...
    val x2778 = WriteMems(List(x2773), x2774).name("x2778").ctrl(x2779) // RegWrite(x2773,x2774,x2777)
    ...
    val b2920 = WriteMems(List(b2917), x2794).name("b2920").ctrl(x2800) // StreamWrite(x2782,x2795,x2798)
    val b2921 = WriteMems(List(b2918), Const(64)).name("b2921").ctrl(x2800) // StreamWrite(x2782,x2795,x2798)
    ...
    val b2922 = ReadMem(b2919).name("b2922").ctrl(x2811) // ParStreamRead(x2783,List(x2807))
    ...
    val x2830 = WriteMems(List(x2813_d0, x2813_d1), x2827).name("x2830").ctrl(x2831) // RegWrite(x2813,x2827,x2829)
    ...
    val x2837 = WriteMems(List(x2771), x2836).name("x2837").ctrl(x2838) // RegWrite(x2771,x2836,x2833)
    ...
    val b2928 = WriteMems(List(b2924), x2869).name("b2928").ctrl(x2872) // StreamWrite(x2861,x2870,Const(true))
    val b2929 = WriteMems(List(b2925), Const(64)).name("b2929").ctrl(x2872) // StreamWrite(x2861,x2870,Const(true))
    ...
    val b2930 = WriteMems(List(b2926), x2876).name("b2930").ctrl(x2879) // ParStreamWrite(x2862,List(x2877),List(b1856))
    ...
    val b2931 = ReadMem(b2927).name("b2931").ctrl(x2882) // StreamRead(x2863,Const(true))
