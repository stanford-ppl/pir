...
object SGD extends PIRApp {
  def main(top:Top) = {
    ...
    val x2734_x2737_data_s = Scalar("x2734_x2737_data")
    val x2782_b2917_x2799_b2920_s = Scalar("x2782_b2917_x2799_b2920")
    val N_argin = ArgIn("N")
    val x2771_x2837_s = Scalar("x2771_x2837")
    val x2734_x2856_wa_v = Vector("x2734_x2856_wa")
    val result_oc = OffChip("result")
    val x2861_b2925_x2871_b2929_s = Scalar("x2861_b2925_x2871_b2929")
    val x2772_x2847_ra_v = Vector("x2772_x2847_ra")
    val x_oc = OffChip("x")
    val x2747_b2910_x2757_b2913_s = Scalar("x2747_b2910_x2757_b2913")
    val x2734_x2821_ra_v = Vector("x2734_x2821_ra")
    val A_argin = ArgIn("A")
    val x2747_b2911_x2757_b2914_s = Scalar("x2747_b2911_x2757_b2914")
    val E_argin = ArgIn("E")
    ...
    val x2734_x2737_wa_s = Scalar("x2734_x2737_wa")
    val x2782_b2918_x2799_b2921_s = Scalar("x2782_b2918_x2799_b2921")
    ...
    val x2748_b2912_x2759_data_v = Vector("x2748_b2912_x2759_data")
    ...
    val x2783_b2919_x2801_data_v = Vector("x2783_b2919_x2801_data")
    val x2772_x2819_ra_v = Vector("x2772_x2819_ra")
    val x2861_b2924_x2871_b2928_s = Scalar("x2861_b2924_x2871_b2928")
    val x2733_dsp0_bank0 = MemoryPipeline(name="x2733_dsp0_bank0",parent="top") { implicit CU => 
      val x2766 = new VectorFIFO()
        .size(1)
        .name("x2766")
        .store(x2748_b2912_x2759_data_v, None, None)
    ...
    val x2734_dsp0_bank0 = MemoryPipeline(name="x2734_dsp0_bank0",parent="top") { implicit CU => 
      val b2932 = new ScalarFIFO()
        .size(1)
        .name("b2932")
        .store(x2734_x2737_wa_s, None, None)
      val b2937 = new VectorFIFO()
        .size(1)
        .name("b2937")
        .store(x2734_x2856_wa_v, None, None)
      val x2737 = new ScalarFIFO()
        .size(1)
        .name("x2737")
        .store(x2734_x2737_data_s, None, None)
      val b2938 = new VectorFIFO()
        .size(1)
        .name("b2938")
        .store(x2734_x2875_ra_v, None, None)
      val x2856 = new VectorFIFO()
        .size(1)
        .name("x2856")
      ...
      val x2734 = new SRAM()
        ...
        .banking(Strided(1,16))
        .buffering(1)
        .store(x2737, Some(b2932), None)
        .store(x2856, Some(b2937), None)
        .load(x2734_x2734_dsp0_bank0_data_v, Some(b2938), None)
    }
    val x2734_dsp1_bank0 = MemoryPipeline(name="x2734_dsp1_bank0",parent="top") { implicit CU => 
      ...
      val x2734 = new SRAM()
        ...
        .store(x2737, Some(b2932), None)
        .store(x2856, Some(b2937), None)
        .load(x2734_x2734_dsp1_bank0_data_v, Some(b2935), None)
    }
    val x2734_dsp2_bank0 = MemoryPipeline(name="x2734_dsp2_bank0",parent="top") { implicit CU => 
      ...
      val x2734 = new SRAM()
        ...
        .store(x2737, Some(b2932), None)
        .store(x2856, Some(b2937), None)
        .load(x2734_x2734_dsp2_bank0_data_v, Some(b2934), None)
    }
    val x2738_0 = Pipeline(name="x2738_0",parent="top") { implicit CU => 
      ...
      val x2736 = CounterChain(name = "x2736", ctr1).iter(16)
      Stage(operands=List(Const(0.0)), op=Bypass, results=List(x2734_x2737_data_s))
      Stage(operands=List(x2736(0)), op=Bypass, results=List(x2734_x2737_wa_s))
    }
    val x2860 = Sequential(name="x2860",parent="top") { implicit CU => 
      val x2711 = new ScalarBuffer()
        .name("x2711")
        .buffering(1)
        .store(E_argin, None, None)
      val ctr2 = Counter(min=Const(0), max=x2711, step=Const(1), par=1) // Counter
      val x2741 = CounterChain(name = "x2741", ctr2).iter(1)
    }
    val x2859 = Sequential(name="x2859",parent="x2860") { implicit CU => 
      val x2712 = new ScalarBuffer()
        .name("x2712")
        .buffering(1)
        .store(N_argin, None, None)
      val ctr3 = Counter(min=Const(0), max=x2712, step=Const(16), par=1) // Counter
    ...
    val x2758_0 = Pipeline(name="x2758_0",parent="x2768") { implicit CU => 
      ...
      Stage(operands=List(x2750, x2752), op=FixAdd, results=List(x2747_b2910_x2757_b2913_s))
      Stage(operands=List(Const(64)), op=Bypass, results=List(x2747_b2911_x2757_b2914_s))
    }
    val x2759 = MemoryController(name="x2759",parent="x2768",offchip=y_oc, mctpe=TileLoad) { implicit CU => 
      val x2747_b2911 = new ScalarFIFO()
        .size(1)
        .name("size")
        .store(x2747_b2911_x2757_b2914_s, None, None)
      val x2747_b2910 = new ScalarFIFO()
        .size(1)
        .name("offset")
        .store(x2747_b2910_x2757_b2913_s, None, None)
      CU.newOut("data", x2748_b2912_x2759_data_v)
    }
    ...
    val x2772_dsp1_bank0 = MemoryPipeline(name="x2772_dsp1_bank0",parent="x2858") { implicit CU => 
      val b2933 = new VectorFIFO()
        .size(1)
        .name("b2933")
        .store(x2772_x2819_ra_v, None, None)
      val x2810 = new VectorFIFO()
        .size(1)
        .name("x2810")
        .store(x2783_b2919_x2801_data_v, None, None)
      ...
      val x2772 = new SRAM()
        ...
        .banking(Strided(1,16))
        .buffering(1)
        .store(x2810, Some(x2803(0)), None)
        .load(x2772_x2772_dsp1_bank0_data_v, Some(b2933), None)
    }
    val x2772_dsp0_bank0 = MemoryPipeline(name="x2772_dsp0_bank0",parent="x2858") { implicit CU => 
      val b2936 = new VectorFIFO()
        .size(1)
        .name("b2936")
      ...
      val x2772 = new SRAM()
        ...
        .buffering(1)
        .store(x2810, Some(x2803(0)), None)
        .load(x2772_x2772_dsp0_bank0_data_v, Some(b2936), None)
    }
    val x2779_0 = Pipeline(name="x2779_0",parent="x2858") { implicit CU => 
      ...
      Stage(operands=List(x2744(0), x2770(0)), op=FixAdd, results=List(x2773_x2778_s))
    }
    ...
    val x2800_0 = Pipeline(name="x2800_0",parent="x2812") { implicit CU => 
      ...
      val x2792 = new ScalarBuffer()
        .name("x2792")
        .buffering(1)
        .store(x_da, None, None)
      val x2773 = new ScalarBuffer()
        .name("x2773")
        .buffering(1)
      ...
      Stage(operands=List(x2790, x2792), op=FixAdd, results=List(x2782_b2917_x2799_b2920_s))
      Stage(operands=List(Const(64)), op=Bypass, results=List(x2782_b2918_x2799_b2921_s))
    }
    val x2801 = MemoryController(name="x2801",parent="x2812",offchip=x_oc, mctpe=TileLoad) { implicit CU => 
      val x2782_b2918 = new ScalarFIFO()
        .size(1)
        .name("size")
        .store(x2782_b2918_x2799_b2921_s, None, None)
      val x2782_b2917 = new ScalarFIFO()
        .size(1)
        .name("offset")
        .store(x2782_b2917_x2799_b2920_s, None, None)
      CU.newOut("data", x2783_b2919_x2801_data_v)
    }
    ...
    val x2831_0 = Pipeline(name="x2831_0",parent="x2839") { implicit CU => 
      val rd262 = CU.reduce
      val ac264 = CU.accum(Const(0.0)).parent("x2831_0")
      val x2819 = new VectorFIFO()
        .size(1)
        .name("x2819")
        .store(x2772_x2772_dsp1_bank0_data_v, None, None)
      val x2821 = new VectorFIFO()
        .size(1)
        .name("x2821")
      ...
      Stage(operands=List(x2819, x2821), op=FixMul, results=List(rd262))
      ReduceStages(operands=List(rd262, ac264), op=FixAdd, results=List(ac264, x2813_x2830_s))
    }
    val x2819_0 = Pipeline(name="x2819_0",parent="x2839") { implicit CU => 
      val x2815 = CounterChain.copy("x2831_0", "x2815").iterIdx(0, 0)
      Stage(operands=List(x2815(0)), op=Bypass, results=List(x2772_x2819_ra_v))
    }
    val x2821_0 = Pipeline(name="x2821_0",parent="x2839") { implicit CU => 
      val x2815 = CounterChain.copy("x2831_0", "x2815").iterIdx(0, 0)
      Stage(operands=List(x2815(0)), op=Bypass, results=List(x2734_x2821_ra_v))
    }
    val x2838_0 = Pipeline(name="x2838_0",parent="x2839") { implicit CU => 
      val x2834 = new ScalarFIFO()
        .size(1)
        .name("x2834")
        .store(x2733_x2733_dsp0_bank0_data_s, None, None)
      val x2813 = new ScalarBuffer()
        .name("x2813")
        .buffering(1)
        .store(x2813_x2830_s, None, None)
      val x2838_unit = CounterChain(name = "x2838_unit", Counter(Const(0), Const(1), Const(1), par=1)).iter(1l)
      Stage(operands=List(x2834, x2813), op=FixSub, results=List(x2771_x2837_s))
    }
    val x2857_0 = Pipeline(name="x2857_0",parent="x2858") { implicit CU => 
      ...
      val x2771 = new ScalarBuffer()
        .name("x2771")
        .buffering(1)
        .store(x2771_x2837_s, None, None)
      val x2845 = new VectorFIFO()
        .size(1)
        .name("x2845")
        .store(x2734_x2734_dsp1_bank0_data_v, None, None)
      val x2713 = new ScalarBuffer()
        .name("x2713")
        .buffering(1)
        .store(A_argin, None, None)
      val x2847 = new VectorFIFO()
        .size(1)
        .name("x2847")
      ...
      Stage(operands=List(x2845, x2854), op=FixAdd, results=List(x2734_x2856_data_v))
      Stage(operands=List(x2841(0)), op=Bypass, results=List(x2734_x2856_wa_v))
    }
    val x2845_0 = Pipeline(name="x2845_0",parent="x2858") { implicit CU => 
      val x2841 = CounterChain.copy("x2857_0", "x2841").iterIdx(0, 0)
      Stage(operands=List(x2841(0)), op=Bypass, results=List(x2734_x2845_ra_v))
    }
    val x2847_0 = Pipeline(name="x2847_0",parent="x2858") { implicit CU => 
      val x2841 = CounterChain.copy("x2857_0", "x2841").iterIdx(0, 0)
      Stage(operands=List(x2841(0)), op=Bypass, results=List(x2772_x2847_ra_v))
    }
    ...
    val x2872_0 = Pipeline(name="x2872_0",parent="x2883") { implicit CU => 
      ...
      Stage(operands=List(x2865, x2867), op=FixAdd, results=List(x2861_b2924_x2871_b2928_s))
      Stage(operands=List(Const(64)), op=Bypass, results=List(x2861_b2925_x2871_b2929_s))
    }
    ...
    val x2875_0 = Pipeline(name="x2875_0",parent="x2883") { implicit CU => 
      ...
      Stage(operands=List(x2874(0)), op=Bypass, results=List(x2734_x2875_ra_v))
    }
    val x2880 = MemoryController(name="x2880",parent="x2883",offchip=result_oc, mctpe=TileStore) { implicit CU => 
      val x2861_b2924 = new ScalarFIFO()
        .size(1)
        .name("offset")
        .store(x2861_b2924_x2871_b2928_s, None, None)
      val x2862_b2926 = new VectorFIFO()
        .size(1)
        .name("data")
        .store(x2734_x2734_dsp0_bank0_data_v, None, None)
      val x2861_b2925 = new ScalarFIFO()
        .size(1)
        .name("size")
        .store(x2861_b2925_x2871_b2929_s, None, None)
    }
