...
object SGD extends PIRApp {
  def main(top:Top) = {
    ...
    val x2737 = StoreBanks(List(x2734_d0_b0, x2734_d1_b0, x2734_d2_b0), List(b1698), Const(0)).name("x2737").ctrl(x2738) // ParSRAMStore(x2734,List(List(b1698)),List(Const(0)),List(b1699))
    ...
    val x2766 = StoreBanks(List(x2733_d0_b0), List(b1729), b2916).name("x2766").ctrl(x2767) // ParSRAMStore(x2733,List(List(b1729)),List(x2765),List(x2763))
    ...
    val x2810 = StoreBanks(List(x2772_d0_b0, x2772_d1_b0), List(b1777), b2923).name("x2810").ctrl(x2811) // ParSRAMStore(x2772,List(List(b1777)),List(x2809),List(x2807))
