...
object CharRNNStandard_Zynq extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x9378 = DRAM(dims=List(Const(64), Const(512))).name("x9378").ctrl(top).srcCtx("CharRNN.scala:30:25:i2h_1w") // x9378 = DRAMNew(ArrayBuffer(Const(64), Const(512)),Const(0))
    val x9379 = DRAM(dims=List(Const(512))).name("x9379").ctrl(top).srcCtx("CharRNN.scala:31:25:i2h_1b") // x9379 = DRAMNew(ArrayBuffer(Const(512)),Const(0))
    val x9380 = DRAM(dims=List(Const(128), Const(512))).name("x9380").ctrl(top).srcCtx("CharRNN.scala:32:25:i2h_2w") // x9380 = DRAMNew(ArrayBuffer(Const(128), Const(512)),Const(0))
    val x9381 = DRAM(dims=List(Const(512))).name("x9381").ctrl(top).srcCtx("CharRNN.scala:33:25:i2h_2b") // x9381 = DRAMNew(ArrayBuffer(Const(512)),Const(0))
    val x9382 = DRAM(dims=List(Const(128), Const(512))).name("x9382").ctrl(top).srcCtx("CharRNN.scala:34:25:h2h_1w") // x9382 = DRAMNew(ArrayBuffer(Const(128), Const(512)),Const(0))
    val x9383 = DRAM(dims=List(Const(512))).name("x9383").ctrl(top).srcCtx("CharRNN.scala:35:25:h2h_1b") // x9383 = DRAMNew(ArrayBuffer(Const(512)),Const(0))
    val x9384 = DRAM(dims=List(Const(128), Const(512))).name("x9384").ctrl(top).srcCtx("CharRNN.scala:36:25:h2h_2w") // x9384 = DRAMNew(ArrayBuffer(Const(128), Const(512)),Const(0))
    val x9385 = DRAM(dims=List(Const(512))).name("x9385").ctrl(top).srcCtx("CharRNN.scala:37:25:h2h_2b") // x9385 = DRAMNew(ArrayBuffer(Const(512)),Const(0))
    val x9386 = DRAM(dims=List(Const(128), Const(64))).name("x9386").ctrl(top).srcCtx("CharRNN.scala:38:29:decoder_w_") // x9386 = DRAMNew(ArrayBuffer(Const(128), Const(64)),Const(0))
    val x9387 = DRAM(dims=List(Const(64))).name("x9387").ctrl(top).srcCtx("CharRNN.scala:39:29:decoder_b_") // x9387 = DRAMNew(ArrayBuffer(Const(64)),Const(0))
    val x9388 = DRAM(dims=List(Const(1), Const(128))).name("x9388").ctrl(top).srcCtx("CharRNN.scala:40:21:c_") // x9388 = DRAMNew(ArrayBuffer(Const(1), Const(128)),Const(0))
    val x9389 = DRAM(dims=List(Const(1), Const(128))).name("x9389").ctrl(top).srcCtx("CharRNN.scala:41:21:h_") // x9389 = DRAMNew(ArrayBuffer(Const(1), Const(128)),Const(0))
    val x9390 = DRAM(dims=List(Const(3), Const(1), Const(64))).name("x9390").ctrl(top).srcCtx("CharRNN.scala:42:25:inputs") // x9390 = DRAMNew(ArrayBuffer(Const(3), Const(1), Const(64)),Const(0))
    val x9490 = DRAM(dims=List(Const(3), Const(64), Const(1))).name("x9490").ctrl(top).srcCtx("CharRNN.scala:53:26:results") // x9490 = DRAMNew(ArrayBuffer(Const(3), Const(64), Const(1)),Const(0))
