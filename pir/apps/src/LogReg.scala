...
object LogReg extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x3622 = withCtrl(x3766) { CounterChain(List(x3621)).name("x3622").srcCtx("LogReg.scala:62:11") } // CounterChainNew(List(x3621))
    val x3754 = withCtrl(x3766) { LoopController(style=MetaPipe, level=OuterControl, cchain=x3622).name("x3754").srcCtx("LogReg.scala:62:11") } // UnrolledReduce(List(b2191),x3622,x3619,Block((x3619) => Const(())),List(List(b2198)),List(List(b2199)))
    ...
    val x3680 = withCtrl(x3754) { CounterChain(List(x3679)).name("x3680").srcCtx("LogReg.scala:61:13") } // CounterChainNew(List(x3679))
    val x3739 = withCtrl(x3754) { LoopController(style=MetaPipe, level=OuterControl, cchain=x3680).name("x3739").srcCtx("LogReg.scala:61:13") } // UnrolledReduce(List(b2199, b2191),x3680,x3678,Block((x3678) => Const(())),List(List(b2266)),List(List(b2267)))
    ...
    val x3682 = withCtrl(x3739) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3682").srcCtx("LogReg.scala:53:45") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    val x3683 = withCtrl(x3739) { CounterChain(List(x3682)).name("x3683").srcCtx("LogReg.scala:53:86") } // CounterChainNew(List(x3682))
    val x3698 = withCtrl(x3739) { LoopController(style=InnerPipe, level=InnerControl, cchain=x3683).name("x3698").srcCtx("LogReg.scala:53:86") } // UnrolledReduce(List(b2267, b2199, b2191),x3683,x3681,Block((x3681) => Const(())),List(List(b2271)),List(List(b2272)))
    ...
    val x3687 = withCtrl(x3698) { LoadBanks(List(x3623_d1_b0), List(b2266, b2271)).name("x3687").srcCtx("LogReg.scala:53:65") } // ParSRAMLoad(x3623,List(List(b2266, b2271)),List(x3686))
    val x3688 = withCtrl(x3698) { x3687 } // VectorApply(x3687,0)
    val x3689 = withCtrl(x3698) { LoadBanks(List(x3597_d2_b0), List(b2271)).name("x3689").srcCtx("LogReg.scala:53:80") } // ParSRAMLoad(x3597,List(List(b2271)),List(x3686))
    val x3690 = withCtrl(x3698) { x3689 } // VectorApply(x3689,0)
    val x3691 = withCtrl(x3698) { OpDef(op=FltMul, inputs=List(x3688, x3690)).name("x3691").srcCtx("LogReg.scala:53:72") } // FltMul(x3688,x3690)
    val x3692 = withCtrl(x3698) { ReadMem(x3681_d1).name("x3692").srcCtx("LogReg.scala:53:86") } // RegRead(x3681)
    val x3693 = withCtrl(x3698) { OpDef(op=FixEql, inputs=List(b2271, Const(0))).name("x3693").srcCtx("LogReg.scala:53:86") } // FixEql(b2271,Const(0))
    val x3694 = withCtrl(x3698) { ReduceAccumOp(op=FltAdd, input=x3691, accum=x3692).name("x3694").srcCtx("LogReg.scala:53:90") } // FltAdd(x3691,x3692)
    ...
    val x3697_x3681_d0 = withCtrl(x3698) { WriteMem(x3681_d0, x3694).name("x3697_x3681_d0").srcCtx("LogReg.scala:53:86") } // RegWrite(x3681,x3694,x3696)
    antiDepsOf(x3697_x3681_d0)=List(x3692)
    val x3697_x3681_d1 = withCtrl(x3698) { WriteMem(x3681_d1, x3694).name("x3697_x3681_d1").srcCtx("LogReg.scala:53:86") } // RegWrite(x3681,x3694,x3696)
    antiDepsOf(x3697_x3681_d1)=List(x3692)
    val x3699 = withCtrl(x3739) { Reg(init=Some(0.0)).name("x3699").srcCtx("LogReg.scala:54:26:sub") } // x3699 = RegNew(Const(0.0))
    isAccum(x3699) = false
    bufferDepthOf(x3699) = 2
    val x3710 = withCtrl(x3739) { UnitController(style=SeqPipe, level=InnerControl).name("x3710").srcCtx("LogReg.scala:55:18") } // UnitPipe(List(b2267, b2199, b2191),Block(x3709))
    ...
    val x3702 = withCtrl(x3710) { LoadBanks(List(x3624_d0_b0), List(b2266)).name("x3702").srcCtx("LogReg.scala:56:27") } // SRAMLoad(x3624,ArrayBuffer(Const(64)),List(b2266),Const(0),x3701)
    val x3703 = withCtrl(x3710) { ReadMem(x3681_d0).name("x3703").srcCtx("LogReg.scala:56:45") } // RegRead(x3681)
    ...
    val x3708 = withCtrl(x3710) { OpDef(op=FltSub, inputs=List(x3702, x3707)).name("x3708").srcCtx("LogReg.scala:56:32") } // FltSub(x3702,x3707)
    val x3709_x3699 = withCtrl(x3710) { WriteMem(x3699, x3708).name("x3709_x3699").srcCtx("LogReg.scala:56:19") } // RegWrite(x3699,x3708,x3701)
    val x3711_d0_b0 = withCtrl(x3739) { SRAM(size=128, banking=Strided(banks=16, stride=1)).name("x3711_d0_b0").srcCtx("LogReg.scala:58:34:gradRow") } // x3711 = SRAMNew(ArrayBuffer(Const(128)))
    isAccum(x3711_d0_b0) = false
    bufferDepthOf(x3711_d0_b0) = 2
    staticDimsOf(x3711_d0_b0) = List(128)
    val x3712 = withCtrl(x3739) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3712").srcCtx("LogReg.scala:59:28") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    val x3713 = withCtrl(x3739) { CounterChain(List(x3712)).name("x3713").srcCtx("LogReg.scala:59:36") } // CounterChainNew(List(x3712))
    val x3722 = withCtrl(x3739) { LoopController(style=InnerPipe, level=InnerControl, cchain=x3713).name("x3722").srcCtx("LogReg.scala:59:36") } // UnrolledForeach(List(b2267, b2199, b2191),x3713,Block(Const(())),List(List(b2303)),List(List(b2304)))
    ...
    val x3717 = withCtrl(x3722) { LoadBanks(List(x3623_d0_b0), List(b2266, b2303)).name("x3717").srcCtx("LogReg.scala:59:61") } // ParSRAMLoad(x3623,List(List(b2266, b2303)),List(x3716))
    val x3718 = withCtrl(x3722) { x3717 } // VectorApply(x3717,0)
    val x3719 = withCtrl(x3722) { ReadMem(x3699).name("x3719").srcCtx("LogReg.scala:59:75") } // RegRead(x3699)
    val x3720 = withCtrl(x3722) { OpDef(op=FltMul, inputs=List(x3718, x3719)).name("x3720").srcCtx("LogReg.scala:59:69") } // FltMul(x3718,x3719)
    val x3721 = withCtrl(x3722) { StoreBanks(List(List(x3711_d0_b0)), List(b2303), x3720).name("x3721").srcCtx("LogReg.scala:59:54") } // ParSRAMStore(x3711,List(List(b2303)),List(x3720),List(x3716))
    val x3723 = withCtrl(x3739) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3723").srcCtx("LogReg.scala:61:13") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    val x3724 = withCtrl(x3739) { CounterChain(List(x3723)).name("x3724").srcCtx("LogReg.scala:61:13") } // CounterChainNew(ArrayBuffer(x3723))
    val x3738 = withCtrl(x3739) { LoopController(style=InnerPipe, level=InnerControl, cchain=x3724).name("x3738").srcCtx("LogReg.scala:61:13") } // UnrolledForeach(List(),x3724,Block(Const(())),ArrayBuffer(List(b2314)),ArrayBuffer(List(b2315)))
    ...
    val x3727 = withCtrl(x3738) { LoadBanks(List(x3711_d0_b0), List(b2314)).name("x3727").srcCtx("LogReg.scala:61:13") } // ParSRAMLoad(x3711,List(ArrayBuffer(b2314)),List(x3726))
    val x3728 = withCtrl(x3738) { x3727 } // VectorApply(x3727,0)
    val x3729 = withCtrl(x3738) { LoadBanks(List(x3678_d1_b0), List(b2314)).name("x3729").srcCtx("LogReg.scala:61:13") } // ParSRAMLoad(x3678,List(ArrayBuffer(b2314)),List(x3726))
    val x3730 = withCtrl(x3738) { x3729 } // VectorApply(x3729,0)
    val x3731 = withCtrl(x3738) { OpDef(op=BitAnd, inputs=List(b2267, b2199)).name("x3731").srcCtx("LogReg.scala:61:13") } // And(b2267,b2199)
    val x3732 = withCtrl(x3738) { OpDef(op=BitAnd, inputs=List(x3731, b2191)).name("x3732").srcCtx("LogReg.scala:61:13") } // And(x3731,b2191)
    val x3733 = withCtrl(x3738) { OpDef(op=BitAnd, inputs=List(x3732, x3726)).name("x3733").srcCtx("LogReg.scala:61:13") } // And(x3732,x3726)
    val x3734 = withCtrl(x3738) { OpDef(op=FixEql, inputs=List(b2266, Const(0))).name("x3734").srcCtx("LogReg.scala:61:13") } // FixEql(b2266,Const(0))
    val x3735 = withCtrl(x3738) { OpDef(op=FltAdd, inputs=List(x3728, x3730)).name("x3735").srcCtx("LogReg.scala:61:17") } // FltAdd(x3728,x3730)
    val x3736 = withCtrl(x3738) { OpDef(op=MuxOp, inputs=List(x3734, x3728, x3735)).name("x3736").srcCtx("LogReg.scala:61:13") } // Mux(x3734,x3728,x3735)
    val x3737 = withCtrl(x3738) { StoreBanks(List(List(x3678_d0_b0), List(x3678_d1_b0)), List(b2314), x3736).name("x3737").srcCtx("LogReg.scala:61:13") } // ParSRAMStore(x3678,List(ArrayBuffer(b2314)),List(x3736),List(x3726))
    antiDepsOf(x3737)=List(x3729)
    val x3740 = withCtrl(x3754) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3740").srcCtx("LogReg.scala:62:11") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    val x3741 = withCtrl(x3754) { CounterChain(List(x3740)).name("x3741").srcCtx("LogReg.scala:62:11") } // CounterChainNew(ArrayBuffer(x3740))
    val x3753 = withCtrl(x3754) { LoopController(style=InnerPipe, level=InnerControl, cchain=x3741).name("x3753").srcCtx("LogReg.scala:62:11") } // UnrolledForeach(List(),x3741,Block(Const(())),ArrayBuffer(List(b2331)),ArrayBuffer(List(b2332)))
    ...
    val x3743 = withCtrl(x3753) { LoadBanks(List(x3678_d0_b0), List(b2331)).name("x3743").srcCtx("LogReg.scala:62:11") } // ParSRAMLoad(x3678,List(ArrayBuffer(b2331)),List(x3742))
    val x3744 = withCtrl(x3753) { x3743 } // VectorApply(x3743,0)
    val x3745 = withCtrl(x3753) { LoadBanks(List(x3619_d1_b0), List(b2331)).name("x3745").srcCtx("LogReg.scala:62:11") } // ParSRAMLoad(x3619,List(ArrayBuffer(b2331)),List(x3742))
    val x3746 = withCtrl(x3753) { x3745 } // VectorApply(x3745,0)
    val x3747 = withCtrl(x3753) { OpDef(op=BitAnd, inputs=List(b2199, b2191)).name("x3747").srcCtx("LogReg.scala:62:11") } // And(b2199,b2191)
    val x3748 = withCtrl(x3753) { OpDef(op=BitAnd, inputs=List(x3747, x3742)).name("x3748").srcCtx("LogReg.scala:62:11") } // And(x3747,x3742)
    val x3749 = withCtrl(x3753) { OpDef(op=FixEql, inputs=List(b2198, Const(0))).name("x3749").srcCtx("LogReg.scala:62:11") } // FixEql(b2198,Const(0))
    val x3750 = withCtrl(x3753) { OpDef(op=FltAdd, inputs=List(x3744, x3746)).name("x3750").srcCtx("LogReg.scala:62:15") } // FltAdd(x3744,x3746)
    val x3751 = withCtrl(x3753) { OpDef(op=MuxOp, inputs=List(x3749, x3744, x3750)).name("x3751").srcCtx("LogReg.scala:62:11") } // Mux(x3749,x3744,x3750)
    val x3752 = withCtrl(x3753) { StoreBanks(List(List(x3619_d0_b0), List(x3619_d1_b0)), List(b2331), x3751).name("x3752").srcCtx("LogReg.scala:62:11") } // ParSRAMStore(x3619,List(ArrayBuffer(b2331)),List(x3751),List(x3742))
    antiDepsOf(x3752)=List(x3745)
    val x3755 = withCtrl(x3766) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3755").srcCtx("LogReg.scala:64:24") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    val x3756 = withCtrl(x3766) { CounterChain(List(x3755)).name("x3756").srcCtx("LogReg.scala:64:32") } // CounterChainNew(List(x3755))
    val x3765 = withCtrl(x3766) { LoopController(style=InnerPipe, level=InnerControl, cchain=x3756).name("x3765").srcCtx("LogReg.scala:64:32") } // UnrolledForeach(List(b2191),x3756,Block(Const(())),List(List(b2348)),List(List(b2349)))
    ...
    val x3758 = withCtrl(x3765) { LoadBanks(List(x3597_d1_b0), List(b2348)).name("x3758").srcCtx("LogReg.scala:64:57") } // ParSRAMLoad(x3597,List(List(b2348)),List(x3757))
    val x3759 = withCtrl(x3765) { x3758 } // VectorApply(x3758,0)
    val x3760 = withCtrl(x3765) { LoadBanks(List(x3619_d0_b0), List(b2348)).name("x3760").srcCtx("LogReg.scala:64:67") } // ParSRAMLoad(x3619,List(List(b2348)),List(x3757))
    val x3761 = withCtrl(x3765) { x3760 } // VectorApply(x3760,0)
    val x3762 = withCtrl(x3765) { OpDef(op=FltMul, inputs=List(x3761, Const(1.0E-7))).name("x3762").srcCtx("LogReg.scala:64:71") } // FltMul(x3761,Const(0.0000001000000011686097423080354928970337))
    val x3763 = withCtrl(x3765) { OpDef(op=FltAdd, inputs=List(x3759, x3762)).name("x3763").srcCtx("LogReg.scala:64:61") } // FltAdd(x3759,x3762)
    val x3764 = withCtrl(x3765) { StoreBanks(List(List(x3597_d0_b0), List(x3597_d1_b0), List(x3597_d2_b0)), List(b2348), x3763).name("x3764").srcCtx("LogReg.scala:64:49") } // ParSRAMStore(x3597,List(List(b2348)),List(x3763),List(x3757))
    antiDepsOf(x3764)=List(x3758)
    val x3788 = withCtrl(x3789) { UnitController(style=StreamPipe, level=OuterControl).name("x3788").srcCtx("LogReg.scala:68:26") } // UnitPipe(List(Const(true)),Block(Const(())))
    val b3871 = withCtrl(x3788) { StreamOut(field="offset").name("b3871").srcCtx("LogReg.scala:68:26") } // x3767 = StreamOutNew(BurstCmdBus)
    isAccum(b3871) = false
    bufferDepthOf(b3871) = 1
    val b3872 = withCtrl(x3788) { StreamOut(field="size").name("b3872").srcCtx("LogReg.scala:68:26") } // x3767 = StreamOutNew(BurstCmdBus)
    isAccum(b3872) = false
    bufferDepthOf(b3872) = 1
    val x3768 = withCtrl(x3788) { StreamOut(field="data").name("x3768").srcCtx("LogReg.scala:68:26") } // x3768 = StreamOutNew(BurstFullDataBus())
    isAccum(x3768) = false
    bufferDepthOf(x3768) = 1
    val x3769 = withCtrl(x3788) { StreamIn(field="ack").name("x3769").srcCtx("LogReg.scala:68:26") } // x3769 = StreamInNew(BurstAckBus)
    isAccum(x3769) = false
    bufferDepthOf(x3769) = 1
    val x3777 = withCtrl(x3788) { UnitController(style=SeqPipe, level=InnerControl).name("x3777").srcCtx("LogReg.scala:68:26") } // UnitPipe(List(Const(true)),Block(x3776))
    val x3770 = withCtrl(x3777) { Const(0) } // FixConvert(Const(0),TRUE,_32,_0) (Same Type. No op)
    val x3771 = withCtrl(x3777) { OpDef(op=FixSla, inputs=List(x3770, Const(2))).name("x3771").srcCtx("LogReg.scala:68:26") } // FixLsh(x3770,Const(2))
    val x3772 = withCtrl(x3777) { x3771 } // FixConvert(x3771,TRUE,_64,_0)
    val x3773 = withCtrl(x3777) { DramAddress(x3591).name("x3773").srcCtx("LogReg.scala:68:26") } // GetDRAMAddress(x3591)
    val x3775_x3774 = withCtrl(x3777) { OpDef(op=FixAdd, inputs=List(x3772, x3773)).name("x3775_x3774").srcCtx("LogReg.scala:68:26") } // FixAdd(x3772,x3773)
    // x3775 = SimpleStruct(ArrayBuffer((offset,x3774), (size,Const(512)), (isLoad,Const(false))))
    val x3776_b3873_b3871 = withCtrl(x3777) { WriteMem(b3871, x3775_x3774).name("x3776_b3873_b3871").srcCtx("LogReg.scala:68:26") } // StreamWrite(x3767,x3775,Const(true))
    val x3776_b3874_b3872 = withCtrl(x3777) { WriteMem(b3872, Const(512)).name("x3776_b3874_b3872").srcCtx("LogReg.scala:68:26") } // StreamWrite(x3767,x3775,Const(true))
    val x3778 = withCtrl(x3788) { Counter(min=Const(0), max=Const(128), step=Const(1), par=16).name("x3778").srcCtx("LogReg.scala:68:26") } // CounterNew(Const(0),Const(128),Const(1),Const(16))
    val x3779 = withCtrl(x3788) { CounterChain(List(x3778)).name("x3779").srcCtx("LogReg.scala:68:26") } // CounterChainNew(List(x3778))
    val x3784 = withCtrl(x3788) { LoopController(style=InnerPipe, level=InnerControl, cchain=x3779).name("x3784").srcCtx("LogReg.scala:68:26") } // UnrolledForeach(List(Const(true)),x3779,Block(Const(())),List(List(b2373)),List(List(b2374)))
    val b2373 = withCtrl(x3784) { CounterIter(x3778, None).name("b2373") } // b2373
    val b2374 = withCtrl(x3784) { Const(true).name("b2374") } // b2374
    val x3780 = withCtrl(x3784) { LoadBanks(List(x3597_d0_b0), List(b2373)).name("x3780").srcCtx("LogReg.scala:68:26") } // ParSRAMLoad(x3597,List(List(b2373)),List(b2374))
    val x3782_x3781 = withCtrl(x3784) { x3780 } // VectorApply(x3780,0)
    // x3782 = SimpleStruct(ArrayBuffer((_1,x3781), (_2,Const(true))))
    val x3783_x3783_x3768 = withCtrl(x3784) { WriteMem(x3768, x3782_x3781).name("x3783_x3783_x3768").srcCtx("LogReg.scala:68:26") } // ParStreamWrite(x3768,List(x3782),List(b2374))
    val x3785 = withCtrl(x3788) { FringeDenseStore(dram=List(x3591), cmdStream=List(b3871, b3872), dataStream=List(x3768), ackStream=List(x3769)).name("x3785").srcCtx("LogReg.scala:68:26") } // FringeDenseStore(x3591,x3767,x3768,x3769)
    val x3787 = withCtrl(x3788) { UnitController(style=SeqPipe, level=InnerControl).name("x3787").srcCtx("LogReg.scala:68:26") } // UnitPipe(List(Const(true)),Block(Const(())))
    val x3786_x3786 = withCtrl(x3787) { ReadMem(x3769).name("x3786_x3786").srcCtx("LogReg.scala:68:26") } // StreamRead(x3769,Const(true))
