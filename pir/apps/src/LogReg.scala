...
object LogReg extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x3613 = StoreBanks(List(x3597_d0_b0, x3597_d1_b0, x3597_d2_b0), List(b2180), x3612_x3612).name("x3613").ctrl(x3614).srcCtx("LogReg.scala:41:14") // ParSRAMStore(x3597,List(List(b2180)),List(x3612),List(b2181))
    ...
    val x3653 = StoreBanks(List(x3623_d0_b0, x3623_d1_b0), List(b2206, b2227), x3652_x3652).name("x3653").ctrl(x3654).srcCtx("LogReg.scala:49:19") // ParSRAMStore(x3623,List(List(b2206, b2227)),List(x3652),List(x3650))
    ...
    val x3674 = StoreBanks(List(x3624_d0_b0), List(b2251), x3673_x3673).name("x3674").ctrl(x3675).srcCtx("LogReg.scala:50:19") // ParSRAMStore(x3624,List(List(b2251)),List(x3673),List(x3671))
    ...
    val x3721 = StoreBanks(List(x3711_d0_b0), List(b2303), x3720).name("x3721").ctrl(x3722).srcCtx("LogReg.scala:61:54") // ParSRAMStore(x3711,List(List(b2303)),List(x3720),List(x3716))
