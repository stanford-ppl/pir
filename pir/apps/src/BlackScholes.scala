...
object BlackScholes extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x5736 = top.argFringe.argIn(init=0).name("x5736").ctrl(top) // ArgInNew(Const(0))
    boundOf(x5736) = 1024
    ...
    val x5776 = top.argFringe.dramAddress(x5740).name("x5776").ctrl(x5781) // GetDRAMAddress(x5740)
    ...
    val x5782 = FringeContainer(x5740,b6127,b6128,x5772).name("x5782").ctrl(x5790) // FringeDenseLoad(x5740,x5771,x5772)
    ...
    val x5796 = top.argFringe.dramAddress(x5742).name("x5796").ctrl(x5801) // GetDRAMAddress(x5742)
    ...
    val x5802 = FringeContainer(x5742,b6131,b6132,x5792).name("x5802").ctrl(x5810) // FringeDenseLoad(x5742,x5791,x5792)
    ...
    val x5816 = top.argFringe.dramAddress(x5744).name("x5816").ctrl(x5821) // GetDRAMAddress(x5744)
    ...
    val x5822 = FringeContainer(x5744,b6135,b6136,x5812).name("x5822").ctrl(x5830) // FringeDenseLoad(x5744,x5811,x5812)
    ...
    val x5836 = top.argFringe.dramAddress(x5746).name("x5836").ctrl(x5841) // GetDRAMAddress(x5746)
    ...
    val x5842 = FringeContainer(x5746,b6139,b6140,x5832).name("x5842").ctrl(x5850) // FringeDenseLoad(x5746,x5831,x5832)
    ...
    val x5856 = top.argFringe.dramAddress(x5748).name("x5856").ctrl(x5861) // GetDRAMAddress(x5748)
    ...
    val x5862 = FringeContainer(x5748,b6143,b6144,x5852).name("x5862").ctrl(x5870) // FringeDenseLoad(x5748,x5851,x5852)
    ...
    val x5876 = top.argFringe.dramAddress(x5750).name("x5876").ctrl(x5881) // GetDRAMAddress(x5750)
    ...
    val x5882 = FringeContainer(x5750,b6147,b6148,x5872).name("x5882").ctrl(x5890) // FringeDenseLoad(x5750,x5871,x5872)
    ...
    val x6097 = top.argFringe.dramAddress(x5752).name("x6097").ctrl(x6102) // GetDRAMAddress(x5752)
    ...
    val x6111 = FringeContainer(x5752,b6151,b6152,x6092,x6093).name("x6111").ctrl(x6114) // FringeDenseStore(x5752,x6091,x6092,x6093)
