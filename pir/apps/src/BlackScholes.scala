...
object BlackScholes extends PIRApp {
  def main(top:Top) = {
    ...
    val b6132 = WriteMems(List(b6129), x5780).name("b6132").ctrl(x5783) // StreamWrite(x5773,x5781,b3728)
    val b6133 = WriteMems(List(b6130), Const(8000)).name("b6133").ctrl(x5783) // StreamWrite(x5773,x5781,b3728)
    ...
    val b6134 = ReadMem(b6131).name("b6134").ctrl(x5791) // ParStreamRead(x5774,List(x5787))
    ...
    val b6139 = WriteMems(List(b6136), x5800).name("b6139").ctrl(x5803) // StreamWrite(x5793,x5801,b3728)
    val b6140 = WriteMems(List(b6137), Const(8000)).name("b6140").ctrl(x5803) // StreamWrite(x5793,x5801,b3728)
    ...
    val b6141 = ReadMem(b6138).name("b6141").ctrl(x5811) // ParStreamRead(x5794,List(x5807))
    ...
    val b6146 = WriteMems(List(b6143), x5820).name("b6146").ctrl(x5823) // StreamWrite(x5813,x5821,b3728)
    val b6147 = WriteMems(List(b6144), Const(8000)).name("b6147").ctrl(x5823) // StreamWrite(x5813,x5821,b3728)
    ...
    val b6148 = ReadMem(b6145).name("b6148").ctrl(x5831) // ParStreamRead(x5814,List(x5827))
    ...
    val b6153 = WriteMems(List(b6150), x5840).name("b6153").ctrl(x5843) // StreamWrite(x5833,x5841,b3728)
    val b6154 = WriteMems(List(b6151), Const(8000)).name("b6154").ctrl(x5843) // StreamWrite(x5833,x5841,b3728)
    ...
    val b6155 = ReadMem(b6152).name("b6155").ctrl(x5851) // ParStreamRead(x5834,List(x5847))
    ...
    val b6160 = WriteMems(List(b6157), x5860).name("b6160").ctrl(x5863) // StreamWrite(x5853,x5861,b3728)
    val b6161 = WriteMems(List(b6158), Const(8000)).name("b6161").ctrl(x5863) // StreamWrite(x5853,x5861,b3728)
    ...
    val b6162 = ReadMem(b6159).name("b6162").ctrl(x5871) // ParStreamRead(x5854,List(x5867))
    ...
    val b6167 = WriteMems(List(b6164), x5880).name("b6167").ctrl(x5883) // StreamWrite(x5873,x5881,b3728)
    val b6168 = WriteMems(List(b6165), Const(8000)).name("b6168").ctrl(x5883) // StreamWrite(x5873,x5881,b3728)
    ...
    val b6169 = ReadMem(b6166).name("b6169").ctrl(x5891) // ParStreamRead(x5874,List(x5887))
    ...
    val b6175 = WriteMems(List(b6171), x6101).name("b6175").ctrl(x6104) // StreamWrite(x6093,x6102,b3728)
    val b6176 = WriteMems(List(b6172), Const(8000)).name("b6176").ctrl(x6104) // StreamWrite(x6093,x6102,b3728)
    ...
    val b6177 = WriteMems(List(b6173), x6109).name("b6177").ctrl(x6112) // ParStreamWrite(x6094,List(x6110),List(x6107))
    ...
    val b6178 = ReadMem(b6174).name("b6178").ctrl(x6115) // StreamRead(x6095,b3728)
