...
object BlackScholes extends PIRApp {
  def main(top:Top) = {
    ...
    val x5761 = LoadMem(x5738, None).name("x5761").ctrl(x6118) // RegRead(x5738)
    ...
    val b6132 = StoreMem(List(b6129), None, x5780).name("b6132").ctrl(x5783) // StreamWrite(x5773,x5781,b3728)
    val b6133 = StoreMem(List(b6130), None, Const(8000)).name("b6133").ctrl(x5783) // StreamWrite(x5773,x5781,b3728)
    ...
    val b6134 = LoadMem(b6131, None).name("b6134").ctrl(x5791) // ParStreamRead(x5774,List(x5787))
    val b6135 = b6134 // x5789 = VectorApply(x5788,0)
    val x5790 = StoreBanks(List(List(x5764_d0_b0)), List(b3752), b6135).name("x5790").ctrl(x5791) // ParSRAMStore(x5764,List(List(b3752)),List(x5789),List(x5787))
    ...
    val b6139 = StoreMem(List(b6136), None, x5800).name("b6139").ctrl(x5803) // StreamWrite(x5793,x5801,b3728)
    val b6140 = StoreMem(List(b6137), None, Const(8000)).name("b6140").ctrl(x5803) // StreamWrite(x5793,x5801,b3728)
    ...
    val b6141 = LoadMem(b6138, None).name("b6141").ctrl(x5811) // ParStreamRead(x5794,List(x5807))
    val b6142 = b6141 // x5809 = VectorApply(x5808,0)
    val x5810 = StoreBanks(List(List(x5765_d0_b0)), List(b3774), b6142).name("x5810").ctrl(x5811) // ParSRAMStore(x5765,List(List(b3774)),List(x5809),List(x5807))
    ...
    val b6146 = StoreMem(List(b6143), None, x5820).name("b6146").ctrl(x5823) // StreamWrite(x5813,x5821,b3728)
    val b6147 = StoreMem(List(b6144), None, Const(8000)).name("b6147").ctrl(x5823) // StreamWrite(x5813,x5821,b3728)
    ...
    val b6148 = LoadMem(b6145, None).name("b6148").ctrl(x5831) // ParStreamRead(x5814,List(x5827))
    val b6149 = b6148 // x5829 = VectorApply(x5828,0)
    val x5830 = StoreBanks(List(List(x5766_d0_b0)), List(b3796), b6149).name("x5830").ctrl(x5831) // ParSRAMStore(x5766,List(List(b3796)),List(x5829),List(x5827))
    ...
    val b6153 = StoreMem(List(b6150), None, x5840).name("b6153").ctrl(x5843) // StreamWrite(x5833,x5841,b3728)
    val b6154 = StoreMem(List(b6151), None, Const(8000)).name("b6154").ctrl(x5843) // StreamWrite(x5833,x5841,b3728)
    ...
    val b6155 = LoadMem(b6152, None).name("b6155").ctrl(x5851) // ParStreamRead(x5834,List(x5847))
    val b6156 = b6155 // x5849 = VectorApply(x5848,0)
    val x5850 = StoreBanks(List(List(x5767_d0_b0)), List(b3818), b6156).name("x5850").ctrl(x5851) // ParSRAMStore(x5767,List(List(b3818)),List(x5849),List(x5847))
    ...
    val b6160 = StoreMem(List(b6157), None, x5860).name("b6160").ctrl(x5863) // StreamWrite(x5853,x5861,b3728)
    val b6161 = StoreMem(List(b6158), None, Const(8000)).name("b6161").ctrl(x5863) // StreamWrite(x5853,x5861,b3728)
    ...
    val b6162 = LoadMem(b6159, None).name("b6162").ctrl(x5871) // ParStreamRead(x5854,List(x5867))
    val b6163 = b6162 // x5869 = VectorApply(x5868,0)
    val x5870 = StoreBanks(List(List(x5768_d0_b0)), List(b3840), b6163).name("x5870").ctrl(x5871) // ParSRAMStore(x5768,List(List(b3840)),List(x5869),List(x5867))
    ...
    val b6167 = StoreMem(List(b6164), None, x5880).name("b6167").ctrl(x5883) // StreamWrite(x5873,x5881,b3728)
    val b6168 = StoreMem(List(b6165), None, Const(8000)).name("b6168").ctrl(x5883) // StreamWrite(x5873,x5881,b3728)
    ...
    val b6169 = LoadMem(b6166, None).name("b6169").ctrl(x5891) // ParStreamRead(x5874,List(x5887))
    val b6170 = b6169 // x5889 = VectorApply(x5888,0)
    val x5890 = StoreBanks(List(List(x5769_d0_b0)), List(b3862), b6170).name("x5890").ctrl(x5891) // ParSRAMStore(x5769,List(List(b3862)),List(x5889),List(x5887))
    ...
    val x6089 = StoreBanks(List(List(x5770_d0_b0)), List(b3873), x6088).name("x6089").ctrl(x6090) // ParSRAMStore(x5770,List(List(b3873)),List(x6088),List(x5895))
    ...
    val b6175 = StoreMem(List(b6171), None, x6101).name("b6175").ctrl(x6104) // StreamWrite(x6093,x6102,b3728)
    val b6176 = StoreMem(List(b6172), None, Const(8000)).name("b6176").ctrl(x6104) // StreamWrite(x6093,x6102,b3728)
    ...
    val b6177 = StoreMem(List(b6173), None, x6109).name("b6177").ctrl(x6112) // ParStreamWrite(x6094,List(x6110),List(x6107))
    ...
    val b6178 = LoadMem(b6174, None).name("b6178").ctrl(x6115) // StreamRead(x6095,b3728)
