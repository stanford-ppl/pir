...
object BlackScholes extends PIRApp {
  def main(top:Top) = {
    ...
    val x5790 = StoreBanks(List(x5764_d0_b0), List(b3752), b6135).name("x5790").ctrl(x5791) // ParSRAMStore(x5764,List(List(b3752)),List(x5789),List(x5787))
    ...
    val x5810 = StoreBanks(List(x5765_d0_b0), List(b3774), b6142).name("x5810").ctrl(x5811) // ParSRAMStore(x5765,List(List(b3774)),List(x5809),List(x5807))
    ...
    val x5830 = StoreBanks(List(x5766_d0_b0), List(b3796), b6149).name("x5830").ctrl(x5831) // ParSRAMStore(x5766,List(List(b3796)),List(x5829),List(x5827))
    ...
    val x5850 = StoreBanks(List(x5767_d0_b0), List(b3818), b6156).name("x5850").ctrl(x5851) // ParSRAMStore(x5767,List(List(b3818)),List(x5849),List(x5847))
    ...
    val x5870 = StoreBanks(List(x5768_d0_b0), List(b3840), b6163).name("x5870").ctrl(x5871) // ParSRAMStore(x5768,List(List(b3840)),List(x5869),List(x5867))
    ...
    val x5890 = StoreBanks(List(x5769_d0_b0), List(b3862), b6170).name("x5890").ctrl(x5891) // ParSRAMStore(x5769,List(List(b3862)),List(x5889),List(x5887))
