...
object BlackScholes extends PIRApp {
  def main(top:Top) = {
    ...
    val x5780 = x5779 // FixConvert(x5779)
    ...
    val x5800 = x5799 // FixConvert(x5799)
    ...
    val x5820 = x5819 // FixConvert(x5819)
    ...
    val x5840 = x5839 // FixConvert(x5839)
    ...
    val x5860 = x5859 // FixConvert(x5859)
    ...
    val x5880 = x5879 // FixConvert(x5879)
    ...
    val x6101 = x6100 // FixConvert(x6100)
