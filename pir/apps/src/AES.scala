...
object AES extends PIRApp {
  def main(top:Top) = {
    ...
    val x5956 = LoadMem(x5951, None).name("x5956").ctrl(top) // RegRead(x5951)
    ...
    val b6391 = StoreMem(List(b6388), None, x5972).name("b6391").ctrl(x5975) // StreamWrite(x5966,x5973,Const(true))
    val b6392 = StoreMem(List(b6389), None, Const(256)).name("b6392").ctrl(x5975) // StreamWrite(x5966,x5973,Const(true))
    ...
    val b6393 = LoadMem(b6390, None).name("b6393").ctrl(x5982) // ParStreamRead(x5967,List(b3733))
    val b6394 = b6393 // x5980 = VectorApply(x5979,0)
    val x5981 = StoreBanks(List(List(x5963_d0_b0), List(x5963_d1_b0), List(x5963_d2_b0)), List(b3732), b6394).name("x5981").ctrl(x5982) // ParSRAMStore(x5963,List(List(b3732)),List(x5980),List(b3733))
    val x5984 = LoadMem(x5951, None).name("x5984").ctrl(x6364) // RegRead(x5951)
    ...
    val b6398 = StoreMem(List(b6395), None, x5993).name("b6398").ctrl(x5996) // StreamWrite(x5987,x5994,b3743)
    val b6399 = StoreMem(List(b6396), None, Const(16)).name("b6399").ctrl(x5996) // StreamWrite(x5987,x5994,b3743)
    ...
    val b6400 = LoadMem(b6397, None).name("b6400").ctrl(x6004) // ParStreamRead(x5988,List(x6000))
    val b6401 = b6400 // x6002 = VectorApply(x6001,0)
    val x6003 = StoreBanks(List(List(x5961_d0_b0)), List(b3757), b6401).name("x6003").ctrl(x6004) // ParSRAMStore(x5961,List(List(b3757)),List(x6002),List(x6000))
    ...
    val b6405 = StoreMem(List(b6402), None, x6012).name("b6405").ctrl(x6015) // StreamWrite(x6006,x6013,b3743)
    val b6406 = StoreMem(List(b6403), None, Const(32)).name("b6406").ctrl(x6015) // StreamWrite(x6006,x6013,b3743)
    ...
    val b6407 = LoadMem(b6404, None).name("b6407").ctrl(x6023) // ParStreamRead(x6007,List(x6019))
    val b6408 = b6407 // x6021 = VectorApply(x6020,0)
    val x6022 = StoreBanks(List(List(x5964_d0_b0), List(x5964_d5_b0), List(x5964_d1_b0), List(x5964_d6_b0), List(x5964_d9_b0), List(x5964_d2_b0), List(x5964_d7_b0), List(x5964_d3_b0), List(x5964_d8_b0), List(x5964_d4_b0)), List(b3778), b6408).name("x6022").ctrl(x6023) // ParSRAMStore(x5964,List(List(b3778)),List(x6021),List(x6019))
    val x6026 = UnitController(style=SeqPipe, level=InnerControl).name("x6026").ctrl(x6363) // UnitPipe(List(b3743),Block(Const(())))
    val x6025 = StoreMem(List(x5965_d0, x5965_d1), None, Const(1)).name("x6025").ctrl(x6026) // RegWrite(x5965,Const(1),b3743)
    ...
    val x6039 = StoreMem(List(x5962_d0, x5962_d1, x5962_d2, x5962_d3, x5962_d4), Some(List(b3790, b3794)), x6038).name("x6039").ctrl(x6040) // ParRegFileStore(x5962,List(List(b3790, b3794)),List(x6038),List(Const(true)))
    ...
    val x6049 = StoreMem(List(x6044_d0, x6044_d5, x6044_d1, x6044_d6, x6044_d2, x6044_d7, x6044_d3, x6044_d8, x6044_d4), None, x6046).name("x6049").ctrl(x6051) // RegWrite(x6044,x6046,x6048)
    val x6050 = StoreMem(List(x6045_d0, x6045_d1), None, x6047).name("x6050").ctrl(x6051) // RegWrite(x6045,x6047,x6048)
    val x6052 = LoadMem(x6045_d1, None).name("x6052").ctrl(x6320) // RegRead(x6045)
    val x6053 = LoadMem(x6044_d8, None).name("x6053").ctrl(x6320) // RegRead(x6044)
    ...
    val x6054 = LoadMem(x6044_d7, None).name("x6054").ctrl(x6074) // RegRead(x6044)
    ...
    val x6058 = LoadMem(x6044_d6, None).name("x6058").ctrl(x6072) // RegRead(x6044)
    val x6059 = LoadMem(x5962_d4, Some(List(b3826, b3827))).name("x6059").ctrl(x6072) // ParRegFileLoad(x5962,List(List(b3826, b3827)),List(x6058))
    ...
    val x6071 = StoreMem(List(x5962_d0, x5962_d1, x5962_d2, x5962_d3, x5962_d4), Some(List(b3826, b3827)), x6070).name("x6071").ctrl(x6072) // ParRegFileStore(x5962,List(List(b3826, b3827)),List(x6070),List(x6058))
    val x6075 = UnitController(style=SeqPipe, level=OuterControl).name("x6075").ctrl(x6076) // //TODO SwitchCase(Block(Const(())))
    val x6077 = LoadMem(x6045_d0, None).name("x6077").ctrl(x6320) // RegRead(x6045)
    val x6078 = LoadMem(x6044_d5, None).name("x6078").ctrl(x6320) // RegRead(x6044)
    ...
    val x6079 = LoadMem(x6044_d4, None).name("x6079").ctrl(x6105) // RegRead(x6044)
    ...
    val x6091 = LoadMem(x6044_d3, None).name("x6091").ctrl(x6095) // RegRead(x6044)
    val x6092 = LoadMem(x5962_d3, Some(List(b3855, b3861))).name("x6092").ctrl(x6095) // ParRegFileLoad(x5962,List(List(b3855, b3861)),List(x6091))
    val x6093 = x6092 // x6093 = VectorApply(x6092,0)
    val x6094 = StoreMem(List(x6082), Some(List(x6090)), x6093).name("x6094").ctrl(x6095) // ParRegFileStore(x6082,List(List(x6090)),List(x6093),List(x6091))
    ...
    val x6098 = LoadMem(x6044_d2, None).name("x6098").ctrl(x6102) // RegRead(x6044)
    val x6099 = LoadMem(x6082, Some(List(b3875))).name("x6099").ctrl(x6102) // ParRegFileLoad(x6082,List(List(b3875)),List(x6098))
    val x6100 = x6099 // x6100 = VectorApply(x6099,0)
    val x6101 = StoreMem(List(x5962_d0, x5962_d1, x5962_d2, x5962_d3, x5962_d4), Some(List(b3855, b3875)), x6100).name("x6101").ctrl(x6102) // ParRegFileStore(x5962,List(List(b3855, b3875)),List(x6100),List(x6098))
    ...
    val x6111 = LoadMem(x6044_d1, None).name("x6111").ctrl(x6117) // RegRead(x6044)
    ...
    val x6115 = StoreMem(List(x6108_d0, x6108_d5, x6108_d1, x6108_d2, x6108_d3, x6108_d4), None, x6112).name("x6115").ctrl(x6117) // RegWrite(x6108,x6112,x6114)
    val x6116 = StoreMem(List(x6109), None, x6113).name("x6116").ctrl(x6117) // RegWrite(x6109,x6113,x6114)
    val x6118 = LoadMem(x6109, None).name("x6118").ctrl(x6320) // RegRead(x6109)
    val x6119 = LoadMem(x6108_d5, None).name("x6119").ctrl(x6320) // RegRead(x6108)
    ...
    val x6120 = LoadMem(x6108_d4, None).name("x6120").ctrl(x6174) // RegRead(x6108)
    ...
    val x6126 = LoadMem(x6108_d3, None).name("x6126").ctrl(x6130) // RegRead(x6108)
    val x6127 = LoadMem(x5962_d2, Some(List(b3909, b3903))).name("x6127").ctrl(x6130) // ParRegFileLoad(x5962,List(List(b3909, b3903)),List(x6126))
    val x6128 = x6127 // x6128 = VectorApply(x6127,0)
    val x6129 = StoreMem(List(x6123_d0, x6123_d1, x6123_d2), Some(List(b3909)), x6128).name("x6129").ctrl(x6130) // ParRegFileStore(x6123,List(List(b3909)),List(x6128),List(x6126))
    ...
    val x6134 = LoadMem(x6108_d2, None).name("x6134").ctrl(x6172) // RegRead(x6108)
    ...
    val x6135 = LoadMem(x6108_d1, None).name("x6135").ctrl(x6148) // RegRead(x6108)
    val x6136 = LoadMem(x6123_d2, Some(List(b3920))).name("x6136").ctrl(x6148) // ParRegFileLoad(x6123,List(List(b3920)),List(x6135))
    ...
    val x6141 = LoadMem(x6131_d1, None).name("x6141").ctrl(x6148) // RegRead(x6131)
    ...
    val x6147 = StoreMem(List(x6131_d0, x6131_d1), None, x6143).name("x6147").ctrl(x6148) // RegWrite(x6131,x6143,x6146)
    ...
    val x6156 = LoadMem(x6108_d0, None).name("x6156").ctrl(x6171) // RegRead(x6108)
    val x6157 = LoadMem(x6123_d1, Some(List(b3940))).name("x6157").ctrl(x6171) // ParRegFileLoad(x6123,List(List(b3940)),List(x6156))
    val x6158 = x6157 // x6158 = VectorApply(x6157,0)
    val x6159 = LoadMem(x6131_d0, None).name("x6159").ctrl(x6171) // RegRead(x6131)
    val x6160 = OpDef(op=BitXor, inputs=List(x6158, x6159)).name("x6160").ctrl(x6171) // FixXor(x6158,x6159)
    val x6161 = LoadMem(x6123_d0, Some(List(x6155))).name("x6161").ctrl(x6171) // ParRegFileLoad(x6123,List(List(x6155)),List(x6156))
    ...
    val x6170 = StoreMem(List(x5962_d0, x5962_d1, x5962_d2, x5962_d3, x5962_d4), Some(List(b3940, b3903)), x6169).name("x6170").ctrl(x6171) // ParRegFileStore(x5962,List(List(b3940, b3903)),List(x6169),List(x6156))
    ...
    val x6183 = LoadMem(x6044_d0, None).name("x6183").ctrl(x6189) // RegRead(x6044)
    ...
    val x6187 = StoreMem(List(x6177_d0, x6177_d5, x6177_d1, x6177_d6, x6177_d2, x6177_d7, x6177_d3, x6177_d4), None, x6184).name("x6187").ctrl(x6189) // RegWrite(x6177,x6184,x6186)
    val x6188 = StoreMem(List(x6178), None, x6185).name("x6188").ctrl(x6189) // RegWrite(x6178,x6185,x6186)
    val x6190 = LoadMem(x6178, None).name("x6190").ctrl(x6320) // RegRead(x6178)
    val x6191 = LoadMem(x6177_d7, None).name("x6191").ctrl(x6320) // RegRead(x6177)
    ...
    val x6192 = LoadMem(x6177_d6, None).name("x6192").ctrl(x6292) // RegRead(x6177)
    ...
    val x6196 = LoadMem(x6177_d5, None).name("x6196").ctrl(x6216) // RegRead(x6177)
    ...
    val x6212 = LoadMem(x5965_d1, None).name("x6212").ctrl(x6216) // RegRead(x5965)
    ...
    val x6215 = StoreBanks(List(List(x5964_d0_b0), List(x5964_d5_b0), List(x5964_d1_b0), List(x5964_d6_b0), List(x5964_d9_b0), List(x5964_d2_b0), List(x5964_d7_b0), List(x5964_d3_b0), List(x5964_d8_b0), List(x5964_d4_b0)), List(b3984), x6214).name("x6215").ctrl(x6216) // ParSRAMStore(x5964,List(List(b3984)),List(x6214),List(x6199))
    val x6217 = LoadMem(x6177_d4, None).name("x6217").ctrl(x6291) // RegRead(x6177)
    ...
    val x6218 = LoadMem(x5965_d0, None).name("x6218").ctrl(x6228) // RegRead(x5965)
    ...
    val x6224 = LoadMem(x6177_d3, None).name("x6224").ctrl(x6228) // RegRead(x6177)
    ...
    val x6227 = StoreMem(List(x5965_d0, x5965_d1), None, x6223).name("x6227").ctrl(x6228) // RegWrite(x5965,x6223,x6226)
    ...
    val x6236 = LoadMem(x6177_d2, None).name("x6236").ctrl(x6249) // RegRead(x6177)
    ...
    val x6248 = StoreBanks(List(List(x5964_d0_b0), List(x5964_d5_b0), List(x5964_d1_b0), List(x5964_d6_b0), List(x5964_d9_b0), List(x5964_d2_b0), List(x5964_d7_b0), List(x5964_d3_b0), List(x5964_d8_b0), List(x5964_d4_b0)), List(x6235), x6247).name("x6248").ctrl(x6249) // ParSRAMStore(x5964,List(List(x6235)),List(x6247),List(x6240))
    ...
    val x6253 = LoadMem(x6177_d1, None).name("x6253").ctrl(x6268) // RegRead(x6177)
    ...
    val x6267 = StoreBanks(List(List(x5964_d0_b0), List(x5964_d5_b0), List(x5964_d1_b0), List(x5964_d6_b0), List(x5964_d9_b0), List(x5964_d2_b0), List(x5964_d7_b0), List(x5964_d3_b0), List(x5964_d8_b0), List(x5964_d4_b0)), List(b4050), x6266).name("x6267").ctrl(x6268) // ParSRAMStore(x5964,List(List(b4050)),List(x6266),List(x6256))
    ...
    val x6276 = LoadMem(x6177_d0, None).name("x6276").ctrl(x6289) // RegRead(x6177)
    ...
    val x6288 = StoreBanks(List(List(x5964_d0_b0), List(x5964_d5_b0), List(x5964_d1_b0), List(x5964_d6_b0), List(x5964_d9_b0), List(x5964_d2_b0), List(x5964_d7_b0), List(x5964_d3_b0), List(x5964_d8_b0), List(x5964_d4_b0)), List(x6275), x6287).name("x6288").ctrl(x6289) // ParSRAMStore(x5964,List(List(x6275)),List(x6287),List(x6280))
    ...
    val x6315 = LoadMem(x5962_d1, Some(List(b4103, b4104))).name("x6315").ctrl(x6319) // ParRegFileLoad(x5962,List(List(b4103, b4104)),List(Const(true)))
    ...
    val x6318 = StoreMem(List(x5962_d0, x5962_d1, x5962_d2, x5962_d3, x5962_d4), Some(List(b4103, b4104)), x6317).name("x6318").ctrl(x6319) // ParRegFileStore(x5962,List(List(b4103, b4104)),List(x6317),List(Const(true)))
    ...
    val x6329 = LoadMem(x5962_d0, Some(List(b4132, b4133))).name("x6329").ctrl(x6336) // ParRegFileLoad(x5962,List(List(b4132, b4133)),List(Const(true)))
    ...
    val x6335 = StoreBanks(List(List(x6321_d0_b0)), List(x6328), x6332).name("x6335").ctrl(x6336) // ParSRAMStore(x6321,List(List(x6328)),List(x6332),List(x6334))
    ...
    val b6413 = StoreMem(List(b6409), None, x6347).name("b6413").ctrl(x6350) // StreamWrite(x6339,x6348,b3743)
    val b6414 = StoreMem(List(b6410), None, Const(64)).name("b6414").ctrl(x6350) // StreamWrite(x6339,x6348,b3743)
    ...
    val b6415 = StoreMem(List(b6411), None, x6355).name("b6415").ctrl(x6358) // ParStreamWrite(x6340,List(x6356),List(x6353))
    ...
    val b6416 = LoadMem(b6412, None).name("b6416").ctrl(x6361) // StreamRead(x6341,b3743)
