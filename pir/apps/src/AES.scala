...
object AES extends PIRApp {
  def main(top:Top) = {
    ...
    val b6391 = WriteMems(List(b6388), x5972).name("b6391").ctrl(x5975) // StreamWrite(x5966,x5973,Const(true))
    val b6392 = WriteMems(List(b6389), Const(256)).name("b6392").ctrl(x5975) // StreamWrite(x5966,x5973,Const(true))
    ...
    val b6393 = ReadMem(b6390).name("b6393").ctrl(x5982) // ParStreamRead(x5967,List(b3733))
    val b6394 = b6393 // x5980 = VectorApply(x5979,0)
    val x5981 = StoreBanks(List(x5963_d0_b0, x5963_d1_b0, x5963_d2_b0), List(b3732), b6394).name("x5981").ctrl(x5982) // ParSRAMStore(x5963,List(List(b3732)),List(x5980),List(b3733))
    ...
    val b6398 = WriteMems(List(b6395), x5993).name("b6398").ctrl(x5996) // StreamWrite(x5987,x5994,b3743)
    val b6399 = WriteMems(List(b6396), Const(16)).name("b6399").ctrl(x5996) // StreamWrite(x5987,x5994,b3743)
    ...
    val b6400 = ReadMem(b6397).name("b6400").ctrl(x6004) // ParStreamRead(x5988,List(x6000))
    val b6401 = b6400 // x6002 = VectorApply(x6001,0)
    val x6003 = StoreBanks(List(x5961_d0_b0), List(b3757), b6401).name("x6003").ctrl(x6004) // ParSRAMStore(x5961,List(List(b3757)),List(x6002),List(x6000))
    ...
    val b6405 = WriteMems(List(b6402), x6012).name("b6405").ctrl(x6015) // StreamWrite(x6006,x6013,b3743)
    val b6406 = WriteMems(List(b6403), Const(32)).name("b6406").ctrl(x6015) // StreamWrite(x6006,x6013,b3743)
    ...
    val b6407 = ReadMem(b6404).name("b6407").ctrl(x6023) // ParStreamRead(x6007,List(x6019))
    val b6408 = b6407 // x6021 = VectorApply(x6020,0)
    val x6022 = StoreBanks(List(x5964_d0_b0, x5964_d5_b0, x5964_d1_b0, x5964_d6_b0, x5964_d9_b0, x5964_d2_b0, x5964_d7_b0, x5964_d3_b0, x5964_d8_b0, x5964_d4_b0), List(b3778), b6408).name("x6022").ctrl(x6023) // ParSRAMStore(x5964,List(List(b3778)),List(x6021),List(x6019))
    val x6026 = UnitController(style=SeqPipe, level=InnerControl).name("x6026").ctrl(x6363) // UnitPipe(List(b3743),Block(Const(())))
    val x6025 = WriteMems(List(x5965_d0, x5965_d1), Const(1)).name("x6025").ctrl(x6026) // RegWrite(x5965,Const(1),b3743)
    ...
    val x6049 = WriteMems(List(x6044_d0, x6044_d5, x6044_d1, x6044_d6, x6044_d2, x6044_d7, x6044_d3, x6044_d8, x6044_d4), x6046).name("x6049").ctrl(x6051) // RegWrite(x6044,x6046,x6048)
    val x6050 = WriteMems(List(x6045_d0, x6045_d1), x6047).name("x6050").ctrl(x6051) // RegWrite(x6045,x6047,x6048)
    ...
    val x6115 = WriteMems(List(x6108_d0, x6108_d5, x6108_d1, x6108_d2, x6108_d3, x6108_d4), x6112).name("x6115").ctrl(x6117) // RegWrite(x6108,x6112,x6114)
    val x6116 = WriteMems(List(x6109), x6113).name("x6116").ctrl(x6117) // RegWrite(x6109,x6113,x6114)
    ...
    val x6147 = WriteMems(List(x6131_d0, x6131_d1), x6143).name("x6147").ctrl(x6148) // RegWrite(x6131,x6143,x6146)
    ...
    val x6187 = WriteMems(List(x6177_d0, x6177_d5, x6177_d1, x6177_d6, x6177_d2, x6177_d7, x6177_d3, x6177_d4), x6184).name("x6187").ctrl(x6189) // RegWrite(x6177,x6184,x6186)
    val x6188 = WriteMems(List(x6178), x6185).name("x6188").ctrl(x6189) // RegWrite(x6178,x6185,x6186)
    ...
    val x6227 = WriteMems(List(x5965_d0, x5965_d1), x6223).name("x6227").ctrl(x6228) // RegWrite(x5965,x6223,x6226)
    ...
    val b6413 = WriteMems(List(b6409), x6347).name("b6413").ctrl(x6350) // StreamWrite(x6339,x6348,b3743)
    val b6414 = WriteMems(List(b6410), Const(64)).name("b6414").ctrl(x6350) // StreamWrite(x6339,x6348,b3743)
    ...
    val b6415 = WriteMems(List(b6411), x6355).name("b6415").ctrl(x6358) // ParStreamWrite(x6340,List(x6356),List(x6353))
    ...
    val b6416 = ReadMem(b6412).name("b6416").ctrl(x6361) // StreamRead(x6341,b3743)
