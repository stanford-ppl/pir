...
object AES extends PIRApp {
  def main(top:Top) = {
    ...
    val b6390_b6388 = WriteMem(b6388, x5972).name("b6390_b6388").ctrl(x5975) // StreamWrite(x5966,x5973,Const(true))
    ...
    val x5979 = ReadMem(x5967).name("x5979").ctrl(x5982) // ParStreamRead(x5967,List(b3733))
    val x5980 = x5979 // x5980 = VectorApply(x5979,0)
    val x5981 = StoreBanks(List(x5963_d0_b0, x5963_d1_b0, x5963_d2_b0), List(b3732), x5980).name("x5981").ctrl(x5982) // ParSRAMStore(x5963,List(List(b3732)),List(x5980),List(b3733))
    ...
    val b6394_b6392 = WriteMem(b6392, x5993).name("b6394_b6392").ctrl(x5996) // StreamWrite(x5987,x5994,b3743)
    ...
    val x6001 = ReadMem(x5988).name("x6001").ctrl(x6004) // ParStreamRead(x5988,List(x6000))
    val x6002 = x6001 // x6002 = VectorApply(x6001,0)
    val x6003 = StoreBanks(List(x5961_d0_b0), List(b3757), x6002).name("x6003").ctrl(x6004) // ParSRAMStore(x5961,List(List(b3757)),List(x6002),List(x6000))
    ...
    val b6398_b6396 = WriteMem(b6396, x6012).name("b6398_b6396").ctrl(x6015) // StreamWrite(x6006,x6013,b3743)
    ...
    val x6020 = ReadMem(x6007).name("x6020").ctrl(x6023) // ParStreamRead(x6007,List(x6019))
    val x6021 = x6020 // x6021 = VectorApply(x6020,0)
    val x6022 = StoreBanks(List(x5964_d0_b0, x5964_d5_b0, x5964_d1_b0, x5964_d6_b0, x5964_d9_b0, x5964_d2_b0, x5964_d7_b0, x5964_d3_b0, x5964_d8_b0, x5964_d4_b0), List(b3778), x6021).name("x6022").ctrl(x6023) // ParSRAMStore(x5964,List(List(b3778)),List(x6021),List(x6019))
    ...
    val x6137_0 = ReduceOp(op=BitXor, input=x6137).name("x6137_0").ctrl(x6148) // FixXor(x6137,x6141)
    val x6137_1 = ReduceOp(op=BitXor, input=x6137_0).name("x6137_1").ctrl(x6148) // FixXor(x6137,x6141)
    val x6143 = AccumOp(op=BitXor, input=x6137_1, accum=x6141).name("x6143").ctrl(x6148) // FixXor(x6137,x6141)
    ...
    val b6402_b6400 = WriteMem(b6400, x6347).name("b6402_b6400").ctrl(x6350) // StreamWrite(x6339,x6348,b3743)
    ...
    val x6357_x6340 = WriteMem(x6340, x6355).name("x6357_x6340").ctrl(x6358) // ParStreamWrite(x6340,List(x6356),List(x6353))
    ...
    val x6360 = ReadMem(x6341).name("x6360").ctrl(x6361) // StreamRead(x6341,b3743)
