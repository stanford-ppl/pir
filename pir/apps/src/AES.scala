...
object AES extends PIRApp {
  def main(top:Top) = {
    ...
    val x6076 = UnitController(style=ForkSwitch, level=OuterControl).name("x6076").ctrl(x6320) // Switch(Block(x6075),List(x6053, x6052),List(x6074, x6075))
    val x6074 = UnitController(style=SeqPipe, level=OuterControl).name("x6074").ctrl(x6076) // SwitchCase(Block(Const(())))
    ...
    val x6075 = UnitController(style=SeqPipe, level=OuterControl).name("x6075").ctrl(x6076) // SwitchCase(Block(Const(())))
    ...
    val x6107 = UnitController(style=ForkSwitch, level=OuterControl).name("x6107").ctrl(x6320) // Switch(Block(x6106),List(x6078, x6077),List(x6105, x6106))
    val x6105 = UnitController(style=SeqPipe, level=OuterControl).name("x6105").ctrl(x6107) // SwitchCase(Block(Const(())))
    ...
    val x6106 = UnitController(style=SeqPipe, level=OuterControl).name("x6106").ctrl(x6107) // SwitchCase(Block(Const(())))
    ...
    val x6176 = UnitController(style=ForkSwitch, level=OuterControl).name("x6176").ctrl(x6320) // Switch(Block(x6175),List(x6119, x6118),List(x6174, x6175))
    val x6174 = UnitController(style=SeqPipe, level=OuterControl).name("x6174").ctrl(x6176) // SwitchCase(Block(Const(())))
    ...
    val x6175 = UnitController(style=SeqPipe, level=OuterControl).name("x6175").ctrl(x6176) // SwitchCase(Block(Const(())))
    ...
    val x6294 = UnitController(style=ForkSwitch, level=OuterControl).name("x6294").ctrl(x6320) // Switch(Block(x6293),List(x6191, x6190),List(x6292, x6293))
    val x6292 = UnitController(style=SeqPipe, level=OuterControl).name("x6292").ctrl(x6294) // SwitchCase(Block(Const(())))
    ...
    val x6293 = UnitController(style=SeqPipe, level=OuterControl).name("x6293").ctrl(x6294) // SwitchCase(Block(Const(())))
