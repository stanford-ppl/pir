...
object TPCHQ6 extends PIRApp {
  def main(top:Top) = {
    ...
    val x2594_0 = Pipeline(name="x2594_0",parent=x2603) { implicit CU => 
    ...
    val x2601_0 = Pipeline(name="x2601_0",parent=x2603) { implicit CU => 
    ...
    val x2614_0 = Pipeline(name="x2614_0",parent=x2623) { implicit CU => 
    ...
    val x2621_0 = Pipeline(name="x2621_0",parent=x2623) { implicit CU => 
    ...
    val x2634_0 = Pipeline(name="x2634_0",parent=x2643) { implicit CU => 
    ...
    val x2641_0 = Pipeline(name="x2641_0",parent=x2643) { implicit CU => 
    ...
    val x2654_0 = Pipeline(name="x2654_0",parent=x2663) { implicit CU => 
    ...
    val x2661_0 = Pipeline(name="x2661_0",parent=x2663) { implicit CU => 
    ...
    val x2674_0 = Pipeline(name="x2674_0",parent=x2683) { implicit CU => 
    ...
    val x2681_0 = Pipeline(name="x2681_0",parent=x2683) { implicit CU => 
    ...
    val x2694_0 = Pipeline(name="x2694_0",parent=x2703) { implicit CU => 
    ...
    val x2701_0 = Pipeline(name="x2701_0",parent=x2703) { implicit CU => 
    ...
    val x2714_0 = Pipeline(name="x2714_0",parent=x2723) { implicit CU => 
    ...
    val x2721_0 = Pipeline(name="x2721_0",parent=x2723) { implicit CU => 
    ...
    val x2734_0 = Pipeline(name="x2734_0",parent=x2743) { implicit CU => 
    ...
    val x2741_0 = Pipeline(name="x2741_0",parent=x2743) { implicit CU => 
    ...
    val x2771 = StreamController(name="x2771",parent=x2808) { implicit CU => 
      val ctr10 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16) // Counter
      val x2747 = CounterChain(name = "x2747", ctr10).iter(24)
    }
    val x2771_0 = Pipeline(name="x2771_0",parent=x2771) { implicit CU => 
      ...
      Stage(operands=List(x2757, x2759), op=BitAnd, results=List(CU.vecOut(bus_374_v)))
      Stage(operands=List(CU.load(x2750), Const(9999)), op=FixLeq, results=List(CU.vecOut(bus_375_v)))
    }
    val x2771_1 = Pipeline(name="x2771_1",parent=x2771) { implicit CU => 
      ...
      val x2760 = VectorFIFO(size=1,name="x2760").wtPort(bus_374_v)
      val x2750 = ScalarFIFO(size=1,name="x2750").wtPort(x2580_x2580_dsp0_bank0_data_s)
      val x2761 = VectorFIFO(size=1,name="x2761").wtPort(bus_375_v)
      val x2752 = ScalarFIFO(size=1,name="x2752").wtPort(x2582_x2582_dsp0_bank0_data_s)
      Stage(operands=List(CU.load(x2760), CU.load(x2761)), op=BitAnd, results=List(x2762))
      ...
      Stage(operands=List(x2765, x2767, Const(0)), op=MuxOp, results=List(CU.vecOut(bus_382_v)))
    }
    val x2771_2 = Pipeline(name="x2771_2",parent=x2771) { implicit CU => 
      val rr382 = VectorFIFO(size=1,name="rr382").wtPort(bus_382_v)
      Stage(operands=List(CU.load(rr382)), op=Bypass, results=List(CU.reduce))
    ...
    val x2749_0 = Pipeline(name="x2749_0",parent=x2808) { implicit CU => 
    ...
    val x2797_0 = Pipeline(name="x2797_0",parent=x2797) { implicit CU => 
      ...
      Stage(operands=List(x2783, x2785), op=BitAnd, results=List(CU.vecOut(bus_391_v)))
      Stage(operands=List(CU.load(x2776), Const(9999)), op=FixLeq, results=List(CU.vecOut(bus_392_v)))
    }
    val x2797_1 = Pipeline(name="x2797_1",parent=x2797) { implicit CU => 
      val x2788 = CU.temp(None)
      val x2791 = CU.temp(None)
      val x2793 = CU.temp(None)
      val x2790 = CU.temp(None)
      val x2776 = ScalarFIFO(size=1,name="x2776").wtPort(x2581_x2581_dsp0_bank0_data_s)
      val x2786 = VectorFIFO(size=1,name="x2786").wtPort(bus_391_v)
      ...
      val x2787 = VectorFIFO(size=1,name="x2787").wtPort(bus_392_v)
      Stage(operands=List(CU.load(x2786), CU.load(x2787)), op=BitAnd, results=List(x2788))
      ...
      Stage(operands=List(x2791, x2793, Const(0)), op=MuxOp, results=List(CU.vecOut(bus_399_v)))
    }
    val x2797_2 = Pipeline(name="x2797_2",parent=x2797) { implicit CU => 
      val rr399 = VectorFIFO(size=1,name="rr399").wtPort(bus_399_v)
      Stage(operands=List(CU.load(rr399)), op=Bypass, results=List(CU.reduce))
    ...
    val x2775_0 = Pipeline(name="x2775_0",parent=x2808) { implicit CU => 
    ...
    val x2776_0 = Pipeline(name="x2776_0",parent=x2808) { implicit CU => 
      val x2773 = CounterChain.copy("x2797", "x2773").iterIdx(0, 0)
      Stage(operands=List(CU.ctr(x2773(0))), op=Bypass, results=List(CU.scalarOut(x2581_x2776_ra_s)))
    }
    val x2777_0 = Pipeline(name="x2777_0",parent=x2808) { implicit CU => 
      val x2773 = CounterChain.copy("x2797", "x2773").iterIdx(0, 0)
      Stage(operands=List(CU.ctr(x2773(0))), op=Bypass, results=List(CU.scalarOut(x2579_x2777_ra_s)))
    }
    val x2778_0 = Pipeline(name="x2778_0",parent=x2808) { implicit CU => 
      val x2773 = CounterChain.copy("x2797", "x2773").iterIdx(0, 0)
      Stage(operands=List(CU.ctr(x2773(0))), op=Bypass, results=List(CU.scalarOut(x2583_x2778_ra_s)))
    }
    val x2807 = StreamController(name="x2807",parent=x2808) { implicit CU => 
      val x2807_unit = CounterChain(name = "x2807_unit", Counter(Const(0), Const(1), Const(1), par=1)).iter(1l)
    }
    val x2807_0 = Pipeline(name="x2807_0",parent=x2807) { implicit CU => 
      val x2744 = ScalarBuffer(name="x2744").wtPort(x2744_x2770_s)
      val x2745 = ScalarBuffer(name="x2745").wtPort(x2745_x2796_s)
      Stage(operands=List(CU.load(x2744), CU.load(x2745)), op=FixAdd, results=List(CU.scalarOut(bus_403_s)))
    }
    val x2807_1 = Pipeline(name="x2807_1",parent=x2807) { implicit CU => 
      val rr403 = ScalarFIFO(size=1,name="rr403").wtPort(bus_403_s)
      Stage(operands=List(CU.load(rr403)), op=Bypass, results=List(CU.reduce))
