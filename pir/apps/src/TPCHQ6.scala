...
object TPCHQ6 extends PIRApp {
  def main(top:Top) = {
    ...
    val b3138 = WriteMems(List(b3135), x2886).name("b3138").ctrl(x2889) // StreamWrite(x2879,x2887,b1375)
    val b3139 = WriteMems(List(b3136), Const(1536)).name("b3139").ctrl(x2889) // StreamWrite(x2879,x2887,b1375)
    ...
    val b3140 = ReadMem(b3137).name("b3140").ctrl(x2897) // ParStreamRead(x2880,List(x2893))
    ...
    val b3145 = WriteMems(List(b3142), x2906).name("b3145").ctrl(x2909) // StreamWrite(x2899,x2907,b1375)
    val b3146 = WriteMems(List(b3143), Const(1536)).name("b3146").ctrl(x2909) // StreamWrite(x2899,x2907,b1375)
    ...
    val b3147 = ReadMem(b3144).name("b3147").ctrl(x2917) // ParStreamRead(x2900,List(x2913))
    ...
    val b3152 = WriteMems(List(b3149), x2926).name("b3152").ctrl(x2929) // StreamWrite(x2919,x2927,b1375)
    val b3153 = WriteMems(List(b3150), Const(1536)).name("b3153").ctrl(x2929) // StreamWrite(x2919,x2927,b1375)
    ...
    val b3154 = ReadMem(b3151).name("b3154").ctrl(x2937) // ParStreamRead(x2920,List(x2933))
    ...
    val b3159 = WriteMems(List(b3156), x2946).name("b3159").ctrl(x2949) // StreamWrite(x2939,x2947,b1375)
    val b3160 = WriteMems(List(b3157), Const(1536)).name("b3160").ctrl(x2949) // StreamWrite(x2939,x2947,b1375)
    ...
    val b3161 = ReadMem(b3158).name("b3161").ctrl(x2957) // ParStreamRead(x2940,List(x2953))
    ...
    val b3166 = WriteMems(List(b3163), x2968).name("b3166").ctrl(x2971) // StreamWrite(x2961,x2969,b1376)
    val b3167 = WriteMems(List(b3164), Const(1536)).name("b3167").ctrl(x2971) // StreamWrite(x2961,x2969,b1376)
    ...
    val b3168 = ReadMem(b3165).name("b3168").ctrl(x2979) // ParStreamRead(x2962,List(x2975))
    ...
    val b3173 = WriteMems(List(b3170), x2988).name("b3173").ctrl(x2991) // StreamWrite(x2981,x2989,b1376)
    val b3174 = WriteMems(List(b3171), Const(1536)).name("b3174").ctrl(x2991) // StreamWrite(x2981,x2989,b1376)
    ...
    val b3175 = ReadMem(b3172).name("b3175").ctrl(x2999) // ParStreamRead(x2982,List(x2995))
    ...
    val b3180 = WriteMems(List(b3177), x3008).name("b3180").ctrl(x3011) // StreamWrite(x3001,x3009,b1376)
    val b3181 = WriteMems(List(b3178), Const(1536)).name("b3181").ctrl(x3011) // StreamWrite(x3001,x3009,b1376)
    ...
    val b3182 = ReadMem(b3179).name("b3182").ctrl(x3019) // ParStreamRead(x3002,List(x3015))
    ...
    val b3187 = WriteMems(List(b3184), x3028).name("b3187").ctrl(x3031) // StreamWrite(x3021,x3029,b1376)
    val b3188 = WriteMems(List(b3185), Const(1536)).name("b3188").ctrl(x3031) // StreamWrite(x3021,x3029,b1376)
    ...
    val b3189 = ReadMem(b3186).name("b3189").ctrl(x3039) // ParStreamRead(x3022,List(x3035))
    ...
    val x3068 = WriteMems(List(x3041_d0, x3041_d1), x3067).name("x3068").ctrl(x3069) // RegWrite(x3041,x3067,b1375)
    ...
    val x3095 = WriteMems(List(x3042_d0, x3042_d1), x3094).name("x3095").ctrl(x3096) // RegWrite(x3042,x3094,b1376)
    ...
    val x3105 = WriteMems(List(x2865_d0, x2865_d1), x3104).name("x3105").ctrl(x3106) // RegWrite(x2865,x3104,Const(true))
    ...
    val x3109 = WriteMems(List(x2860), x3108).name("x3109").ctrl(x3110) // RegWrite(x2860,x3108,Const(true))
