...
object TPCHQ6 extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x2850 = top.argFringe.argIn(init=0).name("x2850").ctrl(top) // ArgInNew(Const(0))
    ...
    val x2860 = top.argFringe.argOut(init=0).name("x2860").ctrl(top) // ArgOutNew(Const(0))
    ...
    isAccum(x2865_d0) = false
    val x2865_d1 = Reg(init=0).name("x2865_d1").ctrl(x3111) // x2865 = RegNew(Const(0))
    isAccum(x2865_d1) = true
    val x2866 = ReadMem(x2850).name("x2866").ctrl(x3111) // RegRead(x2850)
    val x2867 = Counter(min=Const(0), max=x2866, step=Const(384), par=2).name("x2867").ctrl(x3111) // CounterNew(Const(0),x2866,Const(384),Const(2))
    ...
    isAccum(x2876_d0_b0) = false
    val x2878 = UnitController(style=SeqPipe, level=InnerControl).name("x2878").ctrl(x3107) // UnitPipe(List(b1375),Block(Const(())))
    val x2877 = OpDef(op=FixAdd, inputs=List(b1373, Const(384))).name("x2877").ctrl(x2878) // FixAdd(b1373,Const(384))
    ...
    val x2881 = b1373 // FixConvert(b1373,TRUE,_32,_0)
    val x2882 = OpDef(op=FixSla, inputs=List(x2881, Const(2))).name("x2882").ctrl(x2889) // FixLsh(x2881,Const(2))
    val x2883 = x2882 // FixConvert(x2882,TRUE,_64,_0)
    val x2884 = top.argFringe.dramAddress(x2853).name("x2884").ctrl(x2889) // GetDRAMAddress(x2853)
    val x2885 = OpDef(op=FixAdd, inputs=List(x2883, x2884)).name("x2885").ctrl(x2889) // FixAdd(x2883,x2884)
    val x2887_x2886 = x2885 // FixConvert(x2885,TRUE,_64,_0)
    // x2887 = SimpleStruct(ArrayBuffer((offset,x2886), (size,Const(1536)), (isLoad,Const(true))))
    val b3137_b3135 = WriteMem(b3135, x2887_x2886).name("b3137_b3135").ctrl(x2889) // StreamWrite(x2879,x2887,b1375)
    ...
    val x2891 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16).name("x2891").ctrl(x2898) // CounterNew(Const(0),Const(384),Const(1),Const(16))
    ...
    val x2894_x2894 = ReadMem(x2880).name("x2894").ctrl(x2897) // ParStreamRead(x2880,List(x2893))
    val x2895_x2895 = x2894_x2894 // x2895 = VectorApply(x2894,0)
    val x2896 = StoreBanks(List(x2869_d0_b0), List(b1401), x2895_x2895).name("x2896").ctrl(x2897) // ParSRAMStore(x2869,List(List(b1401)),List(x2895),List(x2893))
    ...
    val x2901 = b1373 // FixConvert(b1373,TRUE,_32,_0)
    val x2902 = OpDef(op=FixSla, inputs=List(x2901, Const(2))).name("x2902").ctrl(x2909) // FixLsh(x2901,Const(2))
    val x2903 = x2902 // FixConvert(x2902,TRUE,_64,_0)
    val x2904 = top.argFringe.dramAddress(x2855).name("x2904").ctrl(x2909) // GetDRAMAddress(x2855)
    val x2905 = OpDef(op=FixAdd, inputs=List(x2903, x2904)).name("x2905").ctrl(x2909) // FixAdd(x2903,x2904)
    val x2907_x2906 = x2905 // FixConvert(x2905,TRUE,_64,_0)
    // x2907 = SimpleStruct(ArrayBuffer((offset,x2906), (size,Const(1536)), (isLoad,Const(true))))
    val b3141_b3139 = WriteMem(b3139, x2907_x2906).name("b3141_b3139").ctrl(x2909) // StreamWrite(x2899,x2907,b1375)
    ...
    val x2911 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16).name("x2911").ctrl(x2918) // CounterNew(Const(0),Const(384),Const(1),Const(16))
    ...
    val x2914_x2914 = ReadMem(x2900).name("x2914").ctrl(x2917) // ParStreamRead(x2900,List(x2913))
    val x2915_x2915 = x2914_x2914 // x2915 = VectorApply(x2914,0)
    val x2916 = StoreBanks(List(x2871_d0_b0), List(b1423), x2915_x2915).name("x2916").ctrl(x2917) // ParSRAMStore(x2871,List(List(b1423)),List(x2915),List(x2913))
    ...
    val x2921 = b1373 // FixConvert(b1373,TRUE,_32,_0)
    val x2922 = OpDef(op=FixSla, inputs=List(x2921, Const(2))).name("x2922").ctrl(x2929) // FixLsh(x2921,Const(2))
    val x2923 = x2922 // FixConvert(x2922,TRUE,_64,_0)
    val x2924 = top.argFringe.dramAddress(x2857).name("x2924").ctrl(x2929) // GetDRAMAddress(x2857)
    val x2925 = OpDef(op=FixAdd, inputs=List(x2923, x2924)).name("x2925").ctrl(x2929) // FixAdd(x2923,x2924)
    val x2927_x2926 = x2925 // FixConvert(x2925,TRUE,_64,_0)
    // x2927 = SimpleStruct(ArrayBuffer((offset,x2926), (size,Const(1536)), (isLoad,Const(true))))
    val b3145_b3143 = WriteMem(b3143, x2927_x2926).name("b3145_b3143").ctrl(x2929) // StreamWrite(x2919,x2927,b1375)
    ...
    val x2931 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16).name("x2931").ctrl(x2938) // CounterNew(Const(0),Const(384),Const(1),Const(16))
    ...
    val x2934_x2934 = ReadMem(x2920).name("x2934").ctrl(x2937) // ParStreamRead(x2920,List(x2933))
    val x2935_x2935 = x2934_x2934 // x2935 = VectorApply(x2934,0)
    val x2936 = StoreBanks(List(x2873_d0_b0), List(b1445), x2935_x2935).name("x2936").ctrl(x2937) // ParSRAMStore(x2873,List(List(b1445)),List(x2935),List(x2933))
    ...
    val x2941 = b1373 // FixConvert(b1373,TRUE,_32,_0)
    val x2942 = OpDef(op=FixSla, inputs=List(x2941, Const(2))).name("x2942").ctrl(x2949) // FixLsh(x2941,Const(2))
    val x2943 = x2942 // FixConvert(x2942,TRUE,_64,_0)
    val x2944 = top.argFringe.dramAddress(x2859).name("x2944").ctrl(x2949) // GetDRAMAddress(x2859)
    val x2945 = OpDef(op=FixAdd, inputs=List(x2943, x2944)).name("x2945").ctrl(x2949) // FixAdd(x2943,x2944)
    val x2947_x2946 = x2945 // FixConvert(x2945,TRUE,_64,_0)
    // x2947 = SimpleStruct(ArrayBuffer((offset,x2946), (size,Const(1536)), (isLoad,Const(true))))
    val b3149_b3147 = WriteMem(b3147, x2947_x2946).name("b3149_b3147").ctrl(x2949) // StreamWrite(x2939,x2947,b1375)
    ...
    val x2951 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16).name("x2951").ctrl(x2958) // CounterNew(Const(0),Const(384),Const(1),Const(16))
    ...
    val x2954_x2954 = ReadMem(x2940).name("x2954").ctrl(x2957) // ParStreamRead(x2940,List(x2953))
    val x2955_x2955 = x2954_x2954 // x2955 = VectorApply(x2954,0)
    val x2956 = StoreBanks(List(x2875_d0_b0), List(b1467), x2955_x2955).name("x2956").ctrl(x2957) // ParSRAMStore(x2875,List(List(b1467)),List(x2955),List(x2953))
    val x2960 = UnitController(style=SeqPipe, level=InnerControl).name("x2960").ctrl(x3107) // UnitPipe(List(b1376),Block(Const(())))
    val x2959 = OpDef(op=FixAdd, inputs=List(b1374, Const(384))).name("x2959").ctrl(x2960) // FixAdd(b1374,Const(384))
    ...
    val x2963 = b1374 // FixConvert(b1374,TRUE,_32,_0)
    val x2964 = OpDef(op=FixSla, inputs=List(x2963, Const(2))).name("x2964").ctrl(x2971) // FixLsh(x2963,Const(2))
    val x2965 = x2964 // FixConvert(x2964,TRUE,_64,_0)
    val x2966 = top.argFringe.dramAddress(x2853).name("x2966").ctrl(x2971) // GetDRAMAddress(x2853)
    val x2967 = OpDef(op=FixAdd, inputs=List(x2965, x2966)).name("x2967").ctrl(x2971) // FixAdd(x2965,x2966)
    val x2969_x2968 = x2967 // FixConvert(x2967,TRUE,_64,_0)
    // x2969 = SimpleStruct(ArrayBuffer((offset,x2968), (size,Const(1536)), (isLoad,Const(true))))
    val b3153_b3151 = WriteMem(b3151, x2969_x2968).name("b3153_b3151").ctrl(x2971) // StreamWrite(x2961,x2969,b1376)
    ...
    val x2973 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16).name("x2973").ctrl(x2980) // CounterNew(Const(0),Const(384),Const(1),Const(16))
    ...
    val x2976_x2976 = ReadMem(x2962).name("x2976").ctrl(x2979) // ParStreamRead(x2962,List(x2975))
    val x2977_x2977 = x2976_x2976 // x2977 = VectorApply(x2976,0)
    val x2978 = StoreBanks(List(x2870_d0_b0), List(b1492), x2977_x2977).name("x2978").ctrl(x2979) // ParSRAMStore(x2870,List(List(b1492)),List(x2977),List(x2975))
    ...
    val x2983 = b1374 // FixConvert(b1374,TRUE,_32,_0)
    val x2984 = OpDef(op=FixSla, inputs=List(x2983, Const(2))).name("x2984").ctrl(x2991) // FixLsh(x2983,Const(2))
    val x2985 = x2984 // FixConvert(x2984,TRUE,_64,_0)
    val x2986 = top.argFringe.dramAddress(x2855).name("x2986").ctrl(x2991) // GetDRAMAddress(x2855)
    val x2987 = OpDef(op=FixAdd, inputs=List(x2985, x2986)).name("x2987").ctrl(x2991) // FixAdd(x2985,x2986)
    val x2989_x2988 = x2987 // FixConvert(x2987,TRUE,_64,_0)
    // x2989 = SimpleStruct(ArrayBuffer((offset,x2988), (size,Const(1536)), (isLoad,Const(true))))
    val b3157_b3155 = WriteMem(b3155, x2989_x2988).name("b3157_b3155").ctrl(x2991) // StreamWrite(x2981,x2989,b1376)
    ...
    val x2993 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16).name("x2993").ctrl(x3000) // CounterNew(Const(0),Const(384),Const(1),Const(16))
    ...
    val x2996_x2996 = ReadMem(x2982).name("x2996").ctrl(x2999) // ParStreamRead(x2982,List(x2995))
    val x2997_x2997 = x2996_x2996 // x2997 = VectorApply(x2996,0)
    val x2998 = StoreBanks(List(x2872_d0_b0), List(b1514), x2997_x2997).name("x2998").ctrl(x2999) // ParSRAMStore(x2872,List(List(b1514)),List(x2997),List(x2995))
    ...
    val x3003 = b1374 // FixConvert(b1374,TRUE,_32,_0)
    val x3004 = OpDef(op=FixSla, inputs=List(x3003, Const(2))).name("x3004").ctrl(x3011) // FixLsh(x3003,Const(2))
    val x3005 = x3004 // FixConvert(x3004,TRUE,_64,_0)
    val x3006 = top.argFringe.dramAddress(x2857).name("x3006").ctrl(x3011) // GetDRAMAddress(x2857)
    val x3007 = OpDef(op=FixAdd, inputs=List(x3005, x3006)).name("x3007").ctrl(x3011) // FixAdd(x3005,x3006)
    val x3009_x3008 = x3007 // FixConvert(x3007,TRUE,_64,_0)
    // x3009 = SimpleStruct(ArrayBuffer((offset,x3008), (size,Const(1536)), (isLoad,Const(true))))
    val b3161_b3159 = WriteMem(b3159, x3009_x3008).name("b3161_b3159").ctrl(x3011) // StreamWrite(x3001,x3009,b1376)
    ...
    val x3013 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16).name("x3013").ctrl(x3020) // CounterNew(Const(0),Const(384),Const(1),Const(16))
    ...
    val x3016_x3016 = ReadMem(x3002).name("x3016").ctrl(x3019) // ParStreamRead(x3002,List(x3015))
    val x3017_x3017 = x3016_x3016 // x3017 = VectorApply(x3016,0)
    val x3018 = StoreBanks(List(x2874_d0_b0), List(b1536), x3017_x3017).name("x3018").ctrl(x3019) // ParSRAMStore(x2874,List(List(b1536)),List(x3017),List(x3015))
    ...
    val x3023 = b1374 // FixConvert(b1374,TRUE,_32,_0)
    val x3024 = OpDef(op=FixSla, inputs=List(x3023, Const(2))).name("x3024").ctrl(x3031) // FixLsh(x3023,Const(2))
    val x3025 = x3024 // FixConvert(x3024,TRUE,_64,_0)
    val x3026 = top.argFringe.dramAddress(x2859).name("x3026").ctrl(x3031) // GetDRAMAddress(x2859)
    val x3027 = OpDef(op=FixAdd, inputs=List(x3025, x3026)).name("x3027").ctrl(x3031) // FixAdd(x3025,x3026)
    val x3029_x3028 = x3027 // FixConvert(x3027,TRUE,_64,_0)
    // x3029 = SimpleStruct(ArrayBuffer((offset,x3028), (size,Const(1536)), (isLoad,Const(true))))
    val b3165_b3163 = WriteMem(b3163, x3029_x3028).name("b3165_b3163").ctrl(x3031) // StreamWrite(x3021,x3029,b1376)
    ...
    val x3033 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16).name("x3033").ctrl(x3040) // CounterNew(Const(0),Const(384),Const(1),Const(16))
    ...
    val x3036_x3036 = ReadMem(x3022).name("x3036").ctrl(x3039) // ParStreamRead(x3022,List(x3035))
    val x3037_x3037 = x3036_x3036 // x3037 = VectorApply(x3036,0)
    val x3038 = StoreBanks(List(x2876_d0_b0), List(b1558), x3037_x3037).name("x3038").ctrl(x3039) // ParSRAMStore(x2876,List(List(b1558)),List(x3037),List(x3035))
    val x3041_d0 = Reg(init=0).name("x3041_d0").ctrl(x3107) // x3041 = RegNew(Const(0))
    isAccum(x3041_d0) = false
    val x3041_d1 = Reg(init=0).name("x3041_d1").ctrl(x3107) // x3041 = RegNew(Const(0))
    isAccum(x3041_d1) = true
    val x3042_d0 = Reg(init=0).name("x3042_d0").ctrl(x3107) // x3042 = RegNew(Const(0))
    isAccum(x3042_d0) = false
    val x3042_d1 = Reg(init=0).name("x3042_d1").ctrl(x3107) // x3042 = RegNew(Const(0))
    isAccum(x3042_d1) = true
    val x3043 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16).name("x3043").ctrl(x3107) // CounterNew(Const(0),Const(384),Const(1),Const(16))
    ...
    val x3054 = OpDef(op=FixLt, inputs=List(Const(0), x3047)).name("x3054").ctrl(x3069) // FixLt(Const(0),x3047)
    val x3055 = OpDef(op=FixLt, inputs=List(x3047, Const(9999))).name("x3055").ctrl(x3069) // FixLt(x3047,Const(9999))
    val x3056 = OpDef(op=BitAnd, inputs=List(x3054, x3055)).name("x3056").ctrl(x3069) // And(x3054,x3055)
    val x3057 = OpDef(op=FixLeq, inputs=List(Const(0), x3049)).name("x3057").ctrl(x3069) // FixLeq(Const(0),x3049)
    val x3058 = OpDef(op=BitAnd, inputs=List(x3056, x3057)).name("x3058").ctrl(x3069) // And(x3056,x3057)
    val x3059 = OpDef(op=FixLeq, inputs=List(x3049, Const(9999))).name("x3059").ctrl(x3069) // FixLeq(x3049,Const(9999))
    val x3060 = OpDef(op=BitAnd, inputs=List(x3058, x3059)).name("x3060").ctrl(x3069) // And(x3058,x3059)
    val x3061 = OpDef(op=FixLt, inputs=List(x3051, Const(24))).name("x3061").ctrl(x3069) // FixLt(x3051,Const(24))
    ...
    val x3064 = OpDef(op=MuxOp, inputs=List(x3062, x3063, Const(0))).name("x3064").ctrl(x3069) // Mux(x3062,x3063,Const(0))
    val x3065 = ReadMem(x3041_d1).name("x3065").ctrl(x3069) // RegRead(x3041)
    val x3066 = OpDef(op=FixEql, inputs=List(b1574, Const(0))).name("x3066").ctrl(x3069) // FixEql(b1574,Const(0))
    val x3067 = ReduceAccumOp(op=FixAdd, input=x3064, accum=x3065).name("x3067").ctrl(x3069) // FixAdd(x3064,x3065)
    ...
    val x3070 = Counter(min=Const(0), max=Const(384), step=Const(1), par=16).name("x3070").ctrl(x3107) // CounterNew(Const(0),Const(384),Const(1),Const(16))
    ...
    val x3081 = OpDef(op=FixLt, inputs=List(Const(0), x3074)).name("x3081").ctrl(x3096) // FixLt(Const(0),x3074)
    val x3082 = OpDef(op=FixLt, inputs=List(x3074, Const(9999))).name("x3082").ctrl(x3096) // FixLt(x3074,Const(9999))
    val x3083 = OpDef(op=BitAnd, inputs=List(x3081, x3082)).name("x3083").ctrl(x3096) // And(x3081,x3082)
    val x3084 = OpDef(op=FixLeq, inputs=List(Const(0), x3076)).name("x3084").ctrl(x3096) // FixLeq(Const(0),x3076)
    val x3085 = OpDef(op=BitAnd, inputs=List(x3083, x3084)).name("x3085").ctrl(x3096) // And(x3083,x3084)
    val x3086 = OpDef(op=FixLeq, inputs=List(x3076, Const(9999))).name("x3086").ctrl(x3096) // FixLeq(x3076,Const(9999))
    val x3087 = OpDef(op=BitAnd, inputs=List(x3085, x3086)).name("x3087").ctrl(x3096) // And(x3085,x3086)
    val x3088 = OpDef(op=FixLt, inputs=List(x3078, Const(24))).name("x3088").ctrl(x3096) // FixLt(x3078,Const(24))
    ...
    val x3091 = OpDef(op=MuxOp, inputs=List(x3089, x3090, Const(0))).name("x3091").ctrl(x3096) // Mux(x3089,x3090,Const(0))
    val x3092 = ReadMem(x3042_d1).name("x3092").ctrl(x3096) // RegRead(x3042)
    val x3093 = OpDef(op=FixEql, inputs=List(b1601, Const(0))).name("x3093").ctrl(x3096) // FixEql(b1601,Const(0))
    val x3094 = ReduceAccumOp(op=FixAdd, input=x3091, accum=x3092).name("x3094").ctrl(x3096) // FixAdd(x3091,x3092)
    ...
    val x3103 = OpDef(op=FixEql, inputs=List(b1373, Const(0))).name("x3103").ctrl(x3106) // FixEql(b1373,Const(0))
    val x3104 = ReduceAccumOp(op=FixAdd, input=x3100, accum=x3102).name("x3104").ctrl(x3106) // FixAdd(x3100,x3102)
