...
object TPCHQ6 extends PIRApp {
  def main(top:Top) = {
    ...
    val x2869_dsp0_bank0 = MemoryPipeline(name="x2869_dsp0_bank0",parent="x3107") { implicit CU => 
      val b3175 = VectorFIFO(size=1,name="b3175")
        .store(x2869_x3046_ra_v, None, None)
      val b3139 = VectorFIFO(size=1,name="b3139")
        .store(x2869_x2896_wa_v, None, None)
      ...
      val x2869 = SRAM(size=24,name="x2869",banking = Strided(1,16))
        .buffering(2)
        .store(x2896.readPort, Some(b3139.readPort), Some("x2898"))
        .load(x2869_x2869_dsp0_bank0_data_v, Some(b3175.readPort), Some("x3069"))
    }
    val x2870_dsp0_bank0 = MemoryPipeline(name="x2870_dsp0_bank0",parent="x3107") { implicit CU => 
      ...
      val b3159 = VectorFIFO(size=1,name="b3159")
        .store(x2870_x2978_wa_v, None, None)
      val b3179 = VectorFIFO(size=1,name="b3179")
        .store(x2870_x3073_ra_v, None, None)
      val x2870 = SRAM(size=24,name="x2870",banking = Strided(1,16))
        .buffering(2)
        .store(x2978.readPort, Some(b3159.readPort), Some("x2980"))
        .load(x2870_x2870_dsp0_bank0_data_v, Some(b3179.readPort), Some("x3096"))
    }
    val x2871_dsp0_bank0 = MemoryPipeline(name="x2871_dsp0_bank0",parent="x3107") { implicit CU => 
      val b3177 = VectorFIFO(size=1,name="b3177")
        .store(x2871_x3050_ra_v, None, None)
      val b3144 = VectorFIFO(size=1,name="b3144")
        .store(x2871_x2916_wa_v, None, None)
      ...
      val x2871 = SRAM(size=24,name="x2871",banking = Strided(1,16))
        .buffering(2)
        .store(x2916.readPort, Some(b3144.readPort), Some("x2918"))
        .load(x2871_x2871_dsp0_bank0_data_v, Some(b3177.readPort), Some("x3069"))
    }
    val x2872_dsp0_bank0 = MemoryPipeline(name="x2872_dsp0_bank0",parent="x3107") { implicit CU => 
      val b3181 = VectorFIFO(size=1,name="b3181")
        .store(x2872_x3077_ra_v, None, None)
      val x2998 = VectorFIFO(size=1,name="x2998")
        .store(x2982_x2992_data_v, None, None)
      val b3164 = VectorFIFO(size=1,name="b3164")
        .store(x2872_x2998_wa_v, None, None)
      val x2872 = SRAM(size=24,name="x2872",banking = Strided(1,16))
        .buffering(2)
        .store(x2998.readPort, Some(b3164.readPort), Some("x3000"))
        .load(x2872_x2872_dsp0_bank0_data_v, Some(b3181.readPort), Some("x3096"))
    }
    val x2873_dsp0_bank0 = MemoryPipeline(name="x2873_dsp0_bank0",parent="x3107") { implicit CU => 
      ...
      val b3176 = VectorFIFO(size=1,name="b3176")
        .store(x2873_x3048_ra_v, None, None)
      val b3149 = VectorFIFO(size=1,name="b3149")
        .store(x2873_x2936_wa_v, None, None)
      val x2873 = SRAM(size=24,name="x2873",banking = Strided(1,16))
        .buffering(2)
        .store(x2936.readPort, Some(b3149.readPort), Some("x2938"))
        .load(x2873_x2873_dsp0_bank0_data_v, Some(b3176.readPort), Some("x3069"))
    }
    val x2874_dsp0_bank0 = MemoryPipeline(name="x2874_dsp0_bank0",parent="x3107") { implicit CU => 
      val b3169 = VectorFIFO(size=1,name="b3169")
        .store(x2874_x3018_wa_v, None, None)
      val b3180 = VectorFIFO(size=1,name="b3180")
        .store(x2874_x3075_ra_v, None, None)
      ...
      val x2874 = SRAM(size=24,name="x2874",banking = Strided(1,16))
        .buffering(2)
        .store(x3018.readPort, Some(b3169.readPort), Some("x3020"))
        .load(x2874_x2874_dsp0_bank0_data_v, Some(b3180.readPort), Some("x3096"))
    }
    val x2875_dsp0_bank0 = MemoryPipeline(name="x2875_dsp0_bank0",parent="x3107") { implicit CU => 
      val b3178 = VectorFIFO(size=1,name="b3178")
        .store(x2875_x3052_ra_v, None, None)
      val b3154 = VectorFIFO(size=1,name="b3154")
        .store(x2875_x2956_wa_v, None, None)
      ...
      val x2875 = SRAM(size=24,name="x2875",banking = Strided(1,16))
        .buffering(2)
        .store(x2956.readPort, Some(b3154.readPort), Some("x2958"))
        .load(x2875_x2875_dsp0_bank0_data_v, Some(b3178.readPort), Some("x3069"))
    }
    val x2876_dsp0_bank0 = MemoryPipeline(name="x2876_dsp0_bank0",parent="x3107") { implicit CU => 
      ...
      val b3174 = VectorFIFO(size=1,name="b3174")
        .store(x2876_x3038_wa_v, None, None)
      val b3182 = VectorFIFO(size=1,name="b3182")
        .store(x2876_x3079_ra_v, None, None)
      val x2876 = SRAM(size=24,name="x2876",banking = Strided(1,16))
        .buffering(2)
        .store(x3038.readPort, Some(b3174.readPort), Some("x3040"))
        .load(x2876_x2876_dsp0_bank0_data_v, Some(b3182.readPort), Some("x3096"))
    }
    ...
    val x2910 = MemoryController(name="x2910",parent="x2918",offchip=quants_oc, mctpe=TileLoad) { implicit CU => 
      val x2899_b3141 = ScalarFIFO(size=1,name="size")
        .store(x2899_b3141_x2908_b3143_s, None, None)
      val x2899_b3140 = ScalarFIFO(size=1,name="offset")
    ...
    val x2930 = MemoryController(name="x2930",parent="x2938",offchip=discts_oc, mctpe=TileLoad) { implicit CU => 
      val x2919_b3145 = ScalarFIFO(size=1,name="offset")
        .store(x2919_b3145_x2928_b3147_s, None, None)
      val x2919_b3146 = ScalarFIFO(size=1,name="size")
        .store(x2919_b3146_x2928_b3148_s, None, None)
    ...
    val x2950 = MemoryController(name="x2950",parent="x2958",offchip=prices_oc, mctpe=TileLoad) { implicit CU => 
      val x2939_b3151 = ScalarFIFO(size=1,name="size")
        .store(x2939_b3151_x2948_b3153_s, None, None)
      val x2939_b3150 = ScalarFIFO(size=1,name="offset")
        .store(x2939_b3150_x2948_b3152_s, None, None)
    ...
    val x2972 = MemoryController(name="x2972",parent="x2980",offchip=dates_oc, mctpe=TileLoad) { implicit CU => 
      val x2961_b3156 = ScalarFIFO(size=1,name="size")
        .store(x2961_b3156_x2970_b3158_s, None, None)
      val x2961_b3155 = ScalarFIFO(size=1,name="offset")
        .store(x2961_b3155_x2970_b3157_s, None, None)
    ...
    val x2992 = MemoryController(name="x2992",parent="x3000",offchip=quants_oc, mctpe=TileLoad) { implicit CU => 
      val x2981_b3160 = ScalarFIFO(size=1,name="offset")
        .store(x2981_b3160_x2990_b3162_s, None, None)
      val x2981_b3161 = ScalarFIFO(size=1,name="size")
        .store(x2981_b3161_x2990_b3163_s, None, None)
    ...
    val x3012 = MemoryController(name="x3012",parent="x3020",offchip=discts_oc, mctpe=TileLoad) { implicit CU => 
      val x3001_b3166 = ScalarFIFO(size=1,name="size")
        .store(x3001_b3166_x3010_b3168_s, None, None)
      val x3001_b3165 = ScalarFIFO(size=1,name="offset")
        .store(x3001_b3165_x3010_b3167_s, None, None)
    ...
    val x3032 = MemoryController(name="x3032",parent="x3040",offchip=prices_oc, mctpe=TileLoad) { implicit CU => 
      val x3021_b3171 = ScalarFIFO(size=1,name="size")
        .store(x3021_b3171_x3030_b3173_s, None, None)
      val x3021_b3170 = ScalarFIFO(size=1,name="offset")
        .store(x3021_b3170_x3030_b3172_s, None, None)
    ...
    val x3069_2 = Pipeline(name="x3069_2",parent="x3069") { implicit CU => 
      val rr363 = VectorFIFO(size=1,name="rr363")
        .store(bus_363_v, None, None)
    ...
    val x3096_2 = Pipeline(name="x3096_2",parent="x3096") { implicit CU => 
      val rr381 = VectorFIFO(size=1,name="rr381")
        .store(bus_381_v, None, None)
