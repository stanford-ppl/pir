...
object TPCHQ6 extends PIRApp {
  def main(top:Top) = {
    ...
    val x2889_0 = Pipeline(name="x2889_0",parent="x2898") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2868(0)), Const(2)), op=FixSla, results=List(x2882))
      Stage(operands=List(x2882, CU.load(x2884)), op=FixAdd, results=List(CU.scalarOut(x2879_b3135_x2888_b3137_s)))
    ...
    val x2897_0 = Pipeline(name="x2897_0",parent="x2898") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2892(0))), op=Bypass, results=List(CU.vecOut(x2869_x2896_wa_v)))
    }
    ...
    val x2909_0 = Pipeline(name="x2909_0",parent="x2918") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2868(0)), Const(2)), op=FixSla, results=List(x2902))
      Stage(operands=List(x2902, CU.load(x2904)), op=FixAdd, results=List(CU.scalarOut(x2899_b3140_x2908_b3142_s)))
    ...
    val x2917_0 = Pipeline(name="x2917_0",parent="x2918") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2912(0))), op=Bypass, results=List(CU.vecOut(x2871_x2916_wa_v)))
    }
    ...
    val x2929_0 = Pipeline(name="x2929_0",parent="x2938") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2868(0)), Const(2)), op=FixSla, results=List(x2922))
      Stage(operands=List(x2922, CU.load(x2924)), op=FixAdd, results=List(CU.scalarOut(x2919_b3145_x2928_b3147_s)))
    ...
    val x2937_0 = Pipeline(name="x2937_0",parent="x2938") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2932(0))), op=Bypass, results=List(CU.vecOut(x2873_x2936_wa_v)))
    }
    ...
    val x2949_0 = Pipeline(name="x2949_0",parent="x2958") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2868(0)), Const(2)), op=FixSla, results=List(x2942))
      Stage(operands=List(x2942, CU.load(x2944)), op=FixAdd, results=List(CU.scalarOut(x2939_b3150_x2948_b3152_s)))
    ...
    val x2957_0 = Pipeline(name="x2957_0",parent="x2958") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2952(0))), op=Bypass, results=List(CU.vecOut(x2875_x2956_wa_v)))
    }
    ...
    val x2971_0 = Pipeline(name="x2971_0",parent="x2980") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2868(0)), Const(2)), op=FixSla, results=List(x2964))
      Stage(operands=List(x2964, CU.load(x2966)), op=FixAdd, results=List(CU.scalarOut(x2961_b3155_x2970_b3157_s)))
    ...
    val x2979_0 = Pipeline(name="x2979_0",parent="x2980") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2974(0))), op=Bypass, results=List(CU.vecOut(x2870_x2978_wa_v)))
    }
    ...
    val x2991_0 = Pipeline(name="x2991_0",parent="x3000") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2868(0)), Const(2)), op=FixSla, results=List(x2984))
      Stage(operands=List(x2984, CU.load(x2986)), op=FixAdd, results=List(CU.scalarOut(x2981_b3160_x2990_b3162_s)))
    ...
    val x2999_0 = Pipeline(name="x2999_0",parent="x3000") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2994(0))), op=Bypass, results=List(CU.vecOut(x2872_x2998_wa_v)))
    }
    ...
    val x3011_0 = Pipeline(name="x3011_0",parent="x3020") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2868(0)), Const(2)), op=FixSla, results=List(x3004))
      Stage(operands=List(x3004, CU.load(x3006)), op=FixAdd, results=List(CU.scalarOut(x3001_b3165_x3010_b3167_s)))
    ...
    val x3019_0 = Pipeline(name="x3019_0",parent="x3020") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x3014(0))), op=Bypass, results=List(CU.vecOut(x2874_x3018_wa_v)))
    }
    ...
    val x3031_0 = Pipeline(name="x3031_0",parent="x3040") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x2868(0)), Const(2)), op=FixSla, results=List(x3024))
      Stage(operands=List(x3024, CU.load(x3026)), op=FixAdd, results=List(CU.scalarOut(x3021_b3170_x3030_b3172_s)))
    ...
    val x3039_0 = Pipeline(name="x3039_0",parent="x3040") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x3034(0))), op=Bypass, results=List(CU.vecOut(x2876_x3038_wa_v)))
    }
    ...
    val x3069_2 = Pipeline(name="x3069_2",parent="x3069") { implicit CU => 
      ...
      Stage(operands=List(CU.load(rr363)), op=Bypass, results=List(CU.reduce))
    ...
    val x3069_0 = Pipeline(name="x3069_0",parent="x3069") { implicit CU => 
      val x3054 = CU.temp(None)
      val x3058 = CU.temp(None)
      val x3057 = CU.temp(None)
      val x3059 = CU.temp(None)
      ...
      Stage(operands=List(Const(0), CU.load(x3046)), op=FixLt, results=List(x3054))
      Stage(operands=List(CU.load(x3046), Const(9999)), op=FixLt, results=List(x3055))
      Stage(operands=List(x3054, x3055), op=BitAnd, results=List(x3056))
      Stage(operands=List(Const(0), CU.load(x3048)), op=FixLeq, results=List(x3057))
      Stage(operands=List(x3056, x3057), op=BitAnd, results=List(x3058))
      Stage(operands=List(CU.load(x3048), Const(9999)), op=FixLeq, results=List(x3059))
    ...
    val x3069_1 = Pipeline(name="x3069_1",parent="x3069") { implicit CU => 
      val x3062 = CU.temp(None)
      val x3063 = CU.temp(None)
      val x3061 = CU.temp(None)
      ...
      Stage(operands=List(CU.load(x3050), Const(24)), op=FixLt, results=List(x3061))
      Stage(operands=List(CU.load(x3060), x3061), op=BitAnd, results=List(x3062))
      Stage(operands=List(CU.load(x3052), CU.load(x3048)), op=FixMul, results=List(x3063))
    ...
    val x3046_0 = Pipeline(name="x3046_0",parent="x3107") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x3044(0))), op=Bypass, results=List(CU.vecOut(x2869_x3046_ra_v)))
    }
    val x3048_0 = Pipeline(name="x3048_0",parent="x3107") { implicit CU => 
      val x3044 = CounterChain.copy("x3069", "x3044").iterIdx(0, 0)
      Stage(operands=List(CU.ctr(x3044(0))), op=Bypass, results=List(CU.vecOut(x2873_x3048_ra_v)))
    }
    val x3050_0 = Pipeline(name="x3050_0",parent="x3107") { implicit CU => 
      val x3044 = CounterChain.copy("x3069", "x3044").iterIdx(0, 0)
      Stage(operands=List(CU.ctr(x3044(0))), op=Bypass, results=List(CU.vecOut(x2871_x3050_ra_v)))
    }
    val x3052_0 = Pipeline(name="x3052_0",parent="x3107") { implicit CU => 
      val x3044 = CounterChain.copy("x3069", "x3044").iterIdx(0, 0)
      Stage(operands=List(CU.ctr(x3044(0))), op=Bypass, results=List(CU.vecOut(x2875_x3052_ra_v)))
    }
    val x3096_2 = Pipeline(name="x3096_2",parent="x3096") { implicit CU => 
      ...
      Stage(operands=List(CU.load(rr381)), op=Bypass, results=List(CU.reduce))
    ...
    val x3096_0 = Pipeline(name="x3096_0",parent="x3096") { implicit CU => 
      ...
      val x3083 = CU.temp(None)
      val x3084 = CU.temp(None)
      val x3081 = CU.temp(None)
      val x3082 = CU.temp(None)
      ...
      Stage(operands=List(Const(0), CU.load(x3073)), op=FixLt, results=List(x3081))
      Stage(operands=List(CU.load(x3073), Const(9999)), op=FixLt, results=List(x3082))
      Stage(operands=List(x3081, x3082), op=BitAnd, results=List(x3083))
      Stage(operands=List(Const(0), CU.load(x3075)), op=FixLeq, results=List(x3084))
      Stage(operands=List(x3083, x3084), op=BitAnd, results=List(x3085))
      Stage(operands=List(CU.load(x3075), Const(9999)), op=FixLeq, results=List(x3086))
    ...
    val x3096_1 = Pipeline(name="x3096_1",parent="x3096") { implicit CU => 
      val x3089 = CU.temp(None)
      val x3090 = CU.temp(None)
      val x3088 = CU.temp(None)
      ...
      Stage(operands=List(CU.load(x3077), Const(24)), op=FixLt, results=List(x3088))
      Stage(operands=List(CU.load(x3087), x3088), op=BitAnd, results=List(x3089))
      Stage(operands=List(CU.load(x3079), CU.load(x3075)), op=FixMul, results=List(x3090))
    ...
    val x3073_0 = Pipeline(name="x3073_0",parent="x3107") { implicit CU => 
      ...
      Stage(operands=List(CU.ctr(x3071(0))), op=Bypass, results=List(CU.vecOut(x2870_x3073_ra_v)))
    }
    val x3075_0 = Pipeline(name="x3075_0",parent="x3107") { implicit CU => 
      val x3071 = CounterChain.copy("x3096", "x3071").iterIdx(0, 0)
      Stage(operands=List(CU.ctr(x3071(0))), op=Bypass, results=List(CU.vecOut(x2874_x3075_ra_v)))
    }
    val x3077_0 = Pipeline(name="x3077_0",parent="x3107") { implicit CU => 
      val x3071 = CounterChain.copy("x3096", "x3071").iterIdx(0, 0)
      Stage(operands=List(CU.ctr(x3071(0))), op=Bypass, results=List(CU.vecOut(x2872_x3077_ra_v)))
    }
    val x3079_0 = Pipeline(name="x3079_0",parent="x3107") { implicit CU => 
      val x3071 = CounterChain.copy("x3096", "x3071").iterIdx(0, 0)
      Stage(operands=List(CU.ctr(x3071(0))), op=Bypass, results=List(CU.vecOut(x2876_x3079_ra_v)))
    }
    val x3106_0 = Pipeline(name="x3106_0",parent="x3107") { implicit CU => 
      ...
      Stage(operands=List(CU.load(x3041), CU.load(x3042)), op=FixAdd, results=List(CU.reduce))
