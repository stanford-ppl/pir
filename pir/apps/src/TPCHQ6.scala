...
object TPCHQ6 extends PIRApp {
  def main(top:Top) = {
    ...
    val x2896 = StoreBanks(List(List(x2869_d0_b0)), List(b1401), b3141).name("x2896").ctrl(x2897) // ParSRAMStore(x2869,List(List(b1401)),List(x2895),List(x2893))
    ...
    val x2916 = StoreBanks(List(List(x2871_d0_b0)), List(b1423), b3148).name("x2916").ctrl(x2917) // ParSRAMStore(x2871,List(List(b1423)),List(x2915),List(x2913))
    ...
    val x2936 = StoreBanks(List(List(x2873_d0_b0)), List(b1445), b3155).name("x2936").ctrl(x2937) // ParSRAMStore(x2873,List(List(b1445)),List(x2935),List(x2933))
    ...
    val x2956 = StoreBanks(List(List(x2875_d0_b0)), List(b1467), b3162).name("x2956").ctrl(x2957) // ParSRAMStore(x2875,List(List(b1467)),List(x2955),List(x2953))
    ...
    val x2978 = StoreBanks(List(List(x2870_d0_b0)), List(b1492), b3169).name("x2978").ctrl(x2979) // ParSRAMStore(x2870,List(List(b1492)),List(x2977),List(x2975))
    ...
    val x2998 = StoreBanks(List(List(x2872_d0_b0)), List(b1514), b3176).name("x2998").ctrl(x2999) // ParSRAMStore(x2872,List(List(b1514)),List(x2997),List(x2995))
    ...
    val x3018 = StoreBanks(List(List(x2874_d0_b0)), List(b1536), b3183).name("x3018").ctrl(x3019) // ParSRAMStore(x2874,List(List(b1536)),List(x3017),List(x3015))
    ...
    val x3038 = StoreBanks(List(List(x2876_d0_b0)), List(b1558), b3190).name("x3038").ctrl(x3039) // ParSRAMStore(x2876,List(List(b1558)),List(x3037),List(x3035))
