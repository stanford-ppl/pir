...
object TPCHQ6 extends PIRApp {
  def main(top:Top) = {
    ...
    val x2852 = LoadDef(List(x2850), None).name("x2852").ctrl(top) // RegRead(x2850)
    val x2853 = DRAM().name("x2853").ctrl(top) // x2853 = DRAMNew(ArrayBuffer(x2852),Const(0))
    val x2854 = LoadDef(List(x2850), None).name("x2854").ctrl(top) // RegRead(x2850)
    val x2855 = DRAM().name("x2855").ctrl(top) // x2855 = DRAMNew(ArrayBuffer(x2854),Const(0))
    val x2856 = LoadDef(List(x2850), None).name("x2856").ctrl(top) // RegRead(x2850)
    val x2857 = DRAM().name("x2857").ctrl(top) // x2857 = DRAMNew(ArrayBuffer(x2856),Const(0))
    val x2858 = LoadDef(List(x2850), None).name("x2858").ctrl(top) // RegRead(x2850)
    ...
    val x2866 = LoadDef(List(x2850), None).name("x2866").ctrl(x3111) // RegRead(x2850)
    ...
    val b1373 = IterDef(x2867, Some(0)).ctrl(x3107).name("b1373")
    val b1375 = DummyDef().ctrl(x3107).name("b1375")
    val b1374 = IterDef(x2867, Some(1)).ctrl(x3107).name("b1374")
    val b1376 = DummyDef().ctrl(x3107).name("b1376")
    ...
    val b3138 = StoreDef(List(b3135), None, x2886).name("b3138").ctrl(x2889) // StreamWrite(x2879,x2887,b1375)
    val b3139 = StoreDef(List(b3136), None, Const(1536)).name("b3139").ctrl(x2889) // StreamWrite(x2879,x2887,b1375)
    ...
    val b1401 = IterDef(x2891, None).ctrl(x2897).name("b1401")
    val b1402 = DummyDef().ctrl(x2897).name("b1402")
    val x2893 = OpDef(op=BitAnd, inputs=List(b1402, b1375)).name("x2893").ctrl(x2897) // And(b1402,b1375)
    val b3140 = LoadDef(List(b3137), None).name("b3140").ctrl(x2897) // ParStreamRead(x2880,List(x2893))
    val b3141 = b3140 // x2895 = VectorApply(x2894,0)
    val x2896 = StoreDef(List(x2869_d0_b0), Some(List(b1401)), b3141).name("x2896").ctrl(x2897) // ParSRAMStore(x2869,List(List(b1401)),List(x2895),List(x2893))
    ...
    val b3145 = StoreDef(List(b3142), None, x2906).name("b3145").ctrl(x2909) // StreamWrite(x2899,x2907,b1375)
    val b3146 = StoreDef(List(b3143), None, Const(1536)).name("b3146").ctrl(x2909) // StreamWrite(x2899,x2907,b1375)
    ...
    val b1423 = IterDef(x2911, None).ctrl(x2917).name("b1423")
    val b1424 = DummyDef().ctrl(x2917).name("b1424")
    val x2913 = OpDef(op=BitAnd, inputs=List(b1424, b1375)).name("x2913").ctrl(x2917) // And(b1424,b1375)
    val b3147 = LoadDef(List(b3144), None).name("b3147").ctrl(x2917) // ParStreamRead(x2900,List(x2913))
    val b3148 = b3147 // x2915 = VectorApply(x2914,0)
    val x2916 = StoreDef(List(x2871_d0_b0), Some(List(b1423)), b3148).name("x2916").ctrl(x2917) // ParSRAMStore(x2871,List(List(b1423)),List(x2915),List(x2913))
    ...
    val b3152 = StoreDef(List(b3149), None, x2926).name("b3152").ctrl(x2929) // StreamWrite(x2919,x2927,b1375)
    val b3153 = StoreDef(List(b3150), None, Const(1536)).name("b3153").ctrl(x2929) // StreamWrite(x2919,x2927,b1375)
    ...
    val b1445 = IterDef(x2931, None).ctrl(x2937).name("b1445")
    val b1446 = DummyDef().ctrl(x2937).name("b1446")
    val x2933 = OpDef(op=BitAnd, inputs=List(b1446, b1375)).name("x2933").ctrl(x2937) // And(b1446,b1375)
    val b3154 = LoadDef(List(b3151), None).name("b3154").ctrl(x2937) // ParStreamRead(x2920,List(x2933))
    val b3155 = b3154 // x2935 = VectorApply(x2934,0)
    val x2936 = StoreDef(List(x2873_d0_b0), Some(List(b1445)), b3155).name("x2936").ctrl(x2937) // ParSRAMStore(x2873,List(List(b1445)),List(x2935),List(x2933))
    ...
    val b3159 = StoreDef(List(b3156), None, x2946).name("b3159").ctrl(x2949) // StreamWrite(x2939,x2947,b1375)
    val b3160 = StoreDef(List(b3157), None, Const(1536)).name("b3160").ctrl(x2949) // StreamWrite(x2939,x2947,b1375)
    ...
    val b1467 = IterDef(x2951, None).ctrl(x2957).name("b1467")
    val b1468 = DummyDef().ctrl(x2957).name("b1468")
    val x2953 = OpDef(op=BitAnd, inputs=List(b1468, b1375)).name("x2953").ctrl(x2957) // And(b1468,b1375)
    val b3161 = LoadDef(List(b3158), None).name("b3161").ctrl(x2957) // ParStreamRead(x2940,List(x2953))
    val b3162 = b3161 // x2955 = VectorApply(x2954,0)
    val x2956 = StoreDef(List(x2875_d0_b0), Some(List(b1467)), b3162).name("x2956").ctrl(x2957) // ParSRAMStore(x2875,List(List(b1467)),List(x2955),List(x2953))
    ...
    val b3166 = StoreDef(List(b3163), None, x2968).name("b3166").ctrl(x2971) // StreamWrite(x2961,x2969,b1376)
    val b3167 = StoreDef(List(b3164), None, Const(1536)).name("b3167").ctrl(x2971) // StreamWrite(x2961,x2969,b1376)
    ...
    val b1492 = IterDef(x2973, None).ctrl(x2979).name("b1492")
    val b1493 = DummyDef().ctrl(x2979).name("b1493")
    val x2975 = OpDef(op=BitAnd, inputs=List(b1493, b1376)).name("x2975").ctrl(x2979) // And(b1493,b1376)
    val b3168 = LoadDef(List(b3165), None).name("b3168").ctrl(x2979) // ParStreamRead(x2962,List(x2975))
    val b3169 = b3168 // x2977 = VectorApply(x2976,0)
    val x2978 = StoreDef(List(x2870_d0_b0), Some(List(b1492)), b3169).name("x2978").ctrl(x2979) // ParSRAMStore(x2870,List(List(b1492)),List(x2977),List(x2975))
    ...
    val b3173 = StoreDef(List(b3170), None, x2988).name("b3173").ctrl(x2991) // StreamWrite(x2981,x2989,b1376)
    val b3174 = StoreDef(List(b3171), None, Const(1536)).name("b3174").ctrl(x2991) // StreamWrite(x2981,x2989,b1376)
    ...
    val b1514 = IterDef(x2993, None).ctrl(x2999).name("b1514")
    val b1515 = DummyDef().ctrl(x2999).name("b1515")
    val x2995 = OpDef(op=BitAnd, inputs=List(b1515, b1376)).name("x2995").ctrl(x2999) // And(b1515,b1376)
    val b3175 = LoadDef(List(b3172), None).name("b3175").ctrl(x2999) // ParStreamRead(x2982,List(x2995))
    val b3176 = b3175 // x2997 = VectorApply(x2996,0)
    val x2998 = StoreDef(List(x2872_d0_b0), Some(List(b1514)), b3176).name("x2998").ctrl(x2999) // ParSRAMStore(x2872,List(List(b1514)),List(x2997),List(x2995))
    ...
    val b3180 = StoreDef(List(b3177), None, x3008).name("b3180").ctrl(x3011) // StreamWrite(x3001,x3009,b1376)
    val b3181 = StoreDef(List(b3178), None, Const(1536)).name("b3181").ctrl(x3011) // StreamWrite(x3001,x3009,b1376)
    ...
    val b1536 = IterDef(x3013, None).ctrl(x3019).name("b1536")
    val b1537 = DummyDef().ctrl(x3019).name("b1537")
    val x3015 = OpDef(op=BitAnd, inputs=List(b1537, b1376)).name("x3015").ctrl(x3019) // And(b1537,b1376)
    val b3182 = LoadDef(List(b3179), None).name("b3182").ctrl(x3019) // ParStreamRead(x3002,List(x3015))
    val b3183 = b3182 // x3017 = VectorApply(x3016,0)
    val x3018 = StoreDef(List(x2874_d0_b0), Some(List(b1536)), b3183).name("x3018").ctrl(x3019) // ParSRAMStore(x2874,List(List(b1536)),List(x3017),List(x3015))
    ...
    val b3187 = StoreDef(List(b3184), None, x3028).name("b3187").ctrl(x3031) // StreamWrite(x3021,x3029,b1376)
    val b3188 = StoreDef(List(b3185), None, Const(1536)).name("b3188").ctrl(x3031) // StreamWrite(x3021,x3029,b1376)
    ...
    val b1558 = IterDef(x3033, None).ctrl(x3039).name("b1558")
    val b1559 = DummyDef().ctrl(x3039).name("b1559")
    val x3035 = OpDef(op=BitAnd, inputs=List(b1559, b1376)).name("x3035").ctrl(x3039) // And(b1559,b1376)
    val b3189 = LoadDef(List(b3186), None).name("b3189").ctrl(x3039) // ParStreamRead(x3022,List(x3035))
    val b3190 = b3189 // x3037 = VectorApply(x3036,0)
    val x3038 = StoreDef(List(x2876_d0_b0), Some(List(b1558)), b3190).name("x3038").ctrl(x3039) // ParSRAMStore(x2876,List(List(b1558)),List(x3037),List(x3035))
    ...
    val b1574 = IterDef(x3043, None).ctrl(x3069).name("b1574")
    val b1575 = DummyDef().ctrl(x3069).name("b1575")
    val x3045 = OpDef(op=BitAnd, inputs=List(b1575, b1375)).name("x3045").ctrl(x3069) // And(b1575,b1375)
    val x3046 = LoadDef(List(x2869_d0_b0), Some(List(b1574))).name("x3046").ctrl(x3069) // ParSRAMLoad(x2869,List(List(b1574)),List(x3045))
    val x3047 = x3046 // x3047 = VectorApply(x3046,0)
    val x3048 = LoadDef(List(x2873_d0_b0), Some(List(b1574))).name("x3048").ctrl(x3069) // ParSRAMLoad(x2873,List(List(b1574)),List(x3045))
    val x3049 = x3048 // x3049 = VectorApply(x3048,0)
    val x3050 = LoadDef(List(x2871_d0_b0), Some(List(b1574))).name("x3050").ctrl(x3069) // ParSRAMLoad(x2871,List(List(b1574)),List(x3045))
    val x3051 = x3050 // x3051 = VectorApply(x3050,0)
    val x3052 = LoadDef(List(x2875_d0_b0), Some(List(b1574))).name("x3052").ctrl(x3069) // ParSRAMLoad(x2875,List(List(b1574)),List(x3045))
    ...
    val x3065 = LoadDef(List(x3041_d1), None).name("x3065").ctrl(x3069) // RegRead(x3041)
    ...
    val x3068 = StoreDef(List(x3041_d0, x3041_d1), None, x3067).name("x3068").ctrl(x3069) // RegWrite(x3041,x3067,b1375)
    ...
    val b1601 = IterDef(x3070, None).ctrl(x3096).name("b1601")
    val b1602 = DummyDef().ctrl(x3096).name("b1602")
    val x3072 = OpDef(op=BitAnd, inputs=List(b1602, b1376)).name("x3072").ctrl(x3096) // And(b1602,b1376)
    val x3073 = LoadDef(List(x2870_d0_b0), Some(List(b1601))).name("x3073").ctrl(x3096) // ParSRAMLoad(x2870,List(List(b1601)),List(x3072))
    val x3074 = x3073 // x3074 = VectorApply(x3073,0)
    val x3075 = LoadDef(List(x2874_d0_b0), Some(List(b1601))).name("x3075").ctrl(x3096) // ParSRAMLoad(x2874,List(List(b1601)),List(x3072))
    val x3076 = x3075 // x3076 = VectorApply(x3075,0)
    val x3077 = LoadDef(List(x2872_d0_b0), Some(List(b1601))).name("x3077").ctrl(x3096) // ParSRAMLoad(x2872,List(List(b1601)),List(x3072))
    val x3078 = x3077 // x3078 = VectorApply(x3077,0)
    val x3079 = LoadDef(List(x2876_d0_b0), Some(List(b1601))).name("x3079").ctrl(x3096) // ParSRAMLoad(x2876,List(List(b1601)),List(x3072))
    ...
    val x3092 = LoadDef(List(x3042_d1), None).name("x3092").ctrl(x3096) // RegRead(x3042)
    ...
    val x3095 = StoreDef(List(x3042_d0, x3042_d1), None, x3094).name("x3095").ctrl(x3096) // RegWrite(x3042,x3094,b1376)
    val x3106 = UnitController(style=SeqPipe, level=InnerControl).name("x3106").ctrl(x3107) // UnitPipe(List(Const(true)),Block(x3105))
    val x3097 = LoadDef(List(x3042_d0), None).name("x3097").ctrl(x3106) // RegRead(x3042)
    val x3098 = LoadDef(List(x3041_d0), None).name("x3098").ctrl(x3106) // RegRead(x3041)
    ...
    val x3102 = LoadDef(List(x2865_d1), None).name("x3102").ctrl(x3106) // RegRead(x2865)
    ...
    val x3105 = StoreDef(List(x2865_d0, x2865_d1), None, x3104).name("x3105").ctrl(x3106) // RegWrite(x2865,x3104,Const(true))
    val x3110 = UnitController(style=SeqPipe, level=InnerControl).name("x3110").ctrl(x3111) // UnitPipe(List(Const(true)),Block(Const(())))
    val x3108 = LoadDef(List(x2865_d0), None).name("x3108").ctrl(x3110) // RegRead(x2865)
    val x3109 = StoreDef(List(x2860), None, x3108).name("x3109").ctrl(x3110) // RegWrite(x2860,x3108,Const(true))
