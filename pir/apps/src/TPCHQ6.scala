...
object TPCHQ6 extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x2848 = top.argFringe.argIn(init=0).name("x2848").ctrl(top) // ArgInNew(Const(0))
    boundOf(x2848) = 1024
    ...
    val x2858 = top.argFringe.argOut(init=0).name("x2858").ctrl(top) // ArgOutNew(Const(0))
    ...
    val x2882 = top.argFringe.dramAddress(x2851).name("x2882").ctrl(x2887) // GetDRAMAddress(x2851)
    ...
    val x2888 = FringeContainer(x2851,b3133,b3134,x2878).name("x2888").ctrl(x2896) // FringeDenseLoad(x2851,x2877,x2878)
    ...
    val x2902 = top.argFringe.dramAddress(x2853).name("x2902").ctrl(x2907) // GetDRAMAddress(x2853)
    ...
    val x2908 = FringeContainer(x2853,b3137,b3138,x2898).name("x2908").ctrl(x2916) // FringeDenseLoad(x2853,x2897,x2898)
    ...
    val x2922 = top.argFringe.dramAddress(x2855).name("x2922").ctrl(x2927) // GetDRAMAddress(x2855)
    ...
    val x2928 = FringeContainer(x2855,b3141,b3142,x2918).name("x2928").ctrl(x2936) // FringeDenseLoad(x2855,x2917,x2918)
    ...
    val x2942 = top.argFringe.dramAddress(x2857).name("x2942").ctrl(x2947) // GetDRAMAddress(x2857)
    ...
    val x2948 = FringeContainer(x2857,b3145,b3146,x2938).name("x2948").ctrl(x2956) // FringeDenseLoad(x2857,x2937,x2938)
    ...
    val x2964 = top.argFringe.dramAddress(x2851).name("x2964").ctrl(x2969) // GetDRAMAddress(x2851)
    ...
    val x2970 = FringeContainer(x2851,b3149,b3150,x2960).name("x2970").ctrl(x2978) // FringeDenseLoad(x2851,x2959,x2960)
    ...
    val x2984 = top.argFringe.dramAddress(x2853).name("x2984").ctrl(x2989) // GetDRAMAddress(x2853)
    ...
    val x2990 = FringeContainer(x2853,b3153,b3154,x2980).name("x2990").ctrl(x2998) // FringeDenseLoad(x2853,x2979,x2980)
    ...
    val x3004 = top.argFringe.dramAddress(x2855).name("x3004").ctrl(x3009) // GetDRAMAddress(x2855)
    ...
    val x3010 = FringeContainer(x2855,b3157,b3158,x3000).name("x3010").ctrl(x3018) // FringeDenseLoad(x2855,x2999,x3000)
    ...
    val x3024 = top.argFringe.dramAddress(x2857).name("x3024").ctrl(x3029) // GetDRAMAddress(x2857)
    ...
    val x3030 = FringeContainer(x2857,b3161,b3162,x3020).name("x3030").ctrl(x3038) // FringeDenseLoad(x2857,x3019,x3020)
