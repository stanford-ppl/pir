...
object DotProduct extends PIRApp {
  def main(top:Top) = {
    ...
    val b1555 = WriteMems(List(b1552), x1476).name("b1555").ctrl(x1479) // StreamWrite(x1469,x1477,b929)
    val b1556 = WriteMems(List(b1553), Const(64)).name("b1556").ctrl(x1479) // StreamWrite(x1469,x1477,b929)
    ...
    val b1557 = ReadMem(b1554).name("b1557").ctrl(x1487) // ParStreamRead(x1470,List(x1483))
    val b1558 = b1557 // x1485 = VectorApply(x1484,0)
    val x1486 = StoreBanks(List(x1465_d0_b0), List(b948), b1558).name("x1486").ctrl(x1487) // ParSRAMStore(x1465,List(List(b948)),List(x1485),List(x1483))
    ...
    val b1562 = WriteMems(List(b1559), x1496).name("b1562").ctrl(x1499) // StreamWrite(x1489,x1497,b929)
    val b1563 = WriteMems(List(b1560), Const(64)).name("b1563").ctrl(x1499) // StreamWrite(x1489,x1497,b929)
    ...
    val b1564 = ReadMem(b1561).name("b1564").ctrl(x1507) // ParStreamRead(x1490,List(x1503))
    val b1565 = b1564 // x1505 = VectorApply(x1504,0)
    val x1506 = StoreBanks(List(x1466_d0_b0), List(b970), b1565).name("x1506").ctrl(x1507) // ParSRAMStore(x1466,List(List(b970)),List(x1505),List(x1503))
