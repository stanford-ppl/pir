...
object DotProduct extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x1463 = Counter(min=Const(0), max=x1462, step=Const(16), par=1).name("x1463").ctrl(x1533) // CounterNew(Const(0),x1462,Const(16),Const(1))
    ...
    val x1481 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x1481").ctrl(x1488) // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x1501 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x1501").ctrl(x1508) // CounterNew(Const(0),Const(16),Const(1),Const(16))
    ...
    val x1510 = Counter(min=Const(0), max=Const(16), step=Const(1), par=16).name("x1510").ctrl(x1529) // CounterNew(Const(0),Const(16),Const(1),Const(16))
