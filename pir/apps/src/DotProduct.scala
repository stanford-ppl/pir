...
object DotProduct extends PIRApp {
  def main(top:Top) = {
    val x1451 = top.argIn(init=Const(0)).ctrl(top)
    ...
    val x1458 = top.argOut(init=Const(0)).ctrl(top)
    ...
    val x1461_d0 = Reg(init=Const(0)).name("x1461_d0").ctrl(x1533) // x1461 = RegNew(Const(0))
    val x1461_d1 = Reg(init=Const(0)).name("x1461_d1").ctrl(x1533) // x1461 = RegNew(Const(0))
    ...
    val b928 = IterDef(x1463, Some(0)).ctrl(x1533)
    val b929 = DummyDef().ctrl(x1533)
    ...
    val x1480 = CUContainer().addChildren(x1455,b1552,b1553,b1554).name("x1480").ctrl(x1488) // FringeDenseLoad(x1455,x1469,x1470)
    ...
    val b948 = IterDef(x1481, None).ctrl(x1488)
    val b949 = DummyDef().ctrl(x1488)
    ...
    val x1500 = CUContainer().addChildren(x1457,b1559,b1560,b1561).name("x1500").ctrl(x1508) // FringeDenseLoad(x1457,x1489,x1490)
    ...
    val b970 = IterDef(x1501, None).ctrl(x1508)
    val b971 = DummyDef().ctrl(x1508)
    ...
    val x1509_d0 = Reg(init=Const(0)).name("x1509_d0").ctrl(x1529) // x1509 = RegNew(Const(0))
    val x1509_d1 = Reg(init=Const(0)).name("x1509_d1").ctrl(x1529) // x1509 = RegNew(Const(0))
    ...
    val b982 = IterDef(x1510, None).ctrl(x1529)
    val b983 = DummyDef().ctrl(x1529)
