...
object DotProduct extends PIRApp {
  def main(top:Top) = {
    ...
    val b1554 = WriteMems(List(b1552), x1476).name("b1554").ctrl(x1479) // StreamWrite(x1469,x1477,b929)
    val b1555 = WriteMems(List(b1553), Const(64)).name("b1555").ctrl(x1479) // StreamWrite(x1469,x1477,b929)
    ...
    val b1558 = WriteMems(List(b1556), x1496).name("b1558").ctrl(x1499) // StreamWrite(x1489,x1497,b929)
    val b1559 = WriteMems(List(b1557), Const(64)).name("b1559").ctrl(x1499) // StreamWrite(x1489,x1497,b929)
    ...
    val x1517_0 = ReduceOp(op=FixAdd, input=x1517).name("x1517_0").ctrl(x1522) // FixAdd(x1517,x1518)
    val x1517_1 = ReduceOp(op=FixAdd, input=x1517_0).name("x1517_1").ctrl(x1522) // FixAdd(x1517,x1518)
    val x1517_2 = ReduceOp(op=FixAdd, input=x1517_1).name("x1517_2").ctrl(x1522) // FixAdd(x1517,x1518)
    val x1517_3 = ReduceOp(op=FixAdd, input=x1517_2).name("x1517_3").ctrl(x1522) // FixAdd(x1517,x1518)
    val x1520 = AccumOp(op=FixAdd, input=x1517_3, accum=x1518).name("x1520").ctrl(x1522) // FixAdd(x1517,x1518)
    val x1521 = WriteMems(List(x1509_d0, x1509_d1), x1520).name("x1521").ctrl(x1522) // RegWrite(x1509,x1520,b929)
    ...
    val x1526 = AccumOp(op=FixAdd, input=x1525, accum=x1523).name("x1526").ctrl(x1528) // FixAdd(x1525,x1523)
    val x1527 = WriteMems(List(x1461_d0, x1461_d1), x1526).name("x1527").ctrl(x1528) // RegWrite(x1461,x1526,Const(true))
    ...
    val x1531 = WriteMems(List(x1458), x1530).name("x1531").ctrl(x1532) // RegWrite(x1458,x1530,Const(true))
