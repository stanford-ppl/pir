...
object DotProduct extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val x1478 = FringeContainer(x1453,b1550,b1551,x1468).name("x1478").ctrl(x1486) // FringeDenseLoad(x1453,x1467,x1468)
    ...
    val x1498 = FringeContainer(x1455,b1554,b1555,x1488).name("x1498").ctrl(x1506) // FringeDenseLoad(x1455,x1487,x1488)
