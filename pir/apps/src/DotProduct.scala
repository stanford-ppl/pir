...
object DotProduct extends PIRApp {
  def main(implicit design:PIRDesign) = {
    ...
    val b865 = Const(true).ctrl(x1465).name("b865")
    ...
    val b885 = Const(true).ctrl(x1423).name("b885")
    ...
    val b907 = Const(true).ctrl(x1443).name("b907")
    ...
    val b919 = Const(true).ctrl(x1458).name("b919")
