...
object DotProduct extends PIRApp {
  def main(top:Top) = {
    ...
    val b928 = IterDef(x1463, Some(0)).ctrl(x1529).name("b928")
    val b929 = DummyDef().ctrl(x1529).name("b929")
    ...
    val b948 = IterDef(x1481, None).ctrl(x1487).name("b948")
    val b949 = DummyDef().ctrl(x1487).name("b949")
    ...
    val b970 = IterDef(x1501, None).ctrl(x1507).name("b970")
    val b971 = DummyDef().ctrl(x1507).name("b971")
    ...
    val b982 = IterDef(x1510, None).ctrl(x1522).name("b982")
    val b983 = DummyDef().ctrl(x1522).name("b983")
