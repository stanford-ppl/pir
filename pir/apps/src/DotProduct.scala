...
object DotProduct extends PIRApp {
  def main(top:Top) = {
    ...
    val x1465_dsp0_bank0 = MemoryPipeline(name="x1465_dsp0_bank0",parent="x1529") { implicit CU => 
      val b1562 = VectorFIFO(size=1,name="b1562")
        .store(x1465_x1513_ra_v, None, None)
      val b1556 = VectorFIFO(size=1,name="b1556")
        .store(x1465_x1486_wa_v, None, None)
      ...
      val x1465 = SRAM(size=1,name="x1465",banking = Strided(1,16))
        .buffering(2)
        .store(x1486.readPort, Some(b1556.readPort), Some("x1488"))
        .load(x1465_x1465_dsp0_bank0_data_v, Some(b1562.readPort), Some("x1522_0"))
    }
    val x1466_dsp0_bank0 = MemoryPipeline(name="x1466_dsp0_bank0",parent="x1529") { implicit CU => 
      val b1563 = VectorFIFO(size=1,name="b1563")
        .store(x1466_x1515_ra_v, None, None)
      val x1506 = VectorFIFO(size=1,name="x1506")
        .store(x1490_x1500_data_v, None, None)
      val b1561 = VectorFIFO(size=1,name="b1561")
        .store(x1466_x1506_wa_v, None, None)
      val x1466 = SRAM(size=1,name="x1466",banking = Strided(1,16))
        .buffering(2)
        .store(x1506.readPort, Some(b1561.readPort), Some("x1508"))
        .load(x1466_x1466_dsp0_bank0_data_v, Some(b1563.readPort), Some("x1522_0"))
    }
    ...
    val x1500 = MemoryController(name="x1500",parent="x1508",offchip=b_oc, mctpe=TileLoad) { implicit CU => 
      val x1489_b1557 = ScalarFIFO(size=1,name="offset")
        .store(x1489_b1557_x1498_b1559_s, None, None)
      val x1489_b1558 = ScalarFIFO(size=1,name="size")
        .store(x1489_b1558_x1498_b1560_s, None, None)
