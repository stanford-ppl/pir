...
abstract class BreathFirstRouter(implicit design:PIR) extends Router {
  import spademeta._
...
class VectorBFRouter()(implicit val design:PIR) extends BreathFirstRouter with VectorRouter 

class ScalarBFRouter()(implicit val design:PIR) extends BreathFirstRouter with ScalarRouter

class ControlBFRouter()(implicit val design:PIR) extends BreathFirstRouter with ControlRouter
