...
object PIRConfig extends prism.GlobalConfig {
  ...
  register("proute-vlink", default=0, info="Number of vector static link used in plastiroute") 
  register("proute-slink", default=6, info="Number of scalar static link used in plastiroute") 
  register("proute-iter", default=10, info="Number of iterations to run in plastiroute") 
