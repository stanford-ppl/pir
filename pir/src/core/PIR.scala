...
trait PIR extends Compiler with PIRWorld {
  ...
  override def initSession = {
    ...
    addPass(enableSplitting && enableDot, new PIRIRDotCodegen(s"top6.dot"))
    ...
    addPass(genCtrl && enableDot, new PIRIRDotCodegen(s"top9.dot"))
    ...
    addPass(genPlastisim, psimConfigCodegen).dependsOn(cuPlacer, linkCSVCodegen, psimTraceCodegen)
