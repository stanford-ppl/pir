...
class UnalginReduceFIFO_0 extends UnalginReduceFIFO(op=3, ip=5)
class UnalginReduceFIFO_1 extends UnalginReduceFIFO(op=3)

@spatial abstract class UnalginReduceFIFO(
  N:scala.Int = 64,
  ts1:scala.Int = 16,
  ip:scala.Int = 16,
  op:scala.Int = 1,
