...
class SumSquare_4 extends SumSquare { override lazy val param = SumSquareParam(ip=3, op=2) }
class SumSquare_5 extends SumSquare { override lazy val param = SumSquareParam(ip=3, op=3) }
